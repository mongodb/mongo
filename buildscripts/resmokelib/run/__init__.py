...
class RunPlugin(PluginInterface):
    ...
    def _add_run(cls, subparsers):  # pylint: disable=too-many-statements
        ...
        parser.add_argument(
            "--auto-kill-all-mongo", dest="auto_kill", choices=['on', 'warn',
                                                                'off'], default='warn',
            help=("When resmoke starts up, existing mongo processes could cause"
                  ...
                  " the detected existing processes and continue running the test, or if 'warn'"
                  " is used, just warn and fail the test."))
