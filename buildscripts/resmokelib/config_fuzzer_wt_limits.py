...
config_fuzzer_params = {
    "wt": {
        ...
        "eviction_target": {"min": 50, "max": 95}, "eviction_trigger": {"min": 1, "max": 99},
        "eviction_dirty_target_1": {"min": 5, "max": 50}, "eviction_dirty_target_2": {
            "min": target_bytes_min, "max": target_bytes_max
        }, "close_idle_time_secs": {"min": 1, "max": 100}, "close_handle_minimum": {
            "min": 0, "max": 1000
        }, "close_scan_interval": {"min": 1, "max": 100}, "dbg_eviction": {
            "choices": ['true', 'false']
    ...
    "wt_table": {
        ...
        "internal_page_max": {
            "choices": [4, 8, 12, 1024, 10 * 1024], "min": 4 * 1024, "max": 10 * 1024 * 1024
        },
        "leaf_page_max": {
            "choices": [4, 8, 12, 1024, 10 * 1024], "min": 4 * 1024, "max": 10 * 1024 * 1024
        },
        "leaf_value_max": {
            "choices": [1, 32, 128, 256], "min": 1 * 1024 * 1024, "max": 256 * 1024 * 1024
        },
