...
class SetupMultiversion(Subcommand):
    ...
    def download_and_extract_from_urls(self, urls, bin_suffix, install_dir):
        ...
        python_venv_url = urls.get("Python venv (see included README.txt)", "") or urls.get("Python venv (see included venv_readme.txt)", "") if self.download_python_venv else None
