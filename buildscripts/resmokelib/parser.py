...
def _update_config_vars(values):  # pylint: disable=too-many-statements
    ...
    _config.MERIZO_EXECUTABLE = _expand_user(config.pop("merizo_executable"))
    _config.MERIZOD_EXECUTABLE = _expand_user(config.pop("merizod_executable"))
    _config.MERIZOD_SET_PARAMETERS = config.pop("merizod_set_parameters")
    _config.MERIZOEBENCH_EXECUTABLE = _expand_user(config.pop("merizoebench_executable"))
    _config.MERIZOS_EXECUTABLE = _expand_user(config.pop("merizos_executable"))
    _config.MERIZOS_SET_PARAMETERS = config.pop("merizos_set_parameters")
