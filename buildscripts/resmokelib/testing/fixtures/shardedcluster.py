...
class ShardedClusterFixture(interface.Fixture, interface._DockerComposeInterface):
    ...
    def __init__(
        ...
        self.has_uninitialized_fcv_initial_sync_nodes_in_shards = (
        ...
        self._dbpath_prefix = os.path.join(
            dbpath_prefix if dbpath_prefix else self._dbpath_prefix,
    ...
    def await_ready(self):
        ...
        if self.inject_catalog_metadata:
            ...
            sharded_cluster_util.inject_catalog_metadata_on_the_csrs(
                csrs_client, self.inject_catalog_metadata
            )
