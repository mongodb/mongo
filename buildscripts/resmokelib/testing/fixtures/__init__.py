...
from buildscripts.resmokelib.testing.fixtures.external import (
    ExternalFixture as _ExternalFixture,
)
from buildscripts.resmokelib.testing.fixtures.interface import (
    NoOpFixture as _NoOpFixture,
)
