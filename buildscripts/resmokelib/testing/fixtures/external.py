...
class ExternalFixture(interface.Fixture):
    ...
    def get_internal_connection_string(self):
        ...
        # parse the merizodb:// connection string the user specified via the command line into the
        # internal format used by the server.
        raise NotImplementedError("ExternalFixture can only be used with a MerizoDB connection URI")
