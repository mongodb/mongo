...
def get_config_options(cmd_line_options, config_file):
    ...
    return ConfigOptions(max_sub_suites, project, resmoke_args, resmoke_jobs_max, run_multiple_jobs,
                         suite, task, variant)
...
class Main(object):
    ...
    def get_data(self, project, start_date, end_date, task, variant):
    ...
    def main(self):
        ...
        data = self.get_data(self.config_options.project, start_date, end_date,
