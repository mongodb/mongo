#!/usr/bin/env python
"""Script and library for symbolizing BongoDB stack traces.
...
bongosymb.py --symbolizer-path=/path/to/llvm-symbolizer /path/to/executable </file/with/stacktrace
...
def symbolize_frames(trace_doc, dbg_path_resolver, symbolizer_path=None, dsym_hint=None):
    """Given a trace_doc in BongoDB stack dump format, returns a list of symbolized stack frames.
    """

    if symbolizer_path is None:
        symbolizer_path = os.environ.get("BONGOSYMB_SYMBOLIZER_PATH", "llvm-symbolizer")
