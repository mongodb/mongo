...
#
# Useful script for installing multiple versions of BongoDB on a machine
...
class MultiVersionDownloader:
    ...
    def download_links(self):
        ...
        download_file("https://downloads.bongodb.org/full.json", temp_file)
...
CL_HELP_MESSAGE = \
"""
Downloads and installs particular bongodb versions (each binary is renamed to include its version)
...
Usage: setup_multiversion_bongodb.py INSTALL_DIR LINK_DIR EDITION PLATFORM_AND_ARCH VERSION1 [VERSION2 VERSION3 ...]
...
Ex: setup_multiversion_bongodb.py ./install ./link base "Linux/x86_64" "2.0.6" "2.0.3-rc0" "2.0" "2.2" "2.3"
Ex: setup_multiversion_bongodb.py ./install ./link enterprise "OSX" "2.4" "2.2"

After running the script you will have a directory structure like this:
./install/[bongodb-osx-x86_64-2.4.9, bongodb-osx-x86_64-2.2.7]
./link/[bongod-2.4.9, bongod-2.2.7, bongo-2.4.9...]
