...
from buildscripts.build_system_options import (
    PathOptions,  # pylint: disable=wrong-import-position
)
from buildscripts.util.oauth import (  # pylint: disable=wrong-import-position
    Configs,
