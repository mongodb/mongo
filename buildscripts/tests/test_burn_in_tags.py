...
class TestAcceptance(unittest.TestCase):
    ...
    def test_no_tests_run_if_none_changed(self, find_changed_tests_mock,
        ...
        under_test.burn_in(EXPANSIONS_FILE_DATA, evg_conf_mock, None, repos, 'install_dir/bin')
    ...
    def test_tests_generated_if_a_file_changed(
        ...
        under_test.burn_in(EXPANSIONS_FILE_DATA, evg_conf, None, repos, 'install_dir/bin')
