...
class TestReplicaSetFixtureUDSEnvironmentVariables(unittest.TestCase):
    ...
    def test_fixture_type_is_set(self):
        ...
        self.assertEqual(
            fixture_type,
            "ReplicaSetFixture",
            "Fixture type should be ReplicaSetFixture",
        )
    ...
    def test_mongodb_uds_paths_are_set(self):
        ...
        self.assertIsNotNone(
            uds_paths,
            "MONGODB_UDS_PATHS environment variable should be set when UDS is configured",
        )
    ...
    def test_mongodb_primary_uds_path_is_set(self):
        ...
        self.assertIsNotNone(primary_uds,
                             "MONGODB_PRIMARY_UDS_PATH should be set when UDS is configured")
