...
class TestFixtureUDSEnvironmentVariables(unittest.TestCase):
    ...
    def test_fixture_type_is_set(self):
        ...
        self.assertEqual(
            fixture_type, "MongoDFixture", "Fixture type should be MongoDFixture"
        )
    ...
    def test_mongodb_uds_path_is_set(self):
        ...
        self.assertIsNotNone(
            uds_path,
            "MONGODB_UDS_PATH environment variable should be set when UDS is configured",
        )
    ...
    def test_mongodb_uds_paths_is_set(self):
        ...
        self.assertEqual(
            uds_paths,
            uds_path,
            "MONGODB_UDS_PATHS should equal MONGODB_UDS_PATH for standalone",
        )
