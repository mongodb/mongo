...
class TestTask(unittest.TestCase):
    ...
    def test_suite_to_resmoke_args_map_for_gen_task_with_suite(self):  # pylint: disable=invalid-name
        suite = "core"
        task_commands = [{
            "func": "generate resmoke tasks",
    ...
    def test_suite_to_resmoke_args_map_for_initialize_multiversion_tasks_task(self):  # pylint: disable=invalid-name
        task_commands = [
            {
    ...
    def test_get_resmoke_command_vars_from_run_tests_command(self):  # pylint: disable=invalid-name
    ...
    def test_get_resmoke_command_vars_from_generate_resmoke_tasks_command(self):  # pylint: disable=invalid-name
        resmoke_command_vars = {"suite": "core"}
