...
class TestTask(unittest.TestCase):
    ...
    def test_suite_to_resmoke_args_map_for_non_gen_task(self):
        ...
        self.assertEqual(
            {suite_and_task: f"--suites={suite_and_task} --arg=val"},
    ...
    def test_suite_to_resmoke_args_map_for_gen_task(self):
        ...
        self.assertEqual(
            {suite: f"--suites={suite} --installDir=/bin"},
            task.suite_to_resmoke_args_map,
        )
...
class TestVariant(unittest.TestCase):
    ...
    def test_variant_tasks(self):
        ...
        self.assertEqual(
            {
                "resmoke_task": "--suites=resmoke_task --storageEngine=wiredTiger --param=value --ubuntu"
            },
        ...
        self.assertEqual(
            {"passing_test": "--suites=passing_test --param=value --ubuntu"},
