...
def _bind_ifr_feature_flag_default(ctxt, param, feature_flag_phase):
    ...
    serialize_on_outgoing = "true" if param.serialize_on_outgoing_requests else "false"
    ...
    expr_for_default.expr = (
        ...
        f"{feature_flag_phase.to_camel_case_string()}, {default_value}, {serialize_on_outgoing}"
    )
