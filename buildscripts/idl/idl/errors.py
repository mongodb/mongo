...
class ParserContext(object):
    ...
    def add_unknown_command_type_error(self, location, struct_name):
        ...
        self._add_error(
            location, ERROR_ID_UNKNOWN_TYPE, "'%s' is an unknown command type." % (struct_name)
        )
    ...
    def add_unknown_symbol_error(self, location, symbol_name):
        ...
        self._add_error(
            location, ERROR_ID_UNKNOWN_TYPE, "'%s' is an unknown symbol" % (symbol_name)
        )
    ...
    def is_scalar_sequence_or_scalar_node(self, node, node_name):
        ...
        if not node.id == "scalar" and not node.id == "sequence":
            self._add_node_error(
                node,
                ERROR_ID_IS_NODE_TYPE_SCALAR_OR_SEQUENCE,
    ...
    def add_duplicate_error(self, node, node_name):
        ...
        self._add_node_error(
            node, ERROR_ID_DUPLICATE_NODE, "Duplicate node found for '%s'" % (node_name)
        )
    ...
    def add_missing_required_field_error(self, node, node_parent, node_name):
        ...
        self._add_node_error(
            node,
            ERROR_ID_MISSING_REQUIRED_FIELD,
    ...
    def add_bad_bson_bindata_subtype_error(self, location, ast_type, ast_parent, bson_type_name):
        ...
        self._add_error(
            location,
            ERROR_ID_BAD_BSON_BINDATA_SUBTYPE_TYPE,
    ...
    def add_bad_bson_bindata_subtype_value_error(self, location, ast_type, ast_parent, value):
        ...
        self._add_error(
            location,
            ERROR_ID_BAD_BSON_BINDATA_SUBTYPE_VALUE,
    ...
    def add_ignored_field_must_be_empty_error(self, location, name, field_name):
        ...
        self._add_error(
            location,
            ERROR_ID_FIELD_MUST_BE_EMPTY_FOR_IGNORED,
            (
    ...
    def add_struct_default_must_be_true_or_empty_error(self, location, name):
        ...
        self._add_error(
            location,
            ERROR_ID_DEFAULT_MUST_BE_TRUE_OR_EMPTY_FOR_STRUCT,
            (
    ...
    def add_not_custom_scalar_serialization_not_supported_error(  # pylint: disable=invalid-name
        ...
        self._add_error(
            location,
            ERROR_ID_CUSTOM_SCALAR_SERIALIZATION_NOT_SUPPORTED,
            (
    ...
    def add_bad_array_type_name_error(self, location, field_name, type_name):
        ...
        self._add_error(
            location,
            ERROR_ID_BAD_ARRAY_TYPE_NAME,
            (
                "'%s' is not a valid array type for field '%s'. A valid array type"
                + " is in the form 'array<type_name>'."
            )
    ...
    def add_bad_command_namespace_error(
        ...
        self._add_error(
            location,
            ERROR_ID_BAD_COMMAND_NAMESPACE,
    ...
    def add_bad_struct_field_as_doc_sequence_error(self, location, struct_name, field_name):
        ...
        self._add_error(
            location,
            ERROR_ID_STRUCT_NO_DOC_SEQUENCE,
            (
                "Field '%s' in struct '%s' cannot be used as a Command Document Sequence"
                " type. They are only supported in commands."
            )
    ...
    def add_bad_non_array_as_doc_sequence_error(self, location, struct_name, field_name):
        ...
        self._add_error(
            location,
            ERROR_ID_NO_DOC_SEQUENCE_FOR_NON_ARRAY,
            (
                "Field '%s' in command '%s' cannot be used as a Command Document Sequence"
                " type since it is not an array."
            )
            % (field_name, struct_name),
        )
    ...
    def add_bad_non_object_as_doc_sequence_error(self, location, field_name):
        ...
        self._add_error(
            location,
            ERROR_ID_NO_DOC_SEQUENCE_FOR_NON_OBJECT,
            (
                "Field '%s' cannot be used as a Command Document Sequence"
                " type since it is not a BSON object or struct."
            )
            % (field_name),
        )
    ...
    def add_bad_command_name_duplicates_field(self, location, command_name):
        ...
        self._add_error(
            location,
            ERROR_ID_COMMAND_DUPLICATES_FIELD,
    ...
    def add_bad_field_non_const_getter_in_immutable_struct_error(  # pylint: disable=invalid-name
        ...
        self._add_error(
            ...
            (
                ...
                " struct '%s' is marked as immutable."
            )
    ...
    def add_variant_structs_error(self, location, field_name):
        ...
        self._add_error(
            location,
            ERROR_ID_VARIANT_STRUCTS,
            (
                "Variant field '%s' has multiple struct alternatives, this is prohibited"
                " to avoid ambiguity while parsing BSON subdocuments."
            )
            % (field_name,),
        )
    ...
    def add_variant_enum_error(self, location, field_name, type_name):
        ...
        self._add_error(
            location,
            ERROR_ID_NO_VARIANT_ENUM,
            "Field '%s' cannot be a variant with an enum alternative type '%s'"
            % (field_name, type_name),
        )
    ...
    def add_bad_array_variant_types_error(self, location, type_name):
        ...
        self._add_error(
            location,
            ERROR_ID_INVALID_ARRAY_VARIANT,
            (
                "'%s' is not a valid array variant type. A valid array variant type"
                + " is in the form 'array<variant<type_name1, ...>>'."
            )
            % (type_name),
        )
    ...
    def is_scalar_non_negative_int_node(self, node, node_name):
        ...
        try:
            ...
            if value < 0:
                self._add_node_error(
                    node,
                    ERROR_ID_IS_NODE_VALID_NON_NEGATIVE_INT,
    ...
    def add_server_parameter_invalid_method_override(self, location, method):
        ...
        self._add_error(
            location,
            ERROR_ID_SERVER_PARAMETER_INVALID_METHOD_OVERRIDE,
    ...
    def add_bad_duplicate_behavior(self, location, value):
        ...
        self._add_error(
            location,
            ERROR_ID_BAD_DUPLICATE_BEHAVIOR_SPECIFIER,
    ...
    def add_missing_shortname_for_positional_arg(self, location):
        ...
        self._add_error(
            location,
            ERROR_ID_MISSING_SHORTNAME_FOR_POSITIONAL,
    ...
    def add_invalid_short_name(self, location, name):
        ...
        self._add_error(
            location, ERROR_ID_INVALID_SHORT_NAME, ("Invalid 'short_name' value '%s'") % (name)
        )
    ...
    def add_invalid_single_name(self, location, name):
        ...
        self._add_error(
            location, ERROR_ID_INVALID_SINGLE_NAME, ("Invalid 'single_name' value '%s'") % (name)
        )
    ...
    def add_missing_short_name_with_single_name(self, location, name):
        ...
        self._add_error(
            location,
            ERROR_ID_MISSING_SHORT_NAME_WITH_SINGLE_NAME,
    ...
    def add_feature_flag_default_true_missing_version(self, location):
        ...
        self._add_error(
            location,
            ERROR_ID_FEATURE_FLAG_DEFAULT_TRUE_MISSING_VERSION,
            (
    ...
    def add_duplicate_command_name_and_alias(self, node):
        ...
        self._add_node_error(
            node,
            ERROR_ID_COMMAND_DUPLICATES_NAME_AND_ALIAS,
    ...
    def add_either_check_or_privilege(self, location):
        ...
        self._add_error(
            location,
            ERROR_ID_EITHER_CHECK_OR_PRIVILEGE,
    ...
    def add_duplicate_action_types(self, location, name):
        ...
        self._add_error(
            location,
            ERROR_ID_DUPLICATE_ACTION_TYPE,
    ...
    def add_duplicate_access_check(self, location, name):
        ...
        self._add_error(
            location,
            ERROR_ID_DUPLICATE_ACCESS_CHECK,
    ...
    def add_stability_unknown_value(self, location):
        ...
        self._add_error(
            location,
            ERROR_ID_STABILITY_UNKNOWN_VALUE,
    ...
    def add_duplicate_unstable_stability(self, location):
        ...
        self._add_error(
            location,
            ERROR_ID_DUPLICATE_UNSTABLE_STABILITY,
            (
    ...
    def add_must_declare_shape_type(self, location, struct_name, field_name):
        ...
        self._add_error(
            location,
            ERROR_ID_FIELD_MUST_DECLARE_SHAPE_LITERAL,
    ...
    def add_must_be_query_shape_component(self, location, struct_name, field_name):
        ...
        self._add_error(
            location,
            ERROR_ID_CANNOT_DECLARE_SHAPE_LITERAL,
    ...
    def add_invalid_query_shape_value(self, location, query_shape_value):
        self._add_error(
            location,
            ERROR_ID_QUERY_SHAPE_INVALID_VALUE,
    ...
    def add_strict_and_disable_check_not_allowed(self, location):
        self._add_error(
            location,
            ERROR_ID_STRICT_AND_DISABLE_CHECK_NOT_ALLOWED,
    ...
    def add_inheritance_and_disable_check_not_allowed(self, location):
        self._add_error(
            location,
            ERROR_ID_INHERITANCE_AND_DISABLE_CHECK_NOT_ALLOWED,
