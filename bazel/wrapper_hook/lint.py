...
def list_files_without_targets(
    ...
    exempt_list = {
        # TODO(SERVER-106654): Remove these lint failures that only appear in Evergreen
        "jstests/libs/jstestfuzz/check_for_interrupt_hook.js",
        "jstests/libs/jstestfuzz/hook_utils.js",
