...
hermetic_container allows you to create your build environment as a Docker image,
...
You can configure anything you need through the ".hermetic_containerrc" file in the
...
This helper is vendored with the MongoDB source tree. Invoke it through
``tools/bazel``; it is not published as a standalone package.

Configuration
-------------

You can configure hermetic_container in two ways (or combine): \* A .hermetic_containerrc file in
