...
#    https://github.com/bazelbuild/rules_cc/blob/3a357794d21169dba8704655c500622982cbb1a2/cc/private/toolchain/unix_cc_toolchain_config.bzl
#
# and was heavily modified to support the Apple OSS LLVM Clang toolchain.
###
                ...
                flag_set(
                    ...
                    flag_groups = [
                        ...
                        flag_group(
                            ...
                            flags = ["-Xclang", "-fmodule-map-file=%{dependent_module_map_files}"],
                        ),
                    ],
                ),
            ],
...
def _impl(ctx):
    ...
    ] + layering_check_features(ctx.attr.compiler, ctx.attr.extra_flags_per_feature) + get_apple_features(ctx)
    ...
    if sdkroot_provider not in ctx.attr.builtin_sysroot:
        fail("Requires sdkroot_provider defined in builtin_sysroot attribute.")
    ...
    return cc_common.create_cc_toolchain_config_info(
        ...
        builtin_sysroot = ctx.attr.builtin_sysroot[sdkroot_provider].path,
    )

mongo_apple_llvm_cc_toolchain_config = rule(
