...
type OutputOptions struct {
	...
	JobThreads                 int      `long:"numProcessingThreads" short:"j" description:"Number of collections to dump in parallel" default:"1"`
	MaxProcs                   int      `long:"numCPUThreads" description:"GOMAXPROCS for testing"`
}
