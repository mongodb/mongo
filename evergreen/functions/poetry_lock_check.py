...
POETRY_LOCK_V200 = """# This file is automatically @generated by Poetry 2.0.0 and should not be changed by hand."""
...
subprocess.run(["poetry", "check", "--lock", *extras], check=True)
