...
(function() {
  ...
  var runTests = function(topology, passthrough) {
    ...
    assert[comparison](runMongoProgram.apply(this, ['mongofiles', '--port', conn.port, '--local', '', 'put', filesToInsert[0]].concat(passthrough.args)), 0, 'put failed when it should have succeeded 2');
    ...
    assert[comparison](runMongoProgram.apply(this, ['mongofiles', '--port', conn.port, '--local', '', 'get', putFSName].concat(passthrough.args)), 0, 'get failed unexpectedly');
