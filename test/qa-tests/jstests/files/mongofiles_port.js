...
(function() {
  ...
  var runTests = function(topology, passthrough) {
    ...
    assert.neq(runMongoProgram.apply(this, ["mongofiles", "--port", "12345", "put", filesToInsert[0]].concat(passthrough.args)), 0, "expected mongofiles to fail but it succeeded 1");
    assert.neq(runMongoProgram.apply(this, ["mongofiles", "--port", "random", "put", filesToInsert[0]].concat(passthrough.args)), 0, "expected mongofiles to fail but it succeeded 2");
