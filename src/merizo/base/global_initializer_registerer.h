 ...
 * call to a variant of merizo::runGlobalInitializers().  See merizo/base/initializer.h,
 * merizo/base/init.h and merizo/base/initializer_dependency_graph.h for details.
 */
