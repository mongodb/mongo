...
#include "merizo/db/storage/kv/kv_collection_catalog_entry.h"
#include "merizo/db/storage/kv/kv_engine.h"
#include "merizo/db/storage/kv/kv_storage_engine.h"
#include "merizo/util/assert_util.h"
#include "merizo/util/log.h"

auto merizo::defaultDatabaseCatalogEntryFactory(const StringData name,
