...
MERIZO_FAIL_POINT_DECLARE(hangAfterIndexBuildFirstDrain);
MERIZO_FAIL_POINT_DECLARE(hangAfterIndexBuildSecondDrain);
MERIZO_FAIL_POINT_DECLARE(hangAfterIndexBuildDumpsInsertsFromBulk);
