...
#include "merizo/db/query/stage_types.h"
...
struct QuerySolutionNode {
     ...
     */
    virtual void appendToString(merizoutils::str::stream* ss, int indent) const = 0;
...
protected:
     ...
     */
    static void addIndent(merizoutils::str::stream* ss, int level);

    /**
     * Every solution node has properties and this adds the debug info for the
     * properties.
     */
    void addCommon(merizoutils::str::stream* ss, int indent) const;
...
struct TextNode : public QuerySolutionNode {
    ...
    virtual void appendToString(merizoutils::str::stream* ss, int indent) const;
...
struct ProjectionNode : QuerySolutionNode {
    ...
    void appendToString(merizoutils::str::stream* ss, int indent) const final;
