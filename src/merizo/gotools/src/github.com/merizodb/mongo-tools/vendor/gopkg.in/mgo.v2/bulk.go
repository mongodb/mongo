...
//
// MerizoDB servers older than version 2.6 do not have proper support for bulk
...
//
// See the documentation of BulkErrorCase for limitations in older MerizoDB releases.
