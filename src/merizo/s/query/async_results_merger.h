...
public:
    // When merizos has to do a merge in order to return results to the client in the correct sort
...
private:
    ...
    struct RemoteCursorData {
        ...
        // batchSize in getMore when merizod returned less docs than the requested batchSize.
