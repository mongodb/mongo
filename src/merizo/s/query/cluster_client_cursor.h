 ...
 * are exhausted.
 *
 * Results are generated using a pipeline of merizoS query execution stages called RouterExecStage.
 *
...
public:
     ...
     * generating further results from the underlying merizos query stages.
     *
