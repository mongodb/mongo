...
public:
     ...
     * for situations where you might want to log, but you've not yet run the MERIZO_INITIALIZERs,
     * and should be removed if ever command line parsing is seperated from MERIZO_INITIALIZERs.
     */
