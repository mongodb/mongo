...
__wt_btcur_reset(WT_CURSOR_BTREE *cbt)
{
	...
	WT_RUNSTAT_CONN_INCR(session, cursor_reset);
	WT_RUNSTAT_DATA_INCR(session, cursor_reset);
...
__wt_btcur_search(WT_CURSOR_BTREE *cbt)
{
	...
	WT_RUNSTAT_CONN_INCR(session, cursor_search);
	WT_RUNSTAT_DATA_INCR(session, cursor_search);
...
__wt_btcur_search_near(WT_CURSOR_BTREE *cbt, int *exactp)
{
	...
	WT_RUNSTAT_CONN_INCR(session, cursor_search_near);
	WT_RUNSTAT_DATA_INCR(session, cursor_search_near);
...
__wt_btcur_insert(WT_CURSOR_BTREE *cbt)
{
	...
	WT_RUNSTAT_CONN_INCR(session, cursor_insert);
	WT_RUNSTAT_DATA_INCR(session, cursor_insert);
	WT_RUNSTAT_DATA_INCRV(session,
...
__wt_btcur_remove(WT_CURSOR_BTREE *cbt)
{
	...
	WT_RUNSTAT_CONN_INCR(session, cursor_remove);
	WT_RUNSTAT_DATA_INCR(session, cursor_remove);
	WT_RUNSTAT_DATA_INCRV(session, cursor_remove_bytes, cursor->key.size);
...
__wt_btcur_update(WT_CURSOR_BTREE *cbt)
{
	...
	WT_RUNSTAT_CONN_INCR(session, cursor_update);
	WT_RUNSTAT_DATA_INCR(session, cursor_update);
	WT_RUNSTAT_DATA_INCRV(session, cursor_update_bytes, cursor->value.size);
