...
#undef INITGUID
#endif
#include "jit/MIR-wasm.cpp"
#ifdef PL_ARENA_CONST_ALIGN_MASK
#error "jit/MIR-wasm.cpp uses PL_ARENA_CONST_ALIGN_MASK, so it cannot be built in unified mode."
#undef PL_ARENA_CONST_ALIGN_MASK
#endif
#ifdef INITGUID
#error "jit/MIR-wasm.cpp defines INITGUID, so it cannot be built in unified mode."
#undef INITGUID
#endif
#include "jit/MIR.cpp"
#ifdef PL_ARENA_CONST_ALIGN_MASK
