...
# newline-separated language file in source/merizo_sources/languages.txt.  This language file must
...
# versions of ICU does not contain all the collations needed by merizodb. If this script fails while
...
#      $(pwd)/src/third_party/icu4c-57.1/source/merizo_sources/icudt57l.dat
#
...
MERIZO_SOURCES_DIR="${ICU_THIRD_PARTY_DIR}/source/merizo_sources"
LANGUAGE_FILE_IN="${MERIZO_SOURCES_DIR}/languages.txt"
ICU_DATA_FILE_LITTLE_ENDIAN_OUT="${MERIZO_SOURCES_DIR}/icudt${MAJOR_VERSION}l.dat"
ICU_DATA_FILE_BIG_ENDIAN_OUT="${MERIZO_SOURCES_DIR}/icudt${MAJOR_VERSION}b.dat"
