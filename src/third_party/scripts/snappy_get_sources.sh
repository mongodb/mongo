...
# 1. Run on Darwin
# 2. Run on Linux
# 3. Run on Windows via Cygwin
#
# For Windows you will need CMake installed. If using an Evergreen
# spawn host it is not installed by default but, you can easily
# install it with the following command. (this works in cygwin):
#
# choco install cmake
#
