    ...
    def cache_eviction_stats():
        return [
            PerfStat(short_label="app_dirty_attempt",
                     stat_files=['cache_eviction.stat'],
    ...
    def all_stats():
        return [
            PerfStat(short_label="read_ops",
                     stat_files=['test.stat', 'workload.stat'],
                     pattern=r'Executed \d+ read operations \(\d+%\) \d+ ops',
                     input_offset=5,
                     output_label='Read ops per sec'),
            PerfStat(short_label="insert_ops",
                     stat_files=['test.stat', 'workload.stat'],
                     pattern=r'Executed \d+ insert operations \(\d+%\) \d+ ops',
                     input_offset=5,
                     output_label='Insert ops per sec'),
            PerfStat(short_label="modify_ops",
                     stat_files=['test.stat', 'workload.stat'],
                     pattern=r'Executed \d+ modify operations \(\d+%\) \d+ ops',
                     input_offset=5,
                     output_label='Modify ops per sec'),
            ...
            PerfStat(short_label="wiredtiger_open_no_pickup",
                     stat_files=['../stdout_file.txt'],
                     pattern=r'PERF wiredtiger_open_no_pickup_secs:\s+[\d.]+',
                     input_offset=2,
                     output_label='wiredtiger_open (no pickup) seconds',
                     output_precision=4,
                     conversion_function=float),
            PerfStat(short_label="reconfigure_pickup",
                     stat_files=['../stdout_file.txt'],
                     pattern=r'PERF reconfigure_pickup_secs:\s+[\d.]+',
                     input_offset=2,
                     output_label='reconfigure pickup seconds',
                     output_precision=4,
                     conversion_function=float),
            PerfStat(short_label="reconfigure_update_pickup_ms",
                     stat_files=['../stdout_file.txt'],
                     pattern=r'PERF reconfigure_update_pickup_ms:\s+\d+',
                     input_offset=2,
                     output_label='reconfigure update pickup (ms)',
                     conversion_function=int),
            PerfStat(short_label="disagg_apply_checkpoint_meta_ms",
                     stat_files=['../stdout_file.txt'],
                     pattern=r'PERF disagg_apply_checkpoint_meta_ms:\s+\d+',
                     input_offset=2,
                     output_label='disagg apply checkpoint meta (ms)',
                     conversion_function=int),
