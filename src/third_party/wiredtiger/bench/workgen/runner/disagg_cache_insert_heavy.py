...
#
# Insert heavy workload: ~90% inserts, ~5% reads, ~5% updates + checkpoints,
...
# Inserts in snapshot transactions (~90% of total ops)
...
# ------------------------
# Writes: 5 * tupdate (5k updates) + 90 * tinsert (90k inserts) => 95k write ops
threads = 5 * tupdate + 90 * tinsert
...
print("disagg workload: insert-heavy with checkpoints:")
start_time = time.time()
