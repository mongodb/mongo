...
class test_prepare01(wttest.WiredTigerTestCase):
    ...
    scenarios = make_scenarios([
        ('col-f', dict(uri='file:text_txn01',key_format='r')),
        ('col-t', dict(uri='table:text_txn01',key_format='r')),
        ('row-f', dict(uri='file:text_txn01',key_format='S')),
        ('row-t', dict(uri='table:text_txn01',key_format='S')),
    ])
