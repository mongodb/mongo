...
class test_fast_truncate_disk_space(compatibility_test.CompatibilityTestCase):
    ...
    def test_fast_truncate_disk_space(self):
        ...
        self.run_method_on_branch(older_branch, 'generate_older_database_files')
        ...
        self.run_method_on_branch(newer_branch, 'write_fast_truncate_info')

        # Show that running on an older branch with the cleanup logic does not leak disk space.
        self.run_method_on_branch(older_branch, 'read_fast_truncate_info_with_cleanup')
