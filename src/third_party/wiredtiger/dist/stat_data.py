...
conn_stats = [
    ...
    CacheStat('eviction_app_attempt', 'page evict attempts by application threads'),
    CacheStat('eviction_app_dirty_attempt', 'modified page evict attempts by application threads'),
    CacheStat('eviction_app_dirty_fail', 'modified page evict failures by application threads'),
    CacheStat('eviction_app_fail', 'page evict failures by application threads'),
    ...
    CacheStat('cache_eviction_maximum_milliseconds_per_checkpoint', 'maximum milliseconds spent at a single eviction per checkpoint', 'no_clear,no_scale,size'),
    CacheStat('cache_eviction_maximum_clean_page_size_per_checkpoint', 'maximum clean page size seen at eviction per checkpoint', 'no_clear,no_scale,size'),
    CacheStat('cache_eviction_maximum_dirty_page_size_per_checkpoint', 'maximum dirty page size seen at eviction per checkpoint', 'no_clear,no_scale,size'),
    CacheStat('cache_eviction_maximum_page_size', 'maximum page size seen at eviction', 'no_clear,no_scale,size'),
    CacheStat('cache_eviction_maximum_updates_page_size_per_checkpoint', 'maximum updates page size seen at eviction per checkpoint', 'no_clear,no_scale,size'),
    CacheStat('cache_eviction_maximum_unvisited_gen_gap', 'maximum gap between unvisited page and connection evict pass generation seen at eviction', 'no_clear,no_scale,size'),
    CacheStat('cache_eviction_maximum_unvisited_gen_gap_per_checkpoint', 'maximum gap between unvisited page and connection evict pass generation seen at eviction per checkpoint', 'no_clear,no_scale,size'),
    CacheStat('cache_eviction_maximum_visited_gen_gap', 'maximum gap between visited page and connection evict pass generation seen at eviction', 'no_clear,no_scale,size'),
    CacheStat('cache_eviction_maximum_visited_gen_gap_per_checkpoint', 'maximum gap between visited page and connection evict pass generation seen at eviction per checkpoint', 'no_clear,no_scale,size'),
    ...
    CacheStat('eviction_server_evict_attempt', 'evict page attempts by eviction server'),
    CacheStat('eviction_server_evict_fail', 'evict page failures by eviction server'),
    ...
    CacheStat('cache_eviction_target_strategy_updates', 'eviction walk target strategy pages with updates'),
...
conn_dsrc_stats = [
    ...
    CacheStat('cache_hs_key_processed', 'the number of saved update lists processed in __wt_hs_insert_updates'),
    ...
    CacheStat('cache_hs_update_processed', 'the number of updates processed in __wt_hs_insert_updates'),
