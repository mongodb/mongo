...
conn_stats = [
    ...
    CacheStat('cache_eviction_fail_checkpoint_mm_ts', 'pages selected for eviction unable to be evicted because of race between checkpoint and mixed mode timestamps handling'),
...
conn_dsrc_stats = [
    ...
    CacheStat('cache_eviction_blocked_mm_checkpoint_race_1', 'eviction gave up due to detecting a mixed mode on disk value behind the last update on the chain'),
    CacheStat('cache_eviction_blocked_mm_checkpoint_race_2', 'eviction gave up due to detecting a mixed mode tombstone ahead of the selected on disk update'),
    CacheStat('cache_eviction_blocked_mm_checkpoint_race_3', 'eviction gave up due to detecting a mixed mode tombstone ahead of the selected on disk update after validating the update chain'),
    CacheStat('cache_eviction_blocked_mm_checkpoint_race_4', 'eviction gave up due to detecting mixed mode timestamps on the update chain after the selected on disk update'),
    ...
    CacheStat('cache_hs_order_remove', 'history store table truncation to remove range of updates due to mixed mode timestamp update on data page'),
    ...
    CacheStat('cache_hs_order_reinsert', 'history store table mixed mode updates that were fixed up by reinserting with the fixed timestamp'),
    CacheStat('cache_hs_order_lose_durable_timestamp', 'history store table mixed mode resolved updates that lose their durable timestamp'),
