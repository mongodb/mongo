...
WT_FILELIST = ['src/block/block_addr.c',
 ...
 'src/block_disagg/block_disagg_size.c',
 ...
 'src/conn/conn_layered_checkpoint_pick_up.c',
 'src/conn/conn_layered_ingest.c',
 'src/conn/conn_layered_page_log.c',
 'src/conn/conn_layered_table_manager.c',
 'src/conn/conn_layered.c',
 'src/conn/conn_load_control.c',
 ...
 'src/evict/evict_dispatch.c',
 'src/evict/evict_exclusive.c',
 'src/evict/evict_file.c',
 'src/evict/evict_page.c',
 'src/evict/evict_queue.c',
 'src/evict/evict_stat.c',
 'src/evict/evict_thread.c',
 'src/evict/evict_verbose.c',
 'src/evict/evict_walk.c',
...
WT_FILELIST_DARWIN_HOST = ['src/os_darwin/os_futex.c', 'src/os_darwin/os_mtx_sem.c']

WT_FILELIST_LINUX_HOST = ['src/os_linux/os_futex.c', 'src/os_linux/os_mtx_sem.c']
