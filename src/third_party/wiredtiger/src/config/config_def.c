...
static const WT_CONFIG_CHECK confchk_WT_CONNECTION_query_timestamp[] = {
  {"get", "string", NULL,
    "choices=[\"all_committed\",\"last_checkpoint\",\"oldest\""
...
static const WT_CONFIG_CHECK confchk_WT_CONNECTION_set_timestamp[] = {
  {"commit_timestamp", "string", NULL, NULL, NULL, 0}, {"force", "boolean", NULL, NULL, NULL, 0},
...
static const WT_CONFIG_CHECK confchk_WT_SESSION_begin_transaction[] = {
  ...
  {"round_to_oldest", "boolean", NULL, NULL, NULL, 0}, {"snapshot", "string", NULL, NULL, NULL, 0},
...
static const WT_CONFIG_CHECK confchk_WT_SESSION_timestamp_transaction[] = {
  {"commit_timestamp", "string", NULL, NULL, NULL, 0},
  {"read_timestamp", "string", NULL, NULL, NULL, 0},
  {"round_to_oldest", "boolean", NULL, NULL, NULL, 0}, {NULL, NULL, NULL, NULL, NULL, 0}};
...
static const WT_CONFIG_ENTRY config_entries[] = {{"WT_CONNECTION.add_collator", "", NULL, 0},
  ...
  {"WT_CONNECTION.query_timestamp", "get=all_committed", confchk_WT_CONNECTION_query_timestamp, 1},
  ...
  {"WT_SESSION.begin_transaction",
    ...
    "priority=0,read_timestamp=,round_to_oldest=false,snapshot=,sync=",
  ...
  {"WT_SESSION.commit_transaction", "commit_timestamp=,operation_timeout_ms=0,sync=",
  ...
  {"WT_SESSION.timestamp_transaction", "commit_timestamp=,read_timestamp=,round_to_oldest=false",
