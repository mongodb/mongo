...
#define WT_REC_APP_EVICTION_CKPT_SNAPSHOT 0x0001u
#define WT_REC_APP_EVICTION_SNAPSHOT 0x0002u
#define WT_REC_CALL_URGENT 0x0004u
#define WT_REC_CHECKPOINT 0x0008u
#define WT_REC_CHECKPOINT_RUNNING 0x0010u
#define WT_REC_CLEAN_AFTER_REC 0x0020u
#define WT_REC_EVICT 0x0040u
#define WT_REC_EVICT_CALL_CLOSING 0x0080u
#define WT_REC_HS 0x0100u
#define WT_REC_IN_MEMORY 0x0200u
#define WT_REC_SAVE_IMAGE_ALWAYS 0x0400u
#define WT_REC_SAVE_IMAGE_CLEAN 0x0800u
#define WT_REC_VISIBILITY_ERR 0x1000u
...
extern int __ut_ovfl_discard_wrapup(WT_SESSION_IMPL *session, WT_PAGE *page)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern int __ut_ovfl_reuse_wrapup(WT_SESSION_IMPL *session, WT_PAGE *page)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern int __ut_ovfl_reuse_wrapup_err(WT_SESSION_IMPL *session, WT_PAGE *page)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
