...
#define WT_REC_DISAGG_NEW_PAGE 0x0020u
#define WT_REC_EMPTY_DELTA 0x0040u
#define WT_REC_EVICT 0x0080u
#define WT_REC_EVICT_CALL_CLOSING 0x0100u
#define WT_REC_HS 0x0200u
#define WT_REC_IN_MEMORY 0x0400u
#define WT_REC_REWRITE_DELTA 0x0800u
#define WT_REC_SCRUB 0x1000u
#define WT_REC_VISIBILITY_ERR 0x2000u
#define WT_REC_VISIBLE_NO_SNAPSHOT 0x4000u
