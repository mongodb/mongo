...
static const char *const __stats_dsrc_desc[] = {
  ...
  "cache: the number of saved update lists processed in __wt_hs_insert_updates",
...
__wt_stat_dsrc_aggregate(WT_DSRC_STATS **from, WT_DSRC_STATS *to)
{
    ...
    to->cache_hs_key_processed += WT_STAT_READ(from, cache_hs_key_processed);
    ...
    to->cache_hs_update_processed += WT_STAT_READ(from, cache_hs_update_processed);
...
__wt_stat_connection_clear_single(WT_CONNECTION_STATS *stats)
{
    ...
    /* not clearing cache_eviction_dhandle_complete_walk */
    ...
    /* not clearing cache_eviction_maximum_clean_page_size_per_checkpoint */
    /* not clearing cache_eviction_maximum_dirty_page_size_per_checkpoint */
    ...
    /* not clearing cache_eviction_maximum_updates_page_size_per_checkpoint */
...
__wt_stat_connection_aggregate(WT_CONNECTION_STATS **from, WT_CONNECTION_STATS *to)
{
    ...
    to->block_first_srch_walk_time += WT_STAT_READ(from, block_first_srch_walk_time);
    ...
    to->cache_eviction_dhandle_complete_walk +=
      WT_STAT_READ(from, cache_eviction_dhandle_complete_walk);
    ...
    to->cache_eviction_maximum_clean_page_size_per_checkpoint +=
      WT_STAT_READ(from, cache_eviction_maximum_clean_page_size_per_checkpoint);
    to->cache_eviction_maximum_dirty_page_size_per_checkpoint +=
      WT_STAT_READ(from, cache_eviction_maximum_dirty_page_size_per_checkpoint);
    ...
    to->cache_eviction_maximum_updates_page_size_per_checkpoint +=
      WT_STAT_READ(from, cache_eviction_maximum_updates_page_size_per_checkpoint);
