  ...
  WT_SESSION_IMPL **sessionp)
{
    static const WT_SESSION
      stds = {NULL, NULL, __session_close, __session_reconfigure, __wt_session_strerror,
        ...
        __session_drop, __session_join, __session_log_flush, __session_log_printf,
        __session_rebalance, __session_rename, __session_reset, __session_salvage,
        ...
        __session_snapshot, __session_transaction_pinned_range, __session_transaction_sync,
        __wt_session_breakpoint},
      stds_readonly = {NULL, NULL, __session_close, __session_reconfigure, __wt_session_strerror,
        ...
        __session_log_flush_readonly, __session_log_printf_readonly, __session_rebalance_readonly,
