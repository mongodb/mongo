...
#ifdef __clang__
/*
 * We avoid __sync_bool_compare_and_swap with due to problems with optimization with some versions
 * of clang. See http://llvm.org/bugs/show_bug.cgi?id=21499 for details.
 */
