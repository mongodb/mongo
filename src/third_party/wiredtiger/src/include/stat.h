...
struct __wt_connection_stats {
    ...
    int64_t cache_eviction_maximum_clean_page_size_per_checkpoint;
    int64_t cache_eviction_maximum_dirty_page_size_per_checkpoint;
    int64_t cache_eviction_maximum_unvisited_gen_gap;
    int64_t cache_eviction_maximum_unvisited_gen_gap_per_checkpoint;
    int64_t cache_eviction_maximum_visited_gen_gap;
    int64_t cache_eviction_maximum_visited_gen_gap_per_checkpoint;
    int64_t cache_eviction_maximum_milliseconds;
    int64_t cache_eviction_maximum_milliseconds_per_checkpoint;
    int64_t cache_eviction_maximum_page_size;
    int64_t cache_eviction_maximum_updates_page_size_per_checkpoint;
