...
WT_CONF_API_DECLARE(WT_CONNECTION, reconfigure, 19, 118);
...
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open, 24, 188);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_all, 24, 189);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_basecfg, 24, 183);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_usercfg, 24, 182);
