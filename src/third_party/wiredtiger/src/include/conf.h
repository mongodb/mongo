...
WT_CONF_API_DECLARE(WT_CONNECTION, reconfigure, 19, 105);
...
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open, 23, 168);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_all, 23, 169);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_basecfg, 23, 163);
WT_CONF_API_DECLARE(GLOBAL, wiredtiger_open_usercfg, 23, 162);
