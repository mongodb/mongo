...
#define WT_CONF_ID_buckets 287ULL
#define WT_CONF_ID_buffer_alignment 270ULL
#define WT_CONF_ID_builtin_extension_config 271ULL
...
#define WT_CONF_ID_capacity 273ULL
...
#define WT_CONF_ID_checkpoint_sync 272ULL
...
#define WT_CONF_ID_chunk_cache_evict_trigger 274ULL
...
#define WT_CONF_ID_flushed_data_cache_insertion 276ULL
#define WT_CONF_ID_force 109ULL
#define WT_CONF_ID_force_stop 129ULL
#define WT_CONF_ID_force_write_wait 292ULL
#define WT_CONF_ID_format 22ULL
#define WT_CONF_ID_free_space_target 99ULL
#define WT_CONF_ID_fsync_maximum_wait_period 235ULL
...
#define WT_CONF_ID_hazard_max 289ULL
...
#define WT_CONF_ID_in_memory 290ULL
...
#define WT_CONF_ID_method 305ULL
#define WT_CONF_ID_mmap 294ULL
#define WT_CONF_ID_mmap_all 295ULL
#define WT_CONF_ID_multiprocess 296ULL
...
#define WT_CONF_ID_recover 293ULL
...
#define WT_CONF_ID_require_max 277ULL
#define WT_CONF_ID_require_min 278ULL
...
#define WT_CONF_ID_secretkey 283ULL
...
#define WT_CONF_ID_storage_path 275ULL
...
#define WT_CONF_ID_threads 268ULL
...
static const struct {
    ...
    struct {
        ...
        uint64_t fsync_maximum_wait_period;
        uint64_t total;
    } Io_capacity;
    struct {
        uint64_t archive;
  ...
  },
  {
    ...
    WT_CONF_ID_Io_capacity | (WT_CONF_ID_fsync_maximum_wait_period << 16),
