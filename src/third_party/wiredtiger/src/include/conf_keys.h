...
#define WT_CONF_ID_Block_cache 207ULL
#define WT_CONF_ID_Checkpoint 222ULL
#define WT_CONF_ID_Checkpoint_cleanup 225ULL
#define WT_CONF_ID_Chunk_cache 342ULL
#define WT_CONF_ID_Compatibility 228ULL
#define WT_CONF_ID_Crash_point 232ULL
#define WT_CONF_ID_Debug 133ULL
#define WT_CONF_ID_Debug_mode 230ULL
#define WT_CONF_ID_Disaggregated 20ULL
#define WT_CONF_ID_Dump_version 135ULL
#define WT_CONF_ID_Encryption 23ULL
#define WT_CONF_ID_Eviction 259ULL
#define WT_CONF_ID_File_manager 280ULL
#define WT_CONF_ID_Flush_tier 194ULL
#define WT_CONF_ID_Hash 358ULL
#define WT_CONF_ID_Heuristic_controls 285ULL
#define WT_CONF_ID_History_store 289ULL
#define WT_CONF_ID_Import 103ULL
#define WT_CONF_ID_Incremental 145ULL
#define WT_CONF_ID_Io_capacity 291ULL
#define WT_CONF_ID_Live_restore 65ULL
#define WT_CONF_ID_Load_control 295ULL
#define WT_CONF_ID_Log 41ULL
#define WT_CONF_ID_Lsm 109ULL
#define WT_CONF_ID_Merge_custom 119ULL
#define WT_CONF_ID_Operation_tracking 304ULL
#define WT_CONF_ID_Page_delta 306ULL
#define WT_CONF_ID_Prefetch 331ULL
#define WT_CONF_ID_Prefetch1 336ULL
#define WT_CONF_ID_Rollback_to_stable 312ULL
#define WT_CONF_ID_Roundup_timestamps 183ULL
#define WT_CONF_ID_Shared_cache 314ULL
#define WT_CONF_ID_Statistics_log 318ULL
#define WT_CONF_ID_Tiered_storage 52ULL
#define WT_CONF_ID_Transaction_sync 378ULL
#define WT_CONF_ID_access_pattern_hint 12ULL
#define WT_CONF_ID_action 92ULL
#define WT_CONF_ID_after_drop_colgroup 235ULL
#define WT_CONF_ID_after_drop_file 236ULL
#define WT_CONF_ID_allocation_size 13ULL
#define WT_CONF_ID_app_eviction_min_cache_fill_ratio 267ULL
#define WT_CONF_ID_app_metadata 0ULL
#define WT_CONF_ID_append 89ULL
#define WT_CONF_ID_archive 298ULL
#define WT_CONF_ID_auth_token 53ULL
#define WT_CONF_ID_auto_throttle 110ULL
#define WT_CONF_ID_available 370ULL
#define WT_CONF_ID_background 96ULL
#define WT_CONF_ID_background_compact 231ULL
#define WT_CONF_ID_backup 199ULL
#define WT_CONF_ID_backup_restore_target 337ULL
#define WT_CONF_ID_before_insert_colgroup 233ULL
#define WT_CONF_ID_before_insert_file 234ULL
#define WT_CONF_ID_bitmap 66ULL
#define WT_CONF_ID_blkcache_eviction_aggression 210ULL
...
#define WT_CONF_ID_buckets 359ULL
#define WT_CONF_ID_buffer_alignment 338ULL
#define WT_CONF_ID_builtin_extension_config 339ULL
#define WT_CONF_ID_bulk 131ULL
#define WT_CONF_ID_cache 200ULL
#define WT_CONF_ID_cache_cursors 328ULL
#define WT_CONF_ID_cache_directory 56ULL
#define WT_CONF_ID_cache_max_wait_ms 218ULL
#define WT_CONF_ID_cache_on_checkpoint 208ULL
#define WT_CONF_ID_cache_on_writes 209ULL
#define WT_CONF_ID_cache_overhead 219ULL
#define WT_CONF_ID_cache_resident 17ULL
#define WT_CONF_ID_cache_size 220ULL
#define WT_CONF_ID_cache_stuck_timeout_ms 221ULL
#define WT_CONF_ID_cache_tolerance_for_app_eviction 268ULL
#define WT_CONF_ID_capacity 344ULL
...
#define WT_CONF_ID_checkpoint_cleanup_obsolete_tw_pages_dirty_max 286ULL
#define WT_CONF_ID_checkpoint_crash_point 190ULL
#define WT_CONF_ID_checkpoint_crash_trigger_point 191ULL
#define WT_CONF_ID_checkpoint_fail_before_turtle_update 329ULL
...
#define WT_CONF_ID_checkpoint_retention 238ULL
#define WT_CONF_ID_checkpoint_scrub_eviction 262ULL
#define WT_CONF_ID_checkpoint_scrub_image_max 263ULL
#define WT_CONF_ID_checkpoint_sync 340ULL
#define WT_CONF_ID_checkpoint_threads 341ULL
#define WT_CONF_ID_checkpoint_use_history 132ULL
#define WT_CONF_ID_checkpoint_wait 125ULL
#define WT_CONF_ID_checksum 18ULL
#define WT_CONF_ID_chunk 315ULL
#define WT_CONF_ID_chunk_cache 293ULL
#define WT_CONF_ID_chunk_cache_evict_trigger 345ULL
...
#define WT_CONF_ID_close_handle_minimum 281ULL
#define WT_CONF_ID_close_idle_time 282ULL
#define WT_CONF_ID_close_scan_interval 283ULL
...
#define WT_CONF_ID_compile_configuration_count 350ULL
#define WT_CONF_ID_compressor 363ULL
#define WT_CONF_ID_config 324ULL
#define WT_CONF_ID_config_base 351ULL
#define WT_CONF_ID_configuration 239ULL
#define WT_CONF_ID_consolidate 146ULL
#define WT_CONF_ID_control_threshold 297ULL
#define WT_CONF_ID_corruption_abort 237ULL
#define WT_CONF_ID_create 352ULL
#define WT_CONF_ID_cross_key 140ULL
#define WT_CONF_ID_cursor_copy 240ULL
#define WT_CONF_ID_cursor_reposition 241ULL
#define WT_CONF_ID_cursors 201ULL
#define WT_CONF_ID_database_size_fix 192ULL
#define WT_CONF_ID_default 371ULL
#define WT_CONF_ID_delete_pct 310ULL
#define WT_CONF_ID_delta_pct 307ULL
#define WT_CONF_ID_dhandle_buckets 360ULL
#define WT_CONF_ID_dictionary 19ULL
#define WT_CONF_ID_direct_io 353ULL
#define WT_CONF_ID_disagg_address_cookie_optional_field 243ULL
#define WT_CONF_ID_disagg_address_cookie_upgrade 242ULL
#define WT_CONF_ID_disagg_slow_truncate_follower 244ULL
...
#define WT_CONF_ID_early_load 325ULL
#define WT_CONF_ID_enable 296ULL
#define WT_CONF_ID_enabled 42ULL
#define WT_CONF_ID_entry 326ULL
#define WT_CONF_ID_error_prefix 258ULL
#define WT_CONF_ID_evict_sample_inmem 264ULL
#define WT_CONF_ID_evict_use_softptr 265ULL
#define WT_CONF_ID_eviction 245ULL
#define WT_CONF_ID_eviction_checkpoint_target 272ULL
#define WT_CONF_ID_eviction_checkpoint_ts_ordering 257ULL
#define WT_CONF_ID_eviction_dirty_target 273ULL
#define WT_CONF_ID_eviction_dirty_trigger 274ULL
#define WT_CONF_ID_eviction_obsolete_tw_pages_dirty_max 287ULL
#define WT_CONF_ID_eviction_target 275ULL
#define WT_CONF_ID_eviction_trigger 276ULL
#define WT_CONF_ID_eviction_updates_target 277ULL
#define WT_CONF_ID_eviction_updates_trigger 278ULL
#define WT_CONF_ID_exclude 98ULL
#define WT_CONF_ID_exclusive 102ULL
#define WT_CONF_ID_exclusive_refreshed 95ULL
#define WT_CONF_ID_extensions 355ULL
#define WT_CONF_ID_extensions_strict 356ULL
#define WT_CONF_ID_extra_diagnostics 279ULL
#define WT_CONF_ID_extractor 71ULL
#define WT_CONF_ID_file 147ULL
#define WT_CONF_ID_file_extend 357ULL
#define WT_CONF_ID_file_max 290ULL
#define WT_CONF_ID_file_metadata 105ULL
#define WT_CONF_ID_file_wait_ms 227ULL
...
#define WT_CONF_ID_flushed_data_cache_insertion 347ULL
#define WT_CONF_ID_force 126ULL
#define WT_CONF_ID_force_stop 148ULL
#define WT_CONF_ID_force_write_wait 364ULL
#define WT_CONF_ID_format 26ULL
#define WT_CONF_ID_free_space_target 99ULL
#define WT_CONF_ID_full_target 211ULL
#define WT_CONF_ID_generation_drain_timeout_ms 284ULL
#define WT_CONF_ID_get 161ULL
#define WT_CONF_ID_granularity 149ULL
#define WT_CONF_ID_handles 202ULL
#define WT_CONF_ID_hashsize 213ULL
#define WT_CONF_ID_hazard_max 361ULL
...
#define WT_CONF_ID_incremental_app_eviction 269ULL
...
#define WT_CONF_ID_internal_page_delta 308ULL
#define WT_CONF_ID_internal_page_max 34ULL
#define WT_CONF_ID_interval 377ULL
#define WT_CONF_ID_isolation 179ULL
#define WT_CONF_ID_json 319ULL
#define WT_CONF_ID_json_output 294ULL
...
#define WT_CONF_ID_log 203ULL
#define WT_CONF_ID_log_retention 246ULL
#define WT_CONF_ID_log_size 223ULL
#define WT_CONF_ID_lose_all_my_data 79ULL
#define WT_CONF_ID_max_consecutive_delta 311ULL
#define WT_CONF_ID_max_percent_overhead 214ULL
...
#define WT_CONF_ID_metadata 204ULL
#define WT_CONF_ID_metadata_file 106ULL
#define WT_CONF_ID_method 226ULL
#define WT_CONF_ID_mmap 366ULL
#define WT_CONF_ID_mmap_all 367ULL
#define WT_CONF_ID_multiprocess 368ULL
...
#define WT_CONF_ID_nvram_path 215ULL
#define WT_CONF_ID_object_target_size 58ULL
#define WT_CONF_ID_obsolete_tw_btree_max 288ULL
#define WT_CONF_ID_oldest 87ULL
#define WT_CONF_ID_oldest_timestamp 332ULL
#define WT_CONF_ID_on_close 320ULL
#define WT_CONF_ID_operation_timeout_ms 181ULL
#define WT_CONF_ID_os_cache_dirty_max 45ULL
#define WT_CONF_ID_os_cache_dirty_pct 299ULL
#define WT_CONF_ID_os_cache_max 46ULL
#define WT_CONF_ID_overwrite 90ULL
#define WT_CONF_ID_page_history 247ULL
#define WT_CONF_ID_page_log 21ULL
#define WT_CONF_ID_panic_corrupt 107ULL
#define WT_CONF_ID_path 305ULL
#define WT_CONF_ID_percent_file_in_dram 216ULL
#define WT_CONF_ID_pinned 343ULL
#define WT_CONF_ID_prealloc 300ULL
#define WT_CONF_ID_prealloc_init_count 301ULL
#define WT_CONF_ID_precise_checkpoint 369ULL
#define WT_CONF_ID_prefer_scrub_eviction 270ULL
...
#define WT_CONF_ID_preserve_prepared 372ULL
#define WT_CONF_ID_priority 182ULL
#define WT_CONF_ID_quota 316ULL
...
#define WT_CONF_ID_read_size 362ULL
#define WT_CONF_ID_read_timestamp 4ULL
#define WT_CONF_ID_readonly 68ULL
#define WT_CONF_ID_realloc_exact 248ULL
#define WT_CONF_ID_realloc_malloc 249ULL
#define WT_CONF_ID_recover 365ULL
#define WT_CONF_ID_release 229ULL
#define WT_CONF_ID_release_evict 142ULL
#define WT_CONF_ID_release_evict_page 330ULL
#define WT_CONF_ID_remove 302ULL
#define WT_CONF_ID_remove_files 128ULL
#define WT_CONF_ID_remove_shared 129ULL
#define WT_CONF_ID_repair 108ULL
#define WT_CONF_ID_require_max 348ULL
#define WT_CONF_ID_require_min 349ULL
#define WT_CONF_ID_reserve 317ULL
#define WT_CONF_ID_role 80ULL
#define WT_CONF_ID_rollback_error 250ULL
#define WT_CONF_ID_rollback_timestamp 188ULL
#define WT_CONF_ID_run_once 100ULL
#define WT_CONF_ID_salvage 373ULL
#define WT_CONF_ID_schema_epoch 160ULL
#define WT_CONF_ID_secretkey 354ULL
#define WT_CONF_ID_session_max 374ULL
#define WT_CONF_ID_session_scratch_max 375ULL
#define WT_CONF_ID_session_table_cache 376ULL
#define WT_CONF_ID_sessions 205ULL
#define WT_CONF_ID_shared 59ULL
#define WT_CONF_ID_show_prepared_rollback 141ULL
#define WT_CONF_ID_size 212ULL
...
#define WT_CONF_ID_skip_update_obsolete_check 271ULL
#define WT_CONF_ID_slow_checkpoint 251ULL
#define WT_CONF_ID_slow_truncate 252ULL
#define WT_CONF_ID_source 8ULL
#define WT_CONF_ID_sources 321ULL
...
#define WT_CONF_ID_stable_disaggregated_schema_epoch 333ULL
...
#define WT_CONF_ID_step_down_disaggregated_schema_epoch 334ULL
#define WT_CONF_ID_step_down_timestamp 335ULL
#define WT_CONF_ID_storage_path 346ULL
#define WT_CONF_ID_storage_tier 22ULL
#define WT_CONF_ID_stress_skiplist 253ULL
...
#define WT_CONF_ID_system_ram 217ULL
#define WT_CONF_ID_table_logging 254ULL
#define WT_CONF_ID_target 159ULL
#define WT_CONF_ID_terminate 327ULL
#define WT_CONF_ID_this_id 151ULL
#define WT_CONF_ID_threads 313ULL
#define WT_CONF_ID_threads_max 260ULL
#define WT_CONF_ID_threads_min 261ULL
#define WT_CONF_ID_tiered_flush_error_continue 255ULL
#define WT_CONF_ID_tiered_object 69ULL
#define WT_CONF_ID_tiers 88ULL
#define WT_CONF_ID_timeout 101ULL
#define WT_CONF_ID_timestamp 322ULL
#define WT_CONF_ID_timestamp_order 138ULL
#define WT_CONF_ID_timing_stress_for_test 323ULL
#define WT_CONF_ID_total 292ULL
#define WT_CONF_ID_txn 206ULL
#define WT_CONF_ID_type 9ULL
#define WT_CONF_ID_update_restore_evict 256ULL
#define WT_CONF_ID_use_environment 379ULL
#define WT_CONF_ID_use_environment_priv 380ULL
#define WT_CONF_ID_use_timestamp 195ULL
#define WT_CONF_ID_value_format 60ULL
#define WT_CONF_ID_verbose 10ULL
#define WT_CONF_ID_verify_metadata 381ULL
#define WT_CONF_ID_version 70ULL
#define WT_CONF_ID_visible_only 136ULL
#define WT_CONF_ID_wait 224ULL
#define WT_CONF_ID_write_through 382ULL
#define WT_CONF_ID_write_timestamp 5ULL
#define WT_CONF_ID_write_timestamp_usage 11ULL
#define WT_CONF_ID_zero_fill 303ULL

#define WT_CONF_ID_COUNT 383
/*
