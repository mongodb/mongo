...
#define WT_CONF_ID_Block_cache 201ULL
#define WT_CONF_ID_Checkpoint 216ULL
#define WT_CONF_ID_Checkpoint_cleanup 219ULL
#define WT_CONF_ID_Chunk_cache 334ULL
#define WT_CONF_ID_Compatibility 222ULL
#define WT_CONF_ID_Crash_point 226ULL
#define WT_CONF_ID_Debug 131ULL
#define WT_CONF_ID_Debug_mode 224ULL
#define WT_CONF_ID_Disaggregated 20ULL
#define WT_CONF_ID_Dump_version 133ULL
#define WT_CONF_ID_Encryption 23ULL
#define WT_CONF_ID_Eviction 253ULL
#define WT_CONF_ID_File_manager 272ULL
#define WT_CONF_ID_Flush_tier 188ULL
#define WT_CONF_ID_Hash 350ULL
#define WT_CONF_ID_Heuristic_controls 277ULL
#define WT_CONF_ID_History_store 281ULL
#define WT_CONF_ID_Import 101ULL
#define WT_CONF_ID_Incremental 142ULL
#define WT_CONF_ID_Io_capacity 283ULL
#define WT_CONF_ID_Live_restore 65ULL
#define WT_CONF_ID_Load_control 287ULL
#define WT_CONF_ID_Log 41ULL
#define WT_CONF_ID_Lsm 107ULL
#define WT_CONF_ID_Merge_custom 117ULL
#define WT_CONF_ID_Operation_tracking 296ULL
#define WT_CONF_ID_Page_delta 298ULL
#define WT_CONF_ID_Prefetch 324ULL
#define WT_CONF_ID_Prefetch1 328ULL
#define WT_CONF_ID_Rollback_to_stable 304ULL
#define WT_CONF_ID_Roundup_timestamps 177ULL
#define WT_CONF_ID_Shared_cache 306ULL
#define WT_CONF_ID_Statistics_log 310ULL
#define WT_CONF_ID_Tiered_storage 52ULL
#define WT_CONF_ID_Transaction_sync 370ULL
#define WT_CONF_ID_access_pattern_hint 12ULL
#define WT_CONF_ID_action 90ULL
#define WT_CONF_ID_after_drop_colgroup 229ULL
#define WT_CONF_ID_after_drop_file 230ULL
#define WT_CONF_ID_allocation_size 13ULL
#define WT_CONF_ID_app_eviction_min_cache_fill_ratio 259ULL
#define WT_CONF_ID_app_metadata 0ULL
#define WT_CONF_ID_append 87ULL
#define WT_CONF_ID_archive 290ULL
#define WT_CONF_ID_auth_token 53ULL
#define WT_CONF_ID_auto_throttle 108ULL
#define WT_CONF_ID_available 362ULL
#define WT_CONF_ID_background 94ULL
#define WT_CONF_ID_background_compact 225ULL
#define WT_CONF_ID_backup 193ULL
#define WT_CONF_ID_backup_restore_target 329ULL
...
#define WT_CONF_ID_buckets 351ULL
#define WT_CONF_ID_buffer_alignment 330ULL
#define WT_CONF_ID_builtin_extension_config 331ULL
#define WT_CONF_ID_bulk 129ULL
#define WT_CONF_ID_cache 194ULL
#define WT_CONF_ID_cache_cursors 320ULL
#define WT_CONF_ID_cache_directory 56ULL
#define WT_CONF_ID_cache_max_wait_ms 212ULL
#define WT_CONF_ID_cache_on_checkpoint 202ULL
#define WT_CONF_ID_cache_on_writes 203ULL
#define WT_CONF_ID_cache_overhead 213ULL
#define WT_CONF_ID_cache_resident 17ULL
#define WT_CONF_ID_cache_size 214ULL
#define WT_CONF_ID_cache_stuck_timeout_ms 215ULL
#define WT_CONF_ID_cache_tolerance_for_app_eviction 260ULL
#define WT_CONF_ID_capacity 336ULL
#define WT_CONF_ID_checkpoint 61ULL
#define WT_CONF_ID_checkpoint_backup_info 62ULL
#define WT_CONF_ID_checkpoint_cleanup 183ULL
...
#define WT_CONF_ID_checkpoint_retention 232ULL
#define WT_CONF_ID_checkpoint_sync 332ULL
#define WT_CONF_ID_checkpoint_threads 333ULL
#define WT_CONF_ID_checkpoint_use_history 130ULL
#define WT_CONF_ID_checkpoint_wait 123ULL
#define WT_CONF_ID_checksum 18ULL
#define WT_CONF_ID_chunk 307ULL
#define WT_CONF_ID_chunk_cache 285ULL
#define WT_CONF_ID_chunk_cache_evict_trigger 337ULL
#define WT_CONF_ID_chunk_count_limit 114ULL
#define WT_CONF_ID_chunk_max 115ULL
#define WT_CONF_ID_chunk_size 116ULL
#define WT_CONF_ID_claim_prepared_id 171ULL
#define WT_CONF_ID_close_handle_minimum 273ULL
#define WT_CONF_ID_close_idle_time 274ULL
#define WT_CONF_ID_close_scan_interval 275ULL
...
#define WT_CONF_ID_compile_configuration_count 342ULL
#define WT_CONF_ID_compressor 355ULL
#define WT_CONF_ID_config 316ULL
#define WT_CONF_ID_config_base 343ULL
#define WT_CONF_ID_configuration 233ULL
#define WT_CONF_ID_consolidate 143ULL
#define WT_CONF_ID_control_threshold 289ULL
#define WT_CONF_ID_corruption_abort 231ULL
#define WT_CONF_ID_create 344ULL
...
#define WT_CONF_ID_dhandle_buckets 352ULL
#define WT_CONF_ID_dictionary 19ULL
#define WT_CONF_ID_direct_io 345ULL
#define WT_CONF_ID_disagg_address_cookie_optional_field 237ULL
#define WT_CONF_ID_disagg_address_cookie_upgrade 236ULL
#define WT_CONF_ID_disagg_slow_truncate_follower 238ULL
#define WT_CONF_ID_do_not_clear_txn_id 159ULL
#define WT_CONF_ID_drain_threads 76ULL
#define WT_CONF_ID_drop 187ULL
#define WT_CONF_ID_dryrun 95ULL
#define WT_CONF_ID_dump 141ULL
#define WT_CONF_ID_dump_address 160ULL
#define WT_CONF_ID_dump_all_data 161ULL
#define WT_CONF_ID_dump_blocks 162ULL
#define WT_CONF_ID_dump_key_data 163ULL
#define WT_CONF_ID_dump_layout 164ULL
#define WT_CONF_ID_dump_offsets 165ULL
#define WT_CONF_ID_dump_pages 166ULL
#define WT_CONF_ID_dump_tree_shape 167ULL
#define WT_CONF_ID_durable_timestamp 3ULL
#define WT_CONF_ID_early_load 317ULL
#define WT_CONF_ID_enable 288ULL
#define WT_CONF_ID_enabled 42ULL
#define WT_CONF_ID_entry 318ULL
#define WT_CONF_ID_error_prefix 252ULL
#define WT_CONF_ID_evict_sample_inmem 256ULL
#define WT_CONF_ID_evict_use_softptr 257ULL
#define WT_CONF_ID_eviction 239ULL
#define WT_CONF_ID_eviction_checkpoint_target 264ULL
#define WT_CONF_ID_eviction_checkpoint_ts_ordering 251ULL
#define WT_CONF_ID_eviction_dirty_target 265ULL
#define WT_CONF_ID_eviction_dirty_trigger 266ULL
#define WT_CONF_ID_eviction_obsolete_tw_pages_dirty_max 279ULL
#define WT_CONF_ID_eviction_target 267ULL
#define WT_CONF_ID_eviction_trigger 268ULL
#define WT_CONF_ID_eviction_updates_target 269ULL
#define WT_CONF_ID_eviction_updates_trigger 270ULL
#define WT_CONF_ID_exclude 96ULL
#define WT_CONF_ID_exclusive 100ULL
#define WT_CONF_ID_exclusive_refreshed 93ULL
#define WT_CONF_ID_extensions 347ULL
#define WT_CONF_ID_extensions_strict 348ULL
#define WT_CONF_ID_extra_diagnostics 271ULL
#define WT_CONF_ID_extractor 71ULL
#define WT_CONF_ID_file 144ULL
#define WT_CONF_ID_file_extend 349ULL
#define WT_CONF_ID_file_max 282ULL
#define WT_CONF_ID_file_metadata 103ULL
#define WT_CONF_ID_file_wait_ms 221ULL
#define WT_CONF_ID_final_flush 191ULL
#define WT_CONF_ID_flush_time 73ULL
#define WT_CONF_ID_flush_timestamp 74ULL
#define WT_CONF_ID_flushed_data_cache_insertion 339ULL
#define WT_CONF_ID_force 124ULL
#define WT_CONF_ID_force_stop 145ULL
#define WT_CONF_ID_force_write_wait 356ULL
#define WT_CONF_ID_format 26ULL
#define WT_CONF_ID_free_space_target 97ULL
#define WT_CONF_ID_full_target 205ULL
#define WT_CONF_ID_generation_drain_timeout_ms 276ULL
#define WT_CONF_ID_get 158ULL
#define WT_CONF_ID_granularity 146ULL
#define WT_CONF_ID_handles 196ULL
#define WT_CONF_ID_hashsize 207ULL
#define WT_CONF_ID_hazard_max 353ULL
#define WT_CONF_ID_huffman_key 27ULL
#define WT_CONF_ID_huffman_value 28ULL
#define WT_CONF_ID_id 64ULL
#define WT_CONF_ID_ignore_cache_size 323ULL
#define WT_CONF_ID_ignore_in_memory_cache_size 29ULL
#define WT_CONF_ID_ignore_prepare 172ULL
#define WT_CONF_ID_immutable 72ULL
#define WT_CONF_ID_in_memory 30ULL
#define WT_CONF_ID_inclusive 92ULL
#define WT_CONF_ID_incremental_app_eviction 261ULL
...
#define WT_CONF_ID_internal_page_delta 300ULL
#define WT_CONF_ID_internal_page_max 34ULL
#define WT_CONF_ID_interval 369ULL
#define WT_CONF_ID_isolation 173ULL
#define WT_CONF_ID_json 311ULL
#define WT_CONF_ID_json_output 286ULL
...
#define WT_CONF_ID_leaf_page_delta 301ULL
#define WT_CONF_ID_leaf_page_max 39ULL
#define WT_CONF_ID_leaf_value_max 40ULL
#define WT_CONF_ID_leak_memory 192ULL
#define WT_CONF_ID_legacy_page_visit_strategy 258ULL
#define WT_CONF_ID_local_files_action 78ULL
#define WT_CONF_ID_local_retention 57ULL
#define WT_CONF_ID_lock_wait 125ULL
#define WT_CONF_ID_log 197ULL
#define WT_CONF_ID_log_retention 240ULL
#define WT_CONF_ID_log_size 217ULL
#define WT_CONF_ID_lose_all_my_data 79ULL
#define WT_CONF_ID_max_consecutive_delta 303ULL
#define WT_CONF_ID_max_percent_overhead 208ULL
...
#define WT_CONF_ID_metadata 198ULL
#define WT_CONF_ID_metadata_file 104ULL
#define WT_CONF_ID_method 220ULL
#define WT_CONF_ID_mmap 358ULL
#define WT_CONF_ID_mmap_all 359ULL
#define WT_CONF_ID_multiprocess 360ULL
...
#define WT_CONF_ID_no_timestamp 174ULL
#define WT_CONF_ID_nvram_path 209ULL
#define WT_CONF_ID_object_target_size 58ULL
#define WT_CONF_ID_obsolete_tw_btree_max 280ULL
#define WT_CONF_ID_oldest 85ULL
#define WT_CONF_ID_oldest_timestamp 325ULL
#define WT_CONF_ID_on_close 312ULL
#define WT_CONF_ID_operation_timeout_ms 175ULL
...
#define WT_CONF_ID_path 297ULL
#define WT_CONF_ID_percent_file_in_dram 210ULL
#define WT_CONF_ID_pinned 335ULL
#define WT_CONF_ID_prealloc 292ULL
#define WT_CONF_ID_prealloc_init_count 293ULL
#define WT_CONF_ID_precise_checkpoint 361ULL
#define WT_CONF_ID_prefer_scrub_eviction 262ULL
...
#define WT_CONF_ID_preserve_prepared 364ULL
#define WT_CONF_ID_priority 176ULL
#define WT_CONF_ID_quota 308ULL
#define WT_CONF_ID_raw 152ULL
#define WT_CONF_ID_raw_key_value 137ULL
#define WT_CONF_ID_read 179ULL
#define WT_CONF_ID_read_corrupt 168ULL
#define WT_CONF_ID_read_once 153ULL
#define WT_CONF_ID_read_size 354ULL
#define WT_CONF_ID_read_timestamp 4ULL
#define WT_CONF_ID_readonly 68ULL
#define WT_CONF_ID_realloc_exact 242ULL
#define WT_CONF_ID_realloc_malloc 243ULL
#define WT_CONF_ID_recover 357ULL
#define WT_CONF_ID_release 223ULL
#define WT_CONF_ID_release_evict 140ULL
#define WT_CONF_ID_release_evict_page 322ULL
#define WT_CONF_ID_remove 294ULL
#define WT_CONF_ID_remove_files 126ULL
#define WT_CONF_ID_remove_shared 127ULL
#define WT_CONF_ID_repair 106ULL
#define WT_CONF_ID_require_max 340ULL
#define WT_CONF_ID_require_min 341ULL
#define WT_CONF_ID_reserve 309ULL
#define WT_CONF_ID_role 80ULL
#define WT_CONF_ID_rollback_error 244ULL
#define WT_CONF_ID_rollback_timestamp 182ULL
#define WT_CONF_ID_run_once 98ULL
#define WT_CONF_ID_salvage 365ULL
#define WT_CONF_ID_schema_epoch 157ULL
#define WT_CONF_ID_secretkey 346ULL
#define WT_CONF_ID_session_max 366ULL
#define WT_CONF_ID_session_scratch_max 367ULL
#define WT_CONF_ID_session_table_cache 368ULL
#define WT_CONF_ID_sessions 199ULL
...
#define WT_CONF_ID_sources 313ULL
...
#define WT_CONF_ID_stable_timestamp 169ULL
#define WT_CONF_ID_start_generation 119ULL
#define WT_CONF_ID_start_timestamp 135ULL
#define WT_CONF_ID_statistics 155ULL
#define WT_CONF_ID_step_down_timestamp 327ULL
#define WT_CONF_ID_storage_path 338ULL
#define WT_CONF_ID_storage_tier 22ULL
#define WT_CONF_ID_stress_skiplist 247ULL
#define WT_CONF_ID_strict 170ULL
#define WT_CONF_ID_suffix 120ULL
#define WT_CONF_ID_sync 128ULL
#define WT_CONF_ID_system_ram 211ULL
#define WT_CONF_ID_table_logging 248ULL
#define WT_CONF_ID_target 156ULL
#define WT_CONF_ID_terminate 319ULL
#define WT_CONF_ID_this_id 148ULL
#define WT_CONF_ID_threads 305ULL
#define WT_CONF_ID_threads_max 254ULL
#define WT_CONF_ID_threads_min 255ULL
#define WT_CONF_ID_tiered_flush_error_continue 249ULL
#define WT_CONF_ID_tiered_object 69ULL
#define WT_CONF_ID_tiers 86ULL
#define WT_CONF_ID_timeout 99ULL
#define WT_CONF_ID_timestamp 314ULL
#define WT_CONF_ID_timestamp_order 136ULL
#define WT_CONF_ID_timing_stress_for_test 315ULL
#define WT_CONF_ID_total 284ULL
#define WT_CONF_ID_txn 200ULL
#define WT_CONF_ID_type 9ULL
#define WT_CONF_ID_update_restore_evict 250ULL
#define WT_CONF_ID_use_environment 371ULL
#define WT_CONF_ID_use_environment_priv 372ULL
#define WT_CONF_ID_use_timestamp 189ULL
#define WT_CONF_ID_value_format 60ULL
#define WT_CONF_ID_verbose 10ULL
#define WT_CONF_ID_verify_metadata 373ULL
#define WT_CONF_ID_version 70ULL
#define WT_CONF_ID_visible_only 134ULL
#define WT_CONF_ID_wait 218ULL
#define WT_CONF_ID_write_through 374ULL
#define WT_CONF_ID_write_timestamp 5ULL
#define WT_CONF_ID_write_timestamp_usage 11ULL
#define WT_CONF_ID_zero_fill 295ULL

#define WT_CONF_ID_COUNT 375
/*
