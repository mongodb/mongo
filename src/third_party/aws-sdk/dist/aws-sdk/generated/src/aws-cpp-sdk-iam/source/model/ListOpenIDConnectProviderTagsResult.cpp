...
ListOpenIDConnectProviderTagsResult& ListOpenIDConnectProviderTagsResult::operator =(const Aws::AmazonWebServiceResult<XmlDocument>& result)
{
  const XmlDocument& xmlDocument = result.GetPayload();
  XmlNode rootNode = xmlDocument.GetRootElement();
  XmlNode resultNode = rootNode;
  if (!rootNode.IsNull() && (rootNode.GetName() != "ListOpenIDConnectProviderTagsResult"))
  {
    resultNode = rootNode.FirstChild("ListOpenIDConnectProviderTagsResult");
  }
