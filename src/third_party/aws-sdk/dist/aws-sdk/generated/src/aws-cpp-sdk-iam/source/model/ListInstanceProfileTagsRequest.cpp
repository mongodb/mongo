...
Aws::String ListInstanceProfileTagsRequest::SerializePayload() const
{
  Aws::StringStream ss;
  ss << "Action=ListInstanceProfileTags&";
...
void  ListInstanceProfileTagsRequest::DumpBodyToUrl(Aws::Http::URI& uri ) const
{
