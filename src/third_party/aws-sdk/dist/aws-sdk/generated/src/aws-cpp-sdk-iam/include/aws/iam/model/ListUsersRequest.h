...
namespace Model
{
  ...
  public:
    ...
    inline ListUsersRequest& WithPathPrefix(Aws::String&& value) { SetPathPrefix(std::move(value)); return *this;}
    ...
    inline ListUsersRequest& WithMarker(Aws::String&& value) { SetMarker(std::move(value)); return *this;}
