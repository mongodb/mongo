...
namespace Model
{
  ...
  /**
   */
  class ListSSHPublicKeysRequest : public IAMRequest
  {
  public:
    AWS_IAM_API ListSSHPublicKeysRequest();
  ...
  public:
     ...
     * the <code>UserName</code> field is determined implicitly based on the Amazon Web
     * Services access key used to sign the request.</p> <p>This parameter allows
