...
# define ASIO_OS_DEF_SO_SNDTIMEO 0x1005
# define ASIO_OS_DEF_SO_RCVTIMEO 0x1006
...
# define ASIO_OS_DEF_SO_SNDTIMEO SO_SNDTIMEO
# define ASIO_OS_DEF_SO_RCVTIMEO SO_RCVTIMEO
...
// Winsock2 uses a DWORD number of milliseconds for timeouts, regardless of
// whether ASIO_WINDOWS_RUNTIME is defined.
// POSIX systems use struct timeval.
#ifdef ASIO_WINDOWS
typedef DWORD timeout_type;
#else
typedef timeval timeout_type;
#endif
