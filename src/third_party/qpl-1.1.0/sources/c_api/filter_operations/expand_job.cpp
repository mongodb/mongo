    ...
    switch (job_ptr->data_ptr.path) {
        case qpl_path_hardware: {
            ...
            auto mask_stream = analytics::input_stream_t::builder(mask_begin, mask_end)
                    .element_count((job_ptr->available_src2 * byte_bits_size) / job_ptr->src2_bit_width)
            ...
            // Configure buffers
            limited_buffer_t source_buffer(unpack_buffer_ptr, unpack_buffer_ptr + unpack_buffer_size, input_stream.bit_width());
            limited_buffer_t mask_buffer(mask_buffer_ptr, mask_buffer_ptr + mask_buffer_size, byte_bits_size);
            limited_buffer_t output_buffer(output_buffer_ptr, output_buffer_ptr + output_buffer_size, bit_bits_size);

            result = call_expand<execution_path_t::hardware>(input_stream,
                                                             mask_stream,
                                                             output_stream,
                                                             source_buffer,
                                                             mask_buffer,
        ...
        case qpl_path_auto: {
            ...
            result = call_expand<execution_path_t::auto_detect>(input_stream,
                                                                mask_stream,
                                                                output_stream,
                                                                source_buffer,
                                                                mask_buffer,
        ...
        case qpl_path_software: {
            ...
            result = call_expand<execution_path_t::software>(input_stream,
                                                             mask_stream,
                                                             output_stream,
                                                             source_buffer,
                                                             mask_buffer,
