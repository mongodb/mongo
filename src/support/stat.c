...
__wt_stat_alloc_btree_stats(WT_SESSION_IMPL *session, WT_BTREE_STATS **statsp)
{
	...
	stats->file_read.name = "file_read";
	stats->file_read.desc = "read";
	stats->file_readnear.name = "file_readnear";
	stats->file_readnear.desc = "read-near";
