...
__wt_confdfl_session_create =
    ...
    "internal_page_max=2KB,key_format=u,key_format=u,key_gap=10,"
    "leaf_item_max=0,leaf_page_max=1MB,prefix_compression=true,split_pct=75,"
...
__wt_confdfl_wiredtiger_open =
    ...
    "eviction_trigger=95,exclusive=false,extensions=(),hazard_max=30,"
...
__wt_confchk_wiredtiger_open =
    ...
    "eviction_trigger=(type=int,min=10,max=99),exclusive=(type=boolean),"
    "extensions=(type=list),hazard_max=(type=int,min=15),"
    ...
    "choices=[\"allocate\",\"evict\",\"evictserver\",\"fileops\",\"hazard\","
