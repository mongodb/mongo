...
static const WT_CONFIG_CHECK confchk_file_close_subconfigs[] = {
	{ "idle_time", "int", "min=1,max=1000", NULL },
	{ "interval", "int", "min=1,max=1000", NULL },
	{ NULL, NULL, NULL, NULL }
};
...
static const WT_CONFIG_CHECK confchk_connection_reconfigure[] = {
	...
	{ "file_close", "category", NULL,
	     confchk_file_close_subconfigs },
...
static const WT_CONFIG_ENTRY config_entries[] = {
	...
	{ "connection.reconfigure",
	  ...
	  "eviction_target=80,eviction_trigger=95,file_close=(idle_time=30,"
	  "interval=10),lsm_manager=(merge=,worker_thread_max=4),lsm_merge="
	...
	{ "wiredtiger_open",
	  ...
	  "file_close=(idle_time=30,interval=10),file_extend=,"
	...
	{ "wiredtiger_open_basecfg",
	  ...
	  "extensions=,file_close=(idle_time=30,interval=10),file_extend=,"
	  "hazard_max=1000,log=(archive=,compressor=,enabled=0,"
	  "file_max=100MB,path=,prealloc=,recover=on),lsm_manager=(merge=,"
	  "worker_thread_max=4),lsm_merge=,mmap=,multiprocess=0,"
	  "session_max=100,session_scratch_max=2MB,shared_cache=(chunk=10MB"
