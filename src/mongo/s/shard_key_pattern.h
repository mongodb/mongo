...
namespace mongo {
    ...
    /**
     * This file contains BSON comparison and manipulation of a shard key pattern.
     *
     * No higher-level abstractions should be placed here - in particular, anything that requires
