...
TEST_F(
    AllDatabasesEventHandlerIgnoreRemovedShardsModeFixture,
    Given_MoveChunkControlEventWithNewToShard_When_HandleEventIsCalled_Then_DoesNotUpdateCursors) {
    readerCtx().setDegradedMode(true);
...
TEST_F(AllDatabasesEventHandlerIgnoreRemovedShardsModeFixture,
       When_HandleEventInDegradedModeIsCalledForMoveChunkWithNewShard_Then_DoesNotModifyCursors) {
