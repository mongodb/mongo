...
namespace mongo {
    ...
    bool LocksType::parseBSON(BSONObj source, string* errMsg) {
        ...
        if (fieldState == FieldParser::FIELD_INVALID) return false;
        _isStateSet = fieldState == FieldParser::FIELD_VALID;
        ...
        if (fieldState == FieldParser::FIELD_INVALID) return false;
        _isLockIDSet = fieldState == FieldParser::FIELD_VALID;

        fieldState = FieldParser::extract(source, who, "", &_who, errMsg);
        if (fieldState == FieldParser::FIELD_INVALID) return false;
        _isWhoSet = fieldState == FieldParser::FIELD_VALID;

        fieldState = FieldParser::extract(source, why, "", &_why, errMsg);
        if (fieldState == FieldParser::FIELD_INVALID) return false;
        _isWhySet = fieldState == FieldParser::FIELD_VALID;
