...
TEST(Validity, BasicDatabase) {
    DatabaseType db;
    BSONObj obj = BSON(DatabaseType::name("mydb") << DatabaseType::primary("shard"));
    string errMsg;
...
TEST(Optionals, TestDefault) {
    ...
    BSONObj notDraining = BSON(DatabaseType::name("mydb") << DatabaseType::primary("shard"));
    string errMsg;
...
TEST(Optionals, TestSet) {
    ...
    BSONObj draining = BSON(DatabaseType::name("mydb") << DatabaseType::primary("shard")
