...
Status checkAuth(OperationContext* opCtx,
                 ...
                 const CreateUnsplittableCollection_FOR_TESTING& cmd,
                 bool isMongos) {
...
class CreateUnsplittableCollectionTestCommand final
    : public TypedCommand<CreateUnsplittableCollectionTestCommand> {
public:
    using Request = CreateUnsplittableCollection_FOR_TESTING;
...
MONGO_REGISTER_TEST_COMMAND(CreateUnsplittableCollectionTestCommand);
