...
class StopShardDrainingCmd : public TypedCommand<StopShardDrainingCmd> {
public:
    using Request = StopShardDraining;

    StopShardDrainingCmd() : TypedCommand(Request::kCommandName) {}
    ...
    public:
        ...
        void typedRun(OperationContext* opCtx) {
            ...
            ConfigSvrStopShardDraining configsvrRequest{target};
    ...
    std::string help() const override {
        return "stop draining a shard from the system.";
    }
...
MONGO_REGISTER_COMMAND(StopShardDrainingCmd).forRouter();
