 ...
 */
void _validateCompressedMinMax(boost::intrusive_ptr<bsoncolumn::ElementStorage>& allocator,
    ...
    // column content.
    if (min.type() == Object || min.type() == Array || max.type() == Object ||
        max.type() == Array) {
        TrackingContext trackingContext;
        timeseries::bucket_catalog::MinMax minmax{trackingContext};
 ...
 * min/max.
 */
void _validateCompressedTimeField(boost::intrusive_ptr<bsoncolumn::ElementStorage>& allocator,
