...
TEST_F(DocumentSourceQueryStatsTest, GetNextForAllowPartialResultsTriState) {
    ...
    queryStatsStore.put(0, QueryStatsEntry{makeAggKeyWithAllowPartialResults(boost::none)});
    queryStatsStore.put(1, QueryStatsEntry{makeAggKeyWithAllowPartialResults(true)});
    queryStatsStore.put(2, QueryStatsEntry{makeAggKeyWithAllowPartialResults(false)});
