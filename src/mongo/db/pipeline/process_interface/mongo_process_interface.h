...
public:
    ...
    public:
         ...
         */
        virtual int estimateInsertHeaderSize(const write_ops::Insert& insertReq) const = 0;
        virtual int estimateUpdateHeaderSize(const write_ops::Update& updateReq) const = 0;
