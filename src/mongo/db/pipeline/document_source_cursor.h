...
protected:
    ...
    /**
     * If '_currentBatch.shouldProduceEmptyDocs' is false, this function hook is called on each
     * 'obj' returned by '_exec' when loading a batch and returns a Document to be added to
     * '_currentBatch'.
     *
