...
namespace mongo {
namespace {
Counter64 changeStreamsLargeEventsSplitCounter;
ServerStatusMetricField<Counter64> dchangeStreamsLargeEventsSplitCounter(
    "changeStreams.largeEventsSplit", &changeStreamsLargeEventsSplitCounter);
}  // namespace
REGISTER_DOCUMENT_SOURCE(changeStreamSplitLargeEvent,
                         DocumentSourceChangeStreamSplitLargeEvent::LiteParsed::parse,
