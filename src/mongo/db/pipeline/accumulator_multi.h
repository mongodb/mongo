...
public:
    ...
    static constexpr auto kFieldNameN = "n"sv;
    static constexpr auto kFieldNameInput = "input"sv;
    ...
    static constexpr auto kFieldNameOutput = "output"sv;
    // Sort specification given by user.
    static constexpr auto kFieldNameSortBy = "sortBy"sv;
    // Array containing only the fields needed to generate a sortKey from the input document.
    static constexpr auto kFieldNameSortFields = "sortFields"sv;
    // A sortKey already generated by a previous call to _processValue.
    static constexpr auto kFieldNameGeneratedSortKey = "generatedSortKey"sv;
...
public:
    static constexpr auto kName = "$minN"sv;
...
public:
    static constexpr auto kName = "$maxN"sv;
...
public:
    static constexpr auto kName = "$firstN"sv;
...
public:
    static constexpr auto kName = "$lastN"sv;
