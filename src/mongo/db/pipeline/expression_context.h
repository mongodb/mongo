...
public:
    ...
    // If set to true, always use 'changeStreamTokenVersion' when resuming a stream, regardless of
    // the client resume token's version.
    bool ignoreTokenVersionOnResume = false;
