...
public:
    ...
    // during runtime.
    // TODO SERVER-91262 Move SharedSearchState out of ExpressionContext.
    ...
    public:
        ...
        /**
         * Returns the "success rate" finding docs by id in the idLookup phase as
         ...
         */
        double getDocsLookupByIdSuccessRate() const {
            ...
            tassert(
                9074400,
                str::stream()
                    << "_docsReturnedByIdLookup must not be greater than "
                    << "_docsSeenByIdLookup in SharedSearchState, but _docsReturnedByIdLookup = '"
