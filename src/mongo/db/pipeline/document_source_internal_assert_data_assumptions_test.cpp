...
TEST_F(DocumentSourceInternalAssertDataAssumptionsTest, AutoInsertedWhenKnobEnabled) {
    RAIIServerParameterControllerForTest knob("internalEnableDependencyGraphValidation", true);
...
TEST_F(DocumentSourceInternalAssertDataAssumptionsTest, NotInsertedWhenKnobDisabled) {
    RAIIServerParameterControllerForTest knob("internalEnableDependencyGraphValidation", false);
