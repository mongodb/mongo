...
TEST(JSONSchemaValidation, ArrayBadValueInArray) {
    ...
    BSONObj document1 =
        BSON("a" << BSONArray(BSON("0" << 900 << "10987" << 1024 << "2147483647" << "400")));
    ...
    BSONObj document2 = BSON("a" << BSONArray(BSON("this_should_be_an_index" << "bad")));
    ...
    BSONObj document3 = BSON("a" << BSONArray(BSON("9223372036854775808" << "bad")));
