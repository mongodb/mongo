...
#include "merizo/db/service_liaison.h"
...
/**
 * This is the service liaison to merizos for the logical session cache.
 *
 ...
 * periodic runner for this merizos. The time will be returned from the
 * system clock.
 */
