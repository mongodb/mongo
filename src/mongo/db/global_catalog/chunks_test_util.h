...
/**
 * Builds a ShardRefToHandleMap for passed in chunks. Expects that the chunks were generated by the
 * other helpers in this file. Each shard appears in the map exactly once (keyed by the `shardRef`
 * value embedded in each chunk).
 */
