 ...
 *
 * TODO (SERVER-113356): With the introduction of the Router and Shard Roles, nobody outside of the
 * catalog modules should be concerned with collection UUID checking.
 */
