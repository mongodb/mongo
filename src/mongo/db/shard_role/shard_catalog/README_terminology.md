...
- **Collection generation:** a superset of the collection incarnation. A collection reincarnation
  ...
  [placement versioning protocol](https://github.com/mongodb/mongo/blob/8a79395deff895f18b8878ff4567c9fb309a7c64/src/mongo/db/s/README_versioning_protocols.md#shard-version).
- **Collection instance:** an immutable version of a
  [`Collection` object](https://github.com/mongodb/mongo/blob/5157bf67f0dc75f6d5ea63cac8654a0517fcf516/src/mongo/db/catalog/README.md#collection-objects).
