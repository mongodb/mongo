...
TEST_F(DelayableTimeoutCallbackWithJitterTest, ScheduleAtWithZeroJitter) {
    ...
    ASSERT_OK(
        _delayableTimeoutCallback->scheduleAtWithJitter(_net->now() + Seconds(10), Seconds(0)));
    ASSERT_TRUE(_delayableTimeoutCallback->isActive());
...
TEST_F(DelayableTimeoutCallbackWithJitterTest, ScheduleAtWithJitterMovesCallbackEarlier) {
    ...
    ASSERT_OK(_delayableTimeoutCallback->scheduleAtWithJitter(_net->now() + Seconds(3),
                                                              Milliseconds(100)));
    ...
    ASSERT_OK(_delayableTimeoutCallback->scheduleAtWithJitter(_net->now() + Seconds(1),
                                                              Milliseconds(100)));
...
TEST_F(DelayableTimeoutCallbackWithJitterTest, ScheduleAtWithJitter) {
    ...
    ASSERT_OK(_delayableTimeoutCallback->scheduleAtWithJitter(_net->now() + Seconds(10),
                                                              Milliseconds(100)));
