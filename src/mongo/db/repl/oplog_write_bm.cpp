...
// numEntriesPerBatch
// Since there is 146B overhead per entry, Reduce the number of entries to fit into 240MB queue
// 1KB entrySize
BENCHMARK(BM_TestWriteOps)
    ->Args({1, (245760 - (32 * 1024)), 1024, 1, std::numeric_limits<long>::max()})
...
// 4KB entrySize
BENCHMARK(BM_TestWriteOps)
    ->Args({1, (61440 - 2048), 4 * 1024, 1, std::numeric_limits<long>::max()})
...
// 16KB entrySize
BENCHMARK(BM_TestWriteOps)
    ->Args({1, (15360 - 128), 16 * 1024, 1, std::numeric_limits<long>::max()})
...
// 64KB entrySize
BENCHMARK(BM_TestWriteOps)
    ->Args({1, (3840 - 8), 64 * 1024, 1, std::numeric_limits<long>::max()})
...
// 256KB entrySize
BENCHMARK(BM_TestWriteOps)
    ->Args({1, 960, 256 * 1024, 1, std::numeric_limits<long>::max()})
...
// 1MB entrySize
BENCHMARK(BM_TestWriteOps)
    ->Args({1, 240, 1024 * 1024, 1, std::numeric_limits<long>::max()})
...
// 2MB entrySize
BENCHMARK(BM_TestWriteOps)
    ->Args({1, 120, 2 * 1024 * 1024, 1, std::numeric_limits<long>::max()})
...
// 5MB entrySize
BENCHMARK(BM_TestWriteOps)
    ->Args({1, 48, 5 * 1024 * 1024, 1, std::numeric_limits<long>::max()})
...
// 10MB entrySize
BENCHMARK(BM_TestWriteOps)
    ->Args({1, 24, 10 * 1024 * 1024, 1, std::numeric_limits<long>::max()})
...
// 16MB entrySize
BENCHMARK(BM_TestWriteOps)
    ->Args({1, 15, 16 * 1024 * 1024, 1, std::numeric_limits<long>::max()})
...
// 1KB entrySize
BENCHMARK(BM_TestWriteOps)
    ->Args({1, (245760 - (32 * 1024)), 1024, std::numeric_limits<long>::max(), 1024})
    ->Args({1, (245760 - (32 * 1024)), 1024, std::numeric_limits<long>::max(), 256 * 1024})
    ->Args({1, (245760 - (32 * 1024)), 1024, std::numeric_limits<long>::max(), 512 * 1024})
...
// 4KB entrySize
BENCHMARK(BM_TestWriteOps)
    ->Args({1, (61440 - 2048), 4 * 1024, std::numeric_limits<long>::max(), 1024})
    ->Args({1, (61440 - 2048), 4 * 1024, std::numeric_limits<long>::max(), 256 * 1024})
    ->Args({1, (61440 - 2048), 4 * 1024, std::numeric_limits<long>::max(), 512 * 1024})
...
// 64KB entrySize
BENCHMARK(BM_TestWriteOps)
    ->Args({1, (3840 - 8), 64 * 1024, std::numeric_limits<long>::max(), 1024})
    ->Args({1, (3840 - 8), 64 * 1024, std::numeric_limits<long>::max(), 256 * 1024})
    ->Args({1, (3840 - 8), 64 * 1024, std::numeric_limits<long>::max(), 512 * 1024})
...
// 512KB entrySize
BENCHMARK(BM_TestWriteOps)
    ->Args({1, 480, 512 * 1024, std::numeric_limits<long>::max(), 1024})
    ->Args({1, 480, 512 * 1024, std::numeric_limits<long>::max(), 256 * 1024})
    ->Args({1, 480, 512 * 1024, std::numeric_limits<long>::max(), 512 * 1024})
...
// 1MB entrySize
BENCHMARK(BM_TestWriteOps)
    ->Args({1, 240, 1024 * 1024, std::numeric_limits<long>::max(), 1024})
    ->Args({1, 240, 1024 * 1024, std::numeric_limits<long>::max(), 256 * 1024})
    ->Args({1, 240, 1024 * 1024, std::numeric_limits<long>::max(), 512 * 1024})
...
// 2MB entrySize
BENCHMARK(BM_TestWriteOps)
    ->Args({1, 120, 2 * 1024 * 1024, std::numeric_limits<long>::max(), 1024})
    ->Args({1, 120, 2 * 1024 * 1024, std::numeric_limits<long>::max(), 256 * 1024})
    ->Args({1, 120, 2 * 1024 * 1024, std::numeric_limits<long>::max(), 512 * 1024})
...
// 5MB entrySize
BENCHMARK(BM_TestWriteOps)
    ->Args({1, 48, 5 * 1024 * 1024, std::numeric_limits<long>::max(), 1024})
    ->Args({1, 48, 5 * 1024 * 1024, std::numeric_limits<long>::max(), 256 * 1024})
    ->Args({1, 48, 5 * 1024 * 1024, std::numeric_limits<long>::max(), 512 * 1024})
...
// 10MB entrySize
BENCHMARK(BM_TestWriteOps)
    ->Args({1, 24, 10 * 1024 * 1024, std::numeric_limits<long>::max(), 1024})
    ->Args({1, 24, 10 * 1024 * 1024, std::numeric_limits<long>::max(), 256 * 1024})
    ->Args({1, 24, 10 * 1024 * 1024, std::numeric_limits<long>::max(), 512 * 1024})
...
// 16MB entrySize
BENCHMARK(BM_TestWriteOps)
    ->Args({1, 15, 16 * 1024 * 1024, std::numeric_limits<long>::max(), 1024})
    ->Args({1, 15, 16 * 1024 * 1024, std::numeric_limits<long>::max(), 256 * 1024})
    ->Args({1, 15, 16 * 1024 * 1024, std::numeric_limits<long>::max(), 512 * 1024})
...
BENCHMARK(BM_TestWriteOps)
    ...
    ->Args({30, 200000, 1024, 1000, std::numeric_limits<long>::max()})
    ->UseManualTime()
    ->Unit(benchmark::kMillisecond);
...
BENCHMARK(BM_TestWriteOps)
    ...
    ->Args({30, 200000, 1024, 2000, std::numeric_limits<long>::max()})
    ->UseManualTime()
    ->Unit(benchmark::kMillisecond);
...
BENCHMARK(BM_TestWriteOps)
    ...
    ->Args({30, 200000, 1024, 5000, std::numeric_limits<long>::max()})
    ->UseManualTime()
    ->Unit(benchmark::kMillisecond);
...
BENCHMARK(BM_TestWriteOps)
    ...
    ->Args({30, 200000, 1024, 10000, std::numeric_limits<long>::max()})
    ->UseManualTime()
    ->Unit(benchmark::kMillisecond);
...
BENCHMARK(BM_TestWriteOps)
    ...
    ->Args({30, 2400, 100 * 1024, 1000, std::numeric_limits<long>::max()})
    ->UseManualTime()
    ->Unit(benchmark::kMillisecond);
