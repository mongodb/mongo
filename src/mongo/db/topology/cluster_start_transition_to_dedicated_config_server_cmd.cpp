...
class StartTransitionToDedicatedConfigServerCmd
    : public TypedCommand<StartTransitionToDedicatedConfigServerCmd> {
public:
    using Request = StartTransitionToDedicatedConfigServer;

    StartTransitionToDedicatedConfigServerCmd() : TypedCommand(Request::kCommandName) {}
    ...
    public:
        ...
        void typedRun(OperationContext* opCtx) {
            ConfigSvrStartShardDraining configsvrRequest{ShardId::kConfigServerId};
    ...
    std::string help() const override {
        return "Command to start transitioning from an embedded config server to a dedicated "
               "config server";
    }
...
MONGO_REGISTER_COMMAND(StartTransitionToDedicatedConfigServerCmd).forRouter();
