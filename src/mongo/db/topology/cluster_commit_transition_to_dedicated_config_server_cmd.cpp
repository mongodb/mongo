...
class CommitTransitionToDedicatedConfigServerCmd
    : public TypedCommand<CommitTransitionToDedicatedConfigServerCmd> {
public:
    using Request = CommitTransitionToDedicatedConfigServer;

    CommitTransitionToDedicatedConfigServerCmd() : TypedCommand(Request::kCommandName) {}
    ...
    public:
        ...
        void typedRun(OperationContext* opCtx) {
            ConfigSvrCommitShardRemoval configsvrRequest{ShardId::kConfigServerId};
    ...
    std::string help() const override {
        return "Command to commit a transition from an embedded config server to a dedicated "
               "config server";
    }
...
MONGO_REGISTER_COMMAND(CommitTransitionToDedicatedConfigServerCmd).forRouter();
