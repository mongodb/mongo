...
MONGO_FAIL_POINT_DEFINE(errorAfterProcessingReshardDonorRecipientsFinishedCloningCommand);
...
public:
    ...
    public:
        ...
        void typedRun(OperationContext* opCtx) {
            ...
            if (MONGO_unlikely(errorAfterProcessingReshardDonorRecipientsFinishedCloningCommand
                                   .shouldFail())) {
                uasserted(ErrorCodes::SocketException,
                          "Hit errorAfterProcessingReshardDonorRecipientsFinishedCloningCommand "
                          "failpoint");
            }
        }
