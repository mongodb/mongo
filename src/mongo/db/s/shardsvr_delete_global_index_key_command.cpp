...
class ShardsvrDeleteGlobalIndexKeyCmd final : public TypedCommand<ShardsvrDeleteGlobalIndexKeyCmd> {
public:
    using Request = DeleteGlobalIndexKey;
    ...
    std::string help() const override {
        return "Internal command to delete a key from a global index data container.";
    }
