...
private:
    ...
    void _updateDonorDocument(ChangeStreamsMonitorContext&& newChangeStreamsMonitorCtx);
    void _updateDonorDocument(const BSONObj& updateMod);
    ...
    std::unique_ptr<ReshardingChangeStreamsMonitor> _changeStreamsMonitor;
