...
public:
    ...
    void setUp() override {
        ...
        // Ensure that the new coordinators we create won't actually run. This failpoint will be
        // turned off by PrimaryOnlyServiceMongoDTest::shutdown().
        globalFailPointRegistry()
            .find("hangBeforeRunningConfigsvrCoordinatorInstance")
