...
private:
    ...
    /**
     * Delegate of doGetNext() in the case where an $unwind stage has been absorbed into
     * _sharedState->unwindSrc. This returns the next record resulting from unwinding the
     * lookup's "as" field.
     */
    ...
    // '_sharedState->unwindSrc' is not null.
