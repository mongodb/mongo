...
/* This instruction takes as input a ValueBlock and a type mask and returns a BoolBlock indicating
 * whether each value in the ValueBlock is of the type defined by the type mask.
 */
FastTuple<bool, value::TypeTags, value::Value> ByteCode::builtinValueBlockTypeMatch(
    ...
    tassert(8300801,
            "Second argument of valueBlockTypeMatch must be int32",
            typeMaskTag == value::TypeTags::NumberInt32);
    auto typeMask = static_cast<uint32_t>(value::bitcastTo<int32_t>(typeMaskVal));

    static constexpr auto cmpOpType =
        ColumnOpType{ColumnOpType::kOutputNonNothingOnMissingInput |
                         ColumnOpType::kOutputNonNothingOnExpectedInput,
...
/* This instruction takes as input a timezoneDB and a ValueBlock and returns a BoolBlock indicating
...
FastTuple<bool, value::TypeTags, value::Value> ByteCode::builtinValueBlockIsTimezone(
    ...
    const auto cmpOp = value::makeColumnOp<cmpOpType>(
        [&](value::TypeTags tag, value::Value val) -> std::pair<value::TypeTags, value::Value> {
            ...
            return {value::TypeTags::Boolean, timezoneDB->isTimeZoneIdentifier(timezoneStr)};
        });
