...
void ScanStage::doAttachCollectionAcquisition(MultipleCollectionAccessor mca) {
...
void ParallelScanStage::doAttachCollectionAcquisition(MultipleCollectionAccessor mca) {
