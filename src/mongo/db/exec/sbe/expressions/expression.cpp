...
static stdx::unordered_map<std::string, BuiltinFn> kBuiltinFunctions = {
    ...
    {"fillType", BuiltinFn{[](size_t n) { return n == 3; }, vm::Builtin::fillType, false}},
    {"doubleDoubleSum",
    ...
    {"substrCP", BuiltinFn{[](size_t n) { return n == 3; }, vm::Builtin::substrCP, false}},
    ...
    {"rand", BuiltinFn{[](size_t n) { return n == 0; }, vm::Builtin::rand, false}},
    ...
    {"topN", BuiltinFn{[](size_t n) { return n == 3 || n == 4; }, vm::Builtin::topN, false}},
    {"top", BuiltinFn{[](size_t n) { return n == 2 || n == 3; }, vm::Builtin::top, false}},
    {"bottomN", BuiltinFn{[](size_t n) { return n == 3 || n == 4; }, vm::Builtin::bottomN, false}},
    {"bottom", BuiltinFn{[](size_t n) { return n == 2 || n == 3; }, vm::Builtin::bottom, false}},
    ...
    {"unwindArray", BuiltinFn{[](size_t n) { return n == 1; }, vm::Builtin::unwindArray, false}},
    {"arrayToSet", BuiltinFn{[](size_t n) { return n == 1; }, vm::Builtin::arrayToSet, false}},
    {"collArrayToSet",
     BuiltinFn{[](size_t n) { return n == 2; }, vm::Builtin::collArrayToSet, false}},
    {"array", BuiltinFn{kAnyNumberOfArgs, vm::Builtin::newArray, false}},
    {"avgOfArray", BuiltinFn{[](size_t n) { return n == 1; }, vm::Builtin::avgOfArray, false}},
    {"maxOfArray", BuiltinFn{[](size_t n) { return n == 1; }, vm::Builtin::maxOfArray, false}},
    {"minOfArray", BuiltinFn{[](size_t n) { return n == 1; }, vm::Builtin::minOfArray, false}},
    {"stdDevPop", BuiltinFn{[](size_t n) { return n == 1; }, vm::Builtin::stdDevPop, false}},
    {"stdDevSamp", BuiltinFn{[](size_t n) { return n == 1; }, vm::Builtin::stdDevSamp, false}},
    {"sumOfArray", BuiltinFn{[](size_t n) { return n == 1; }, vm::Builtin::sumOfArray, false}},
