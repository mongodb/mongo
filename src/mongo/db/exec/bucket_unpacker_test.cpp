    ...
    auto bucket = fromjson(R"(
{
    ...
    auto specWithIncludeFields = BucketSpec{kUserDefinedTimeName.toString(),
                                            kUserDefinedMetaName.toString(),
                                            std::move(includeFields),
                                            computedMetaProjFields};

    // This calls eraseUnneededComputedMetaProjFields().
    unpacker.setBucketSpecAndBehavior(std::move(specWithIncludeFields),
                                      BucketUnpacker::Behavior::kInclude);
    ...
    auto bucket = fromjson(R"(
{
    ...
    auto specWithExcludeFields = BucketSpec{kUserDefinedTimeName.toString(),
                                            kUserDefinedMetaName.toString(),
                                            std::move(excludeFields),
                                            computedMetaProjFields};

    // This calls eraseUnneededComputedMetaProjFields().
    unpacker.setBucketSpecAndBehavior(std::move(specWithExcludeFields),
                                      BucketUnpacker::Behavior::kExclude);
