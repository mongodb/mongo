...
TEST(ParseNamespaceFromCommand, String) {
    ASSERT_EQ(CommandHelpers::parseNsFromCommand(DatabaseName{boost::none, "test"},
                                                 BSON("command"
                                                      << "coll")),
...
TEST(ParseNamespaceFromCommand, Symbol) {
    ...
    ASSERT_EQ(CommandHelpers::parseNsFromCommand(DatabaseName{boost::none, "test"}, builder.obj()),
              NamespaceString::createNamespaceString_forTest("test.coll"));
}
