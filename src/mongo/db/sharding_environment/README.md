...
- Routing Info: The subset of data stored in the [catalog containers](../shard_role/shard_catalog/README_sharding_catalog.md#catalog-containers) which is used for making routing decisions. As of the time of this writing, the contents of _config.databases_, _config.collections_ and _config.chunks_.
