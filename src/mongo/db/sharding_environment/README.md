...
- CSS: [Collection Sharding State](/src/mongo/db/local_catalog/shard_role_catalog/collection_sharding_state.h#L59)
...
- DSS: [Database Sharding State](/src/mongo/db/local_catalog/shard_role_catalog/database_sharding_state.h#L42)
