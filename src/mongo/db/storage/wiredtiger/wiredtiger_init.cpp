...
#define EXT4_SUPER_MAGIC 0xEF53
        ...
        // disableSpillEngine is a test-only flag to skip opening the spill WiredTiger
        // instance, avoiding contention from multiple WiredTiger opens during concurrent unit
        // test runs. Tests that exercise spilling must opt in via
        // Options{}.enableSpillEngine().
        if (storageGlobalParams.disableSpillEngine) {
