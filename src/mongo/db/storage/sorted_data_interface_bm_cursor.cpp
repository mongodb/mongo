...
BENCHMARK_CAPTURE(
    BM_Advance, AdvanceForwardStringLoc, kForward, kRecordId, kNonUnique, KeyFormat::String);
...
BENCHMARK_CAPTURE(
    BM_AdvanceWithEnd, AdvanceForwardStringLoc, kForward, kNonUnique, KeyFormat::String);
