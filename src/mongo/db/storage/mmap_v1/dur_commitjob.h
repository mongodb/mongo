...
namespace mongo {
    namespace dur {
        ...
        public:
            ...
            /**
             * This method is safe to call outside of locks. when haswritten is false we don't do
             * any group commit and avoid even trying to acquire a lock, which might be helpful
             * at times.
             */
            ...
            /**
             * Sorts the internal list of write intents so that overlapping and duplicate items
             * can be merged. We do the sort here so the caller receives something they must keep
             * const from their POV.
             */
