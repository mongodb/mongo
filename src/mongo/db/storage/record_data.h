...
namespace mongo {
     ...
     * it must point to an object which owns data. This means that the memory pointed to by _data 
     * is owned by the RecordData class, and will be cleaned up automatically when the RecordData
     * destructor calls the _dataPtr destructor.
     */
    class RecordData {
    public:
