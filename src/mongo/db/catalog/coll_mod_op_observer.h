...
/**
 * OpObserver for the collMod command.
 * Observes CRUD operations on interested collections that have an ongoing
 * unique index converstion.
 */
class CollModOpObserver final : public OpObserver {
    CollModOpObserver(const CollModOpObserver&) = delete;
    CollModOpObserver& operator=(const CollModOpObserver&) = delete;

public:
    CollModOpObserver() = default;
    ~CollModOpObserver() = default;
