...
public:
    ...
    struct RemoveExistingIndexesFlags {
        ...
        // Flag indicating whether we should also check unfinished index builds for whether the
        // given specs match.
        ...
        //
        // Useful when comparing against output that has been fixed beforehand and won't affect the
