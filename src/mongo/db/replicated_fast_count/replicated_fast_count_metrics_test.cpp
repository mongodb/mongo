...
class ReplicatedFastCountMetricsTest : public CatalogTestFixture {
public:
    ReplicatedFastCountMetricsTest()
...
TEST_F(ReplicatedFastCountMetricsTest, MetadataMutexRegisteredWithObservableMutexRegistry) {
