        ...
        return writeConflictRetry(opCtx, "filemd5", dbname, [&] {
            ...
            while (PlanExecutor::ADVANCED == (state = exec->getNext(&obj, NULL))) {
                ...
                if (owned["data"].type() == EOO) {
                    uassert(50751, str::stream() << "The element that calls binDataClean() must be type of BinData and field name is required for this request", (owned["data"].type() == BSONType::BinData));
                } else {
