...
// A 4.4 mongoS issues $mergeCursors pipelines with ChunkVersion::IGNORED. On the shard, this will
...
// versioned. This can happen in the case where we are running in a cluster with a 4.2 mongoS, which
