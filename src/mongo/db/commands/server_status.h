 ...
 * command. Make sure to perform the registration at static-initialization time to ensure your
 * section is regsitered before the server can run commands.
 */
...
/**
 * Builder that can be used to construct ServerStatusSections at static-initialization
 * time and register them with the global registry used by the serverStatus command.
 *
