...
namespace {
    ...
    TEST(RoleParsingTest, BuildRoleBSON) {
        ...
        ASSERT_OK(auth::getBSONForRole(&graph, roleA, doc.root()));
        ...
        // Role B
        doc.reset();
        ASSERT_OK(auth::getBSONForRole(&graph, roleB, doc.root()));
        ...
        // Role C
        doc.reset();
        ASSERT_OK(auth::getBSONForRole(&graph, roleC, doc.root()));
        roleDoc = doc.getObject();
