...
public:
    ...
    void assertCounts(uint64_t whole, uint64_t name) {
...
public:
    ...
    void assertInvalidateCounts(uint64_t whole, uint64_t name) {
        authzManager->assertCounts(whole, name);
    }
