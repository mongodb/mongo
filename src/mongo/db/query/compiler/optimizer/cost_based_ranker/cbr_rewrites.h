 ...
 * The function can return nullptr if the index bounds specify a fully open interval (e.g. [MinKey,
 * MaxKey] for all index fields) and the filter expression is null.
 */
