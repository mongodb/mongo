...
TEST_F(SamplingEstimatorTest, ExtractTopLevelFieldsFromMatchExpressionDottedPath) {
    auto bson = fromjson("{a: 1, b: {c: 2}, b: {c: {d: 3}}}");
    auto expr = parse(bson);
