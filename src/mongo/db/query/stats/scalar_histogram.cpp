...
const ScalarHistogram ScalarHistogram::make() {
    return ScalarHistogram();
}

const ScalarHistogram ScalarHistogram::make(const StatsHistogram& histogram) {
...
const ScalarHistogram ScalarHistogram::make(sbe::value::Array bounds,
                                            std::vector<Bucket> buckets,
                                            bool doValidation) {
    if (doValidation) {
