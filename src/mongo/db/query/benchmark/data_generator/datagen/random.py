...
# This is a custom RNG for making it easier to generate correlated data.
class CorrelatedRng(random.Random):
    ...
    # This override uses multiplication instead of modulus to generate integers.
    ...
    def random(self, *args, **kwargs):
        # Shadow the random calls with the default state as well. This way, if a correlation is
