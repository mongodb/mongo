...
TEST(PlanCacheKeyInfoTest, ComputeKeyElemMatchNoIndexOnPath) {
    CollatorInterfaceMock collator(CollatorInterfaceMock::MockType::kReverseString);
    const auto keyPattern = BSON("a" << 1);
    const std::vector<CoreIndexInfo> indexCores = {
        CoreIndexInfo(keyPattern,
...
TEST(PlanCacheKeyInfoTest, ComputeKeyObjectElemMatch) {
    CollatorInterfaceMock collator(CollatorInterfaceMock::MockType::kReverseString);
...
TEST(PlanCacheKeyInfoTest, ComputeKeyWithNot) {
    const auto keyPattern = BSON("a.b" << 1);
...
TEST(PlanCacheKeyInfoTest, ComputeKeyWithLogicalNodes) {
