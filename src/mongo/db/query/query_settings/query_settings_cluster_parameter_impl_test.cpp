...
bool operator==(const QueryShapeConfiguration& lhs, const QueryShapeConfiguration& rhs) {
    return SimpleBSONObjComparator::kInstance.compare(lhs.toBSON(), rhs.toBSON()) == 0;
}

bool operator==(const QueryShapeConfigurationsWithTimestamp& lhs,
 ...
 */
TEST_F(QuerySettingsServiceTest, QuerySettingsClusterParameterSetReset) {
 ...
 * sanitization.
 */
TEST_F(QuerySettingsServiceTest, QuerySettingsClusterParameterSetInvalidQSWithSanitization) {
    boost::optional<TenantId> tenantId;
    auto sp = std::make_unique<QuerySettingsClusterParameter>(
        QuerySettingsService::getQuerySettingsClusterParameterName(),
        ServerParameterType::kClusterWide);
 ...
 * sanitized.
 */
TEST_F(QuerySettingsServiceTest, SetValidClusterParameterAndAssertResultIsSanitized) {
 ...
 */
TEST_F(QuerySettingsServiceTest, SetClusterParameterAndAssertResultIsSanitized) {
    IndexHintSpecs initialIndexHintSpec{
 ...
 */
TEST_F(QuerySettingsServiceTest, SetClusterParameterAndAssertResultIsSanitizedMultipleQS) {
