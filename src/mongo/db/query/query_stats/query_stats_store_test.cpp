...
TEST_F(QueryStatsStoreTest, GenerateMaxBsonSizeQueryShape) {
    ...
    // TODO SERVER-87731 backport: re-enable SERVER-79794 test. This test is currently
    ...
    ASSERT_DOES_NOT_THROW(try {
        opDebug.queryStatsInfo.key = std::make_unique<query_stats::FindKey>(
    ...
    ASSERT(opDebug.queryStatsInfo.keyHash == boost::none);

    // TODO SERVER-87731 backport. Below is the proper test using queryStats.
