...
| `queryPlanner.planShapeCounters`                               | Per-shape counts of the winning plan (e.g. `collscan`, `ixscanFetch`) observed across executions  | Summed from shards via `DataBearingNodeMetrics` (per-shape counts added together)                         |
