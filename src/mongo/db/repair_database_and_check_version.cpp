...
Status restoreMissingFeatureCompatibilityVersionDocument(OperationContext* opCtx,
    ...
    if (!Helpers::findOne(opCtx,
        ...
        LOGV2(21000,
              ...
              "version"_attr = FeatureCompatibilityVersionParser::kVersion42);
                ...
                if (Helpers::findOne(
                    ...
                    if (version ==
                        ...
                        LOGV2_WARNING_OPTIONS(
                            ...
                            "setFeatureCompatibilityVersion command to resume upgrade to 4.4.",
                        ...
                        LOGV2_WARNING_OPTIONS(
                            ...
                            "featureCompatibilityVersion is "
                            "{currentfeatureCompatibilityVersion}. To fix this, use the "
                            "setFeatureCompatibilityVersion command to resume downgrade to 4.2.",
