...
struct TaskExecutorCursorOptions {
     ...
     */
    TaskExecutorCursorOptions(std::unique_ptr<TaskExecutorCursorGetMoreStrategy> getMoreStrategy =
                                  std::make_unique<DefaultTaskExecutorCursorGetMoreStrategy>(),
    ...
    TaskExecutorCursorOptions(TaskExecutorCursorOptions& other) = delete;
    TaskExecutorCursorOptions(TaskExecutorCursorOptions&& other);

    // Specifies the strategy with which the cursor should configure GetMore requests.
    std::unique_ptr<TaskExecutorCursorGetMoreStrategy> getMoreStrategy;
