...
public:
    ...
    void CancelTECWhileSharedPCTEInUse() {
        ...
        RemoteCommandRequest rcr(HostAndPort("localhost"),
                                 ...
                                 aggCmd,
                                 opCtx.get());
        std::vector<TaskExecutorCursor> cursorVec;
        {
...
TEST_F(PinnedConnTaskExecutorCursorTestFixture, MultipleCursorsCancellation) {
    CancelTECWhileSharedPCTEInUse();
}

TEST_F(NonPinningTaskExecutorCursorTestFixture, MultipleCursorsCancellation) {
