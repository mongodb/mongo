...
namespace mongo {
namespace executor {
BSONObj DefaultTaskExecutorCursorGetMoreStrategy::createGetMoreRequest(const CursorId& cursorId,
...
TaskExecutorCursorOptions::TaskExecutorCursorOptions(boost::optional<int64_t> batchSize,
                                                     ...
                                                     bool pinConnection)
    : getMoreStrategy(
          std::make_unique<DefaultTaskExecutorCursorGetMoreStrategy>(batchSize, preFetchNextBatch)),
...
TaskExecutorCursorOptions::TaskExecutorCursorOptions(TaskExecutorCursorOptions&& other) {
    getMoreStrategy = std::move(other.getMoreStrategy);
    yieldPolicy = std::move(other.yieldPolicy);
    pinConnection = other.pinConnection;
}
}  // namespace executor
}  // namespace mongo
