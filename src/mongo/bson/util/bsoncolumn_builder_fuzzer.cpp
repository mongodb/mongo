...
#include "mongo/bson/util/bsoncolumn_fuzzer_util.h"
...
extern "C" int LLVMFuzzerTestOneInput(const char* Data, size_t Size) {
    ...
    // Verify bsoncolumn::min, max, minmax
    {
        ...
        std::tie(expectedMin, expectedMax) = bsoncolumn::expectedMinMax(generatedElements);
        ...
        std::tie(minmaxMin, minmaxMax) = bsoncolumn::minmax<bsoncolumn::BSONElementMaterializer>(
            diff.data(), diff.size(), allocator);
