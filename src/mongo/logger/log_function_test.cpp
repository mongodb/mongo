...
TEST_F(LogTestDetailsEncoder, LogFunctionsOverrideGlobalComponent) {
    ...
    ASSERT_TRUE(shouldLogV1(LogSeverity::Severe()));
    ...
    ASSERT_TRUE(shouldLogV1(componentA, LogSeverity::Severe()));
    ASSERT_EQUALS(1U, _logLines.size());
    ...
    ASSERT_TRUE(shouldLogV1(LogSeverity::Error()));
    ASSERT_EQUALS(1U, _logLines.size());
    ...
    ASSERT_TRUE(shouldLogV1(componentA, LogSeverity::Error()));
    ASSERT_EQUALS(1U, _logLines.size());
    ...
    ASSERT_TRUE(shouldLogV1(LogSeverity::Warning()));
    ASSERT_EQUALS(1U, _logLines.size());
    ...
    ASSERT_TRUE(shouldLogV1(componentA, LogSeverity::Warning()));
    ASSERT_EQUALS(1U, _logLines.size());
    ...
    ASSERT_TRUE(shouldLogV1(componentA, LogSeverity::Log()));
    ASSERT_EQUALS(1U, _logLines.size());
