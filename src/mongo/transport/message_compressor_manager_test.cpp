...
void checkWrongUncompressedSize(std::unique_ptr<MessageCompressorBase> compressor,
    ...
    MessageCompressorManager::CompressionHeader originalHeader(&input);
    ...
    const size_t malformedMessageSize = MsgData::MsgDataHeaderSize +
        MessageCompressorManager::CompressionHeader::size() + compressedDataSize;
