...
public:
     ...
     * _internalProcessType: INJECTOR). Injector-tagged servers belong to a standby cluster's
    ...
    static inline const std::string kProcessTypeTagKey = "_internalProcessType";
