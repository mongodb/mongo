...
concept ImplementsLockShared = requires(MutexType m) {
    m.lock_shared();
};
...
private:
    ...
    mutable stdx::mutex _mutex;  // NOLINT(mongo-mutex-check)
...
public:
    ...
    void lock_shared() requires observable_mutex_details::ImplementsLockShared<MutexType> {
    ...
    void unlock_shared() requires observable_mutex_details::ImplementsLockShared<MutexType> {
...
private:
    ...
    mutable MutexType _mutex;  // NOLINT(mongo-mutex-check)
