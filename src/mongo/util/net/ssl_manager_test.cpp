...
public:
    ...
    void tearDown() override {
        _sessionManager->endAllSessionsNoTagMask();
        // wait until all sessions are drained and ServiceContext's Client list is empty.
        _sessionManager->waitForNoSessions(Seconds{60});
...
private:
    ...
    transport::AsioSessionManager* _sessionManager = nullptr;
};
