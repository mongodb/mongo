...
std::string testConfigPath(std::string x) {
    return "src/mongo/util/options_parser/test_config_files/" + x;
}
...
TEST(Registration, ComposableNotVectorOrMap) {
    ...
    try {
        testOpts
            .addOptionChaining(
                "setParameter", "setParameter", moe::String, "Multiple Values", {}, {})
            .composing();
...
TEST(Parsing, StringVector) {
    ...
    testOpts.addOptionChaining(
        "multival", "multival", moe::StringVector, "Multiple Values", {}, {});
...
TEST(ConfigFromFilesystem, Nonexistent) {
    ...
    std::vector<std::string> argv{
        "binaryname",
        "--config",
        testConfigPath("nonexistent_file.conf"),
    };
...
TEST(ConfigFromFilesystem, NullSubDir) {
    ...
    std::vector<std::string> argv{
        "binaryname",
        "--config",
        testConfigPath("dirNullByte.conf"),
    };
...
TEST(ConfigFromFilesystem, NullTerminated) {
    ...
    std::vector<std::string> argv{
        "binaryname",
        "--config",
        testConfigPath("endStringNull.conf"),
    };
...
TEST(ConfigFromFilesystem, ReadRawFile) {
    ...
    ASSERT_OK(readRawFile(testConfigPath("good.json"), &fileContents, moe::ConfigExpand{}));
    ASSERT_EQ("{\n    \"port\" : 5\n}\n", fileContents);
}
...
TEST(JSONConfigFile, ComposingStringMap) {
    ...
    testOpts
        .addOptionChaining(
            "setParameter", "setParameter", moe::StringMap, "Multiple Values", {}, {})
        .composing();
...
TEST(ChainingInterface, DefaultValue) {
    ...
    moe::OptionSection testOpts;
    testOpts
        .addOptionChaining("default", "default", moe::String, "Option With Default Value", {}, {})
...
TEST(ChainingInterface, ImplicitValue) {
    ...
    testOpts
        .addOptionChaining(
            "implicit", "implicit", moe::String, "Option With Implicit Value", {}, {})
...
TEST(ChainingInterface, PositionalSingleMultipleUnlimitedAndFlag) {
    ...
    testOpts.addOptionChaining("positional1", "positional1", moe::String, "Positional", {}, {})
        .positional(1, 1);
    testOpts
        .addOptionChaining("positional2", "positional2", moe::StringVector, "Positional", {}, {})
        .positional(2, 3);
    testOpts
        .addOptionChaining("positional3", "positional3", moe::StringVector, "Positional", {}, {})
        .positional(4, -1);
    testOpts.addOptionChaining("port", "port", moe::Int, "Port", {}, {});
...
TEST(ChainingInterface, PositionalHoleInRange) {
    ...
    testOpts.addOptionChaining("positional1", "positional1", moe::String, "Positional", {}, {})
        .positional(1, 1);
    testOpts
        .addOptionChaining("positional3", "positional2", moe::StringVector, "Positional", {}, {})
        .positional(3, -1);
    testOpts.addOptionChaining("port", "port", moe::Int, "Port", {}, {});
...
TEST(YAMLConfigFile, DeprecatedDottedNameDeprecatedOnly) {
    ...
    testOpts.addOptionChaining("config", "config", moe::String, "Config file to parse", {}, {});
    testOpts.addOptionChaining(
        "dotted.canonical", "var1", moe::Int, "Var1", {"dotted.deprecated"}, {});
...
TEST(YAMLConfigFile, DeprecatedDottedNameMultipleDeprecated) {
    ...
    testOpts.addOptionChaining("config", "config", moe::String, "Config file to parse", {}, {});
    testOpts.addOptionChaining(
        "dotted.canonical", "var1", moe::Int, "Var1", deprecatedDottedNames, {});
...
TEST(YAMLConfigFile, OutputConfig) {
    ...
    options.addOptionChaining(
        "security.javascriptEnabled", "javascriptEnabled", moe::Bool, "", {}, {});
...
TEST(YAMLConfigFile, canonicalize) {
    ...
    opts.addOptionChaining(
            "net.bindIpAll", "bind_ip_all", moe::Switch, "Bind all addresses", {}, {})
