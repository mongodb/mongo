...
private:
    MutexType _m;  // NOLINT(mongo-mutex-check)
};

using ThrowingObservableMutex = ObservableMutex<ThrowingMutex<std::mutex>>;               // NOLINT
using ThrowingObservableSharedMutex = ObservableMutex<ThrowingMutex<std::shared_mutex>>;  // NOLINT
