 ...
 * strings.
 *
 * Usage:  BONGO_MAKE_STRING_VECTOR("a", "b", "c") returns a vector containing
 * std::strings "a", "b", "c", in that order.
 */
#define BONGO_MAKE_STRING_VECTOR(...) ::bongo::_makeStringVector(0, __VA_ARGS__, NULL)
 ...
 *
 * WARNING: Only intended for use by BONGO_MAKE_STRING_VECTOR macro, defined above.  Aborts
 ...
 * the last parameter. The BONGO_MAKE_STRING_VECTOR macro enforces this.
 *
