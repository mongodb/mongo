 ...
 *
 * Usage:
 *     BONGO_INITIALIZER_WITH_PREREQUISITES(myGlobalStateChecker,
 *                                         ("globalStateInitialized", "stacktraces"))(
 *            ::bongo::InitializerContext* context) {
 *    }
 */
#define BONGO_INITIALIZER_WITH_PREREQUISITES(NAME, PREREQUISITES) \
    BONGO_INITIALIZER_GENERAL(NAME, PREREQUISITES, BONGO_NO_DEPENDENTS)
 ...
 * explicit PREREQUISITES and the set of all other bongo initializers that name NAME in their
 * list of dependents.
 *
 * Usage:
 *    BONGO_INITIALIZER_GENERAL(myInitializer,
 *                             ("myPrereq1", "myPrereq2", ...),
 ...
 */
#define BONGO_INITIALIZER_GENERAL(NAME, PREREQUISITES, DEPENDENTS)                        \
    ::bongo::Status _BONGO_INITIALIZER_FUNCTION_NAME(NAME)(::bongo::InitializerContext*); \
    namespace {                                                                           \
    ::bongo::GlobalInitializerRegisterer _bongoInitializerRegisterer_##NAME(              \
        #NAME,                                                                            \
        _BONGO_INITIALIZER_FUNCTION_NAME(NAME),                                           \
        BONGO_MAKE_STRING_VECTOR PREREQUISITES,                                           \
        BONGO_MAKE_STRING_VECTOR DEPENDENTS);                                             \
    }                                                                                     \
    ::bongo::Status _BONGO_INITIALIZER_FUNCTION_NAME(NAME)
 ...
 */
#define BONGO_INITIALIZER_GROUP(NAME, PREREQUISITES, DEPENDENTS)                               \
    BONGO_INITIALIZER_GENERAL(NAME, PREREQUISITES, DEPENDENTS)(::bongo::InitializerContext*) { \
        return ::bongo::Status::OK();                                                          \
    }

/**
 * Macro to produce a name for a bongo initializer function for an initializer operation
 * named "NAME".
 */
#define _BONGO_INITIALIZER_FUNCTION_NAME(NAME) _bongoInitializerFunction_##NAME
