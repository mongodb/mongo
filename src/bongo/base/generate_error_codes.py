...
// See src/bongo/base/generate_error_codes.py
...
namespace bongo {
     ...
     * strings. The class is derived from the definitions in src/bongo/base/error_codes.err file.
     *
     * Do not update this file directly. Update src/bongo/base/error_codes.err instead.
     */
    class ErrorCodes {
    public:
...
namespace bongo {
    std::string ErrorCodes::errorString(Error err) {
        ...
        default: return bongoutils::str::stream() << "Location" << err;
        }
    }
