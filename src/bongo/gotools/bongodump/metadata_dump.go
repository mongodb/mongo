...
func (dump *BongoDump) dumpMetadata(intent *intents.Intent, buffer resettableOutputBuffer) (err error) {
	...
	meta := Metadata{
		...
		// but {indexes:null} will cause assertions in our legacy C++ bongotools
		Indexes: []interface{}{},
	}
