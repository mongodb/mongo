...
import (
	...
	"github.com/bongodb/bongo-tools/common/archive"
...
// by the bongodump options.
func (dump *BongoDump) shouldSkipCollection(colName string) bool {
...
func (dump *BongoDump) outputPath(dbName, colName string) string {
	var root string
...
func (dump *BongoDump) NewIntent(dbName, colName string) (*intents.Intent, error) {
	intent := &intents.Intent{
		DB: dbName,
		C:  colName,
	}
...
func (dump *BongoDump) CreateOplogIntents() error {
...
func (dump *BongoDump) CreateUsersRolesVersionIntentsForDB(db string) error {
...
func (dump *BongoDump) CreateCollectionIntent(dbName, colName string) error {
...
func (dump *BongoDump) createIntentFromOptions(dbName string, ci *collectionInfo) error {
...
func (dump *BongoDump) CreateIntentsForDatabase(dbName string) error {
...
func (dump *BongoDump) CreateAllIntents() error {
