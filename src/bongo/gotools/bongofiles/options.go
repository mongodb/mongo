...
See http://docs.bongodb.org/manual/reference/program/bongofiles/ for more information.`
...
type StorageOptions struct {
	...
	// Specifies the write concern for each write operation that bongofiles writes to the target database.
	// By default, bongofiles waits for a majority of members from the replica set to respond before returning.
