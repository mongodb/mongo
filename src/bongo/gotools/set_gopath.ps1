...
New-Item $goPath\src\github.com\bongodb -ItemType Container | Out-Null
Invoke-Expression "cmd /c mklink /J $goPath\src\github.com\bongodb\bongo-tools ${pwd}" | Out-Null
