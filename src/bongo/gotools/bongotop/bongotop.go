// Package bongotop provides a method to track the amount of time a BongoDB instance spends reading and writing data.
package bongotop
...
// BongoTop is a container for the user-specified options and
// internal state used for running bongotop.
type BongoTop struct {
	// Generic bongo tool options
	Options *options.ToolOptions

	// Bongotop-specific output options
...
func (mt *BongoTop) runDiff() (outDiff FormattableDiff, err error) {
...
// Run executes the bongotop program.
func (mt *BongoTop) Run() error {
