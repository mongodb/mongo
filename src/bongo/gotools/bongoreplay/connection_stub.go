...
// SessionStub mocks an BongoSession by implementing the AcquireSocketPrivate
...
// AcquireSocketPrivate is an implementation of BongoSession's function that
// allows for the a stubbed connection to the passed to the other operations of
// llmgo for testing
func (session *SessionStub) AcquireSocketPrivate(slaveOk bool) (*mgo.BongoSocket, error) {
