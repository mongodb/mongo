...
// PlayCommand stores settings for the bongoreplay 'play' subcommand
type PlayCommand struct {
	...
	URL          string  `short:"h" long:"host" description:"Location of the host to play back against" default:"bongodb://localhost:27017"`
	...
	NoPreprocess bool    `long:"no-preprocess" description:"don't preprocess the input file to premap data such as bongo cursorIDs"`
