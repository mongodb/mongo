...
// ErrNotMsg is returned if a provided buffer is too small to contain a Bongo message
var ErrNotMsg = fmt.Errorf("buffer is too small to be a Bongo message")
...
// functionality of a reply from a bongodb server. This includes both
