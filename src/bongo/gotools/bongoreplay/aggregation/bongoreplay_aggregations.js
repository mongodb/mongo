//bongoreplay_aggregations.js


//max_latency_per_type returns an aggregation pipeline to view the average and max latency for each type in a 
//bongoreplay report. Latency is calculated as the amount of time between when an operation is played and when it completes
...
//average_and_peak_lag returns an aggregation pipeline to view the average and max lag for a bongoreplay report
...
//and when it actually is played in bongoreplay
...
//latency_delta returns an aggregation pipeline to view the difference in latency in two bongoreplay reports
...
//latency_delta returns an aggregation pipeline to view the difference in errors in two bongoreplay reports
...
//average_latency_compare returns a pipeline to view the average latency of each optype in different bongoreplay reports
...
//it is a helper function to execute any of the bongoreplay statics functions
