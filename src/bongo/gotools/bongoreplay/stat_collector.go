...
// StatOptions stores settings for the bongoreplay subcommands which have stat
// output
...
// about operations bongoreplay performs. It contains a StatGenerator and a
...
// bongoreplay to be reviewed by a program directly following execution.
//
...
type BufferedStatRecorder struct {
	...
	// store information about the commands bongoreplay ran as a result of reading
	// a playback file
	Buffer []OpStat
}
