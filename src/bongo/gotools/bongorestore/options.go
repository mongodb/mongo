...
// Usage describes basic usage of bongorestore
var Usage = `<options> <directory or file to restore>

Restore backups generated with bongodump to a running server.

Specify a database with -d to restore a single database from the target directory,
or use -d and -c to restore a single collection from a single .bson file.

See http://docs.bongodb.org/manual/reference/program/bongorestore/ for more information.`
