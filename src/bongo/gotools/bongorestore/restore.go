...
func (restore *BongoRestore) RestoreIntents() error {
...
// RestoreIntent attempts to restore a given intent into BongoDB.
func (restore *BongoRestore) RestoreIntent(intent *intents.Intent) error {
...
func (restore *BongoRestore) RestoreCollectionToDB(dbName, colName string,
