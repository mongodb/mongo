...
// File types constants used by bongorestore.
const (
...
func (restore *BongoRestore) getInfoFromFilename(filename string) (string, FileType) {
...
func (restore *BongoRestore) CreateAllIntents(dir archive.DirLike) error {
...
func (restore *BongoRestore) CreateIntentForOplog() error {
...
func (restore *BongoRestore) CreateIntentsForDB(db string, dir archive.DirLike) (err error) {
...
func (restore *BongoRestore) CreateStdinIntentForCollection(db string, collection string) error {
...
func (restore *BongoRestore) CreateIntentForCollection(db string, collection string, dir archive.DirLike) error {
...
// the path to the BSON file passed to bongorestore. This is only
...
func (restore *BongoRestore) handleBSONInsteadOfDirectory(path string) error {
