...
func newBongoRestore() *BongoRestore {
...
func TestCreateAllIntents(t *testing.T) {
	...
	Convey("With a test BongoRestore", t, func() {
		mr = newBongoRestore()
		log.SetWriter(&buff)
