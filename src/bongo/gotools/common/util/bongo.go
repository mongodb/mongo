...
// ValidateFullNamespace validates a full bongodb namespace (database +
...
// ValidateDBName validates that a string is a valid name for a bongodb
...
// ValidateCollectionName validates that a string is a valid name for a bongodb
