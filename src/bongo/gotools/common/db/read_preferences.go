...
const (
	WarningNonPrimaryBongosConnection = "Warning: using a non-primary readPreference with a " +
		"connection to bongos may produce inconsistent duplicates or miss some documents."
)
