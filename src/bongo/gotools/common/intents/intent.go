...
import (
	...
	"github.com/bongodb/bongo-tools/common"
...
// bongorestore first scans the directory to generate a list
...
type Manager struct {
	...
	// special intents are for all of the collections that are created by bongod
	// and require special handling
	specialIntents map[string]*Intent

	// legacy bongorestore works in the order that paths are discovered,
	...
	// bongod/bongos and whether or not we are multi threading;
...
// Finish tells the prioritizer that bongorestore is done restoring
