...
for (var i = 0; i != 60; i++) {
	try {
		db1 = new Bongo("127.0.0.1:40001").getDB("admin")
		db2 = new Bongo("127.0.0.1:40002").getDB("admin")
		rs1a = new Bongo("127.0.0.1:40011").getDB("admin")
		rs2a = new Bongo("127.0.0.1:40021").getDB("admin")
		rs3a = new Bongo("127.0.0.1:40031").getDB("admin")
		break
	} catch(err) {
...
function configAuth() {
    ...
    for (var i in addrs) {
        ...
        var db = new Bongo(addrs[i]).getDB("admin")
