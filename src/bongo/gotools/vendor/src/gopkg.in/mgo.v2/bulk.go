...
//
// BongoDB servers older than version 2.6 do not have proper support for bulk
...
//
//   http://blog.bongodb.org/post/84922794768/bongodbs-new-bulk-api
//
type Bulk struct {
	c       *Collection
	opcount int
...
type BulkResult struct {
	Matched  int
	Modified int // Available only for BongoDB 2.6+
...
//
// See the documentation of BulkErrorCase for limitations in older BongoDB releases.
...
// operations running on BongoDB versions prior to 2.6 will report the last
