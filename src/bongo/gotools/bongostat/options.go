...
Monitor basic BongoDB server statistics.

See http://docs.bongodb.org/manual/reference/program/bongostat/ for more information.`

// StatOptions defines the set of options to use for configuring bongostat.
...
// Name returns a human-readable group name for bongostat options.
