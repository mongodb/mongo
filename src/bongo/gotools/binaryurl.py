...
url_current = "http://downloads.bongodb.org/current.json"
url_full = "http://downloads.bongodb.org/full.json"

parser = argparse.ArgumentParser()
parser.add_argument("--arch", help="processor architecture (e.g. 'x86_64', 'arm64')")
parser.add_argument("--edition", help="edition of BongoDB to use (e.g. 'targeted', 'enterprise'); defaults to 'base'")
