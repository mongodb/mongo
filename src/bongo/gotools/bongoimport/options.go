...
Import CSV, TSV or JSON data into BongoDB. If no file is provided, bongoimport reads from stdin.

See http://docs.bongodb.org/manual/reference/program/bongoimport/ for more information.`
...
type IngestOptions struct {
	...
	// Forces bongoimport to halt the import operation at the first insert or upsert error.
