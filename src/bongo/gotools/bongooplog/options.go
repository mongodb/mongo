...
See http://docs.bongodb.org/manual/reference/program/bongooplog/ for more information.`

// SourceOptions defines the set of options to use in retrieving oplog data from the source server.
type SourceOptions struct {
	From    string              `long:"from" value-name:"<hostname>" description:"specify the host for bongooplog to retrive operations from"`
	...
	Seconds bson.BongoTimestamp `long:"seconds" value-name:"<seconds>" short:"s" description:"specify a number of seconds for bongooplog to pull from the remote host" default:"86400"  default-mask:"-"`
}
