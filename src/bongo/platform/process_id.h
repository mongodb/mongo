...
#include "bongo/platform/hash_namespace.h"
...
BONGO_HASH_NAMESPACE_START
template <>
struct hash<::bongo::ProcessId> {
    size_t operator()(const ::bongo::ProcessId pid) const {
        return hash<::std::uint32_t>()(pid.asUInt32());
    }
};
BONGO_HASH_NAMESPACE_END
