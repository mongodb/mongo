...
#pragma push_macro("BONGO_UINT16_SWAB")
#pragma push_macro("BONGO_UINT32_SWAB")
#pragma push_macro("BONGO_UINT64_SWAB")
...
#undef BONGO_UINT16_SWAB
#undef BONGO_UINT32_SWAB
#undef BONGO_UINT64_SWAB
#undef htobe16
#undef htobe32
#undef htobe64
#undef htole16
...
#define BONGO_LITTLE_ENDIAN 1234
#define BONGO_BIG_ENDIAN 4321

#if defined(_MSC_VER)
#include <cstdlib>
#define BONGO_UINT16_SWAB(v) _byteswap_ushort(v)
#define BONGO_UINT32_SWAB(v) _byteswap_ulong(v)
#define BONGO_UINT64_SWAB(v) _byteswap_uint64(v)
#elif defined(__clang__) && defined(__clang_major__) && defined(__clang_minor__) && \
    (__clang_major__ >= 3) && (__clang_minor__ >= 1)
#if __has_builtin(__builtin_bswap16)
#define BONGO_UINT16_SWAB(v) __builtin_bswap16(v)
#endif
#if __has_builtin(__builtin_bswap32)
#define BONGO_UINT32_SWAB(v) __builtin_bswap32(v)
#endif
#if __has_builtin(__builtin_bswap64)
#define BONGO_UINT64_SWAB(v) __builtin_bswap64(v)
#endif
...
#define BONGO_UINT16_SWAB(v) BSWAP_16(v)
#define BONGO_UINT32_SWAB(v) BSWAP_32(v)
#define BONGO_UINT64_SWAB(v) BSWAP_64(v)
#endif

#ifndef BONGO_UINT16_SWAB
#define BONGO_UINT16_SWAB(v) endian::bswap_slow16(v)
#endif

#ifndef BONGO_UINT32_SWAB
#define BONGO_UINT32_SWAB(v) endian::bswap_slow32(v)
#endif

#ifndef BONGO_UINT64_SWAB
#define BONGO_UINT64_SWAB(v) endian::bswap_slow64(v)
#endif

#if BONGO_CONFIG_BYTE_ORDER == BONGO_LITTLE_ENDIAN
#define htobe16(v) BONGO_UINT16_SWAB(v)
#define htobe32(v) BONGO_UINT32_SWAB(v)
#define htobe64(v) BONGO_UINT64_SWAB(v)
#define htole16(v) (v)
#define htole32(v) (v)
#define htole64(v) (v)
#define be16toh(v) BONGO_UINT16_SWAB(v)
#define be32toh(v) BONGO_UINT32_SWAB(v)
#define be64toh(v) BONGO_UINT64_SWAB(v)
#define le16toh(v) (v)
#define le32toh(v) (v)
#define le64toh(v) (v)
#elif BONGO_CONFIG_BYTE_ORDER == BONGO_BIG_ENDIAN
#define htobe16(v) (v)
#define htobe32(v) (v)
#define htobe64(v) (v)
#define htole16(v) BONGO_UINT16_SWAB(v)
#define htole32(v) BONGO_UINT32_SWAB(v)
#define htole64(v) BONGO_UINT64_SWAB(v)
#define be16toh(v) (v)
#define be32toh(v) (v)
#define be64toh(v) (v)
#define le16toh(v) BONGO_UINT16_SWAB(v)
#define le32toh(v) BONGO_UINT32_SWAB(v)
#define le64toh(v) BONGO_UINT64_SWAB(v)
#else
#error \
    "The endianness of target architecture is unknown. " \
        "Please define BONGO_CONFIG_BYTE_ORDER"
#endif
...
struct ByteOrderConverter<float> {
    ...
    inline static T nativeToBig(T t) {
        BONGO_STATIC_ASSERT(sizeof(T) == sizeof(uint32_t));
...
struct ByteOrderConverter<double> {
    ...
    inline static T nativeToBig(T t) {
        BONGO_STATIC_ASSERT(sizeof(T) == sizeof(uint64_t));
...
struct IntegralTypeMap<long long> {
    BONGO_STATIC_ASSERT(sizeof(long long) == sizeof(int64_t));
    typedef int64_t type;
};

template <>
struct IntegralTypeMap<unsigned long long> {
    BONGO_STATIC_ASSERT(sizeof(unsigned long long) == sizeof(uint64_t));
...
#pragma pop_macro("BONGO_UINT16_SWAB")
#pragma pop_macro("BONGO_UINT32_SWAB")
#pragma pop_macro("BONGO_UINT64_SWAB")
