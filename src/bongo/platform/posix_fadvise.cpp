...
#include "bongo/platform/posix_fadvise.h"
...
static PosixFadviseFunc posix_fadvise_switcher = bongo::pal::posix_fadvise_emulation;
...
//
BONGO_INITIALIZER_GENERAL(SolarisPosixFadvise, BONGO_NO_PREREQUISITES, ("default"))
(InitializerContext* context) {
    void* functionAddress = dlsym(RTLD_DEFAULT, "posix_fadvise");
    if (functionAddress != NULL) {
        bongo::pal::posix_fadvise_switcher =
            reinterpret_cast<bongo::pal::PosixFadviseFunc>(functionAddress);
    }
    return Status::OK();
}
