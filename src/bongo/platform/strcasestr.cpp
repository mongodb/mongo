...
#include "bongo/platform/strcasestr.h"
...
static StrCaseStrFunc strcasestr_switcher = bongo::pal::strcasestr_emulation;
...
//
BONGO_INITIALIZER_GENERAL(SolarisStrCaseCmp, BONGO_NO_PREREQUISITES, ("default"))
(InitializerContext* context) {
    void* functionAddress = dlsym(RTLD_DEFAULT, "strcasestr");
    if (functionAddress != NULL) {
        bongo::pal::strcasestr_switcher =
            reinterpret_cast<bongo::pal::StrCaseStrFunc>(functionAddress);
    }
    return Status::OK();
}
