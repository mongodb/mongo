 ...
 */
inline bool bongoSignedMultiplyOverflow64(int64_t lhs, int64_t rhs, int64_t* product);
 ...
 */
inline bool bongoSignedAddOverflow64(int64_t lhs, int64_t rhs, int64_t* sum);
 ...
 */
inline bool bongoSignedSubtractOverflow64(int64_t lhs, int64_t rhs, int64_t* difference);
...
inline bool bongoSignedMultiplyOverflow64(long lhs, long rhs, long* product) {
    return __builtin_smull_overflow(lhs, rhs, product);
}

inline bool bongoSignedAddOverflow64(long lhs, long rhs, long* sum) {
    return __builtin_saddl_overflow(lhs, rhs, sum);
}

inline bool bongoSignedSubtractOverflow64(long lhs, long rhs, long* difference) {
    return __builtin_ssubl_overflow(lhs, rhs, difference);
}

inline bool bongoSignedMultiplyOverflow64(long long lhs, long long rhs, long long* product) {
    return __builtin_smulll_overflow(lhs, rhs, product);
}

inline bool bongoSignedAddOverflow64(long long lhs, long long rhs, long long* sum) {
    return __builtin_saddll_overflow(lhs, rhs, sum);
}

inline bool bongoSignedSubtractOverflow64(long long lhs, long long rhs, long long* difference) {
