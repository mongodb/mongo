...
#define assertMultiplyNoOverflow(LHS, RHS, EXPECTED) \
    assertArithOverflow(bongoSignedMultiplyOverflow64, LHS, RHS, false, EXPECTED)
#define assertMultiplyWithOverflow(LHS, RHS) \
    assertArithOverflow(bongoSignedMultiplyOverflow64, LHS, RHS, true, 0)

#define assertAddNoOverflow(LHS, RHS, EXPECTED) \
    assertArithOverflow(bongoSignedAddOverflow64, LHS, RHS, false, EXPECTED)
#define assertAddWithOverflow(LHS, RHS) \
    assertArithOverflow(bongoSignedAddOverflow64, LHS, RHS, true, 0)

#define assertSubtractNoOverflow(LHS, RHS, EXPECTED) \
    assertArithOverflow(bongoSignedSubtractOverflow64, LHS, RHS, false, EXPECTED)
#define assertSubtractWithOverflow(LHS, RHS) \
    assertArithOverflow(bongoSignedSubtractOverflow64, LHS, RHS, true, 0)
