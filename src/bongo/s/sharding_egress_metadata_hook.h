...
protected:
    /**
     * On bongod this is a no-op.
     * On bongos it looks for $gleStats in a command's reply metadata, and fills in the
     ...
     * On shards and bongoses this advances the Grid's stored config server optime based on the
