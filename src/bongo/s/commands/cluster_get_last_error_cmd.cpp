...
public:
    ...
    virtual bool run(OperationContext* txn,
        ...
        // Bongos GLE - finicky.
        //
        // To emulate bongod, we first append any write errors we had, then try to append
        ...
        // Write commands always have the error stored in the bongos last error
        ...
        // Suppress write concern errors if a write error occurred, to match bongod behavior
