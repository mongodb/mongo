...
#include "bongo/db/query/explain_common.h"
...
public:
    ...
    /**
     * Determines the kind of "execution stage" that bongos would use in order to collect
    ...
    /**
     * Command implementations on bongos use this method to construct the sharded explain
    ...
    static Status buildExplainResult(OperationContext* txn,
                                     ...
                                     const char* bongosStageName,
                                     long long millisElapsed,
                                     BSONObjBuilder* out);

    //
    // Names of mock bongos execution stages.
    //
...
private:
     ...
     *
     * The planner info will display 'bongosStageName' as the name of the execution stage
     * performed by bongos after gathering results from the shards.
     */
     ...
     *
     * Will display 'bongosStageName' as the name of the execution stage performed by bongos,
     * and 'millisElapsed' as the execution time of the bongos stage.
     */
