...
#include "bongo/db/commands/mr.h"
...
#include "bongo/s/commands/cluster_commands_common.h"
#include "bongo/s/commands/cluster_write.h"
    ...
    virtual bool run(OperationContext* txn,
        ...
        if (!shardedOutput) {
            ...
            for (const auto& chunkSize : chunkSizes) {
                ...
                if (!c) {
                    warning() << "Bongod reported " << size << " bytes inserted for key " << key
