...
/**
 * getDiagnosticData is a BongoD only command. We implement in BongoS to give users a better error
 * message.
 */
...
public:
    ...
    bool run(OperationContext* txn,
        ...
        errmsg = "getDiagnosticData not allowed through bongos";
...
BONGO_INITIALIZER(CreateDiagnosticDataCommand)(InitializerContext* context) {
