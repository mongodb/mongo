...
#include "bongo/s/commands/chunk_manager_targeter.h"

#include <boost/thread/tss.hpp>

#include "bongo/db/matcher/extensions_callback_noop.h"
#include "bongo/db/operation_context.h"
#include "bongo/db/query/canonical_query.h"
#include "bongo/db/query/collation/collation_index_key.h"
#include "bongo/s/catalog_cache.h"
#include "bongo/s/chunk.h"
#include "bongo/s/client/shard_registry.h"
#include "bongo/s/grid.h"
#include "bongo/s/shard_key_pattern.h"
#include "bongo/s/sharding_raii.h"
...
// TODO: Centralize this behavior better by refactoring config reload in bongos
