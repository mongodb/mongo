...
/**
 * Base class for bongos plan cache commands.
...
class ClusterPlanCacheCmd : public Command {
    BONGO_DISALLOW_COPYING(ClusterPlanCacheCmd);
...
BONGO_INITIALIZER(RegisterPlanCacheCommands)(InitializerContext* context) {
