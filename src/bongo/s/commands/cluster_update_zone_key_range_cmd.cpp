...
#include "bongo/s/request_types/update_zone_key_range_request_type.h"
...
public:
    ...
    virtual bool run(OperationContext* txn,
        ...
        auto parsedRequest =
            uassertStatusOK(UpdateZoneKeyRangeRequest::parseFromBongosCommand(cmdObj));
