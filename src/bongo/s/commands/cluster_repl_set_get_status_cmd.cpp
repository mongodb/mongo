...
public:
    ...
    virtual void help(std::stringstream& help) const {
        help << "Not supported through bongos";
    }

    virtual Status checkAuthForCommand(Client* client,
                                       const std::string& dbname,
                                       const BSONObj& cmdObj) {
        // Require no auth since this command isn't supported in bongos
        return Status::OK();
    }
    ...
    virtual bool run(OperationContext* txn,
        ...
        errmsg = "replSetGetStatus is not supported through bongos";
        result.append("info", "bongos");
