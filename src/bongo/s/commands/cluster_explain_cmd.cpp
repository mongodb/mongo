...
/**
 * Implements the explain command on bongos.
 *
 ...
 * through bongos, it is forwarded to all relevant shards. If *any* shard does not
...
class ClusterExplainCmd : public Command {
    BONGO_DISALLOW_COPYING(ClusterExplainCmd);
