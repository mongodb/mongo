 ...
 * provided by ShardingBongodTestFixture.
 */
class ConfigServerTestFixture : public ShardingBongodTestFixture {
public:
    ...
    /**
     * Same as ShardingBongodTestFixture::onCommand but run against _addShardNetworkTestEnv.
     */
    void onCommandForAddShard(executor::NetworkTestEnv::OnCommandFunction func);

protected:
    /**
     * Sets this node up as a bongod with sharding components for ClusterRole::ConfigServer.
     */
    void setUp() override;
