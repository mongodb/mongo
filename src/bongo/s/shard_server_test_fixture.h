...
/**
 * Test fixture for shard components, as opposed to config or bongos components.
 * Has a mock network and ephemeral storage engine provided by ShardingBongodTestFixture,
 * additionally sets up mock dist lock catalog and manager with a real catalog client.
 */
class ShardServerTestFixture : public ShardingBongodTestFixture {
public:
