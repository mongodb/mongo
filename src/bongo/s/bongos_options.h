...
struct BongosGlobalParams {
    // The config server connection string
    ConnectionString configdbs;
};

extern BongosGlobalParams bongosGlobalParams;
...
/**
 * Handle custom validation of bongos options that can not currently be done by using
...
/**
 * Canonicalize bongos options for the given environment.
 *
