/**
 *    Copyright (C) 2010-2015 BongoDB Inc.
 *
...
public:
    ...
    /**
     * Deprecated. This is only used on bongos, and once addShard is solely handled by the configs,
     * it can be deleted.
    ...
    /**
     * Called whenever a bongos or shard gets a response from a config server or shard and updates
...
private:
    ...
    // This value is updated any time a shard or bongos talks to a config server or a shard.
