...
public:
    ...
    /**
     * Finds the Shard that the bongod listening at this HostAndPort is a member of.
     */
 ...
 */
class ShardRegistry {
    BONGO_DISALLOW_COPYING(ShardRegistry);
...
public:
    ...
    /**
     * Finds the Shard that the bongod listening at this HostAndPort is a member of. Will not
    ...
    /**
     * For use in bongos and bongod which needs notifications about changes to shard and config
    ...
    /**
     * For use in bongos which needs notifications about changes to shard replset membership to
