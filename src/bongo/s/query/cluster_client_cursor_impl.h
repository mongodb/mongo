...
class ClusterClientCursorGuard final {
    BONGO_DISALLOW_COPYING(ClusterClientCursorGuard);
...
class ClusterClientCursorImpl final : public ClusterClientCursor {
    BONGO_DISALLOW_COPYING(ClusterClientCursorImpl);
