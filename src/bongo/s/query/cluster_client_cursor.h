 ...
 * are exhausted.
 *
 * Results are generated using a pipeline of bongoS query execution stages called RouterExecStage.
 *
...
public:
     ...
     * generating further results from the underlying bongos query stages.
     *
