...
class ClusterCursorManager {
    BONGO_DISALLOW_COPYING(ClusterCursorManager);
...
public:
     ...
     */
    class PinnedCursor {
        BONGO_DISALLOW_COPYING(PinnedCursor);
...
private:
     ...
     */
    class CursorEntry {
        BONGO_DISALLOW_COPYING(CursorEntry);
    ...
    struct CursorEntryContainer {
        BONGO_DISALLOW_COPYING(CursorEntryContainer);
