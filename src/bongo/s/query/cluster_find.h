...
public:
     ...
     * If a CommandOnShardedViewNotSupportedOnBongod error is returned, then 'viewDefinition', if
     ...
     *
     * Expects a read preference that has already been "unwrapped" by the bongos command handling
