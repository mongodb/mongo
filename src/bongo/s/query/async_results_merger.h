...
class AsyncResultsMerger {
    BONGO_DISALLOW_COPYING(AsyncResultsMerger);
...
private:
    ...
    struct RemoteCursorData {
        ...
        // batchSize in getMore when bongod returned less docs than the requested batchSize.
