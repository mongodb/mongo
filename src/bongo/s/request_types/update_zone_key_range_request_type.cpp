...
const char kBongosUpdateZoneKeyRange[] = "updateZoneKeyRange";
const char kConfigsvrUpdateZoneKeyRange[] = "_configsvrUpdateZoneKeyRange";
const char kZoneName[] = "zone";

}  // unnamed namespace

StatusWith<UpdateZoneKeyRangeRequest> UpdateZoneKeyRangeRequest::parseFromBongosCommand(
...
StatusWith<UpdateZoneKeyRangeRequest> UpdateZoneKeyRangeRequest::_parseFromCommand(
    ...
    auto parseNamespaceStatus = bsonExtractStringField(
        cmdObj, (forBongos ? kBongosUpdateZoneKeyRange : kConfigsvrUpdateZoneKeyRange), &rawNS);
    ...
    if (zoneElem.type() == String) {
        ...
        return {ErrorCodes::TypeMismatch,
                bongoutils::str::stream() << "\"" << kZoneName << "\" had the wrong type. Expected "
                                          << typeName(String)
                                          << " or "
                                          << typeName(jstNULL)
                                          << ", found "
