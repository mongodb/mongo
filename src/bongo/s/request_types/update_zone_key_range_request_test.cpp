...
TEST(UpdateZoneKeyRangeRequest, BasicValidBongosAssignCommand) {
    auto requestStatus = UpdateZoneKeyRangeRequest::parseFromBongosCommand(fromjson(R"BSON({
...
TEST(UpdateZoneKeyRangeRequest, BasicValidBongosRemoveCommand) {
    auto requestStatus = UpdateZoneKeyRangeRequest::parseFromBongosCommand(fromjson(R"BSON({
            updateZoneKeyRange: "foo.bar",
            min: { x: 1 },
            max: { x: 100 },
...
TEST(UpdateZoneKeyRangeRequest, InvalidNSBongosAssignCommand) {
    auto requestStatus = UpdateZoneKeyRangeRequest::parseFromBongosCommand(fromjson(R"BSON({
...
TEST(UpdateZoneKeyRangeRequest, MissingMinErrors) {
    auto request = UpdateZoneKeyRangeRequest::parseFromBongosCommand(fromjson(R"BSON({
            updateZoneKeyRange: "foo.bar",
            max: { x: 100 },
            zone: "z"
        })BSON"));
...
TEST(UpdateZoneKeyRangeRequest, CannotUseBongosToParseConfigCommand) {
    auto request = UpdateZoneKeyRangeRequest::parseFromBongosCommand(fromjson(R"BSON({
            _configsvrUpdateZoneKeyRange: "foo.bar",
            min: { x: 1 },
            max: { x: 100 },
...
TEST(CfgAssignKeyRangeToZoneRequest, BasicValidBongosAssignCommand) {
...
TEST(CfgAssignKeyRangeToZoneRequest, BasicValidBongosRemoveCommand) {
    auto requestStatus = UpdateZoneKeyRangeRequest::parseFromConfigCommand(fromjson(R"BSON({
            _configsvrUpdateZoneKeyRange: "foo.bar",
            min: { x: 1 },
            max: { x: 100 },
...
TEST(CfgAssignKeyRangeToZoneRequest, CannotUseConfigToParseBongosCommand) {
    auto request = UpdateZoneKeyRangeRequest::parseFromConfigCommand(fromjson(R"BSON({
            updateZoneKeyRange: "foo.bar",
            min: { x: 1 },
            max: { x: 100 },
