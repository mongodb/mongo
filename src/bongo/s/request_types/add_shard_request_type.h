...
/**
 * Specifies a representation of the external bongos and internal config versions of the addShard
...
public:
    ...
    static const BSONField<std::string> bongosAddShard;
    static const BSONField<std::string> bongosAddShardDeprecated;
     ...
     */
    static StatusWith<AddShardRequest> parseFromBongosCommand(const BSONObj& obj);
...
private:
    ...
    // If the shard to be added is standalone, then the hostname and port of the bongod instance to
