...
/**
 * The BongoVersionRange represents a min/max of BongoDB versions, useful for
 ...
 * between the two.
 */
struct BongoVersionRange {
    static BSONArray toBSONArray(const std::vector<BongoVersionRange>& ranges);
...
bool isInBongoVersionRanges(StringData version, const std::vector<BongoVersionRange>& ranges);
}
