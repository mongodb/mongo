...
#include "bongo/s/catalog/sharding_catalog_client_mock.h"
#include "bongo/s/catalog/type_lockpings.h"
#include "bongo/s/catalog/type_locks.h"
 ...
 */
class ReplSetDistLockManagerFixture : public ShardingBongodTestFixture {
public:
    /**
