...
#include "bongo/s/catalog/bongo_version_range.h"
...
public:
    ...
    static const BSONField<BSONArray> excludingBongoVersions;
    ...
    const std::vector<BongoVersionRange> getExcludingBongoVersions() const {
        if (!isExcludingBongoVersionsSet()) {
            return std::vector<BongoVersionRange>();
        }
        return _excludingBongoVersions.get();
    }
    bool isExcludingBongoVersionsSet() const {
        return _excludingBongoVersions.is_initialized();
    }
    void setExcludingBongoVersions(const std::vector<BongoVersionRange>& excludingBongoVersions);
...
private:
    ...
    boost::optional<std::vector<BongoVersionRange>> _excludingBongoVersions;
