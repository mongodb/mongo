...
/**
 * The BatchWriteOp class manages the lifecycle of a batched write received by bongos.  Each
 ...
 */
class BatchWriteOp {
    BONGO_DISALLOW_COPYING(BatchWriteOp);
 ...
 */
class TargetedWriteBatch {
    BONGO_DISALLOW_COPYING(TargetedWriteBatch);
