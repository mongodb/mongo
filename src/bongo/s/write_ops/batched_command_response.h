...
#include "bongo/rpc/write_concern_error_detail.h"
#include "bongo/s/bson_serializable.h"
#include "bongo/s/write_ops/batched_upsert_detail.h"
#include "bongo/s/write_ops/write_error_detail.h"
...
private:
    ...
    //      bongos which loses track of the session due to RCAR.  Therefore, we must
