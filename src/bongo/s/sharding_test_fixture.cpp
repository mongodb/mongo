...
#include "bongo/s/sharding_test_fixture.h"
...
#include "bongo/db/query/collation/collator_factory_mock.h"
...
#include "bongo/transport/mock_session.h"
#include "bongo/transport/transport_layer.h"
#include "bongo/transport/transport_layer_mock.h"
...
using rpc::ShardingEgressMetadataHookForBongos;
...
void ShardingTestFixture::setUp() {
    ...
    fixedNet->setEgressMetadataHook(stdx::make_unique<ShardingEgressMetadataHookForBongos>());
    ...
    netForPool->setEgressMetadataHook(stdx::make_unique<ShardingEgressMetadataHookForBongos>());
