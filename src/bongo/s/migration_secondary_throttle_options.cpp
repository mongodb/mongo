...
const char kSecondaryThrottleBongos[] = "_secondaryThrottle";
const char kSecondaryThrottleBongod[] = "secondaryThrottle";
...
StatusWith<MigrationSecondaryThrottleOptions> MigrationSecondaryThrottleOptions::createFromCommand(
    ...
    // Parse the two variants of the 'secondaryThrottle' option
    {
        ...
        Status status =
            bsonExtractBooleanField(obj, kSecondaryThrottleBongod, &isSecondaryThrottle);
        if (status == ErrorCodes::NoSuchKey) {
            status = bsonExtractBooleanField(obj, kSecondaryThrottleBongos, &isSecondaryThrottle);
        }
...
MigrationSecondaryThrottleOptions::createFromBalancerConfig(const BSONObj& obj) {
    {
        bool isSecondaryThrottle;
        Status status =
            bsonExtractBooleanField(obj, kSecondaryThrottleBongos, &isSecondaryThrottle);
        if (status.isOK()) {
    ...
    BSONElement elem;
    Status status = bsonExtractTypedField(obj, kSecondaryThrottleBongos, BSONType::Object, &elem);
...
void MigrationSecondaryThrottleOptions::append(BSONObjBuilder* builder) const {
    ...
    builder->appendBool(kSecondaryThrottleBongod, _secondaryThrottle == kOn);
