 ...
 * to modify the data.
 *
 * The current form is templated b/c the overall algorithm is identical between bongos and bongod,
 ...
 *
 * TODO: Standardize between bongos and bongod and convert template parameters to types.
 */
