...
class SymbolHandler {
    BONGO_DISALLOW_COPYING(SymbolHandler);
...
BONGO_INITIALIZER(IntializeSymbolHandler)(::bongo::InitializerContext* ctx) {
...
static void getSourceFileAndLineNumber(HANDLE process,
    ...
    std::string::size_type start = filename.find("\\src\\bongo\\");
