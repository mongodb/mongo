/**
 *    Copyright (C) 2010-2014 BongoDB Inc.
 *
...
class MallocFreeStreambuf : public std::streambuf {
    BONGO_DISALLOW_COPYING(MallocFreeStreambuf);
...
class MallocFreeOStream : public std::ostream {
    BONGO_DISALLOW_COPYING(MallocFreeOStream);
...
private:
    ...
    static BONGO_TRIVIALLY_CONSTRUCTIBLE_THREAD_LOCAL int terminateDepth;
    stdx::unique_lock<stdx::mutex> _lk;
};
stdx::mutex MallocFreeOStreamGuard::_streamMutex;
BONGO_TRIVIALLY_CONSTRUCTIBLE_THREAD_LOCAL
