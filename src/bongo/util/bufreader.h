...
#include "bongo/base/data_range.h"
#include "bongo/base/data_range_cursor.h"
#include "bongo/base/data_type_terminated.h"
#include "bongo/base/disallow_copying.h"
#include "bongo/bson/util/builder.h"
#include "bongo/platform/strnlen.h"
...
*/
class BufReader {
    BONGO_DISALLOW_COPYING(BufReader);
