...
#if defined(BONGO_CONFIG_HAVE_THREAD_LOCAL)
#define BONGO_TRIVIALLY_CONSTRUCTIBLE_THREAD_LOCAL thread_local
#elif defined(BONGO_CONFIG_HAVE___THREAD)
#define BONGO_TRIVIALLY_CONSTRUCTIBLE_THREAD_LOCAL __thread
#elif defined(BONGO_CONFIG_HAVE___DECLSPEC_THREAD)
#define BONGO_TRIVIALLY_CONSTRUCTIBLE_THREAD_LOCAL __declspec(thread)
#else
...
#define TSP_DEFINE(T, p)                                \
    BONGO_TRIVIALLY_CONSTRUCTIBLE_THREAD_LOCAL T* _##p; \
    TSP<T> p;                                           \
    template <>                                         \
    T* TSP<T>::get() const {                            \
        return _##p;                                    \
