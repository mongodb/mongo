...
BONGO_INITIALIZER_GROUP(BeginStartupOptionHandling,
                        ("GlobalLogManager", "ValidateLocale"),
                        ("EndStartupOptionHandling"))

/* Groups for option registration */
BONGO_INITIALIZER_GROUP(BeginStartupOptionRegistration,
...
BONGO_INITIALIZER_GROUP(BeginGeneralStartupOptionRegistration,
                        ("BeginStartupOptionRegistration"),
                        ("EndGeneralStartupOptionRegistration"))
BONGO_INITIALIZER_GROUP(EndGeneralStartupOptionRegistration,
                        ("BeginGeneralStartupOptionRegistration"),
                        ("EndStartupOptionRegistration"))

BONGO_INITIALIZER_GROUP(EndStartupOptionRegistration,
                        ("BeginStartupOptionRegistration"),
                        ("BeginStartupOptionParsing"))

/* Groups for option parsing */
BONGO_INITIALIZER_GROUP(BeginStartupOptionParsing,
                        ("EndStartupOptionRegistration"),
                        ("EndStartupOptionParsing"))
BONGO_INITIALIZER_GROUP(EndStartupOptionParsing,
                        ("BeginStartupOptionParsing"),
                        ("BeginStartupOptionValidation"))

/* Groups for option validation */
BONGO_INITIALIZER_GROUP(BeginStartupOptionValidation,
                        ("EndStartupOptionParsing"),
                        ("EndStartupOptionValidation"))
BONGO_INITIALIZER_GROUP(EndStartupOptionValidation,
                        ("BeginStartupOptionValidation"),
                        ("BeginStartupOptionSetup"))

/* Groups for option setup */
BONGO_INITIALIZER_GROUP(BeginStartupOptionSetup,
                        ("EndStartupOptionValidation"),
                        ("EndStartupOptionSetup"))
BONGO_INITIALIZER_GROUP(EndStartupOptionSetup,
                        ("BeginStartupOptionSetup"),
                        ("BeginStartupOptionStorage"))

/* Groups for option storage */
BONGO_INITIALIZER_GROUP(BeginStartupOptionStorage,
                        ("EndStartupOptionSetup"),
                        ("EndStartupOptionStorage"))
BONGO_INITIALIZER_GROUP(EndStartupOptionStorage,
                        ("BeginStartupOptionStorage"),
                        ("EndStartupOptionHandling"))

BONGO_INITIALIZER_GROUP(EndStartupOptionHandling, ("BeginStartupOptionHandling"), ("default"))
