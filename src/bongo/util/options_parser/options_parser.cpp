...
BONGO_INITIALIZER_GENERAL(OptionsParseUseStrict,
        ...
        if (vm.count(long_name)) {
            ...
            if (iterator->_type == StringMap) {
                ...
                for (StringVector_t::iterator keyValueVectorIt = keyValueVector.begin();
                    ...
                    std::string key;
                    std::string value;
                    if (!bongoutils::str::splitOn(*keyValueVectorIt, '=', key, value)) {
                        StringBuilder sb;
        ...
        do {
            ...
            if (arg[0] == '-') {
                ...
                if (argvOriginal[i + 1].empty()) {
                    ...
                    // bongod and bongos which makes it a breaking change for this one specific
