 ...
 *
 * Initializer functions take a parameter of type ::bongo::InitializerContext*, and return
 ...
 *
 * Usage:
 *     BONGO_GENERAL_STARTUP_OPTIONS_REGISTER(BongodOptions)(InitializerContext* context) {
 *         return Status::OK();
 *     }
 */
#define BONGO_GENERAL_STARTUP_OPTIONS_REGISTER(fname)                    \
    BONGO_INITIALIZER_GENERAL(fname##_Register,                          \
 ...
 *
 * Usage:
 *     BONGO_MODULE_STARTUP_OPTIONS_REGISTER(BongodOptions)(InitializerContext* context) {
 *         return Status::OK();
 *     }
 */
#define BONGO_MODULE_STARTUP_OPTIONS_REGISTER(fname)                   \
    BONGO_INITIALIZER_GENERAL(fname##_Register,                        \
                              ("EndGeneralStartupOptionRegistration"), \
 ...
 *
 * Usage:
 *     BONGO_STARTUP_OPTIONS_PARSE(BongodOptions)(InitializerContext* context) {
 *         return Status::OK();
 *     }
 */
#define BONGO_STARTUP_OPTIONS_PARSE(fname) \
    BONGO_INITIALIZER_GENERAL(             \
 ...
 *     }
 */
#define BONGO_STARTUP_OPTIONS_VALIDATE(fname) \
    BONGO_INITIALIZER_GENERAL(                \
 ...
 *
 * Usage:
 *     BONGO_STARTUP_OPTIONS_STORE(BongodOptions)(InitializerContext* context) {
 *         return Status::OK();
 *     }
 */
#define BONGO_STARTUP_OPTIONS_STORE(fname) \
    BONGO_INITIALIZER_GENERAL(             \
