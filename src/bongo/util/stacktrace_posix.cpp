...
#if defined(BONGO_CONFIG_HAVE_EXECINFO_BACKTRACE)
#include <execinfo.h>
#elif defined(__sun)
#include <ucontext.h>
#endif
...
#define BONGO_NO_BACKTRACE
#endif

}  // namespace

#if defined(BONGO_NO_BACKTRACE)
