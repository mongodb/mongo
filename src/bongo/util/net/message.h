...
#include "bongo/base/data_type_endian.h"
#include "bongo/base/data_view.h"
#include "bongo/base/encoded_value_storage.h"
...
#pragma pack(1)
/**
 * See http://dochub.bongodb.org/core/bongowireprotocol
 */
struct Layout {
...
public:
    Value() {
        BONGO_STATIC_ASSERT(sizeof(Value) == sizeof(Layout));
    }
