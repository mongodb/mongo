...
public:
    BONGO_DISALLOW_COPYING(ASIOSSLContext);

    /**
     * A class to house the ASIO SSL context as well as the bongo SSL mode. This will be decorated
    ...
    /**
     * A copy of the ASIO SSL context generated upon construction from the bongo::SSLParams.
     */
