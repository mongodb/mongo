 ...
 */
#define BONGO_FP_DECLARE(fp)                                                          \
    FailPoint fp;                                                                     \
    BONGO_INITIALIZER_GENERAL(fp, ("FailPointRegistry"), ("AllFailPointsRegistered")) \
 ...
 */
#define BONGO_FP_FORWARD_DECLARE(fp) extern FailPoint fp;
}
