 ...
 * modules tend to just stop working at some point after bongo::shutdown() is
 ...
 */
BONGO_COMPILER_NORETURN void shutdown(ExitCode code);
...
BONGO_COMPILER_NORETURN inline void exitCleanly(ExitCode code) {
    shutdown(code);
}
