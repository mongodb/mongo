...
#if BONGO_HAVE_GPERFTOOLS_GET_THREAD_CACHE_SIZE
...
BONGO_INITIALIZER(TCMallocThreadIdleListener)(InitializerContext*) {
...
#if BONGO_HAVE_GPERFTOOLS_SIZE_CLASS_STATS
            if (verbosity >= 2) {
