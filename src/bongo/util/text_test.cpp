...
TEST(WindowsCommandLineConstruction, RegressionSERVER_7252) {
    ASSERT_EQUALS(
        "bongod \"--serviceName=My Service\" --serviceDescription \"My Service\" "
        "--serviceDisplayName \"My Service\" --dbpath C:\\bongo\\data\\config "
        "--port 20001 --logpath C:\\bongo\\logs\\bongo_config.log.txt "
        "--configsvr --service",
        constructUtf8WindowsCommandLine(svec("bongod",
                                             ...
                                             "20001",
                                             "--logpath",
                                             "C:\\bongo\\logs\\bongo_config.log.txt",
                                             "--configsvr",
                                             "--service",
                                             NULL)));
}
