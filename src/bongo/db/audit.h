 ...
 * party interested in generating logs of user activity in a BongoDB server instance.
 */
...
/*
 * Looks for an 'impersonatedUsers' field.  This field is used by bongos to
 ...
 * bongos cannot properly audit itself; examples are implicit collection and database creation.
...
/*
 * Looks for an 'impersonatedRoles' field.  This field is used by bongos to
