...
#include "bongo/db/concurrency/lock_manager_defs.h"
#include "bongo/db/concurrency/lock_request_list.h"
#include "bongo/platform/atomic_word.h"
#include "bongo/platform/compiler.h"
#include "bongo/platform/unordered_map.h"
#include "bongo/stdx/condition_variable.h"
#include "bongo/stdx/mutex.h"
#include "bongo/util/concurrency/mutex.h"
 ...
 */
class LockManager {
    BONGO_DISALLOW_COPYING(LockManager);
