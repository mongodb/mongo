...
public:
     ...
     */
    class TempRelease {
        BONGO_DISALLOW_COPYING(TempRelease);
     ...
     */
    class ResourceLock {
        BONGO_DISALLOW_COPYING(ResourceLock);
    ...
    class CollectionLock {
        BONGO_DISALLOW_COPYING(CollectionLock);
    ...
    class OplogIntentWriteLock {
        BONGO_DISALLOW_COPYING(OplogIntentWriteLock);
    ...
    class ParallelBatchWriterMode {
        BONGO_DISALLOW_COPYING(ParallelBatchWriterMode);
