...
#include "bongo/db/geo/r2_region_coverer.h"
...
using bongo::Polygon;  // "windows.h" has another Polygon for Windows GDI.

std::default_random_engine generator;

BONGO_INITIALIZER(R2CellUnion_Test)(InitializerContext* context) {
