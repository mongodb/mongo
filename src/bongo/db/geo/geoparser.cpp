...
#define BAD_VALUE(error) Status(ErrorCodes::BadValue, ::bongoutils::str::stream() << error)
...
static const string CRS_STRICT_WINDING = "urn:x-bongodb:crs:strictwinding:EPSG:4326";
...
GeoParser::GeoSpecifier GeoParser::parseGeoSpecifier(const BSONElement& type) {
    ...
    if (bongoutils::str::equals(fieldName, "$box")) {
        return GeoParser::BOX;
    } else if (bongoutils::str::equals(fieldName, "$center")) {
        return GeoParser::CENTER;
    } else if (bongoutils::str::equals(fieldName, "$polygon")) {
        return GeoParser::POLYGON;
    } else if (bongoutils::str::equals(fieldName, "$centerSphere")) {
        return GeoParser::CENTER_SPHERE;
    } else if (bongoutils::str::equals(fieldName, "$geometry")) {
