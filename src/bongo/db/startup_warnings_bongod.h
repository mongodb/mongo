...
class StartupWarningsBongod {
private:
    StartupWarningsBongod();
...
// are specific to the bongod process.
void logBongodStartupWarnings(const StorageGlobalParams& storageParams,
