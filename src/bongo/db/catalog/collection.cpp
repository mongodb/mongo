...
#include "bongo/base/owned_pointer_map.h"
...
#include "bongo/db/auth/user_document_parser.h"  // XXX-ANDY
...
BONGO_FP_DECLARE(failCollectionInserts);
...
Status Collection::insertDocuments(OperationContext* txn,
    ...
    BONGO_FAIL_POINT_BLOCK(failCollectionInserts, extraData) {
