...
#include "bongo/db/range_deleter.h"
#include "bongo/db/range_deleter_mock_env.h"
...
const bongo::repl::ReplSettings replSettings = {};
...
private:
    void setUp() override {
        ...
        bongo::repl::ReplicationCoordinator::set(
            getServiceContext(),
            stdx::make_unique<bongo::repl::ReplicationCoordinatorMock>(getServiceContext(),
                                                                       replSettings));
