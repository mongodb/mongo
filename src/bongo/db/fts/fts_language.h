...
#include "bongo/db/fts/fts_phrase_matcher.h"
#include "bongo/db/fts/fts_unicode_phrase_matcher.h"
#include "bongo/db/fts/fts_util.h"
...
#define BONGO_FTS_LANGUAGE_DECLARE(language, name, version)                                    \
    BasicFTSLanguage language;                                                                 \
    BONGO_INITIALIZER_GENERAL(language, BONGO_NO_PREREQUISITES, ("FTSAllLanguagesRegistered")) \
...
class FTSLanguage {
    ...
    BONGO_DISALLOW_COPYING(FTSLanguage);
