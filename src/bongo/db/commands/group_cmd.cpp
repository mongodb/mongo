 ...
 * http://dochub.bongodb.org/core/group-command-deprecation for more detail.
 */
...
private:
    ...
    virtual void help(std::stringstream& help) const {
        help << "http://dochub.bongodb.org/core/aggregation";
    }
    ...
    virtual bool run(OperationContext* txn,
        ...
        RARELY {
            warning() << "The group command is deprecated. See "
                         "http://dochub.bongodb.org/core/group-command-deprecation.";
        }
