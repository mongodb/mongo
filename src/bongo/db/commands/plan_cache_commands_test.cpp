...
/**
 * This file contains tests for bongo/db/commands/plan_cache_commands.h
 */

#include "bongo/db/commands/plan_cache_commands.h"
...
std::vector<BSONObj> getShapes(const PlanCache& planCache) {
    ...
    ASSERT_EQUALS(shapesElt.type(), bongo::Array);
...
vector<BSONObj> getPlans(const PlanCache& planCache,
    ...
    ASSERT_EQUALS(plansElt.type(), bongo::Array);
