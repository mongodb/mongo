...
void State::dropTempCollections() {
    ...
    if (_useIncremental && !_config.incLong.isEmpty()) {
        ...
        BONGO_WRITE_CONFLICT_RETRY_LOOP_END(_txn, "M/R dropTempCollections", _config.incLong.ns())
...
void State::prepTempCollection() {
    ...
    if (_useIncremental) {
        ...
        BONGO_WRITE_CONFLICT_RETRY_LOOP_BEGIN {
            ...
            // BongoDB when the featureCompatibilityVersion of this server is 3.2.
            BSONObj indexSpec =
        ...
        BONGO_WRITE_CONFLICT_RETRY_LOOP_END(_txn, "M/R prepTempCollection", _config.incLong.ns());
    }
    ...
    BONGO_WRITE_CONFLICT_RETRY_LOOP_END(_txn, "M/R prepTempCollection", _config.tempNamespace.ns())
}
...
void State::insert(const NamespaceString& nss, const BSONObj& o) {
    ...
    BONGO_WRITE_CONFLICT_RETRY_LOOP_END(_txn, "M/R insert", nss.ns());
}
...
void State::_insertToInc(BSONObj& o) {
    ...
    BONGO_WRITE_CONFLICT_RETRY_LOOP_END(_txn, "M/R insertToInc", _config.incLong.ns());
}
...
void State::finalReduce(OperationContext* txn, CurOp* curOp, ProgressMeterHolder& pm) {
    ...
    BONGO_WRITE_CONFLICT_RETRY_LOOP_END(_txn, "finalReduce", _config.incLong.ns());
...
public:
    ...
    virtual void help(stringstream& help) const {
        ...
        help << "Note this is used for aggregation, not querying, in BongoDB.\n";
        help << "http://dochub.bongodb.org/core/mapreduce";
    }
