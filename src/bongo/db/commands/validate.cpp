...
#include "bongo/db/storage/record_store.h"
...
BONGO_FP_DECLARE(validateCmdCollectionNotValid);
...
public:
    ...
    bool run(OperationContext* txn,
        ...
        if (BONGO_FAIL_POINT(validateCmdCollectionNotValid)) {
        ...
        if (!results.valid) {
            result.append("advice",
                          ...
                          "http://dochub.bongodb.org/core/data-recovery for recovery steps.");
        }
