...
/**
 * Maintains a global read lock while bongod is fsyncLocked.
 */
...
public:
    static const char* url() {
        return "http://dochub.bongodb.org/core/fsynccommand";
    }
    ...
    virtual bool run(OperationContext* txn,
        ...
        log() << "bongod is locked and no writes are allowed. db.fsyncUnlock() to unlock";
...
public:
    ...
    bool run(OperationContext* txn,
        ...
        if (unlockFsync()) {
            ...
            if (lockCount == 0) {
                log() << "fsyncUnlock completed. bongod is now unlocked and free to accept writes";
            } else {
...
void FSyncLockThread::run() {
    ...
    try {
        ...
        try {
            ...
            BONGO_WRITE_CONFLICT_RETRY_LOOP_END(&txn, "beginBackup", "global");
