 ...
 *
 * The "copydb" command gets sent by the client or the bongos to the destination of the copy
 ...
 *
 * NOTE: bongos doesn't know how to call or handle the "copydbgetnonce" command.  See
 * SERVER-6427.
 *
