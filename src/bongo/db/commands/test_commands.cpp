...
public:
    ...
    void _sleepInReadLock(bongo::OperationContext* txn, long long millis) {
        ScopedTransaction transaction(txn, MODE_S);
        Lock::GlobalRead lk(txn->lockState());
        sleepmillis(millis);
    }

    void _sleepInWriteLock(bongo::OperationContext* txn, long long millis) {
...
BONGO_INITIALIZER(RegisterEmptyCappedCmd)(InitializerContext* context) {
