...
/**
 * This file contains tests for bongo/db/commands/index_filter_commands.h
 */
...
vector<BSONObj> getFilters(const QuerySettings& querySettings) {
    ...
    ASSERT_EQUALS(filtersElt.type(), bongo::Array);
    ...
    for (vector<BSONElement>::const_iterator i = filtersEltArray.begin();
        ...
        ASSERT_EQUALS(indexesElt.type(), bongo::Array);
