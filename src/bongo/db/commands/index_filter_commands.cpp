...
#include "bongo/db/commands/index_filter_commands.h"
...
BONGO_INITIALIZER_WITH_PREREQUISITES(SetupIndexFilterCommands, BONGO_NO_PREREQUISITES)
...
Status SetFilter::set(OperationContext* txn,
    ...
    if (indexesElt.type() != bongo::Array) {
