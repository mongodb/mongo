...
#include "bongo/bson/mutable/element.h"
#include "bongo/db/catalog/database_holder.h"
#include "bongo/db/client.h"
#include "bongo/db/commands.h"
#include "bongo/db/commands/write_commands/write_commands_common.h"
#include "bongo/db/curop.h"
#include "bongo/db/db_raii.h"
#include "bongo/db/json.h"
#include "bongo/db/lasterror.h"
#include "bongo/db/ops/delete_request.h"
#include "bongo/db/ops/parsed_delete.h"
#include "bongo/db/ops/parsed_update.h"
#include "bongo/db/ops/update_lifecycle_impl.h"
#include "bongo/db/ops/write_ops_exec.h"
#include "bongo/db/ops/write_ops_parsers.h"
...
void serializeReply(OperationContext* txn,
    ...
    {
        // Undocumented repl fields that bongos depends on.
