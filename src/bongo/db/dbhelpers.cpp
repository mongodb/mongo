...
#include "bongo/db/ops/update_request.h"
#include "bongo/db/ops/update_result.h"
...
#include "bongo/db/storage/data_protector.h"
...
long long Helpers::removeRange(OperationContext* txn,
    ...
    BONGO_LOG_COMPONENT(1, LogComponent::kSharding)
    ...
    BONGO_LOG_COMPONENT(1, LogComponent::kSharding) << "end removal of " << min << " to " << max
                                                    << " in " << nss.ns() << " (took "
