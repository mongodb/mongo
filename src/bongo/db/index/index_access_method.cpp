...
BONGO_EXPORT_SERVER_PARAMETER(failIndexKeyTooLong, bool, true);
...
Status IndexAccessMethod::commitBulk(OperationContext* txn,
    ...
    BONGO_WRITE_CONFLICT_RETRY_LOOP_END(txn, "setting index multikey flag", "");
...
BONGO_CREATE_SORTER(bongo::BSONObj, bongo::RecordId, bongo::BtreeExternalSortComparison);
