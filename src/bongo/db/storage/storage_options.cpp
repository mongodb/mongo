...
/**
 * The directory where the bongod instance stores its data.
 */
#ifdef _WIN32
 ...
 * If 1, BongoDB will not execute queries that require a table scan and will return an error.
...
/**
 * Specify the interval in seconds between fsync operations where bongod flushes its
 * working memory to disk. By default, bongod flushes memory to disk every 60 seconds.
