...
#include "bongo/db/storage/kv/kv_database_catalog_entry.h"

#include "bongo/db/catalog/index_catalog_entry.h"
#include "bongo/db/index/2d_access_method.h"
#include "bongo/db/index/btree_access_method.h"
#include "bongo/db/index/fts_access_method.h"
#include "bongo/db/index/hash_access_method.h"
#include "bongo/db/index/haystack_access_method.h"
#include "bongo/db/index/index_access_method.h"
#include "bongo/db/index/index_descriptor.h"
#include "bongo/db/index/s2_access_method.h"
#include "bongo/db/storage/kv/kv_collection_catalog_entry.h"
...
auto bongo::defaultDatabaseCatalogEntryFactory(const StringData name, KVStorageEngine* const engine)
