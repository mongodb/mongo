...
std::unique_ptr<bongo::KVDatabaseCatalogEntryMock> bongo::kvDatabaseCatalogEntryMockFactory(
...
bongo::IndexAccessMethod* bongo::KVDatabaseCatalogEntryMock::getIndex(
