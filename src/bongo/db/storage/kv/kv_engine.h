...
public:
     ...
     * See:
     *     http://docs.bongodb.org/manual/reference/program/bongod/#cmdoption--directoryperdb
     */
     ...
     * BongoDB will not call into the storage subsystem after calling this function.
     *
    ...
    /**
     * The destructor will never be called from bongod, but may be called from tests.
