...
#include "bongo/db/storage/kv/kv_engine_test_harness.h"

#include "bongo/db/operation_context_noop.h"
#include "bongo/db/storage/kv/kv_catalog_feature_tracker.h"
...
TEST_F(KVCatalogFeatureTrackerTest,
...

    {
        ...
        ASSERT_EQ(
            "The data files use features not recognized by this version of bongod; the NR feature"
            " bits in positions [ 0 ] aren't recognized by this version of bongod",
            status.reason());
    }
}
...
TEST_F(KVCatalogFeatureTrackerTest,
...

    {
        ...
        ASSERT_EQ(
            "The data files use features not recognized by this version of bongod; the NR feature"
            " bits in positions [ 1, 2 ] aren't recognized by this version of bongod",
            status.reason());
    }
}
...
TEST_F(KVCatalogFeatureTrackerTest, DataFilesAreIncompatibleWithAnUnrecognizedRepairableFeature) {
...

    {
        ...
        ASSERT_EQ(
            "The data files use features not recognized by this version of bongod; the R feature"
            " bits in positions [ 0 ] aren't recognized by this version of bongod",
            status.reason());
    }
}
