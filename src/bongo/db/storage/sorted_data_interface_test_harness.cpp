...
auto bongo::SortedDataInterfaceHarnessHelper::newSortedDataInterface(
...
void bongo::insertToIndex(unowned_ptr<OperationContext> txn,
...
void bongo::removeFromIndex(unowned_ptr<OperationContext> txn,
                            unowned_ptr<SortedDataInterface> index,
