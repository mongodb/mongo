...
#include "bongo/db/storage/mmap_v1/record_access_tracker.h"
...
BONGO_INITIALIZER_WITH_PREREQUISITES(RecordBlockSupported, ("SystemInfo"))(InitializerContext* cx) {
...
inline void resetIfNeeded(Data* data, ClockSource* cs) {
    ...
    if (BONGO_unlikely(sinceReset > RecordAccessTracker::RotateTimeSecs * 1000)) {
        reset(data, cs);
    }
}
