...
#include "bongo/db/storage/mmap_v1/catalog/index_details.h"
...
private:
    ...
    BONGO_STATIC_ASSERT(NIndexesMax <= NIndexesBase + NIndexesExtra * 2);
    BONGO_STATIC_ASSERT(NIndexesMax <= 64);  // multiKey bits
    BONGO_STATIC_ASSERT(sizeof(NamespaceDetails::Extra) == 496);
};  // NamespaceDetails
BONGO_STATIC_ASSERT(sizeof(NamespaceDetails) == 496);
#pragma pack()
