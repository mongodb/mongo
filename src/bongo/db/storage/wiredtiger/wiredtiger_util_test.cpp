...
class WiredTigerUtilMetadataTest : public bongo::unittest::Test {
public:
    virtual void setUp() {
...
TEST_F(WiredTigerUtilMetadataTest, GetApplicationMetadataTypes) {
    ...
    ASSERT_EQUALS(bongo::String, stringElement.type());
    ...
    ASSERT_EQUALS(bongo::String, identifierElement.type());
    ...
    ASSERT_EQUALS(bongo::String, structElement.type());
