 ...
 */
#define WT_OP_CHECK(x) (((BONGO_FAIL_POINT(WTWriteConflictException))) ? (WT_ROLLBACK) : (x))
...
BONGO_FP_FORWARD_DECLARE(WTWriteConflictException);
...
BONGO_FP_FORWARD_DECLARE(WTPausePrimaryOplogDurabilityLoop);
}
