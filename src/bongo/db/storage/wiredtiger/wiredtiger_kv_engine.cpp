...
#include "bongo/db/bson/dotted_path_support.h"
...
namespace dps = ::bongo::dotted_path_support;
...
class TicketServerParameter : public ServerParameter {
    BONGO_DISALLOW_COPYING(TicketServerParameter);
