...
BONGO_MODULE_STARTUP_OPTIONS_REGISTER(WiredTigerOptions)(InitializerContext* context) {
    return wiredTigerGlobalOptions.add(&moe::startupOptions);
}

BONGO_STARTUP_OPTIONS_VALIDATE(WiredTigerOptions)(InitializerContext* context) {
    return Status::OK();
}

BONGO_STARTUP_OPTIONS_STORE(WiredTigerOptions)(InitializerContext* context) {
