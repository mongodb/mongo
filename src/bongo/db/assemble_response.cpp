...
#include "bongo/db/curop_metrics.h"
...
#include "bongo/db/run_commands.h"
...
BONGO_FP_DECLARE(rsStopGetMore);
...
// TODO: remove after BongoDB 3.2 is released
...
bool receivedGetMore(OperationContext* txn, DbResponse& dbresponse, Message& m, CurOp& curop) {
    ...
    try {
        ...
        while (BONGO_FAIL_POINT(rsStopGetMore)) {
            sleepmillis(0);
        }
