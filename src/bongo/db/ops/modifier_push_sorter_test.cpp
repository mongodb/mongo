...
using bongo::BSONObj;
using bongo::CollatorInterface;
using bongo::CollatorInterfaceMock;
using bongo::PatternElementCmp;
using bongo::fromjson;
using bongo::mutablebson::Document;
using bongo::mutablebson::Element;
using bongo::mutablebson::sortChildren;

class ObjectArray : public bongo::unittest::Test {
public:
    ...
    void addObj(BSONObj obj) {
        ...
        ASSERT_OK(_doc.root()["x"].appendObject(bongo::StringData(), obj));
    }
