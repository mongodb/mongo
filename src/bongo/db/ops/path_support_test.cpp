...
class EmptyDoc : public bongo::unittest::Test {
public:
    EmptyDoc() : _doc() {}
...
class SimpleDoc : public bongo::unittest::Test {
public:
    SimpleDoc() : _doc() {}
...
class NestedDoc : public bongo::unittest::Test {
public:
    NestedDoc() : _doc() {}
...
class ArrayDoc : public bongo::unittest::Test {
public:
    ArrayDoc() : _doc() {}
...
TEST_F(ArrayDoc, ExcessivePaddingRequested) {
    ...
    string paddedField = stream() << "b." << bongo::pathsupport::kMaxPaddingAllowed + 2;
...
TEST_F(ArrayDoc, ExcessivePaddingNotRequestedIfArrayAlreadyPadded) {
    ...
    string paddedField = stream() << "a." << bongo::pathsupport::kMaxPaddingAllowed + 5;
    setField(paddedField);
    ...
    for (size_t i = 0; i < 5; ++i) {
        ...
        ASSERT_EQ(arrayA.getType(), bongo::Array);
        arrayA.appendInt("", 1);
    }
    ...
    ASSERT_EQ(countChildren(doc().root().leftChild()), bongo::pathsupport::kMaxPaddingAllowed + 6);
}
