...
using bongo::ModifierPush;
using bongo::NumberInt;
using bongo::Ordering;
using bongo::Status;
...
public:
    ...
    explicit Mod(BSONObj modObj,
        ...
        : _mod(bongoutils::str::equals(modObj.firstElement().fieldName(), "$pushAll")
 ...
 */
class SlicedMod : public bongo::unittest::Test {
public:
    SlicedMod() : _mod() {}
