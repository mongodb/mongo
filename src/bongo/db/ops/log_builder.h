...
public:
     ...
     *  'logRoot' Element, which must be of type bongo::Object and have no children.
     */
    inline LogBuilder(mutablebson::Element logRoot)
        ...
        dassert(logRoot.isType(bongo::Object));
    ...
    /** Obtain, via the out parameter 'outElt', a pointer to the bongo::Object type Element
