...
using bongo::ModifierCurrentDate;
using bongo::ModifierInterface;
using bongo::Status;
using bongo::StringData;
using bongo::Timestamp;
using bongo::fromjson;
using bongo::mutablebson::ConstElement;
using bongo::mutablebson::Document;
using bongo::mutablebson::Element;

using Init = bongo::LogicalClockTest;
using BoolInput = bongo::LogicalClockTest;
using DateInput = bongo::LogicalClockTest;
using TimestampInput = bongo::LogicalClockTest;
using DottedTimestampInput = bongo::LogicalClockTest;
