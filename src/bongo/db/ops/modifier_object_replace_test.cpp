...
#include "bongo/db/ops/modifier_object_replace.h"
...
#include "bongo/bson/timestamp.h"
#include "bongo/db/jsobj.h"
#include "bongo/db/json.h"
#include "bongo/db/logical_clock_test_fixture.h"
...
using bongo::BSONObj;
using bongo::fromjson;
using bongo::LogBuilder;
using bongo::ModifierInterface;
using bongo::ModifierObjectReplace;
using bongo::mutablebson::ConstElement;
using bongo::mutablebson::countChildren;
using bongo::mutablebson::Document;
using bongo::mutablebson::Element;
using bongo::mutablebson::findFirstChildNamed;
using bongo::NumberInt;
using bongo::Status;
using bongo::StringData;

using Normal = bongo::LogicalClockTest;
using IdLeft = bongo::LogicalClockTest;
using IdImmutable = bongo::LogicalClockTest;
using Timestamp = bongo::LogicalClockTest;
