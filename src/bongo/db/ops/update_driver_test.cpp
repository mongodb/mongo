...
using bongo::BSONElementComparator;
using bongo::BSONObj;
using bongo::BSONObjIterator;
using bongo::CollatorInterfaceMock;
using bongo::FieldRef;
using bongo::OperationContext;
using bongo::OwnedPointerVector;
using bongo::QueryTestServiceContext;
using bongo::ServiceContext;
using bongo::SimpleStringDataComparator;
using bongo::StringData;
using bongo::UpdateDriver;
using bongo::UpdateIndexData;
...
class CreateFromQueryFixture : public bongo::unittest::Test {
public:
