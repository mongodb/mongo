 ...
 */
class AutoGetDb {
    BONGO_DISALLOW_COPYING(AutoGetDb);
...
class AutoGetCollection {
    BONGO_DISALLOW_COPYING(AutoGetCollection);
...
class AutoGetOrCreateDb {
    BONGO_DISALLOW_COPYING(AutoGetOrCreateDb);
...
class AutoGetCollectionForRead {
    BONGO_DISALLOW_COPYING(AutoGetCollectionForRead);
...
class AutoGetCollectionOrViewForRead final : public AutoGetCollectionForRead {
    BONGO_DISALLOW_COPYING(AutoGetCollectionOrViewForRead);
...
class OldClientContext {
    BONGO_DISALLOW_COPYING(OldClientContext);
...
class OldClientWriteContext {
    BONGO_DISALLOW_COPYING(OldClientWriteContext);
