...
#include "bongo/db/ttl_collection_cache.h"
...
BONGO_EXPORT_SERVER_PARAMETER(ttlMonitorEnabled, bool, true);
BONGO_EXPORT_SERVER_PARAMETER(ttlMonitorSleepSecs, int, 60);  // used for testing
