...
class OperationContext : public Decorable<OperationContext> {
    BONGO_DISALLOW_COPYING(OperationContext);
...
class WriteUnitOfWork {
    BONGO_DISALLOW_COPYING(WriteUnitOfWork);
...
class ScopedTransaction {
    BONGO_DISALLOW_COPYING(ScopedTransaction);
...
class UnreplicatedWritesBlock {
    BONGO_DISALLOW_COPYING(UnreplicatedWritesBlock);
