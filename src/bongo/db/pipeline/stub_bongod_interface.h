...
/**
 * A stub BongodInterface that can be used for testing. Create a subclass and override methods as
 * needed.
 */
class StubBongodInterface : public DocumentSourceNeedsBongod::BongodInterface {
public:
    virtual ~StubBongodInterface() = default;
