...
public:
    ...
    /**
      ...
      a Pipeline that combines the results within bongos.
    ...
    */
    ...
    /// The initial source is special since it varies between bongos and bongod.
    ...
    /*
      ...
      Pipeline needs to function in bongod and bongos.  PipelineD
      contains extra functionality required in bongod, and which can't
      appear in bongos because the required symbols are unavailable
      for linking there.  Consider PipelineD to be an extension of this
      class for bongod only.
     */
