...
void IndexBoundsBuilder::translate(const MatchExpression* expr,
    ...
    bool isHashed = false;
    if (bongoutils::str::equals("hashed", elt.valuestrsafe())) {
        isHashed = true;
    }
    ...
    if (MatchExpression::ELEM_MATCH_VALUE == expr->matchType()) {
        ...
        *tightnessOut = IndexBoundsBuilder::EXACT;
        ...
        if (bongoutils::str::equals("2dsphere", elt.valuestrsafe())) {
            ...
            *tightnessOut = IndexBoundsBuilder::INEXACT_FETCH;
        } else if (bongoutils::str::equals("2d", elt.valuestrsafe())) {
