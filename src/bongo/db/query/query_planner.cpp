...
#include "bongo/db/matcher/expression_text.h"
...
#include "bongo/db/query/plan_enumerator.h"
#include "bongo/db/query/planner_access.h"
#include "bongo/db/query/planner_analysis.h"
#include "bongo/db/query/planner_ixselect.h"
...
static bool indexCompatibleMaxMin(const BSONObj& obj,
    ...
    for (;;) {
        ...
        if (!bongoutils::str::equals(kpElt.fieldName(), objElt.fieldName())) {
            return false;
        }
