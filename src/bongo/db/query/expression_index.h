...
#include "bongo/db/geo/hash.h"
#include "bongo/db/geo/shapes.h"
#include "bongo/db/index/s2_common.h"
#include "bongo/db/jsobj.h"
#include "bongo/db/query/index_bounds_builder.h"  // For OrderedIntervalList
