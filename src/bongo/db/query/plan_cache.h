...
#include "bongo/db/query/plan_cache_indexability.h"
...
private:
    BONGO_DISALLOW_COPYING(CachedSolution);
...
class PlanCacheEntry {
private:
    BONGO_DISALLOW_COPYING(PlanCacheEntry);
...
class PlanCache {
private:
    BONGO_DISALLOW_COPYING(PlanCache);
