...
#include "bongo/db/query/plan_executor.h"
...
#include "bongo/db/exec/cached_plan.h"
#include "bongo/db/exec/multi_plan.h"
#include "bongo/db/exec/pipeline_proxy.h"
#include "bongo/db/exec/plan_stage.h"
#include "bongo/db/exec/plan_stats.h"
#include "bongo/db/exec/subplan.h"
#include "bongo/db/exec/working_set.h"
#include "bongo/db/exec/working_set_common.h"
#include "bongo/db/query/plan_yield_policy.h"
...
namespace {
BONGO_FP_DECLARE(planExecutorAlwaysDead);
}  // namespace
...
PlanExecutor::ExecState PlanExecutor::getNextImpl(Snapshotted<BSONObj>* objOut, RecordId* dlOut) {
    BONGO_FAIL_POINT_BLOCK(planExecutorAlwaysDead, customKill) {
