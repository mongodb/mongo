...
#include "bongo/db/fts/fts_query.h"
...
struct QuerySolutionNode {
     ...
     */
    virtual void appendToString(bongoutils::str::stream* ss, int indent) const = 0;
...
protected:
     ...
     */
    static void addIndent(bongoutils::str::stream* ss, int level);

    /**
     * Every solution node has properties and this adds the debug info for the
     * properties.
     */
    void addCommon(bongoutils::str::stream* ss, int indent) const;

private:
    BONGO_DISALLOW_COPYING(QuerySolutionNode);
};
...
private:
    BONGO_DISALLOW_COPYING(QuerySolution);
};
...
struct TextNode : public QuerySolutionNode {
    ...
    virtual void appendToString(bongoutils::str::stream* ss, int indent) const;
...
struct SortKeyGeneratorNode : public QuerySolutionNode {
    ...
    void appendToString(bongoutils::str::stream* ss, int indent) const final;
