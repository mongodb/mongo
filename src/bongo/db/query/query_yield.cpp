...
namespace {
BONGO_FP_DECLARE(setYieldAllLocksHang);
BONGO_FP_DECLARE(setYieldAllLocksWait);
}  // namespace
...
void QueryYield::yieldAllLocks(OperationContext* txn,
    ...
    BONGO_FAIL_POINT_PAUSE_WHILE_SET(setYieldAllLocksHang);

    BONGO_FAIL_POINT_BLOCK(setYieldAllLocksWait, customWait) {
