...
#include "bongo/db/repl/multiapplier.h"
#include "bongo/db/repl/oplog_buffer.h"
#include "bongo/db/repl/optime.h"
#include "bongo/db/repl/optime_with.h"
...
class DataReplicatorExternalState {
    BONGO_DISALLOW_COPYING(DataReplicatorExternalState);
...
public:
     ...
     *
     * TODO (SERVER-27668): Make OplogQueryMetadata non-optional in bongodb 3.8.
     */
