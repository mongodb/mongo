...
#include "bongo/db/repl/repl_set_command.h"
...
BONGO_INITIALIZER(RegisterReplSetTestCmd)(InitializerContext* context) {
...
public:
    virtual void help(stringstream& help) const {
        ...
        help << "\nhttp://dochub.bongodb.org/core/replicasetcommands";
    }
...
public:
    virtual void help(stringstream& help) const {
        ...
        help << "(If another member with same priority takes over in the meantime, it will stay "
                "primary.)\n";
        help << "http://dochub.bongodb.org/core/replicasetcommands";
    }
...
BONGO_FP_DECLARE(rsDelayHeartbeatResponse);
...
public:
    ...
    virtual bool run(OperationContext* txn,
                     ...
                     string& errmsg,
                     BSONObjBuilder& result) {
        BONGO_FAIL_POINT_BLOCK(rsDelayHeartbeatResponse, delay) {
