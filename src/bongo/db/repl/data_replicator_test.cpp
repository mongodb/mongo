...
#include "bongo/client/fetcher.h"
#include "bongo/db/client.h"
#include "bongo/db/json.h"
#include "bongo/db/query/getmore_request.h"
#include "bongo/db/repl/base_cloner_test_fixture.h"
#include "bongo/db/repl/data_replicator.h"
#include "bongo/db/repl/data_replicator_external_state_mock.h"
#include "bongo/db/repl/member_state.h"
#include "bongo/db/repl/oplog_entry.h"
#include "bongo/db/repl/oplog_fetcher.h"
#include "bongo/db/repl/optime.h"
#include "bongo/db/repl/reporter.h"
#include "bongo/db/repl/storage_interface.h"
#include "bongo/db/repl/storage_interface_mock.h"
#include "bongo/db/repl/sync_source_resolver.h"
#include "bongo/db/repl/sync_source_selector.h"
#include "bongo/db/repl/sync_source_selector_mock.h"
#include "bongo/db/repl/update_position_args.h"
...
#include "bongo/unittest/task_executor_proxy.h"
#include "bongo/util/concurrency/old_thread_pool.h"
...
#include "bongo/unittest/barrier.h"
...
void DataReplicatorTest::processSuccessfulLastOplogEntryFetcherResponse(std::vector<BSONObj> docs) {
    ...
    ASSERT_EQUALS(bongo::BSONType::Object, request.cmdObj["sort"].type());
...
class SharedCallbackState {
    BONGO_DISALLOW_COPYING(SharedCallbackState);
