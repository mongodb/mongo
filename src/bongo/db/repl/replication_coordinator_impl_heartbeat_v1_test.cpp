...
#include "bongo/db/operation_context_noop.h"
#include "bongo/db/repl/repl_set_heartbeat_args.h"
#include "bongo/db/repl/repl_set_heartbeat_args_v1.h"
#include "bongo/db/repl/replica_set_config.h"
#include "bongo/db/repl/replication_coordinator_external_state_mock.h"
#include "bongo/db/repl/replication_coordinator_impl.h"
#include "bongo/db/repl/replication_coordinator_test_fixture.h"
...
TEST_F(ReplCoordHBV1Test, IgnoreTheContentsOfMetadataWhenItsReplicaSetIdDoesNotMatchOurs) {
    ...
    ASSERT_EQ(bongo::Array, statusObj["members"].type());
