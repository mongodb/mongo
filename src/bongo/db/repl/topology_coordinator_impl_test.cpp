...
#define ASSERT_NO_ACTION(EXPRESSION) \
    ASSERT_EQUALS(bongo::repl::HeartbeatResponseAction::NoAction, (EXPRESSION))

using std::unique_ptr;
using bongo::rpc::ReplSetMetadata;
using bongo::rpc::OplogQueryMetadata;
...
class TopoCoordTest : public bongo::unittest::Test {
public:
    virtual void setUp() {
