...
BSONObj getMinValidDocument(OperationContext* txn, const NamespaceString& minValidNss) {
    ...
    BONGO_WRITE_CONFLICT_RETRY_LOOP_END(txn, "getMinValidDocument", minValidNss.ns());
    return BSONObj();
}
...
class StorageInterfaceImplTest : public ServiceContextBongoDTest {
protected:
...
class StorageInterfaceImplWithReplCoordTest : public ServiceContextBongoDTest {
protected:
    void setUp() override {
        ServiceContextBongoDTest::setUp();
        createOptCtx();
