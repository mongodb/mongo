...
#include "bongo/db/repl/oplog_interface.h"
#include "bongo/db/repl/oplog_interface_mock.h"
#include "bongo/db/repl/replication_coordinator_global.h"
#include "bongo/db/repl/replication_coordinator_mock.h"
#include "bongo/db/repl/rollback_source.h"
#include "bongo/db/repl/rs_rollback.h"
...
using namespace bongo::repl::rollback_internal;
...
class RSRollbackTest : public ServiceContextBongoDTest {
protected:
...
Collection* _createCollection(OperationContext* txn,
    ...
    bongo::WriteUnitOfWork wuow(txn);
...
TEST_F(RSRollbackTest, RollbackUnknownCommand) {
    ...
    {
        Lock::DBLock dbLock(_txn->lockState(), "test", MODE_X);
        bongo::WriteUnitOfWork wuow(_txn.get());
