...
unique_ptr<AuthzManagerExternalState> createAuthzManagerExternalStateBongod() {
    return stdx::make_unique<AuthzManagerExternalStateBongod>();
}

BONGO_INITIALIZER(CreateAuthorizationExternalStateFactory)(InitializerContext* context) {
    AuthzManagerExternalState::create = &createAuthzManagerExternalStateBongod;
    return Status::OK();
}
