...
#include "bongo/db/auth/user_set.h"
#include "bongo/db/client.h"
#include "bongo/db/server_parameters.h"
#include "bongo/logger/max_log_size.h"
...
BONGO_EXPORT_STARTUP_SERVER_PARAMETER(logUserIds, bool, false);
BONGO_EXPORT_SERVER_PARAMETER(maxLogSizeKB, int, 10);
...
BONGO_INITIALIZER(SetServerLogContextFunction)(InitializerContext*) {
