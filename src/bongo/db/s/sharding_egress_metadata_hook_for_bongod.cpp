...
void ShardingEgressMetadataHookForBongod::_saveGLEStats(const BSONObj& metadata,
                                                        StringData hostString) {}

repl::OpTime ShardingEgressMetadataHookForBongod::_getConfigServerOpTime() {
...
Status ShardingEgressMetadataHookForBongod::_advanceConfigOptimeFromShard(
