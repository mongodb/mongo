...
BONGO_INITIALIZER_WITH_PREREQUISITES(BongoDLocalShardingInfo, ("SetGlobalEnvironment"))
...
ShardingState::ShardingState()
    : _initializationState(static_cast<uint32_t>(InitializationState::kNew)),
      ...
      _globalInit(&initializeGlobalShardingStateForBongod),
...
bool ShardingState::needCollectionMetadata(OperationContext* txn, const string& ns) {
    ...
    // Shard version information received from bongos may either by attached to the Client or
