...
#include "bongo/db/s/migration_session_id.h"
...
class ActiveMigrationsRegistry {
    BONGO_DISALLOW_COPYING(ActiveMigrationsRegistry);
 ...
 */
class ScopedRegisterDonateChunk {
    BONGO_DISALLOW_COPYING(ScopedRegisterDonateChunk);
 ...
 */
class ScopedRegisterReceiveChunk {
    BONGO_DISALLOW_COPYING(ScopedRegisterReceiveChunk);
