...
#include "bongo/db/auth/authz_session_external_state.h"

namespace bongo {

/**
 * The implementation of AuthzSessionExternalState functionality common to bongod and bongos.
 */
class AuthzSessionExternalStateServerCommon : public AuthzSessionExternalState {
    BONGO_DISALLOW_COPYING(AuthzSessionExternalStateServerCommon);
