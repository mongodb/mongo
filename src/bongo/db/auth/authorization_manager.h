...
#include "bongo/db/auth/role_graph.h"
#include "bongo/db/auth/user.h"
#include "bongo/db/auth/user_name.h"
#include "bongo/db/auth/user_name_hash.h"
...
class AuthorizationManager {
    BONGO_DISALLOW_COPYING(AuthorizationManager);
...
public:
    ...
    static const NamespaceString defaultTempUsersCollectionNamespace;  // for bongorestore
    static const NamespaceString defaultTempRolesCollectionNamespace;  // for bongorestore
    ...
    /**
     * Auth schema version for BongoDB v2.4 and prior.
     */
    static const int schemaVersion24 = 1;

    /**
     * Auth schema version for BongoDB v2.6 during the upgrade process.  Same as
    ...
    /**
     * Auth schema version for BongoDB 2.6 and 3.0 BONGODB-CR/SCRAM mixed auth mode.
     * Users are stored in admin.system.users, roles in admin.system.roles.
     */
    static const int schemaVersion26Final = 3;

    /**
     * Auth schema version for BongoDB 3.0 SCRAM only mode.
     * Users are stored in admin.system.users, roles in admin.system.roles.
     * BONGODB-CR credentials have been replaced with SCRAM credentials in the user documents.
     */
