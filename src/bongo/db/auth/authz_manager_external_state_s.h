...
/**
 * The implementation of AuthzManagerExternalState functionality for bongos.
 */
class AuthzManagerExternalStateBongos : public AuthzManagerExternalState {
    BONGO_DISALLOW_COPYING(AuthzManagerExternalStateBongos);

public:
    AuthzManagerExternalStateBongos();
    virtual ~AuthzManagerExternalStateBongos();
