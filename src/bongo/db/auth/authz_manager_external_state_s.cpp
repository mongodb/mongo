...
#include "bongo/db/auth/authz_session_external_state_s.h"
...
AuthzManagerExternalStateBongos::AuthzManagerExternalStateBongos() = default;

AuthzManagerExternalStateBongos::~AuthzManagerExternalStateBongos() = default;

Status AuthzManagerExternalStateBongos::initialize(OperationContext* txn) {
    return Status::OK();
}

std::unique_ptr<AuthzSessionExternalState>
AuthzManagerExternalStateBongos::makeAuthzSessionExternalState(AuthorizationManager* authzManager) {
    return stdx::make_unique<AuthzSessionExternalStateBongos>(authzManager);
}

Status AuthzManagerExternalStateBongos::getStoredAuthorizationVersion(OperationContext* txn,
                                                                      int* outVersion) {
    // Note: we are treating
    // { 'getParameter' : 1, <authSchemaVersionServerParameter> : 1 }
    // as a user management command since this is the *only* part of bongos
...
Status AuthzManagerExternalStateBongos::getUserDescription(OperationContext* txn,
...
Status AuthzManagerExternalStateBongos::getRoleDescription(OperationContext* txn,
...
Status AuthzManagerExternalStateBongos::getRolesDescription(OperationContext* txn,
...
Status AuthzManagerExternalStateBongos::getRoleDescriptionsForDB(OperationContext* txn,
...
bool AuthzManagerExternalStateBongos::hasAnyPrivilegeDocuments(OperationContext* txn) {
