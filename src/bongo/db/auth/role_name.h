...
/**
 * Representation of a name of a role in a BongoDB system.
 *
...
template <>
struct hash<bongo::RoleName> {
    size_t operator()(const bongo::RoleName& rname) const {
...
class RoleNameContainerIteratorImpl : public RoleNameIterator::Impl {
    BONGO_DISALLOW_COPYING(RoleNameContainerIteratorImpl);
