...
/**
 * Representation of a name of a principal (authenticatable user) in a BongoDB system.
 *
...
class UserNameContainerIteratorImpl : public UserNameIterator::Impl {
    BONGO_DISALLOW_COPYING(UserNameContainerIteratorImpl);
