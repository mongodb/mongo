...
BONGO_INITIALIZER_WITH_PREREQUISITES(PostSaslCommands, ("NativeSaslServerCore"))
(InitializerContext*) {
    ...
    for (size_t i = 0; i < saslGlobalParams.authenticationMechanisms.size(); ++i) {
        ...
        if (mechanism == "BONGODB-CR" || mechanism == "BONGODB-X509") {
