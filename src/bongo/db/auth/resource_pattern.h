...
public:
    ...
    inline size_t hash() const {
        ...
        return BONGO_HASH_NAMESPACE::hash<std::string>()(_ns.ns()) ^ _matchType;
    }
...
template <>
struct hash<bongo::ResourcePattern> {
    size_t operator()(const bongo::ResourcePattern& resource) const {
