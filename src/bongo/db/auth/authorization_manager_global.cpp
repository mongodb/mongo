...
class AuthzVersionParameter : public ServerParameter {
    BONGO_DISALLOW_COPYING(AuthzVersionParameter);
...
BONGO_INITIALIZER_GENERAL(AuthzSchemaParameter,
...
BONGO_EXPORT_STARTUP_SERVER_PARAMETER(startupAuthSchemaValidation, bool, true);

BONGO_INITIALIZER_WITH_PREREQUISITES(CreateAuthorizationManager,
