 ...
 *
 * An example subclass is BongoAuthenticationSession.
 */
class AuthenticationSession {
    BONGO_DISALLOW_COPYING(AuthenticationSession);

public:
    enum SessionType {
        SESSION_TYPE_BONGO,  // The bongo-specific challenge-response authentication mechanism.
