...
#define DEATH_TEST(CASE_NAME, TEST_NAME, MATCH_EXPR)                               \
    ...
    private:                                                                       \
        ...
        static const RegistrationAgent<                                            \
            ::bongo::unittest::DeathTest<_TEST_TYPE_NAME(CASE_NAME, TEST_NAME)>>   \
            _agent;                                                                \
    };                                                                             \
    const ::bongo::unittest::Test::RegistrationAgent<                              \
        ::bongo::unittest::DeathTest<_TEST_TYPE_NAME(CASE_NAME, TEST_NAME)>>       \
...
#define DEATH_TEST_F(FIXTURE_NAME, TEST_NAME, MATCH_EXPR)                            \
    ...
    private:                                                                         \
        virtual void _doTest();                                                      \
                                                                                     \
        static const RegistrationAgent<                                              \
            ::bongo::unittest::DeathTest<_TEST_TYPE_NAME(FIXTURE_NAME, TEST_NAME)>>  \
            _agent;                                                                  \
    };                                                                               \
    const ::bongo::unittest::Test::RegistrationAgent<                                \
        ::bongo::unittest::DeathTest<_TEST_TYPE_NAME(FIXTURE_NAME, TEST_NAME)>>      \
...
class DeathTestImpl : public Test {
    BONGO_DISALLOW_COPYING(DeathTestImpl);
