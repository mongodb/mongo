...
#include "bongo/logger/tee.h"
#include "bongo/stdx/memory.h"
#include "bongo/util/assert_util.h"  // TODO: remove apple dep for this in threadlocal.h
...
BONGO_INITIALIZER(LogstreamBuilder)(InitializerContext*) {
