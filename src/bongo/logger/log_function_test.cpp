...
#include "bongo/logger/log_test.h"

#include <sstream>
#include <string>
#include <vector>

#include "bongo/logger/appender.h"
#include "bongo/logger/encoder.h"
#include "bongo/logger/log_component.h"
#include "bongo/logger/message_event_utf8_encoder.h"
#include "bongo/util/log.h"
#include "bongo/util/bongoutils/str.h"

using namespace bongo::logger;
...
const LogComponent componentB = BONGO_LOG_DEFAULT_COMPONENT;
...
// BONGO_DEFAULT_LOG_COMPONENT is set to kReplication before including util/log.h
