 ...
 * "unknown" in Bongo Drivers). The "driver", and "os" documents while required, are for
 * informational purposes only. The content is logged to disk but otherwise ignored.
 *
 * See Driver Specification: "BongoDB Handshake" for more information.
 */
class ClientMetadata {
    BONGO_DISALLOW_COPYING(ClientMetadata);
