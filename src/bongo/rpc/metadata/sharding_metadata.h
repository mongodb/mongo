...
/**
 * This class compromises the reply metadata fields that concern sharding. BongoD attaches
 * this information to a command reply, which BongoS uses to process getLastError.
