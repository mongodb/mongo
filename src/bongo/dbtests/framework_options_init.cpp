...
namespace bongo {
BONGO_GENERAL_STARTUP_OPTIONS_REGISTER(FrameworkOptions)(InitializerContext* context) {
    return addTestFrameworkOptions(&moe::startupOptions);
}

BONGO_STARTUP_OPTIONS_VALIDATE(FrameworkOptions)(InitializerContext* context) {
...
BONGO_STARTUP_OPTIONS_STORE(FrameworkOptions)(InitializerContext* context) {
