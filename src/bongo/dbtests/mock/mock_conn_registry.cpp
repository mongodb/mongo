...
#include "bongo/dbtests/mock/mock_conn_registry.h"
...
BONGO_INITIALIZER(MockConnRegistry)(InitializerContext* context) {
...
bongo::DBClientBase* MockConnRegistry::MockConnHook::connect(const ConnectionString& connString,
                                                             std::string& errmsg,
