...
#include "bongo/dbtests/mock/mock_replica_set.h"
#include "bongo/unittest/unittest.h"

#include <set>
#include <string>

using bongo::BSONArrayBuilder;
using bongo::BSONElement;
using bongo::BSONObj;
using bongo::BSONObjBuilder;
using bongo::BSONObjIterator;
using bongo::ConnectionString;
using bongo::HostAndPort;
using bongo::MockRemoteDBServer;
using bongo::MockReplicaSet;
using bongo::repl::ReplicaSetConfig;
