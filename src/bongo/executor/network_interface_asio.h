...
#include "bongo/base/system_error.h"
#include "bongo/executor/async_stream_factory_interface.h"
...
#include "bongo/stdx/unordered_set.h"
#include "bongo/transport/message_compressor_manager.h"
...
#define BONGO_ASIO_INVARIANT(_Expression, ...)              \
    do {                                                    \
...
#define BONGO_ASIO_INVARIANT_INLOCK(_Expression, ...)              \
    do {                                                           \
        if (BONGO_unlikely(!(_Expression))) {                      \
 ...
 * Kohlhoff's ASIO library instead of existing BongoDB networking primitives.
 */
