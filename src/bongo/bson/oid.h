...
public:
    ...
    BONGO_STATIC_ASSERT_MSG(sizeof(int64_t) == kInstanceUniqueSize + kIncrementSize,
...
/** Formatting mode for generating JSON from BSON.
    See <http://dochub.bongodb.org/core/bongodbextendedjson>
    for details.
*/
enum JsonStringFormat {
    ...
    /** 10gen format, which is close to JS format.  This form is understandable by
        javascript running inside the Bongo server via eval() */
    TenGen,
};
