...
#include "bongo/bson/mutable/document.h"

#include "bongo/base/status.h"
#include "bongo/bson/bsonobj.h"
#include "bongo/bson/mutable/algorithm.h"
#include "bongo/bson/mutable/damage_vector.h"
#include "bongo/bson/mutable/mutable_bson_test_utils.h"
#include "bongo/db/json.h"
#include "bongo/db/query/collation/collator_interface_mock.h"
...
TEST(TopologyBuilding, TopDownFromScratch) {
    ...
    */
    ...
    ASSERT_EQUALS(e0.pushBack(e1), bongo::Status::OK());
    ASSERT_EQUALS(e0.pushBack(e2), bongo::Status::OK());
    ASSERT_EQUALS(e2.pushBack(e3), bongo::Status::OK());
    ASSERT_EQUALS(e3.pushBack(e4), bongo::Status::OK());
    ASSERT_EQUALS(e3.pushBack(e5), bongo::Status::OK());
...
TEST(TopologyBuilding, AddSiblingAfter) {
    ...
    */
    ...
    ASSERT_EQUALS(e0.pushBack(e2), bongo::Status::OK());
    ASSERT_EQUALS(e2.pushBack(e3), bongo::Status::OK());
    ASSERT_EQUALS(e3.addSiblingRight(e4), bongo::Status::OK());
...
TEST(TopologyBuilding, AddSiblingBefore) {
    ...
    */
    ...
    ASSERT_EQUALS(e2.pushBack(e3), bongo::Status::OK());
    ASSERT_EQUALS(e2.pushBack(e4), bongo::Status::OK());
    ASSERT_EQUALS(e3.pushBack(e5), bongo::Status::OK());
    ASSERT_EQUALS(e5.addSiblingRight(e6), bongo::Status::OK());
    ASSERT_EQUALS(e5.addSiblingLeft(e7), bongo::Status::OK());
...
TEST(TopologyBuilding, AddSubtreeBottomUp) {
    ...
    */
    ...
    ASSERT_EQUALS(e3.pushBack(e4), bongo::Status::OK());
    ASSERT_EQUALS(e3.pushBack(e5), bongo::Status::OK());
    ASSERT_EQUALS(e3.pushBack(e6), bongo::Status::OK());
    ASSERT_EQUALS(e8.pushBack(e9), bongo::Status::OK());
    ASSERT_EQUALS(e8.pushBack(e10), bongo::Status::OK());
    ASSERT_EQUALS(e5.pushBack(e8), bongo::Status::OK());
...
TEST(TopologyBuilding, RemoveLeafNode) {
    ...
    */
    ...
    ASSERT_EQUALS(e0.pushBack(e1), bongo::Status::OK());
    ASSERT_EQUALS(e0.pushBack(e2), bongo::Status::OK());
    ASSERT_EQUALS(e1.remove(), bongo::Status::OK());
...
TEST(TopologyBuilding, RemoveSubtree) {
    ...
    */
    ...
    ASSERT_EQUALS(e8.pushBack(e10), bongo::Status::OK());
    ASSERT_EQUALS(e5.pushBack(e8), bongo::Status::OK());
    ASSERT_EQUALS(e5.remove(), bongo::Status::OK());
...
TEST(TopologyBuilding, RenameNode) {
    ...
    */
    ...
    ASSERT_EQUALS(e0.pushBack(e1), bongo::Status::OK());
    ASSERT_EQUALS(e0.pushBack(e2), bongo::Status::OK());
    ASSERT_EQUALS(e0.rename("f0"), bongo::Status::OK());
...
TEST(TopologyBuilding, MoveNode) {
    ...
    */
    ...
    ASSERT_EQUALS(e3.remove(), bongo::Status::OK());
    ASSERT_EQUALS(e0.pushBack(e3), bongo::Status::OK());
...
TEST(ArrayAPI, SimpleNumericArray) {
    ...
    */
    ...
    ASSERT_EQUALS(e1.pushBack(e2), bongo::Status::OK());
    ASSERT_EQUALS(e1.pushBack(e3), bongo::Status::OK());
    ASSERT_EQUALS(e1.pushBack(e4), bongo::Status::OK());
    ASSERT_EQUALS(e1.pushBack(e5), bongo::Status::OK());
    ASSERT_EQUALS(e1.pushFront(e6), bongo::Status::OK());
    ASSERT_EQUALS(e1.pushFront(e7), bongo::Status::OK());
    ...
    ASSERT_EQUALS(e1.popBack(), bongo::Status::OK());
    ...
    ASSERT_EQUALS(e1.popFront(), bongo::Status::OK());
    ...
    ASSERT_EQUALS(e1[0].setValueInt(100), bongo::Status::OK());
...
TEST(Element, setters) {
    ...
    ASSERT_EQUALS(bongo::Bool, t0.getType());

    t0.setValueInt(12345);
    ASSERT_EQUALS(bongo::NumberInt, t0.getType());

    t0.setValueLong(12345LL);
    ASSERT_EQUALS(bongo::NumberLong, t0.getType());

    t0.setValueTimestamp(bongo::Timestamp());
    ASSERT_EQUALS(bongo::bsonTimestamp, t0.getType());

    t0.setValueDate(bongo::Date_t::fromMillisSinceEpoch(12345LL));
    ASSERT_EQUALS(bongo::Date, t0.getType());

    t0.setValueDouble(123.45);
    ASSERT_EQUALS(bongo::NumberDouble, t0.getType());

    t0.setValueDecimal(bongo::Decimal128("123.45E1234"));
    ASSERT_EQUALS(bongo::NumberDecimal, t0.getType());

    t0.setValueOID(bongo::OID("47cc67093475061e3d95369d"));
    ASSERT_EQUALS(bongo::jstOID, t0.getType());

    t0.setValueRegex("[a-zA-Z]?", "");
    ASSERT_EQUALS(bongo::RegEx, t0.getType());

    t0.setValueString("foo bar baz");
    ASSERT_EQUALS(bongo::String, t0.getType());
}

TEST(Element, toString) {
    bongo::BSONObj obj = bongo::fromjson("{ a : 1, b : [1, 2, 3], c : { x : 'x' } }");
    ...
    // 'a'
    bongo::BSONObjIterator iter(obj);
...
TEST(DecimalType, createElement) {
    ...
    mmb::Element d0 = doc.makeElementDecimal("d0", bongo::Decimal128("12345"));
    ASSERT_TRUE(bongo::Decimal128("12345").isEqual(d0.getValueDecimal()));
}

TEST(DecimalType, setElement) {
    mmb::Document doc;

    mmb::Element d0 = doc.makeElementDecimal("d0", bongo::Decimal128("128"));
    d0.setValueDecimal(bongo::Decimal128("123456"));
    ASSERT_TRUE(bongo::Decimal128("123456").isEqual(d0.getValueDecimal()));

    d0.setValueDouble(0.1);
    ASSERT_EQUALS(0.1, d0.getValueDouble());
    d0.setValueDecimal(bongo::Decimal128("23"));
    ASSERT_TRUE(bongo::Decimal128("23").isEqual(d0.getValueDecimal()));
}
...
TEST(DecimalType, appendElement) {
    ...
    d0.appendDecimal("precision", bongo::Decimal128(34));

    mmb::Element it = mmb::findFirstChildNamed(d0, "precision");
    ASSERT_TRUE(it.ok());
    ASSERT_TRUE(bongo::Decimal128(34).isEqual(it.getValueDecimal()));
}

TEST(TimestampType, createElement) {
    mmb::Document doc;

    mmb::Element t0 = doc.makeElementTimestamp("t0", bongo::Timestamp());
    ASSERT(bongo::Timestamp() == t0.getValueTimestamp());

    mmb::Element t1 = doc.makeElementTimestamp("t1", bongo::Timestamp(123, 456));
    ASSERT(bongo::Timestamp(123, 456) == t1.getValueTimestamp());
}
...
TEST(TimestampType, setElement) {
    ...
    mmb::Element t0 = doc.makeElementTimestamp("t0", bongo::Timestamp());
    t0.setValueTimestamp(bongo::Timestamp(123, 456));
    ASSERT(bongo::Timestamp(123, 456) == t0.getValueTimestamp());

    // Try setting to other types and back to Timestamp
    t0.setValueLong(1234567890);
    ASSERT_EQUALS(1234567890LL, t0.getValueLong());
    t0.setValueTimestamp(bongo::Timestamp(789, 321));
    ASSERT(bongo::Timestamp(789, 321) == t0.getValueTimestamp());

    t0.setValueString("foo bar baz");
    ASSERT_EQUALS("foo bar baz", t0.getValueString());
    t0.setValueTimestamp(bongo::Timestamp(9876, 5432));
    ASSERT(bongo::Timestamp(9876, 5432) == t0.getValueTimestamp());
}
...
TEST(TimestampType, appendElement) {
    ...
    t0.appendTimestamp("a timestamp field", bongo::Timestamp(1352151971, 471));

    mmb::Element it = mmb::findFirstChildNamed(t0, "a timestamp field");
    ASSERT_TRUE(it.ok());
    ASSERT(bongo::Timestamp(1352151971, 471) == it.getValueTimestamp());
}

TEST(SafeNumType, createElement) {
    mmb::Document doc;

    mmb::Element t0 = doc.makeElementSafeNum("t0", bongo::SafeNum(123.456));
    ASSERT_EQUALS(bongo::SafeNum(123.456), t0.getValueSafeNum());
}
...
TEST(SafeNumType, getSafeNum) {
    ...
    bongo::SafeNum num = t0.getValueSafeNum();
    ...
    t0.setValueDecimal(bongo::Decimal128("12345678.1234"));
    ASSERT_TRUE(bongo::Decimal128("12345678.1234").isEqual(t0.getValueDecimal()));
    num = t0.getValueSafeNum();
    ASSERT_EQUALS(num, bongo::Decimal128("12345678.1234"));
}

TEST(SafeNumType, setSafeNum) {
    mmb::Document doc;

    mmb::Element t0 = doc.makeElementSafeNum("t0", bongo::SafeNum(123456));
    t0.setValueSafeNum(bongo::SafeNum(654321));
    ASSERT_EQUALS(bongo::SafeNum(654321), t0.getValueSafeNum());

    // Try setting to other types and back to SafeNum
    t0.setValueLong(1234567890);
    ASSERT_EQUALS(1234567890LL, t0.getValueLong());
    t0.setValueSafeNum(bongo::SafeNum(1234567890));
    ASSERT_EQUALS(bongo::SafeNum(1234567890), t0.getValueSafeNum());

    t0.setValueString("foo bar baz");

    bongo::StringData left = "foo bar baz";
    bongo::StringData right = t0.getValueString();
    ASSERT_EQUALS(left, right);

    ASSERT_EQUALS(bongo::StringData("foo bar baz"), t0.getValueString());
    t0.setValueSafeNum(bongo::SafeNum(12345));
    ASSERT_EQUALS(bongo::SafeNum(12345), t0.getValueSafeNum());
}
...
TEST(SafeNumType, appendElement) {
    ...
    mmb::Element t0 = doc.makeElementObject("e0");
    t0.appendSafeNum("a timestamp field", bongo::SafeNum(static_cast<int64_t>(1352151971LL)));

    mmb::Element it = findFirstChildNamed(t0, "a timestamp field");
    ASSERT_TRUE(it.ok());
    ASSERT_EQUALS(bongo::SafeNum(static_cast<int64_t>(1352151971LL)), it.getValueSafeNum());
}

TEST(OIDType, getOidValue) {
    mmb::Document doc;
    mmb::Element t0 = doc.makeElementObject("e0");
    const bongo::OID generated = bongo::OID::gen();
    t0.appendOID("myOid", generated);
    mmb::Element it = findFirstChildNamed(t0, "myOid");
    const bongo::OID recovered = bongo::OID(it.getValueOID());
...
TEST(OIDType, nullOID) {
    mmb::Document doc;
    mmb::Element t0 = doc.makeElementObject("e0");
    const bongo::OID withNull("50a9c82263e413ad0028faad");
...
TEST(Serialization, RoundTrip) {
    bongo::BSONObj obj;
    obj = bongo::fromjson(jsonSampleWithDecimal);
    mmb::Document doc(obj.copy());
    bongo::BSONObj built = doc.getObject();
...
TEST(Documentation, Example1) {
    ...
    mmb::Document doc;
    ASSERT_BSONOBJ_EQ(bongo::fromjson("{}"), doc.getObject());

    // Get the root of the document.
    mmb::Element root = doc.root();

    // Create a new bongo::NumberInt typed Element to represent life, the universe, and
    ...
    ASSERT_BSONOBJ_EQ(bongo::fromjson("{ ltuae : 42 }"), doc.getObject());

    // Create a new empty bongo::Object-typed Element named 'magic', and push it back as a
    // child of the root, making it a sibling of e0.
    mmb::Element e1 = doc.makeElementObject("magic");
    ASSERT_OK(root.pushBack(e1));
    ASSERT_BSONOBJ_EQ(bongo::fromjson("{ ltuae : 42, magic : {} }"), doc.getObject());

    // Create a new bongo::NumberDouble typed Element to represent Pi, and insert it as child
    // of the new object we just created.
    mmb::Element e3 = doc.makeElementDouble("pi", 3.14);
    ASSERT_OK(e1.pushBack(e3));
    ASSERT_BSONOBJ_EQ(bongo::fromjson("{ ltuae : 42, magic : { pi : 3.14 } }"), doc.getObject());

    // Create a new bongo::NumberDouble to represent Plancks constant in electrovolt
...
TEST(Documentation, Example2) {
    static const char inJson[] =
        ...
        "}";
    bongo::BSONObj obj = bongo::fromjson(inJson);
    ...
    // Construct a new bongo::Object element for the ex-whale.
    ...
    bongo::BSONObjBuilder builder;
    doc.writeTo(&builder);
    ASSERT_BSONOBJ_EQ(bongo::fromjson(outJson), doc.getObject());
}

namespace {
void apply(bongo::BSONObj* obj, const mmb::DamageVector& damages, const char* source) {
...
TEST(Documentation, Example2InPlaceWithDamageVector) {
    ...
    bongo::BSONObj obj = bongo::fromjson(inJson);
    const bongo::BSONObj copyOfObj = obj.getOwned();
    ...
    static const char outJson[] =
        ...
        "}";
    bongo::BSONObj outObj = bongo::fromjson(outJson);
...
TEST(Documentation, Example3) {
    static const char inJson[] =
        ...
        "  'ys': { 'y' : 'y' }"
        "}";
    bongo::BSONObj inObj = bongo::fromjson(inJson);
    ...
    bongo::BSONObj outObj = doc.getObject();
    ...
    static const char outJson[] =
        ...
        "  'ys': { 'y' : 'y', 'Y' : 'Y', 'why' : ['not'] }"
        "}";
    ASSERT_BSONOBJ_EQ(bongo::fromjson(outJson), outObj);
}
...
TEST(Document, LifecycleConstructDefault) {
    ...
    ASSERT_TRUE(doc.root().isType(bongo::Object));
...
TEST(Document, LifecycleConstructSimpleBSONObj) {
    ...
    // simple (flat) BSONObj.
    bongo::BSONObj obj = bongo::fromjson("{ e1: 1, e2: 'hello', e3: false }");
    mmb::Document doc(obj);
    ...
    ASSERT_TRUE(e1Child.isType(bongo::NumberInt));
    ...
    ASSERT_TRUE(e2Child.isType(bongo::String));
    ...
    ASSERT_TRUE(e3Child.isType(bongo::Bool));
...
TEST(Document, ArrayIndexedAccessFromJson) {
    ...
    ASSERT_EQUALS(bongo::NumberInt, a.getType());

    mmb::Element b = a.rightSibling();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS("b", b.getFieldName());
    ASSERT_EQUALS(bongo::Array, b.getType());

    mmb::Element b0 = b[0];
    ASSERT_TRUE(b0.ok());
    ASSERT_EQUALS("0", b0.getFieldName());
    ASSERT_EQUALS(bongo::Object, b0.getType());
}
...
TEST(Document, AddChildToEmptyOpaqueSubobject) {
    bongo::BSONObj inObj = bongo::fromjson("{a: {}}");
    mmb::Document doc(inObj);
...
TEST(Element, IsNumeric) {
    ...
    elt = doc.makeElementDecimal("dummy", bongo::Decimal128(20));
    ASSERT_TRUE(elt.isNumeric());
}
...
TEST(Document, ArraySerialization) {
    ...
    const bongo::BSONObj outObj = doc.getObject();
    ASSERT_BSONOBJ_EQ(bongo::fromjson(outJson), outObj);
}
...
TEST(Document, SetValueBSONElementFieldNameHandling) {
    ...
    bongo::BSONObj inObj2 = bongo::fromjson(inJson2);
    bongo::BSONObjIterator iterator = inObj2.begin();

    ASSERT_TRUE(iterator.more());
    const bongo::BSONElement b = iterator.next();
...
TEST(Document, SetValueElementFromSeparateDocument) {
    bongo::BSONObj inObj = bongo::fromjson("{ a : 4 }");
    mmb::Document doc1(inObj);

    bongo::BSONObj inObj2 = bongo::fromjson("{ b : 5 }");
    ...
    ASSERT_BSONOBJ_EQ(bongo::fromjson("{ a : 5 }"), doc1.getObject());
...
TEST(Document, SetValueElementIsNoopWhenSetToSelfNonRootElement) {
    bongo::BSONObj inObj = bongo::fromjson("{ a : { b : { c: 4 } } }");
    mmb::Document doc(inObj);
...
TEST(Document, SetValueElementSetToNestedObject) {
    ...
    bongo::BSONObj inObj2 = bongo::fromjson("{ b : { c : 5, d : 6 } }");
    const mmb::Document doc2(inObj2);
    ...
    ASSERT_BSONOBJ_EQ(bongo::fromjson("{ a : { c : 5, d : 6 } }"), doc1.getObject());
...
TEST(Document, SetValueElementNonRootElements) {
    bongo::BSONObj inObj = bongo::fromjson("{ a : { b : 5, c : 6 } }");
    mmb::Document doc1(inObj);

    bongo::BSONObj inObj2 = bongo::fromjson("{ d : { e : 8, f : 9 } }");
    const mmb::Document doc2(inObj2);
    ...
    ASSERT_BSONOBJ_EQ(bongo::fromjson("{ a : { b : 5, c : 8 } }"), doc1.getObject());
...
TEST(Document, SetValueElementSetToOwnRootErrors) {
    bongo::BSONObj inObj = bongo::fromjson("{ a : { b : 4 } }");
    mmb::Document doc(inObj);
...
TEST(Document, SetValueElementSetToOtherDocRoot) {
    ...
    bongo::BSONObj inObj2 = bongo::fromjson("{ c : 5 } }");
    ...
    ASSERT_OK(setTo.setValueElement(setFrom));
    ASSERT_BSONOBJ_EQ(bongo::fromjson("{ a : { b : { c : 5 } } }"), doc1.getObject());
    ASSERT_BSONOBJ_EQ(inObj2, doc2.getObject());
}

TEST(Document, CreateElementWithEmptyFieldName) {
    mmb::Document doc;
    mmb::Element noname = doc.makeElementObject(bongo::StringData());
    ASSERT_TRUE(noname.ok());
    ASSERT_EQUALS(bongo::StringData(), noname.getFieldName());
}

TEST(Document, CreateElementFromBSONElement) {
    bongo::BSONObj obj = bongo::fromjson("{a:1}}");
    mmb::Document doc;
    ASSERT_OK(doc.root().appendElement(obj["a"]));

    mmb::Element newElem = doc.root()["a"];
    ASSERT_TRUE(newElem.ok());
    ASSERT_EQUALS(newElem.getType(), bongo::NumberInt);
...
TEST(Document, toStringComplex) {
    bongo::BSONObj obj = bongo::fromjson("{a : 1, b : [1, 2, 3], c : 'c'}");
    mmb::Document doc(obj);
    ASSERT_EQUALS(obj.toString(), doc.toString());
}
...
TEST(Document, toStringEphemeralObject) {
    ...
    ASSERT_EQUALS(bongo::fromjson("{ foo: { d : 1.0, s : 'str' } }").firstElement().toString(),
                  e.toString());
}
...
TEST(Document, toStringEphemeralArray) {
    ...
    ASSERT_OK(doc.root().pushBack(e));
    ASSERT_OK(e.appendDouble(bongo::StringData(), 1.0));
    ASSERT_OK(e.appendString(bongo::StringData(), "str"));
    ASSERT_EQUALS(bongo::fromjson("{ foo: [ 1.0, 'str' ] }").firstElement().toString(),
                  e.toString());
}
...
TEST(Document, ElementCloningToDifferentDocument) {
    ...
    mmb::Document source(bongo::fromjson(initial));

    // Dirty the 'd' node and parents.
    source.root()["d"].pushBack(source.makeElementInt(bongo::StringData(), 7));

    mmb::Document target;

    mmb::Element newElement = target.makeElement(source.root()["d"]);
    ASSERT_TRUE(newElement.ok());
    bongo::Status status = target.root().pushBack(newElement);
    ASSERT_OK(status);
    const char* expected = "{ d : [ 4, 5, 6, 7 ] }";
    ASSERT_EQUALS(bongo::fromjson(expected), target);
...
TEST(Document, ElementCloningToSameDocument) {
    ...
    mmb::Document doc(bongo::fromjson(initial));

    // Dirty the 'd' node and parents.
    doc.root()["d"].pushBack(doc.makeElementInt(bongo::StringData(), 7));

    mmb::Element newElement = doc.makeElement(doc.root()["d"]);
    ASSERT_TRUE(newElement.ok());
    bongo::Status status = doc.root().pushBack(newElement);
    ASSERT_OK(status);
    const char* expected =
        "{ "
        ...
        " d : [ 4, 5, 6, 7 ] "
        "}";
    ASSERT_EQUALS(bongo::fromjson(expected), doc);
...
TEST(Document, NameOfRootElementIsEmpty) {
    ...
    ASSERT_EQUALS(bongo::StringData(), doc.root().getFieldName());
}
...
TEST(Document, ValueOfEphemeralObjectElementIsEmpty) {
    ...
    // NOTE: You really shouldn't rely on this behavior; this test is mostly for coverage.
    ASSERT_BSONELT_EQ(bongo::BSONElement(), ephemeralObject.getValue());
}
...
TEST(Element, RemovingRemovedElementFails) {
    ...
    mmb::Document doc(bongo::fromjson("{ a : { b : 'c' } }"));
    mmb::Element a = doc.root().leftChild();
    ASSERT_TRUE(a.ok());
    ASSERT_OK(a.remove());
...
bool identical(const bongo::BSONElement& lhs, const bongo::BSONElement& rhs) {
...
TEST(TypeSupport, EncodingEquivalenceDouble) {
    ...
    bongo::BSONObj source = builder.done();
    const bongo::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == bongo::NumberDouble);
    ...
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), bongo::NumberDouble);
    ...
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), bongo::NumberDouble);
    ...
    ASSERT_EQUALS(c.getType(), bongo::NumberDouble);
...
TEST(TypeSupport, EncodingEquivalenceString) {
    ...
    bongo::BSONObj source = builder.done();
    const bongo::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == bongo::String);
    ...
    mmb::Element a = doc.root().rightChild();
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), bongo::String);
    ASSERT_TRUE(a.hasValue());
    ...
    mmb::Element b = doc.root().rightChild();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), bongo::String);
    ASSERT_TRUE(b.hasValue());
    ...
    ASSERT_EQUALS(c.getType(), bongo::String);
    ASSERT_TRUE(c.hasValue());
...
TEST(TypeSupport, EncodingEquivalenceObject) {
    bongo::BSONObjBuilder builder;
    const char name[] = "thing";
    const bongo::BSONObj value1 = bongo::fromjson("{ a : 1, b : 2.0, c : 'hello' }");
    builder.append(name, value1);
    bongo::BSONObj source = builder.done();
    const bongo::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == bongo::Object);
    ...
    mmb::Element a = doc.root().rightChild();
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), bongo::Object);
    ASSERT_TRUE(a.hasValue());
    ...
    mmb::Element b = doc.root().rightChild();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), bongo::Object);
    ASSERT_TRUE(b.hasValue());
    ...
    ASSERT_EQUALS(c.getType(), bongo::Object);
    ASSERT_TRUE(c.hasValue());
...
TEST(TypeSupport, EncodingEquivalenceArray) {
    bongo::BSONObjBuilder builder;
    const char name[] = "thing";
    const bongo::BSONObj dummy = (bongo::fromjson("{ x : [ 1, 2.0, 'hello' ] } "));
    const bongo::BSONArray value1(dummy.firstElement().embeddedObject());
    builder.append(name, value1);
    bongo::BSONObj source = builder.done();
    const bongo::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == bongo::Array);
    ...
    mmb::Element a = doc.root().rightChild();
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), bongo::Array);
    ASSERT_TRUE(a.hasValue());
    ...
    mmb::Element b = doc.root().rightChild();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), bongo::Array);
    ASSERT_TRUE(b.hasValue());
    ...
    ASSERT_EQUALS(c.getType(), bongo::Array);
    ASSERT_TRUE(c.hasValue());
...
TEST(TypeSupport, EncodingEquivalenceBinary) {
    bongo::BSONObjBuilder builder;
    const char name[] = "thing";
    const bongo::BinDataType value1 = bongo::newUUID;
    ...
    bongo::BSONObj source = builder.done();
    const bongo::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == bongo::BinData);
    ...
    mmb::Element a = doc.root().rightChild();
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), bongo::BinData);
    ASSERT_TRUE(a.hasValue());
    ...
    mmb::Element b = doc.root().rightChild();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), bongo::BinData);
    ASSERT_TRUE(b.hasValue());
    ...
    ASSERT_EQUALS(c.getType(), bongo::BinData);
    ASSERT_TRUE(c.hasValue());
...
TEST(TypeSupport, EncodingEquivalenceUndefined) {
    ...
    bongo::BSONObj source = builder.done();
    const bongo::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == bongo::Undefined);
    ...
    mmb::Element a = doc.root().rightChild();
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), bongo::Undefined);
    ASSERT_TRUE(a.hasValue());
    ...
    mmb::Element b = doc.root().rightChild();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), bongo::Undefined);
    ASSERT_TRUE(b.hasValue());
    ...
    ASSERT_TRUE(c.ok());
    c.setValueUndefined();
    ASSERT_EQUALS(c.getType(), bongo::Undefined);
    ASSERT_TRUE(c.hasValue());
...
TEST(TypeSupport, EncodingEquivalenceOID) {
    bongo::BSONObjBuilder builder;
    const char name[] = "thing";
    const bongo::OID value1 = bongo::OID::gen();
    builder.append(name, value1);
    bongo::BSONObj source = builder.done();
    const bongo::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == bongo::jstOID);
    ...
    mmb::Element a = doc.root().rightChild();
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), bongo::jstOID);
    ASSERT_TRUE(a.hasValue());
    ...
    mmb::Element b = doc.root().rightChild();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), bongo::jstOID);
    ASSERT_TRUE(b.hasValue());
    ...
    ASSERT_EQUALS(c.getType(), bongo::jstOID);
    ASSERT_TRUE(c.hasValue());
...
TEST(TypeSupport, EncodingEquivalenceBoolean) {
    ...
    bongo::BSONObj source = builder.done();
    const bongo::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == bongo::Bool);
    ...
    mmb::Element a = doc.root().rightChild();
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), bongo::Bool);
    ASSERT_TRUE(a.hasValue());
    ...
    mmb::Element b = doc.root().rightChild();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), bongo::Bool);
    ASSERT_TRUE(b.hasValue());
    ...
    ASSERT_EQUALS(c.getType(), bongo::Bool);
    ASSERT_TRUE(c.hasValue());
...
TEST(TypeSupport, EncodingEquivalenceDate) {
    bongo::BSONObjBuilder builder;
    const char name[] = "thing";
    const bongo::Date_t value1 = bongo::jsTime();
    builder.append(name, value1);
    bongo::BSONObj source = builder.done();
    const bongo::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == bongo::Date);
    ...
    mmb::Element a = doc.root().rightChild();
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), bongo::Date);
    ASSERT_TRUE(a.hasValue());
    ...
    mmb::Element b = doc.root().rightChild();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), bongo::Date);
    ASSERT_TRUE(b.hasValue());
    ...
    ASSERT_EQUALS(c.getType(), bongo::Date);
    ASSERT_TRUE(c.hasValue());
...
TEST(TypeSupport, EncodingEquivalenceNull) {
    ...
    bongo::BSONObj source = builder.done();
    const bongo::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == bongo::jstNULL);
    ...
    mmb::Element a = doc.root().rightChild();
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), bongo::jstNULL);
    ASSERT_TRUE(a.hasValue());
    ...
    mmb::Element b = doc.root().rightChild();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), bongo::jstNULL);
    ASSERT_TRUE(b.hasValue());
    ...
    ASSERT_TRUE(c.ok());
    c.setValueNull();
    ASSERT_EQUALS(c.getType(), bongo::jstNULL);
    ASSERT_TRUE(c.hasValue());
...
TEST(TypeSupport, EncodingEquivalenceRegex) {
    ...
    bongo::BSONObj source = builder.done();
    const bongo::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == bongo::RegEx);
    ...
    mmb::Element a = doc.root().rightChild();
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), bongo::RegEx);
    ASSERT_TRUE(a.hasValue());
    ...
    mmb::Element b = doc.root().rightChild();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), bongo::RegEx);
    ASSERT_TRUE(b.hasValue());
    ...
    ASSERT_EQUALS(c.getType(), bongo::RegEx);
    ASSERT_TRUE(c.hasValue());
...
TEST(TypeSupport, EncodingEquivalenceDBRef) {
    ...
    const bongo::OID value2 = bongo::OID::gen();
    builder.appendDBRef(name, value1, value2);
    bongo::BSONObj source = builder.done();
    const bongo::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == bongo::DBRef);
    ...
    mmb::Element a = doc.root().rightChild();
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), bongo::DBRef);
    ASSERT_TRUE(a.hasValue());
    ...
    mmb::Element b = doc.root().rightChild();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), bongo::DBRef);
    ASSERT_TRUE(b.hasValue());
    ...
    ASSERT_EQUALS(c.getType(), bongo::DBRef);
    ASSERT_TRUE(c.hasValue());
...
TEST(TypeSupport, EncodingEquivalenceCode) {
    ...
    bongo::BSONObj source = builder.done();
    const bongo::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == bongo::Code);
    ...
    mmb::Element a = doc.root().rightChild();
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), bongo::Code);
    ASSERT_TRUE(a.hasValue());
    ...
    mmb::Element b = doc.root().rightChild();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), bongo::Code);
    ASSERT_TRUE(b.hasValue());
    ...
    ASSERT_EQUALS(c.getType(), bongo::Code);
    ASSERT_TRUE(c.hasValue());
...
TEST(TypeSupport, EncodingEquivalenceSymbol) {
    ...
    bongo::BSONObj source = builder.done();
    const bongo::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == bongo::Symbol);
    ...
    mmb::Element a = doc.root().rightChild();
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), bongo::Symbol);
    ASSERT_TRUE(a.hasValue());
    ...
    mmb::Element b = doc.root().rightChild();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), bongo::Symbol);
    ASSERT_TRUE(b.hasValue());
    ...
    ASSERT_EQUALS(c.getType(), bongo::Symbol);
    ASSERT_TRUE(c.hasValue());
...
TEST(TypeSupport, EncodingEquivalenceCodeWithScope) {
    ...
    const bongo::BSONObj value2 = bongo::fromjson("{ x : 4 }");
    builder.appendCodeWScope(name, value1, value2);
    bongo::BSONObj source = builder.done();
    const bongo::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == bongo::CodeWScope);
    ...
    mmb::Element a = doc.root().rightChild();
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), bongo::CodeWScope);
    ASSERT_TRUE(a.hasValue());
    ...
    mmb::Element b = doc.root().rightChild();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), bongo::CodeWScope);
    ASSERT_TRUE(b.hasValue());
    ...
    ASSERT_EQUALS(c.getType(), bongo::CodeWScope);
    ASSERT_TRUE(c.hasValue());
...
TEST(TypeSupport, EncodingEquivalenceInt) {
    ...
    bongo::BSONObj source = builder.done();
    const bongo::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == bongo::NumberInt);
    ...
    mmb::Element a = doc.root().rightChild();
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), bongo::NumberInt);
    ASSERT_TRUE(a.hasValue());
    ...
    mmb::Element b = doc.root().rightChild();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), bongo::NumberInt);
    ASSERT_TRUE(b.hasValue());
    ...
    ASSERT_EQUALS(c.getType(), bongo::NumberInt);
    ASSERT_TRUE(c.hasValue());
...
TEST(TypeSupport, EncodingEquivalenceTimestamp) {
    bongo::BSONObjBuilder builder;
    const char name[] = "thing";
    const bongo::Timestamp value1 = bongo::Timestamp(bongo::jsTime());
    builder.append(name, value1);
    bongo::BSONObj source = builder.done();
    const bongo::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == bongo::bsonTimestamp);
    ...
    mmb::Element a = doc.root().rightChild();
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), bongo::bsonTimestamp);
    ASSERT_TRUE(a.hasValue());
    ...
    mmb::Element b = doc.root().rightChild();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), bongo::bsonTimestamp);
    ASSERT_TRUE(b.hasValue());
    ...
    ASSERT_EQUALS(c.getType(), bongo::bsonTimestamp);
    ASSERT_TRUE(c.hasValue());
...
TEST(TypeSupport, EncodingEquivalenceLong) {
    ...
    bongo::BSONObj source = builder.done();
    const bongo::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == bongo::NumberLong);
    ...
    mmb::Element a = doc.root().rightChild();
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), bongo::NumberLong);
    ASSERT_TRUE(a.hasValue());
    ...
    mmb::Element b = doc.root().rightChild();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), bongo::NumberLong);
    ASSERT_TRUE(b.hasValue());
    ...
    ASSERT_EQUALS(c.getType(), bongo::NumberLong);
    ASSERT_TRUE(c.hasValue());
...
TEST(TypeSupport, EncodingEquivalenceDecimal) {
    bongo::BSONObjBuilder builder;
    const char name[] = "thing";
    const bongo::Decimal128 value1 = bongo::Decimal128(2);
    builder.append(name, value1);
    bongo::BSONObj source = builder.done();
    const bongo::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == bongo::NumberDecimal);
    ...
    mmb::Element a = doc.root().rightChild();
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), bongo::NumberDecimal);
    ASSERT_TRUE(a.hasValue());
    ...
    mmb::Element b = doc.root().rightChild();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), bongo::NumberDecimal);
    ASSERT_TRUE(b.hasValue());
    ...
    ASSERT_EQUALS(c.getType(), bongo::NumberDecimal);
    ASSERT_TRUE(c.hasValue());
...
TEST(TypeSupport, EncodingEquivalenceMinKey) {
    ...
    bongo::BSONObj source = builder.done();
    const bongo::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == bongo::MinKey);
    ...
    mmb::Element a = doc.root().rightChild();
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), bongo::MinKey);
    ASSERT_TRUE(a.hasValue());
    ...
    mmb::Element b = doc.root().rightChild();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), bongo::MinKey);
    ASSERT_TRUE(b.hasValue());
    ...
    ASSERT_TRUE(c.ok());
    c.setValueMinKey();
    ASSERT_EQUALS(c.getType(), bongo::MinKey);
    ASSERT_TRUE(c.hasValue());
...
TEST(TypeSupport, EncodingEquivalenceMaxKey) {
    ...
    bongo::BSONObj source = builder.done();
    const bongo::BSONElement thing = source.firstElement();
    ASSERT_TRUE(thing.type() == bongo::MaxKey);
    ...
    mmb::Element a = doc.root().rightChild();
    ASSERT_TRUE(a.ok());
    ASSERT_EQUALS(a.getType(), bongo::MaxKey);
    ASSERT_TRUE(a.hasValue());
    ...
    mmb::Element b = doc.root().rightChild();
    ASSERT_TRUE(b.ok());
    ASSERT_EQUALS(b.getType(), bongo::MaxKey);
    ASSERT_TRUE(b.hasValue());
    ...
    ASSERT_TRUE(c.ok());
    c.setValueMaxKey();
    ASSERT_EQUALS(c.getType(), bongo::MaxKey);
    ASSERT_TRUE(c.hasValue());
...
TEST(Document, ManipulateComplexObjInLeafHeap) {
    ...
    mmb::Element embedded = doc.makeElementObject("embedded", bongo::fromjson(inJson));
...
TEST(DocumentInPlace, InPlaceModeIsDisabledByAddSiblingLeft) {
    bongo::BSONObj obj = bongo::fromjson("{ foo : 'foo' }");
    mmb::Document doc(obj, mmb::Document::kInPlaceEnabled);
    ASSERT_TRUE(doc.isInPlaceModeEnabled());
...
TEST(DocumentInPlace, InPlaceModeIsDisabledByIncompatibleSetValue) {
    bongo::BSONObj obj(bongo::fromjson("{ foo : false }"));
    mmb::Document doc(obj, mmb::Document::kInPlaceEnabled);
    ASSERT_TRUE(doc.isInPlaceModeEnabled());
...
TEST(DocumentInPlace, DisablingInPlaceDoesNotDiscardUpdates) {
    bongo::BSONObj obj(bongo::fromjson("{ foo : false, bar : true }"));
    mmb::Document doc(obj, mmb::Document::kInPlaceEnabled);
    ASSERT_TRUE(doc.isInPlaceModeEnabled());
...
TEST(DocumentInPlace, StringLifecycle) {
    bongo::BSONObj obj(bongo::fromjson("{ x : 'foo' }"));
    mmb::Document doc(obj, mmb::Document::kInPlaceEnabled);
    ...
    ASSERT_TRUE(x.isType(bongo::String));
...
TEST(DocumentInPlace, BinDataLifecycle) {
    ...
    const bongo::BSONBinData binData1(kData1, sizeof(kData1) - 1, bongo::BinDataGeneral);
    const bongo::BSONBinData binData2(kData2, sizeof(kData2) - 1, bongo::bdtCustom);

    bongo::BSONObj obj(BSON("x" << binData1));
    mmb::Document doc(obj, mmb::Document::kInPlaceEnabled);
    ...
    apply(&obj, damages, source);
    ASSERT_TRUE(x.hasValue());
    ASSERT_TRUE(x.isType(bongo::BinData));

    bongo::BSONElement value = x.getValue();
...
TEST(DocumentInPlace, OIDLifecycle) {
    const bongo::OID oid1 = bongo::OID::gen();
    const bongo::OID oid2 = bongo::OID::gen();
    ASSERT_NOT_EQUALS(oid1, oid2);

    bongo::BSONObj obj(BSON("x" << oid1));
    mmb::Document doc(obj, mmb::Document::kInPlaceEnabled);
    ...
    apply(&obj, damages, source);
    ASSERT_TRUE(x.hasValue());
    ASSERT_TRUE(x.isType(bongo::jstOID));
...
TEST(DocumentInPlace, BooleanLifecycle) {
    bongo::BSONObj obj(bongo::fromjson("{ x : false }"));
    mmb::Document doc(obj, mmb::Document::kInPlaceEnabled);
    ...
    apply(&obj, damages, source);
    ASSERT_TRUE(x.hasValue());
    ASSERT_TRUE(x.isType(bongo::Bool));
...
TEST(DocumentInPlace, DateLifecycle) {
    bongo::BSONObj obj(BSON("x" << bongo::Date_t::fromMillisSinceEpoch(1000)));
    mmb::Document doc(obj, mmb::Document::kInPlaceEnabled);
    ...
    x.setValueDate(bongo::Date_t::fromMillisSinceEpoch(20000));
    ASSERT_TRUE(doc.getInPlaceUpdates(&damages, &source));
    ASSERT_EQUALS(1U, damages.size());
    apply(&obj, damages, source);
    ASSERT_TRUE(x.hasValue());
    ASSERT_TRUE(x.isType(bongo::Date));
    ASSERT_EQUALS(bongo::Date_t::fromMillisSinceEpoch(20000), x.getValueDate());
...
TEST(DocumentInPlace, NumberIntLifecycle) {
    const int value1 = 42;
    const int value2 = 3;
    bongo::BSONObj obj(BSON("x" << value1));
    mmb::Document doc(obj, mmb::Document::kInPlaceEnabled);
    ...
    apply(&obj, damages, source);
    ASSERT_TRUE(x.hasValue());
    ASSERT_TRUE(x.isType(bongo::NumberInt));
...
TEST(DocumentInPlace, TimestampLifecycle) {
    bongo::BSONObj obj(BSON("x" << bongo::Timestamp(bongo::Date_t::fromMillisSinceEpoch(1000))));
    mmb::Document doc(obj, mmb::Document::kInPlaceEnabled);
    ...
    x.setValueTimestamp(bongo::Timestamp(bongo::Date_t::fromMillisSinceEpoch(20000)));
    ASSERT_TRUE(doc.getInPlaceUpdates(&damages, &source));
    ASSERT_EQUALS(1U, damages.size());
    apply(&obj, damages, source);
    ASSERT_TRUE(x.hasValue());
    ASSERT_TRUE(x.isType(bongo::bsonTimestamp));
    ASSERT_TRUE(bongo::Timestamp(20000U) == x.getValueTimestamp());
...
TEST(DocumentInPlace, NumberLongLifecycle) {
    ...
    apply(&obj, damages, source);
    ASSERT_TRUE(x.hasValue());
    ASSERT_TRUE(x.isType(bongo::NumberLong));
...
TEST(DocumentInPlace, NumberDoubleLifecycle) {
    ...
    apply(&obj, damages, source);
    ASSERT_TRUE(x.hasValue());
    ASSERT_TRUE(x.isType(bongo::NumberDouble));
...
TEST(DocumentInPlace, NumberDecimalLifecycle) {
    const bongo::Decimal128 value1 = bongo::Decimal128(32);
    const bongo::Decimal128 value2 = bongo::Decimal128(2);
    ...
    apply(&obj, damages, source);
    ASSERT_TRUE(x.hasValue());
    ASSERT_TRUE(x.isType(bongo::NumberDecimal));
...
TEST(DocumentComparison, SimpleComparison) {
    const bongo::BSONObj obj =
        bongo::fromjson("{ a : 'a', b : ['b', 'b', 'b'], c : { one : 1.0 } }");
...
TEST(DocumentComparison, DocumentCompareWithRespectsCollation) {
    bongo::CollatorInterfaceMock collator(bongo::CollatorInterfaceMock::MockType::kAlwaysEqual);
    const mmb::Document doc1(bongo::fromjson("{a: 'foo'}"));
    const mmb::Document doc2(bongo::fromjson("{a: 'bar'}"));
...
TEST(DocumentComparison, DocumentCompareWithBSONObjRespectsCollation) {
    bongo::CollatorInterfaceMock collator(bongo::CollatorInterfaceMock::MockType::kAlwaysEqual);
    const mmb::Document doc1(bongo::fromjson("{a: 'foo'}"));
    const bongo::BSONObj doc2 = bongo::fromjson("{a: 'bar'}");
    // Pass true to indicate that we should compare field names. The two documents should be unequal
    // without the collator, but equal when using the "always equal" collator.
...
TEST(DocumentComparison, ElementCompareWithBSONElementRespectsCollator) {
    ...
    const bongo::BSONObj doc2 = bongo::fromjson("{a: 'bar'}");
    const mmb::ConstElement element1 = doc1.root().leftChild();
    const bongo::BSONElement element2 = doc2["a"];
    // Pass true to indicate that we should compare field names. The two documents should be unequal
    // without the collator, but equal when using the "always equal" collator.
...
TEST(DocumentComparison, ElementCompareWithBSONObjRespectsCollator) {
    bongo::CollatorInterfaceMock collator(bongo::CollatorInterfaceMock::MockType::kAlwaysEqual);
    const mmb::Document doc1(bongo::fromjson("{b: {c: 'foo'}}"));
    const bongo::BSONObj doc2 = bongo::fromjson("{c: 'bar'}");
    const mmb::ConstElement element1 = doc1.root().leftChild();
    // Pass true to indicate that we should compare field names. The two documents should be unequal
    // without the collator, but equal when using the "always equal" collator.
...
TEST(DocumentComparison, DocumentCompareWithRespectsCollationRecursively) {
    bongo::CollatorInterfaceMock collator(bongo::CollatorInterfaceMock::MockType::kAlwaysEqual);
    const mmb::Document doc1(bongo::fromjson("{a: [{b: 'foo'}, {b: 'bar'}]}"));
    const mmb::Document doc2(bongo::fromjson("{a: [{b: 'notFoo'}, {b: 'notBar'}]}"));
    // Pass true to indicate that we should compare field names. The two documents should be unequal
    // without the collator, but equal when using the "always equal" collator.
    ASSERT_NE(0, doc1.compareWith(doc2, nullptr, true));
    ASSERT_EQ(0, doc1.compareWith(doc2, &collator, true));
...
TEST(DocumentComparison, DocumentCompareWithRespectsCollationWithDeserializedElement) {
    bongo::CollatorInterfaceMock collator(bongo::CollatorInterfaceMock::MockType::kAlwaysEqual);
    mmb::Document doc1(bongo::fromjson("{a: ['foo', 'foo']}"));
    mmb::Document doc2(bongo::fromjson("{a: ['bar', 'bar']}"));
...
TEST(UnorderedEqualityChecker, Identical) {
    const bongo::BSONObj b1 =
        bongo::fromjson("{ a : [1, 2, { 'a' : 'b', 'x' : 'y' } ], b : { x : 1, y : 2, z : 3 } }");

    const bongo::BSONObj b2 = b1.getOwned();
...
TEST(UnorderedEqualityChecker, DifferentValuesAreNotEqual) {
    const bongo::BSONObj b1 =
        bongo::fromjson("{ a : [ 1, 2, { 'a' : 'b', 'x' : 'y' } ], b : { x : 1, y : 2, z : 3 } }");
    const bongo::BSONObj b2 =
        bongo::fromjson("{ a : [ 1, 2, { 'a' : 'b', 'x' : 'y' } ], b : { x : 1, y : 2, z : 4 } }");
...
TEST(UnorderedEqualityChecker, DifferentTypesAreNotEqual) {
    const bongo::BSONObj b1 =
        bongo::fromjson("{ a : [ 1, 2, { 'a' : 'b', 'x' : 'y' } ], b : { x : 1, y : 2, z : 3 } }");
    const bongo::BSONObj b2 = bongo::fromjson(
...
TEST(UnorderedEqualityChecker, MissingFieldsInObjectAreNotEqual) {
    const bongo::BSONObj b1 =
        bongo::fromjson("{ a : [ 1, 2, { 'a' : 'b', 'x' : 'y' } ], b : { x : 1, y : 2, z : 3 } }");
    const bongo::BSONObj b2 =
        bongo::fromjson("{ a : [ 1, 2, { 'a' : 'b', 'x' : 'y' } ], b : { x : 1, z : 3 } }");
...
TEST(UnorderedEqualityChecker, ArrayOrderingIsConsidered) {
    ...
    const bongo::BSONObj b2 =
        bongo::fromjson("{ a : [ 1, { 'a' : 'b', 'x' : 'y' }, 2 ], b : { x : 1, y : 2, z : 3 } }");
...
TEST(UnorderedEqualityChecker, MissingItemsInArrayAreNotEqual) {
    const bongo::BSONObj b1 =
        bongo::fromjson("{ a : [ 1, 2, { 'a' : 'b', 'x' : 'y' } ], b : { x : 1, y : 2, z : 3 } }");
    const bongo::BSONObj b2 =
        bongo::fromjson("{ a : [ 1, { 'a' : 'b', 'x' : 'y' } ], b : { x : 1, z : 3 } }");
