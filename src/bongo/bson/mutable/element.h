...
public:
    ...
    Status setValueBinary(uint32_t len, bongo::BinDataType binType, const void* data);
    ...
    Status appendOID(StringData fieldName, bongo::OID value);
    ...
    Status appendDBRef(StringData fieldName, StringData ns, bongo::OID oid);
...
#include "bongo/bson/mutable/element-inl.h"
