 ...
 *  tree, and Elements of proper type (bongo::Object or bongo::Array) may have child
 ...
 *  for children (i.e. it represents a bongo::Array or bongo::Object) it may have child
 ...
 *  Example 1: Building up a document from scratch, reworking it, and then serializing it:
     ...
     doc.writeTo(&builder);
     bongo::BSONObj result = builder.obj();
...
class Document {
    ...
    BONGO_DISALLOW_COPYING(Document);
...
public:
    ...
    Element makeElementOID(StringData fieldName, bongo::OID value);
    ...
    Element makeElementDBRef(StringData fieldName, StringData ns, bongo::OID oid);
...
#include "bongo/bson/mutable/document-inl.h"
