...
/**
 * Represents a pool of connections to a BongoDB server. The pool is synchronized internally
...
class ConnectionPool {
    BONGO_DISALLOW_COPYING(ConnectionPool);
...
public:
     ...
     */
    class ConnectionPtr {
        BONGO_DISALLOW_COPYING(ConnectionPtr);
