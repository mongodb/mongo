...
public:
    ...
    /** Explicitly request an index of the given version. As of BongoDB 2.6, the only accepted
    ...
    /** Sets the version of the text index to use. BongoDB 2.4 only supports version
     *  '1'. If not otherwise specified, BongoDB 2.6 defaults to version 2.
     */
    ...
    /** Sets the version of the 2D sphere index to use. BongoDB 2.4 only supports version
     *  '1'. If not otherwise specified, BongoDB 2.6 defaults to version 2.
     */
