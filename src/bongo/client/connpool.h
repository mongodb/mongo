 ...
 */
class PoolForHost {
    BONGO_DISALLOW_COPYING(PoolForHost);
...
public:
    ...
    DBClientBase* get(const BongoURI& uri, double socketTimeout = 0);
...
class AScopedConnection {
    BONGO_DISALLOW_COPYING(AScopedConnection);
...
public:
    ...
    explicit ScopedDbConnection(const BongoURI& host, double socketTimeout = 0);
