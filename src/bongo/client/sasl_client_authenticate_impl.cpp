...
/**
 * This module implements the client side of SASL authentication in BongoDB, in terms of the Cyrus
 ...
 * bongo::createPasswordDigest(), this method takes care of that.
...
Status extractPassword(const BSONObj& saslParameters,
    ...
    if (digestPassword) {
        ...
        *outPassword = bongo::createPasswordDigest(user, rawPassword);
    } else {
...
BONGO_INITIALIZER(SaslClientAuthenticateFunction)(InitializerContext* context) {
