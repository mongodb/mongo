...
const char kAuthMechBongoCR[] = "BONGODB-CR";
...
std::string authKeyCopyDBBongoCR(const std::string& username,
...
BSONObj BongoURI::_makeAuthObjFromOptions(int maxWireVersion) const {
    BSONObjBuilder bob;
    ...
    if (it != _options.end()) {
        ...
        bob.append(saslCommandMechanismFieldName, kAuthMechBongoCR);
    }
...
DBClientBase* BongoURI::connect(StringData applicationName,
                                std::string& errmsg,
