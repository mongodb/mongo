...
extern const char* const kMechanismBongoCR;
extern const char* const kMechanismBongoX509;
 ...
 *         credential information is stored outside of the bongo cluster.  Mandatory.
