...
#include "bongo/client/sasl_sspi_options.h"
...
BONGO_MODULE_STARTUP_OPTIONS_REGISTER(SASLSSPIOptions)(InitializerContext* context) {
    return addSASLSSPIOptions(&moe::startupOptions);
}

BONGO_STARTUP_OPTIONS_STORE(SASLSSPIOptions)(InitializerContext* context) {
