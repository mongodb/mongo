...
TEST(ReplSetMonitorNode, PriNodeCompatibleTag) {
    ...
    ASSERT(isCompatible(node, bongo::ReadPreference::PrimaryOnly, tags));
    ASSERT(isCompatible(node, bongo::ReadPreference::PrimaryPreferred, tags));
    ASSERT(isCompatible(node, bongo::ReadPreference::SecondaryPreferred, tags));
    ASSERT(!isCompatible(node, bongo::ReadPreference::SecondaryOnly, tags));
    ASSERT(isCompatible(node, bongo::ReadPreference::Nearest, tags));
}
