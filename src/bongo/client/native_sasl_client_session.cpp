...
#include "bongo/client/native_sasl_client_session.h"

#include "bongo/base/init.h"
#include "bongo/client/sasl_client_conversation.h"
...
BONGO_INITIALIZER(NativeSaslClientContext)(InitializerContext* context) {
...
Status NativeSaslClientSession::initialize() {
    ...
    if (mechanism == "PLAIN") {
        ...
        return Status(ErrorCodes::BadValue,
                      bongoutils::str::stream() << "SASL mechanism " << mechanism
                                                << " is not supported");
    }
