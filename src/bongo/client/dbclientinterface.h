...
enum UpdateOptions {
    ...
    /** flag from bongo saying this update went everywhere */
...
*/
#define QUERY(x) ::bongo::Query(BSON(x))
...
class DBClientInterface {
    BONGO_DISALLOW_COPYING(DBClientInterface);
...
public:
    ...
    */
     ...
     *
     * TODO: remove after BongoDB 3.2 is released and replace all callers with
...
/**
    ...
    This is the main entry point for talking to a simple Bongo setup
*/
...
public:
    ...
    /**
     * Connect to a Bongo database server.
     *
    ...
    /** Connect to a Bongo database server.  Exception throwing version.
