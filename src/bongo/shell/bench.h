...
class BenchRunConfig {
    BONGO_DISALLOW_COPYING(BenchRunConfig);
...
public:
    ...
    // Create a new connection to the bongo instance specified by this configuration.
...
class BenchRunEventCounter {
    BONGO_DISALLOW_COPYING(BenchRunEventCounter);
...
class BenchRunEventTrace {
    BONGO_DISALLOW_COPYING(BenchRunEventTrace);
 ...
 */
class BenchRunStats {
    BONGO_DISALLOW_COPYING(BenchRunStats);
 ...
 */
class BenchRunState {
    BONGO_DISALLOW_COPYING(BenchRunState);
...
public:
    ...
    */
     ...
     * starts sending requests to the configured bongo instance.
     */
    void onWorkerStarted();

    /**
     * Called by each BenchRunWorker from within its thread context, shortly after it finishes
     * sending requests to the configured bongo instance.
     */
...
class BenchRunWorker {
    BONGO_DISALLOW_COPYING(BenchRunWorker);
 ...
 */
class BenchRunner {
    BONGO_DISALLOW_COPYING(BenchRunner);
