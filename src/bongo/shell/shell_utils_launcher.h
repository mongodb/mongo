// bongo/shell/shell_utils_launcher.h
/*
...
// Scoped management of bongo program instances.  Simple implementation:
// destructor kills all bongod instances created by the shell.
struct BongoProgramScope {
    BongoProgramScope() {}  // Avoid 'unused variable' warning.
    ~BongoProgramScope();
};
