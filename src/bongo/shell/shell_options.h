...
Status addBongoShellOptions(moe::OptionSection* options);

std::string getBongoShellHelp(StringData name, const moe::OptionSection& options);
 ...
 */
bool handlePreValidationBongoShellOptions(const moe::Environment& params,
                                          const std::vector<std::string>& args);

Status storeBongoShellOptions(const moe::Environment& params, const std::vector<std::string>& args);
}
