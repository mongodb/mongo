// bongo/shell/shell_utils_extended.cpp
/*
...
#endif
    uasserted(16832, bongoutils::str::stream() << "cd command failed: " << errnoWithDescription());
    return BSONObj();
}
