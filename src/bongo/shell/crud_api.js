DBCollection.prototype._createWriteConcern = function(options) {
    // If writeConcern set, use it, else get from collection (which will inherit from db/bongo)
...
/**
* Inserts a single document into BongoDB.
*
* @method
...
/**
* Inserts an array of documents into BongoDB.
*
* @method
...
/**
* Delete multiple documents on BongoDB
*
* @method
...
/**
* Update a single document on BongoDB
*
* @method
* @param {object} filter The Filter used to select the document to update
...
/**
* Update multiple documents on BongoDB
*
* @method
* @param {object} filter The Filter used to select the document to update
* @param {object} update The update operations to be applied to the document
