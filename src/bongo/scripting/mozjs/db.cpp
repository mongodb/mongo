...
#include "bongo/scripting/mozjs/db.h"

#include "bongo/db/namespace_string.h"
#include "bongo/db/operation_context.h"
#include "bongo/s/local_sharding_info.h"
#include "bongo/scripting/mozjs/idwrapper.h"
...
void DBInfo::construct(JSContext* cx, JS::CallArgs args) {
    ...
    o.setValue(InternedString::_bongo, args.get(0));
