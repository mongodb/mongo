...
const JSFunctionSpec NumberIntInfo::methods[5] = {
    BONGO_ATTACH_JS_CONSTRAINED_METHOD(toNumber, NumberIntInfo),
    BONGO_ATTACH_JS_CONSTRAINED_METHOD(toString, NumberIntInfo),
    BONGO_ATTACH_JS_CONSTRAINED_METHOD(toJSON, NumberIntInfo),
    BONGO_ATTACH_JS_CONSTRAINED_METHOD(valueOf, NumberIntInfo),
    JS_FS_END,
};
