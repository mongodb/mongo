...
#include "bongo/scripting/mozjs/numberdecimal.h"
...
const JSFunctionSpec NumberDecimalInfo::methods[3] = {
    BONGO_ATTACH_JS_CONSTRAINED_METHOD(toString, NumberDecimalInfo),
    BONGO_ATTACH_JS_CONSTRAINED_METHOD(toJSON, NumberDecimalInfo),
    JS_FS_END,
};
