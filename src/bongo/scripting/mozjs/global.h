...
struct GlobalInfo : public BaseInfo {
    struct Functions {
        BONGO_DECLARE_JS_FUNCTION(gc);
        BONGO_DECLARE_JS_FUNCTION(print);
        BONGO_DECLARE_JS_FUNCTION(version);
        BONGO_DECLARE_JS_FUNCTION(buildInfo);
        BONGO_DECLARE_JS_FUNCTION(getJSHeapLimitMB);
    };
