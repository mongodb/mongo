 ...
 * from C++. Current callers are all via the Bongo object.
 */
struct CursorInfo : public BaseInfo {
    ...
    struct Functions {
        ...
        BONGO_DECLARE_JS_FUNCTION(hasNext);
        BONGO_DECLARE_JS_FUNCTION(next);
        BONGO_DECLARE_JS_FUNCTION(objsLeftInBatch);
        BONGO_DECLARE_JS_FUNCTION(readOnly);
    };
