...
#include "bongo/scripting/mozjs/uri.h"
...
const JSFunctionSpec URIInfo::methods[2] = {
    BONGO_ATTACH_JS_CONSTRAINED_METHOD(toString, URIInfo), JS_FS_END,
};

const char* const URIInfo::className = "BongoURI";
...
void URIInfo::construct(JSContext* cx, JS::CallArgs args) {
    uassert(ErrorCodes::BadValue, "BongoURI needs 1 argument", args.length() == 1);
