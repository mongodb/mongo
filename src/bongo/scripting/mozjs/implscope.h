...
#include "bongo/scripting/mozjs/bindata.h"
#include "bongo/scripting/mozjs/bson.h"
#include "bongo/scripting/mozjs/code.h"
#include "bongo/scripting/mozjs/countdownlatch.h"
#include "bongo/scripting/mozjs/cursor.h"
#include "bongo/scripting/mozjs/cursor_handle.h"
...
#include "bongo/scripting/mozjs/dbref.h"
...
#include "bongo/scripting/mozjs/jsthread.h"
#include "bongo/scripting/mozjs/maxkey.h"
#include "bongo/scripting/mozjs/minkey.h"
#include "bongo/scripting/mozjs/bongo.h"
...
#include "bongo/scripting/mozjs/numberint.h"
#include "bongo/scripting/mozjs/numberlong.h"
#include "bongo/scripting/mozjs/object.h"
#include "bongo/scripting/mozjs/oid.h"
 ...
 * along with a number of global prototypes for bongoDB specific types. Each
 ...
 *
 * For more information about overriden fields, see bongo::Scope
 */
class MozJSImplScope final : public Scope {
    BONGO_DISALLOW_COPYING(MozJSImplScope);
...
public:
    ...
    template <typename T>
    typename std::enable_if<std::is_same<T, BongoExternalInfo>::value, WrapType<T>&>::type
    getProto() {
        return _bongoExternalProto;
    }

    template <typename T>
    typename std::enable_if<std::is_same<T, BongoHelpersInfo>::value, WrapType<T>&>::type
    getProto() {
        return _bongoHelpersProto;
    }

    template <typename T>
    typename std::enable_if<std::is_same<T, BongoLocalInfo>::value, WrapType<T>&>::type getProto() {
        return _bongoLocalProto;
    }
...
private:
    ...
    WrapType<BongoExternalInfo> _bongoExternalProto;
    WrapType<BongoHelpersInfo> _bongoHelpersProto;
    WrapType<BongoLocalInfo> _bongoLocalProto;
