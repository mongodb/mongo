...
// codegen, and turn bongo exceptions into instances of Status, then convert
...
// top level and converted back to bongo exceptions by an error handler on
// ImplScope.

// BONGO_*_JS_FUNCTION_* macros are public and allow wrapped types to install
// their own functions on types and into the global scope
#define BONGO_DECLARE_JS_FUNCTION(function)                 \
    struct function {                                       \
...
#define BONGO_ATTACH_JS_FUNCTION_WITH_FLAGS(name, flags) \
    JS_FS(#name, smUtils::wrapFunction<Functions::name>, 0, flags)

#define BONGO_ATTACH_JS_FUNCTION(name) BONGO_ATTACH_JS_FUNCTION_WITH_FLAGS(name, 0)

#define BONGO_ATTACH_JS_CONSTRAINED_METHOD(name, ...)                                              \
    {                                                                                              \
...
#define BONGO_ATTACH_JS_CONSTRAINED_METHOD_NO_PROTO(name, ...)                                    \
    {                                                                                             \
