...
#include "bongo/scripting/mozjs/countdownlatch.h"
...
const JSFunctionSpec CountDownLatchInfo::methods[5] = {
    BONGO_ATTACH_JS_FUNCTION(_new),
    BONGO_ATTACH_JS_FUNCTION(_await),
    BONGO_ATTACH_JS_FUNCTION(_countDown),
    BONGO_ATTACH_JS_FUNCTION(_getCount),
    JS_FS_END,
};
