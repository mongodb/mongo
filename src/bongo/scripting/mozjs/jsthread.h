...
struct JSThreadInfo : public BaseInfo {
    ...
    struct Functions {
        BONGO_DECLARE_JS_FUNCTION(init);
        BONGO_DECLARE_JS_FUNCTION(start);
        BONGO_DECLARE_JS_FUNCTION(join);
        BONGO_DECLARE_JS_FUNCTION(hasFailed);
        BONGO_DECLARE_JS_FUNCTION(returnData);

        BONGO_DECLARE_JS_FUNCTION(_threadInject);
        BONGO_DECLARE_JS_FUNCTION(_scopedThreadInject);
    };
