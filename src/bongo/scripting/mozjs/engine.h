 ...
 */
class MozJSScriptEngine final : public bongo::ScriptEngine {
public:
    MozJSScriptEngine();
    ~MozJSScriptEngine() override;

    bongo::Scope* createScope() override;
    bongo::Scope* createScopeForCurrentThread() override;
...
private:
    ...
    OpIdToScopeMap _opToScopeMap;  // map of bongo op ids to scopes (protected by
