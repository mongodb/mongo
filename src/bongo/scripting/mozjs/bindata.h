...
struct BinDataInfo : public BaseInfo {
    ...
    struct Functions {
        BONGO_DECLARE_JS_FUNCTION(base64);
        BONGO_DECLARE_JS_FUNCTION(hex);
        BONGO_DECLARE_JS_FUNCTION(toString);
        BONGO_DECLARE_JS_FUNCTION(toJSON);

        BONGO_DECLARE_JS_FUNCTION(HexData);
        BONGO_DECLARE_JS_FUNCTION(MD5);
        BONGO_DECLARE_JS_FUNCTION(UUID);
    };
