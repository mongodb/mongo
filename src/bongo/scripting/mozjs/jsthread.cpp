...
const JSFunctionSpec JSThreadInfo::threadMethods[6] = {
    BONGO_ATTACH_JS_FUNCTION(init),
    BONGO_ATTACH_JS_FUNCTION(start),
    BONGO_ATTACH_JS_FUNCTION(join),
    BONGO_ATTACH_JS_FUNCTION(hasFailed),
    BONGO_ATTACH_JS_FUNCTION(returnData),
    JS_FS_END,
};

const JSFunctionSpec JSThreadInfo::freeFunctions[3] = {
    BONGO_ATTACH_JS_FUNCTION(_threadInject),
    BONGO_ATTACH_JS_FUNCTION(_scopedThreadInject),
    JS_FS_END,
};
