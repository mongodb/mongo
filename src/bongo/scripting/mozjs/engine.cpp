...
BONGO_EXPORT_SERVER_PARAMETER(disableJavaScriptJIT, bool, false);
BONGO_EXPORT_SERVER_PARAMETER(javascriptProtection, bool, false);
BONGO_EXPORT_SERVER_PARAMETER(jsHeapLimitMB, int, 1100);
...
bongo::Scope* MozJSScriptEngine::createScope() {
    return new MozJSProxyScope(this);
}

bongo::Scope* MozJSScriptEngine::createScopeForCurrentThread() {
