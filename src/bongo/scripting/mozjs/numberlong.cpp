...
const JSFunctionSpec NumberLongInfo::methods[6] = {
    BONGO_ATTACH_JS_CONSTRAINED_METHOD(toNumber, NumberLongInfo),
    BONGO_ATTACH_JS_CONSTRAINED_METHOD(toString, NumberLongInfo),
    BONGO_ATTACH_JS_CONSTRAINED_METHOD(toJSON, NumberLongInfo),
    BONGO_ATTACH_JS_CONSTRAINED_METHOD(valueOf, NumberLongInfo),
    BONGO_ATTACH_JS_CONSTRAINED_METHOD(compare, NumberLongInfo),
    JS_FS_END};
