...
#define	WT_FILE_TYPE_CHECKPOINT				0x00000008
#define	WT_FILE_TYPE_DATA				0x00000004
#define	WT_FILE_TYPE_DIRECTORY				0x00000002
...
#define	WT_SESSION_CAN_WAIT				0x00002000
#define	WT_SESSION_DISCARD_FORCE			0x00001000
#define	WT_SESSION_HANDLE_LIST_LOCKED			0x00000800
#define	WT_SESSION_INTERNAL				0x00000400
...
#define	WT_SESSION_NO_DATA_HANDLES			0x00000040
#define	WT_SESSION_NO_LOGGING				0x00000020
#define	WT_SESSION_NO_SCHEMA_LOCK			0x00000010
#define	WT_SESSION_SALVAGE_CORRUPT_OK			0x00000008
#define	WT_SESSION_SCHEMA_LOCKED			0x00000004
#define	WT_SESSION_SERVER_ASYNC				0x00000002
#define	WT_SESSION_TABLE_LOCKED				0x00000001
