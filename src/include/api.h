...
#define	WT_VERB_EVICT					0x00000080
#define	WT_VERB_FILEOPS					0x00000040
#define	WT_VERB_HAZARD					0x00000020
#define	WT_VERB_MUTEX					0x00000010
#define	WT_VERB_READ					0x00000008
#define	WT_VERB_READSERVER				0x00000004
