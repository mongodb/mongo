...
#define	WT_VERB_FILEOPS					0x00000010
#define	WT_VERB_HAZARD					0x00000008
#define	WT_VERB_MUTEX					0x00000004
#define	WT_VERB_READ					0x00000002
#define	WT_VERB_SALVAGE					0x00000001
