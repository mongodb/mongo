...
struct __wt_cursor_btree {
	...
	/*
	 * A temporary buffer with three uses: caching RLE values for
	 * column-store files, caching the last-returned keys for row-store
	 * files and caching metadata cursor values.
	 */
	WT_ITEM tmp;
