...
extern int __wt_las_remove_block(WT_SESSION_IMPL *session, WT_CURSOR *cursor_arg, uint32_t btree_id, const uint8_t *addr, size_t addr_size);
...
extern int __wt_las_cursor(WT_SESSION_IMPL *session, WT_CURSOR **cursorp, int *reset_evict);
extern int __wt_las_cursor_close( 	WT_SESSION_IMPL *session, WT_CURSOR **cursorp, int reset_evict);
