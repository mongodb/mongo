...
extern int __wt_las_search(WT_SESSION_IMPL *session, WT_ITEM *key, WT_ITEM *value);
extern int __wt_las_remove(WT_SESSION_IMPL *session, WT_ITEM *key);
extern int __wt_las_remove_block( WT_SESSION_IMPL *session, const uint8_t *addr, size_t addr_size);
