...
extern int __wt_log_acquire(WT_SESSION_IMPL *session, uint64_t recsize, WT_LOGSLOT *slot, int *closep);
...
extern int __wt_log_slot_switch(WT_SESSION_IMPL *session, wt_off_t new_offset);
...
extern int64_t __wt_log_slot_release(WT_LOGSLOT *slot, int64_t size);
