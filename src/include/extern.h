...
extern int __wt_ext_config_scan_next( WT_EXTENSION_API *wt_api,
    ...
    WT_CONFIG_ITEM *key,
    WT_CONFIG_ITEM *value);
extern void __wt_conn_remove_collator(WT_CONNECTION_IMPL *conn,
    WT_NAMED_COLLATOR *ncoll);
extern void __wt_conn_remove_compressor( WT_CONNECTION_IMPL *conn,
    WT_NAMED_COMPRESSOR *ncomp);
extern void __wt_conn_remove_data_source( WT_CONNECTION_IMPL *conn,
