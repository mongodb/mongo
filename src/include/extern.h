...
extern int __wt_encryptor_confchk(WT_SESSION_IMPL *session, WT_CONFIG_ITEM *cval);
extern int __wt_encryptor_config(WT_SESSION_IMPL *session, const char *uri, WT_CONFIG_ITEM *cval, WT_CONFIG_ITEM *passval, WT_ENCRYPTOR **encryptorp, int *ownp);
