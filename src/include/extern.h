...
extern int __wt_block_addr_to_buffer(WT_BLOCK *block, uint8_t **pp, off_t offset, uint32_t size, uint32_t cksum);
extern int __wt_block_buffer_to_addr(WT_BLOCK *block, const uint8_t *p, off_t *offsetp, uint32_t *sizep, uint32_t *cksump);
extern int __wt_block_addr_valid(WT_SESSION_IMPL *session, WT_BLOCK *block, const uint8_t *addr, size_t addr_size);
...
extern int __wt_block_misplaced(WT_SESSION_IMPL *session, WT_BLOCK *block, const char *tag, off_t offset, uint32_t size, int live);
extern int __wt_block_off_remove_overlap( WT_SESSION_IMPL *session, WT_EXTLIST *el, off_t off, off_t size);
extern int __wt_block_alloc( WT_SESSION_IMPL *session, WT_BLOCK *block, off_t *offp, off_t size);
extern int __wt_block_free(WT_SESSION_IMPL *session, WT_BLOCK *block, const uint8_t *addr, size_t addr_size);
extern int __wt_block_off_free( WT_SESSION_IMPL *session, WT_BLOCK *block, off_t offset, off_t size);
...
extern int __wt_block_insert_ext( WT_SESSION_IMPL *session, WT_EXTLIST *el, off_t off, off_t size);
extern int __wt_block_extlist_read_avail( WT_SESSION_IMPL *session, WT_BLOCK *block, WT_EXTLIST *el, off_t ckpt_size);
extern int __wt_block_extlist_read( WT_SESSION_IMPL *session, WT_BLOCK *block, WT_EXTLIST *el, off_t ckpt_size);
...
extern int __wt_block_map( WT_SESSION_IMPL *session, WT_BLOCK *block, void *mapp, size_t *maplenp);
extern int __wt_block_unmap( WT_SESSION_IMPL *session, WT_BLOCK *block, void *map, size_t maplen);
...
extern int __wt_block_read_off_blind( WT_SESSION_IMPL *session, WT_BLOCK *block, WT_ITEM *buf, off_t offset);
extern int __wt_block_read_off(WT_SESSION_IMPL *session, WT_BLOCK *block, WT_ITEM *buf, off_t offset, uint32_t size, uint32_t cksum);
...
extern int __wt_block_offset_invalid(WT_BLOCK *block, off_t offset, uint32_t size);
...
extern int __wt_block_write_off(WT_SESSION_IMPL *session, WT_BLOCK *block, WT_ITEM *buf, off_t *offsetp, uint32_t *sizep, uint32_t *cksump, int data_cksum, int locked);
...
extern int __wt_debug_offset_blind( WT_SESSION_IMPL *session, off_t offset, const char *ofile);
extern int __wt_debug_offset(WT_SESSION_IMPL *session, off_t offset, uint32_t size, uint32_t cksum, const char *ofile);
...
extern int __wt_lsm_tree_lock( WT_SESSION_IMPL *session, WT_LSM_TREE *lsm_tree, int exclusive);
extern int __wt_lsm_tree_unlock( WT_SESSION_IMPL *session, WT_LSM_TREE *lsm_tree);
...
extern int __wt_fallocate(WT_SESSION_IMPL *session, WT_FH *fh, off_t offset, off_t len);
extern int __wt_filesize(WT_SESSION_IMPL *session, WT_FH *fh, off_t *sizep);
extern int __wt_filesize_name(WT_SESSION_IMPL *session, const char *filename, off_t *sizep);
...
extern int __wt_mmap(WT_SESSION_IMPL *session, WT_FH *fh, void *mapp, size_t *lenp);
...
extern int __wt_munmap(WT_SESSION_IMPL *session, WT_FH *fh, void *map, size_t len);
...
extern int __wt_read( WT_SESSION_IMPL *session, WT_FH *fh, off_t offset, size_t len, void *buf);
extern int __wt_write(WT_SESSION_IMPL *session, WT_FH *fh, off_t offset, size_t len, const void *buf);
