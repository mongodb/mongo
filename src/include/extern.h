...
extern int __wt_cache_full_check(WT_SESSION_IMPL *session, int busy, int *didworkp);
...
extern int __wt_evict_page_clean_update( WT_SESSION_IMPL *session, WT_REF *ref, int exclusive);
