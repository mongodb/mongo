...
#define	WT_STAT_DB_ERRCALL_GET			   19
#define	WT_STAT_DB_ERRCALL_SET			   20
#define	WT_STAT_DB_ERRFILE_GET			   21
#define	WT_STAT_DB_ERRFILE_SET			   22
#define	WT_STAT_DB_ERRPFX_GET			   23
#define	WT_STAT_DB_ERRPFX_SET			   24
#define	WT_STAT_DB_HUFFMAN_SET			   25
#define	WT_STAT_DB_OPEN				   26
#define	WT_STAT_DB_ROW_DEL			   27
#define	WT_STAT_DB_ROW_GET			   28
#define	WT_STAT_DB_ROW_PUT			   29
#define	WT_STAT_DB_STAT_CLEAR			   30
#define	WT_STAT_DB_STAT_PRINT			   31
#define	WT_STAT_DB_SYNC				   32
#define	WT_STAT_DB_VERIFY			   33
#define	WT_STAT_ENV_CACHE_HASH_SIZE_GET		   34
#define	WT_STAT_ENV_CACHE_HASH_SIZE_SET		   35
#define	WT_STAT_ENV_CACHE_SIZE_GET		   36
#define	WT_STAT_ENV_CACHE_SIZE_SET		   37
#define	WT_STAT_ENV_CLOSE			   38
#define	WT_STAT_ENV_DB				   39
#define	WT_STAT_ENV_ERRCALL_GET			   40
#define	WT_STAT_ENV_ERRCALL_SET			   41
#define	WT_STAT_ENV_ERRFILE_GET			   42
#define	WT_STAT_ENV_ERRFILE_SET			   43
#define	WT_STAT_ENV_ERRPFX_GET			   44
#define	WT_STAT_ENV_ERRPFX_SET			   45
#define	WT_STAT_ENV_HAZARD_SIZE_GET		   46
#define	WT_STAT_ENV_HAZARD_SIZE_SET		   47
#define	WT_STAT_ENV_MSGCALL_GET			   48
#define	WT_STAT_ENV_MSGCALL_SET			   49
#define	WT_STAT_ENV_MSGFILE_GET			   50
#define	WT_STAT_ENV_MSGFILE_SET			   51
#define	WT_STAT_ENV_OPEN			   52
#define	WT_STAT_ENV_STAT_CLEAR			   53
#define	WT_STAT_ENV_STAT_PRINT			   54
#define	WT_STAT_ENV_SYNC			   55
#define	WT_STAT_ENV_TOC				   56
#define	WT_STAT_ENV_TOC_SIZE_GET		   57
#define	WT_STAT_ENV_TOC_SIZE_SET		   58
#define	WT_STAT_ENV_VERBOSE_GET			   59
#define	WT_STAT_ENV_VERBOSE_SET			   60
#define	WT_STAT_WT_TOC_CLOSE			   61
