...
/*
 * Do not clear the DB handle in the ENV schedule macro, we may be doing
 * an ENV call from within a DB call.
 */
...
#define	wt_args_db_bulk_load_unpack\
	DB *db = toc->db;\
	u_int32_t flags =\
	    ((wt_args_db_bulk_load *)(toc->argp))->flags;\
	int (*cb)(DB *, DBT **, DBT **) =\
	    ((wt_args_db_bulk_load *)(toc->argp))->cb
...
#define	wt_args_db_close_unpack\
	DB *db = toc->db;\
	u_int32_t flags =\
	    ((wt_args_db_close *)(toc->argp))->flags
...
#define	wt_args_db_destroy_unpack\
	DB *db = toc->db;\
	u_int32_t flags =\
	    ((wt_args_db_destroy *)(toc->argp))->flags
...
#define	wt_args_db_dump_unpack\
	DB *db = toc->db;\
	FILE *stream =\
	    ((wt_args_db_dump *)(toc->argp))->stream;\
	u_int32_t flags =\
	    ((wt_args_db_dump *)(toc->argp))->flags

#define	WT_OP_DB_GET_BTREE_COMPARE	5
typedef struct {
...
#define	wt_args_db_get_btree_compare_unpack\
	DB *db = toc->db;\
	int (**btree_compare)(DB *, const DBT *, const DBT *) =\
	    ((wt_args_db_get_btree_compare *)(toc->argp))->btree_compare

#define	WT_OP_DB_GET_BTREE_COMPARE_INT	6
typedef struct {
...
#define	wt_args_db_get_btree_compare_int_unpack\
	DB *db = toc->db;\
	int *btree_compare_int =\
	    ((wt_args_db_get_btree_compare_int *)(toc->argp))->btree_compare_int

#define	WT_OP_DB_GET_BTREE_DUP_COMPARE	7
typedef struct {
...
#define	wt_args_db_get_btree_dup_compare_unpack\
	DB *db = toc->db;\
	int (**btree_dup_compare)(DB *, const DBT *, const DBT *) =\
	    ((wt_args_db_get_btree_dup_compare *)(toc->argp))->btree_dup_compare

#define	WT_OP_DB_GET_BTREE_DUP_OFFPAGE	8
typedef struct {
...
#define	wt_args_db_get_btree_dup_offpage_unpack\
	DB *db = toc->db;\
	u_int32_t *btree_dup_offpage =\
	    ((wt_args_db_get_btree_dup_offpage *)(toc->argp))->btree_dup_offpage

#define	WT_OP_DB_GET_BTREE_ITEMSIZE	9
typedef struct {
...
#define	wt_args_db_get_btree_itemsize_unpack\
	DB *db = toc->db;\
	u_int32_t *intlitemsize =\
	    ((wt_args_db_get_btree_itemsize *)(toc->argp))->intlitemsize;\
	u_int32_t *leafitemsize =\
	    ((wt_args_db_get_btree_itemsize *)(toc->argp))->leafitemsize

#define	WT_OP_DB_GET_BTREE_PAGESIZE	10
typedef struct {
	u_int32_t *allocsize;
	u_int32_t *intlsize;
	u_int32_t *leafsize;
...
#define	wt_args_db_get_btree_pagesize_unpack\
	DB *db = toc->db;\
	u_int32_t *allocsize =\
	    ((wt_args_db_get_btree_pagesize *)(toc->argp))->allocsize;\
	u_int32_t *intlsize =\
	    ((wt_args_db_get_btree_pagesize *)(toc->argp))->intlsize;\
	u_int32_t *leafsize =\
	    ((wt_args_db_get_btree_pagesize *)(toc->argp))->leafsize;\
	u_int32_t *extsize =\
	    ((wt_args_db_get_btree_pagesize *)(toc->argp))->extsize

#define	WT_OP_DB_GET_ERRCALL	11
typedef struct {
...
#define	wt_args_db_get_errcall_unpack\
	DB *db = toc->db;\
	void (**errcall)(const DB *, const char *) =\
	    ((wt_args_db_get_errcall *)(toc->argp))->errcall

#define	WT_OP_DB_GET_ERRFILE	12
typedef struct {
	FILE **errfile;
...
#define	wt_args_db_get_errfile_unpack\
	DB *db = toc->db;\
	FILE **errfile =\
	    ((wt_args_db_get_errfile *)(toc->argp))->errfile

#define	WT_OP_DB_GET_ERRPFX	13
typedef struct {
	const char **errpfx;
...
#define	wt_args_db_get_errpfx_unpack\
	DB *db = toc->db;\
	const char **errpfx =\
	    ((wt_args_db_get_errpfx *)(toc->argp))->errpfx

#define	WT_OP_DB_GET_RECNO_STOC	14
typedef struct {
	u_int64_t recno;
	DBT *key;
	DBT *pkey;
	DBT *data;
	u_int32_t flags;
} wt_args_db_get_recno_stoc;
#define	wt_args_db_get_recno_stoc_pack\
	args.recno = recno;\
	args.key = key;\
	args.pkey = pkey;\
	args.data = data;\
	args.flags = flags
#define	wt_args_db_get_recno_stoc_unpack\
	DB *db = toc->db;\
	u_int64_t recno =\
	    ((wt_args_db_get_recno_stoc *)(toc->argp))->recno;\
	DBT *key =\
	    ((wt_args_db_get_recno_stoc *)(toc->argp))->key;\
	DBT *pkey =\
	    ((wt_args_db_get_recno_stoc *)(toc->argp))->pkey;\
	DBT *data =\
	    ((wt_args_db_get_recno_stoc *)(toc->argp))->data;\
	u_int32_t flags =\
	    ((wt_args_db_get_recno_stoc *)(toc->argp))->flags

#define	WT_OP_DB_GET_STOC	15
typedef struct {
	DBT *key;
	DBT *pkey;
	DBT *data;
...
#define	wt_args_db_get_stoc_pack\
	args.key = key;\
	args.pkey = pkey;\
	args.data = data;\
	args.flags = flags
#define	wt_args_db_get_stoc_unpack\
	DB *db = toc->db;\
	DBT *key =\
	    ((wt_args_db_get_stoc *)(toc->argp))->key;\
	DBT *pkey =\
	    ((wt_args_db_get_stoc *)(toc->argp))->pkey;\
	DBT *data =\
	    ((wt_args_db_get_stoc *)(toc->argp))->data;\
	u_int32_t flags =\
	    ((wt_args_db_get_stoc *)(toc->argp))->flags
...
#define	wt_args_db_open_unpack\
	DB *db = toc->db;\
	const char *dbname =\
	    ((wt_args_db_open *)(toc->argp))->dbname;\
	mode_t mode =\
	    ((wt_args_db_open *)(toc->argp))->mode;\
	u_int32_t flags =\
	    ((wt_args_db_open *)(toc->argp))->flags
...
#define	wt_args_db_set_btree_compare_unpack\
	DB *db = toc->db;\
	int (*btree_compare)(DB *, const DBT *, const DBT *) =\
	    ((wt_args_db_set_btree_compare *)(toc->argp))->btree_compare
...
#define	wt_args_db_set_btree_compare_int_unpack\
	DB *db = toc->db;\
	int btree_compare_int =\
	    ((wt_args_db_set_btree_compare_int *)(toc->argp))->btree_compare_int
...
#define	wt_args_db_set_btree_dup_compare_unpack\
	DB *db = toc->db;\
	int (*btree_dup_compare)(DB *, const DBT *, const DBT *) =\
	    ((wt_args_db_set_btree_dup_compare *)(toc->argp))->btree_dup_compare
...
#define	wt_args_db_set_btree_dup_offpage_unpack\
	DB *db = toc->db;\
	u_int32_t btree_dup_offpage =\
	    ((wt_args_db_set_btree_dup_offpage *)(toc->argp))->btree_dup_offpage
...
#define	wt_args_db_set_btree_itemsize_unpack\
	DB *db = toc->db;\
	u_int32_t intlitemsize =\
	    ((wt_args_db_set_btree_itemsize *)(toc->argp))->intlitemsize;\
	u_int32_t leafitemsize =\
	    ((wt_args_db_set_btree_itemsize *)(toc->argp))->leafitemsize
...
#define	wt_args_db_set_btree_pagesize_unpack\
	DB *db = toc->db;\
	u_int32_t allocsize =\
	    ((wt_args_db_set_btree_pagesize *)(toc->argp))->allocsize;\
	u_int32_t intlsize =\
	    ((wt_args_db_set_btree_pagesize *)(toc->argp))->intlsize;\
	u_int32_t leafsize =\
	    ((wt_args_db_set_btree_pagesize *)(toc->argp))->leafsize;\
	u_int32_t extsize =\
	    ((wt_args_db_set_btree_pagesize *)(toc->argp))->extsize
...
#define	wt_args_db_set_errcall_unpack\
	DB *db = toc->db;\
	void (*errcall)(const DB *, const char *) =\
	    ((wt_args_db_set_errcall *)(toc->argp))->errcall
...
#define	wt_args_db_set_errfile_unpack\
	DB *db = toc->db;\
	FILE *errfile =\
	    ((wt_args_db_set_errfile *)(toc->argp))->errfile
...
#define	wt_args_db_set_errpfx_unpack\
	DB *db = toc->db;\
	const char *errpfx =\
	    ((wt_args_db_set_errpfx *)(toc->argp))->errpfx
...
#define	wt_args_db_stat_clear_unpack\
	DB *db = toc->db;\
	u_int32_t flags =\
	    ((wt_args_db_stat_clear *)(toc->argp))->flags
...
#define	wt_args_db_stat_print_unpack\
	DB *db = toc->db;\
	FILE * stream =\
	    ((wt_args_db_stat_print *)(toc->argp))->stream;\
	u_int32_t flags =\
	    ((wt_args_db_stat_print *)(toc->argp))->flags
...
#define	wt_args_db_sync_unpack\
	DB *db = toc->db;\
	u_int32_t flags =\
	    ((wt_args_db_sync *)(toc->argp))->flags
...
#define	wt_args_db_verify_unpack\
	DB *db = toc->db;\
	u_int32_t flags =\
	    ((wt_args_db_verify *)(toc->argp))->flags
...
#define	wt_args_env_close_unpack\
	ENV *env = toc->env;\
	u_int32_t flags =\
	    ((wt_args_env_close *)(toc->argp))->flags
...
#define	wt_args_env_db_create_unpack\
	ENV *env = toc->env;\
	u_int32_t flags =\
	    ((wt_args_env_db_create *)(toc->argp))->flags;\
	DB **dbp =\
	    ((wt_args_env_db_create *)(toc->argp))->dbp
...
#define	wt_args_env_get_cachesize_unpack\
	ENV *env = toc->env;\
	u_int32_t *cachesize =\
	    ((wt_args_env_get_cachesize *)(toc->argp))->cachesize
...
#define	wt_args_env_get_errcall_unpack\
	ENV *env = toc->env;\
	void (**errcall)(const ENV *, const char *) =\
	    ((wt_args_env_get_errcall *)(toc->argp))->errcall
...
#define	wt_args_env_get_errfile_unpack\
	ENV *env = toc->env;\
	FILE **errfile =\
	    ((wt_args_env_get_errfile *)(toc->argp))->errfile
...
#define	wt_args_env_get_errpfx_unpack\
	ENV *env = toc->env;\
	const char **errpfx =\
	    ((wt_args_env_get_errpfx *)(toc->argp))->errpfx
...
#define	wt_args_env_get_verbose_unpack\
	ENV *env = toc->env;\
	u_int32_t *verbose =\
	    ((wt_args_env_get_verbose *)(toc->argp))->verbose
...
#define	wt_args_env_open_unpack\
	ENV *env = toc->env;\
	const char *home =\
	    ((wt_args_env_open *)(toc->argp))->home;\
	mode_t mode =\
	    ((wt_args_env_open *)(toc->argp))->mode;\
	u_int32_t flags =\
	    ((wt_args_env_open *)(toc->argp))->flags
...
#define	wt_args_env_set_cachesize_unpack\
	ENV *env = toc->env;\
	u_int32_t cachesize =\
	    ((wt_args_env_set_cachesize *)(toc->argp))->cachesize
...
#define	wt_args_env_set_errcall_unpack\
	ENV *env = toc->env;\
	void (*errcall)(const ENV *, const char *) =\
	    ((wt_args_env_set_errcall *)(toc->argp))->errcall
...
#define	wt_args_env_set_errfile_unpack\
	ENV *env = toc->env;\
	FILE *errfile =\
	    ((wt_args_env_set_errfile *)(toc->argp))->errfile
...
#define	wt_args_env_set_errpfx_unpack\
	ENV *env = toc->env;\
	const char *errpfx =\
	    ((wt_args_env_set_errpfx *)(toc->argp))->errpfx
...
#define	wt_args_env_set_verbose_unpack\
	ENV *env = toc->env;\
	u_int32_t verbose =\
	    ((wt_args_env_set_verbose *)(toc->argp))->verbose
...
#define	wt_args_env_stat_clear_unpack\
	ENV *env = toc->env;\
	u_int32_t flags =\
	    ((wt_args_env_stat_clear *)(toc->argp))->flags
...
#define	wt_args_env_stat_print_unpack\
	ENV *env = toc->env;\
	FILE *stream =\
	    ((wt_args_env_stat_print *)(toc->argp))->stream;\
	u_int32_t flags =\
	    ((wt_args_env_stat_print *)(toc->argp))->flags
