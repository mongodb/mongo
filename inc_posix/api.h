...
#define	wt_args_env_toc_sched(oparg)\
	...
	toc->env = env;\
	toc->argp = &args;\
	return (__wt_env_toc_sched(toc, WT_PSTOC_MASTER))
...
#define	wt_args_db_bulk_load_unpack\
	DB *db = stoc->db;\
	u_int32_t flags =\
	    ((wt_args_db_bulk_load *)(stoc->toc->argp))->flags;\
	int (*cb)(DB *, DBT **, DBT **) =\
	    ((wt_args_db_bulk_load *)(stoc->toc->argp))->cb
...
#define	wt_args_db_close_unpack\
	DB *db = stoc->db;\
	u_int32_t flags =\
	    ((wt_args_db_close *)(stoc->toc->argp))->flags
...
#define	wt_args_db_destroy_unpack\
	DB *db = stoc->db;\
	u_int32_t flags =\
	    ((wt_args_db_destroy *)(stoc->toc->argp))->flags
...
#define	wt_args_db_dump_unpack\
	DB *db = stoc->db;\
	FILE *stream =\
	    ((wt_args_db_dump *)(stoc->toc->argp))->stream;\
	u_int32_t flags =\
	    ((wt_args_db_dump *)(stoc->toc->argp))->flags
...
#define	wt_args_db_get_unpack\
	DB *db = stoc->db;\
	DBT *key =\
	    ((wt_args_db_get *)(stoc->toc->argp))->key;\
	DBT *pkey =\
	    ((wt_args_db_get *)(stoc->toc->argp))->pkey;\
	DBT *data =\
	    ((wt_args_db_get *)(stoc->toc->argp))->data;\
	u_int32_t flags =\
	    ((wt_args_db_get *)(stoc->toc->argp))->flags
...
#define	wt_args_db_get_btree_compare_unpack\
	DB *db = stoc->db;\
	int (**btree_compare)(DB *, const DBT *, const DBT *) =\
	    ((wt_args_db_get_btree_compare *)(stoc->toc->argp))->btree_compare
...
#define	wt_args_db_get_btree_compare_int_unpack\
	DB *db = stoc->db;\
	int *btree_compare_int =\
	    ((wt_args_db_get_btree_compare_int *)(stoc->toc->argp))->btree_compare_int
...
#define	wt_args_db_get_btree_dup_compare_unpack\
	DB *db = stoc->db;\
	int (**btree_dup_compare)(DB *, const DBT *, const DBT *) =\
	    ((wt_args_db_get_btree_dup_compare *)(stoc->toc->argp))->btree_dup_compare
...
#define	wt_args_db_get_btree_dup_offpage_unpack\
	DB *db = stoc->db;\
	u_int32_t *btree_dup_offpage =\
	    ((wt_args_db_get_btree_dup_offpage *)(stoc->toc->argp))->btree_dup_offpage
...
#define	wt_args_db_get_btree_itemsize_unpack\
	DB *db = stoc->db;\
	u_int32_t *intlitemsize =\
	    ((wt_args_db_get_btree_itemsize *)(stoc->toc->argp))->intlitemsize;\
	u_int32_t *leafitemsize =\
	    ((wt_args_db_get_btree_itemsize *)(stoc->toc->argp))->leafitemsize
...
#define	wt_args_db_get_btree_pagesize_unpack\
	DB *db = stoc->db;\
	u_int32_t *allocsize =\
	    ((wt_args_db_get_btree_pagesize *)(stoc->toc->argp))->allocsize;\
	u_int32_t *intlsize =\
	    ((wt_args_db_get_btree_pagesize *)(stoc->toc->argp))->intlsize;\
	u_int32_t *leafsize =\
	    ((wt_args_db_get_btree_pagesize *)(stoc->toc->argp))->leafsize;\
	u_int32_t *extsize =\
	    ((wt_args_db_get_btree_pagesize *)(stoc->toc->argp))->extsize
...
#define	wt_args_db_get_errcall_unpack\
	DB *db = stoc->db;\
	void (**errcall)(const DB *, const char *) =\
	    ((wt_args_db_get_errcall *)(stoc->toc->argp))->errcall
...
#define	wt_args_db_get_errfile_unpack\
	DB *db = stoc->db;\
	FILE **errfile =\
	    ((wt_args_db_get_errfile *)(stoc->toc->argp))->errfile
...
#define	wt_args_db_get_errpfx_unpack\
	DB *db = stoc->db;\
	const char **errpfx =\
	    ((wt_args_db_get_errpfx *)(stoc->toc->argp))->errpfx
...
#define	wt_args_db_get_recno_unpack\
	DB *db = stoc->db;\
	u_int64_t recno =\
	    ((wt_args_db_get_recno *)(stoc->toc->argp))->recno;\
	DBT *key =\
	    ((wt_args_db_get_recno *)(stoc->toc->argp))->key;\
	DBT *pkey =\
	    ((wt_args_db_get_recno *)(stoc->toc->argp))->pkey;\
	DBT *data =\
	    ((wt_args_db_get_recno *)(stoc->toc->argp))->data;\
	u_int32_t flags =\
	    ((wt_args_db_get_recno *)(stoc->toc->argp))->flags
...
#define	wt_args_db_open_unpack\
	DB *db = stoc->db;\
	const char *dbname =\
	    ((wt_args_db_open *)(stoc->toc->argp))->dbname;\
	mode_t mode =\
	    ((wt_args_db_open *)(stoc->toc->argp))->mode;\
	u_int32_t flags =\
	    ((wt_args_db_open *)(stoc->toc->argp))->flags
...
#define	wt_args_db_set_btree_compare_unpack\
	DB *db = stoc->db;\
	int (*btree_compare)(DB *, const DBT *, const DBT *) =\
	    ((wt_args_db_set_btree_compare *)(stoc->toc->argp))->btree_compare
...
#define	wt_args_db_set_btree_compare_int_unpack\
	DB *db = stoc->db;\
	int btree_compare_int =\
	    ((wt_args_db_set_btree_compare_int *)(stoc->toc->argp))->btree_compare_int
...
#define	wt_args_db_set_btree_dup_compare_unpack\
	DB *db = stoc->db;\
	int (*btree_dup_compare)(DB *, const DBT *, const DBT *) =\
	    ((wt_args_db_set_btree_dup_compare *)(stoc->toc->argp))->btree_dup_compare
...
#define	wt_args_db_set_btree_dup_offpage_unpack\
	DB *db = stoc->db;\
	u_int32_t btree_dup_offpage =\
	    ((wt_args_db_set_btree_dup_offpage *)(stoc->toc->argp))->btree_dup_offpage
...
#define	wt_args_db_set_btree_itemsize_unpack\
	DB *db = stoc->db;\
	u_int32_t intlitemsize =\
	    ((wt_args_db_set_btree_itemsize *)(stoc->toc->argp))->intlitemsize;\
	u_int32_t leafitemsize =\
	    ((wt_args_db_set_btree_itemsize *)(stoc->toc->argp))->leafitemsize
...
#define	wt_args_db_set_btree_pagesize_unpack\
	DB *db = stoc->db;\
	u_int32_t allocsize =\
	    ((wt_args_db_set_btree_pagesize *)(stoc->toc->argp))->allocsize;\
	u_int32_t intlsize =\
	    ((wt_args_db_set_btree_pagesize *)(stoc->toc->argp))->intlsize;\
	u_int32_t leafsize =\
	    ((wt_args_db_set_btree_pagesize *)(stoc->toc->argp))->leafsize;\
	u_int32_t extsize =\
	    ((wt_args_db_set_btree_pagesize *)(stoc->toc->argp))->extsize
...
#define	wt_args_db_set_errcall_unpack\
	DB *db = stoc->db;\
	void (*errcall)(const DB *, const char *) =\
	    ((wt_args_db_set_errcall *)(stoc->toc->argp))->errcall
...
#define	wt_args_db_set_errfile_unpack\
	DB *db = stoc->db;\
	FILE *errfile =\
	    ((wt_args_db_set_errfile *)(stoc->toc->argp))->errfile
...
#define	wt_args_db_set_errpfx_unpack\
	DB *db = stoc->db;\
	const char *errpfx =\
	    ((wt_args_db_set_errpfx *)(stoc->toc->argp))->errpfx
...
#define	wt_args_db_stat_clear_unpack\
	DB *db = stoc->db;\
	u_int32_t flags =\
	    ((wt_args_db_stat_clear *)(stoc->toc->argp))->flags
...
#define	wt_args_db_stat_print_unpack\
	DB *db = stoc->db;\
	FILE * stream =\
	    ((wt_args_db_stat_print *)(stoc->toc->argp))->stream;\
	u_int32_t flags =\
	    ((wt_args_db_stat_print *)(stoc->toc->argp))->flags
...
#define	wt_args_db_sync_unpack\
	DB *db = stoc->db;\
	u_int32_t flags =\
	    ((wt_args_db_sync *)(stoc->toc->argp))->flags
...
#define	wt_args_db_verify_unpack\
	DB *db = stoc->db;\
	u_int32_t flags =\
	    ((wt_args_db_verify *)(stoc->toc->argp))->flags
...
#define	wt_args_env_close_unpack\
	ENV *env = stoc->env;\
	u_int32_t flags =\
	    ((wt_args_env_close *)(stoc->toc->argp))->flags
...
#define	wt_args_env_db_create_unpack\
	ENV *env = stoc->env;\
	u_int32_t flags =\
	    ((wt_args_env_db_create *)(stoc->toc->argp))->flags;\
	DB **dbp =\
	    ((wt_args_env_db_create *)(stoc->toc->argp))->dbp
...
#define	wt_args_env_get_cachesize_unpack\
	ENV *env = stoc->env;\
	u_int32_t *cachesize =\
	    ((wt_args_env_get_cachesize *)(stoc->toc->argp))->cachesize
...
#define	wt_args_env_get_errcall_unpack\
	ENV *env = stoc->env;\
	void (**errcall)(const ENV *, const char *) =\
	    ((wt_args_env_get_errcall *)(stoc->toc->argp))->errcall
...
#define	wt_args_env_get_errfile_unpack\
	ENV *env = stoc->env;\
	FILE **errfile =\
	    ((wt_args_env_get_errfile *)(stoc->toc->argp))->errfile
...
#define	wt_args_env_get_errpfx_unpack\
	ENV *env = stoc->env;\
	const char **errpfx =\
	    ((wt_args_env_get_errpfx *)(stoc->toc->argp))->errpfx
...
#define	wt_args_env_get_verbose_unpack\
	ENV *env = stoc->env;\
	u_int32_t *verbose =\
	    ((wt_args_env_get_verbose *)(stoc->toc->argp))->verbose
...
#define	wt_args_env_open_unpack\
	ENV *env = stoc->env;\
	const char *home =\
	    ((wt_args_env_open *)(stoc->toc->argp))->home;\
	mode_t mode =\
	    ((wt_args_env_open *)(stoc->toc->argp))->mode;\
	u_int32_t flags =\
	    ((wt_args_env_open *)(stoc->toc->argp))->flags
...
#define	wt_args_env_set_cachesize_unpack\
	ENV *env = stoc->env;\
	u_int32_t cachesize =\
	    ((wt_args_env_set_cachesize *)(stoc->toc->argp))->cachesize
...
#define	wt_args_env_set_errcall_unpack\
	ENV *env = stoc->env;\
	void (*errcall)(const ENV *, const char *) =\
	    ((wt_args_env_set_errcall *)(stoc->toc->argp))->errcall
...
#define	wt_args_env_set_errfile_unpack\
	ENV *env = stoc->env;\
	FILE *errfile =\
	    ((wt_args_env_set_errfile *)(stoc->toc->argp))->errfile
...
#define	wt_args_env_set_errpfx_unpack\
	ENV *env = stoc->env;\
	const char *errpfx =\
	    ((wt_args_env_set_errpfx *)(stoc->toc->argp))->errpfx
...
#define	wt_args_env_set_verbose_unpack\
	ENV *env = stoc->env;\
	u_int32_t verbose =\
	    ((wt_args_env_set_verbose *)(stoc->toc->argp))->verbose
...
#define	wt_args_env_stat_clear_unpack\
	ENV *env = stoc->env;\
	u_int32_t flags =\
	    ((wt_args_env_stat_clear *)(stoc->toc->argp))->flags
...
#define	wt_args_env_stat_print_unpack\
	ENV *env = stoc->env;\
	FILE *stream =\
	    ((wt_args_env_stat_print *)(stoc->toc->argp))->stream;\
	u_int32_t flags =\
	    ((wt_args_env_stat_print *)(stoc->toc->argp))->flags
