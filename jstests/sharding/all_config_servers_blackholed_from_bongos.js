// Ensures that if the config servers are blackholed from the point of view of BongoS, metadata
...
(function() {
    ...
    jsTest.log('Making all the config servers appear as a blackhole to bongos');
