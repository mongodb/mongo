(function() {
    ...
    var st = new ShardingTest({shards: 1, rs: {nodes: 1}, bongos: 1});
    var bongos = st.s;
    var rs = st.rs0;
    ...
    bongos.adminCommand({configureFailPoint: "failAsyncConfigChangeHook", mode: "alwaysOn"});
    ...
    // issue a read from bongos with secondaryOnly read preference to force it use just added node
