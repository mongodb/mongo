...
// TODO SERVER-78094 Re-enable this validation once sharding creates the external key TTL index.
...
//     assert.commandWorked(configRstPrimary.adminCommand({setParameter: 1, ttlMonitorSleepSecs:
//     1})); assert.soon(() => externalKeysColl.find().itcount() == 0);
// } else {
