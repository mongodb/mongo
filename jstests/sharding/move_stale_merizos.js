//
// Tests that stale merizoses can properly move chunks.
//
...
for (var i = 0; i < 100; i += 10) {
    ...
    st.configRS.awaitLastOpCommitted();  // Ensure that other merizos sees the split
    ...
    st.configRS.awaitLastOpCommitted();  // Ensure that other merizos sees the move
}
