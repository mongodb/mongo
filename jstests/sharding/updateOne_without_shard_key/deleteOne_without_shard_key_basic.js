...
const testCases = [
    ...
    {
        logMessage:
            "Running mixed deleteOnes with shard key and deleteOne without" +
    ...
    {
        logMessage:
            "Running mixed deleteOne with shard key and deleteOne without " +
...
configurations.forEach((config) => {
    ...
    testCases.forEach((testCase) => {
        WriteWithoutShardKeyTestUtil.runTestWithConfig(
            ...
            testCase,
            config,
            WriteWithoutShardKeyTestUtil.OperationType.deleteOne,
        );
    });
});
