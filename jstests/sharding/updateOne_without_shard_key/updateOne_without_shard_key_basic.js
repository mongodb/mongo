...
const testCases = [
    ...
    {
        logMessage:
            "Running mixed set style update with shard key and updateOne without" +
    ...
    {
        logMessage:
            "Running mixed $set update with shard key and updateOne without " +
    ...
    {
        logMessage:
            "Running mixed aggregate style update with shard key and updateOne without " +
            "shard key for documents on different shards.",
        docsToInsert: [
            {_id: 0, x: xFieldValShard0_1, y: yFieldVal},
            {_id: 1, x: xFieldValShard1_1, y: yFieldVal},
    ...
    {
        logMessage:
            "Running mixed aggregation update with shard key and updateOne without " +
            "shard key for documents on the same shard.",
        docsToInsert: [
            {_id: 0, x: xFieldValShard0_1, y: yFieldVal},
            {_id: 1, x: xFieldValShard0_2, y: yFieldVal},
    ...
    {
        logMessage:
            "Running single replacement style update with shard key and updateOne " +
    ...
    {
        logMessage:
            "Running multiple replacement style update with shard key and updateOne " +
            "without shard key on the same shard.",
        docsToInsert: [
            {_id: 0, x: xFieldValShard0_1, y: yFieldVal},
            {_id: 1, x: xFieldValShard0_2, y: yFieldVal},
    ...
    },
    {
        ...
        docsToInsert: [{_id: 0, x: xFieldValShard0_1, y: yFieldVal}],
        cmdObj: {
            update: collName,
            updates: [
...
configurations.forEach((config) => {
    ...
    testCases.forEach((testCase) => {
        ...
        WriteWithoutShardKeyTestUtil.runTestWithConfig(
            ...
            testCase,
            config,
            WriteWithoutShardKeyTestUtil.OperationType.updateOne,
        );
    });
});
