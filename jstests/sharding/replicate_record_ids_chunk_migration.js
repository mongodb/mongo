...
function runMoveChunkReplicaRecordIDsTest(collName, keyDoc, useBounds, splitChunk) {
    ...
    assert.neq(
        collRecordIdsBeforeMoveChunk["Bart"],
    ...
    assert.neq(
        collRecordIdsBeforeMoveChunk["Lisa"],
    ...
    assert.neq(
        collRecordIdsAfterMoveChunk["Bart"],
        collRecordIdsAfterMoveChunk["Lisa"],
        `Documents on destination shard have conflicting record IDs: ${tojson(docsAfterMoveChunk)}`,
    );
...
runMoveChunkReplicaRecordIDsTest(
    jsTestName() + "_hashed_bounds",
    /*keyDoc=*/ undefined,
    /*useBounds=*/ true,
    /*splitChunk=*/ false,
);
...
runMoveChunkReplicaRecordIDsTest(
    jsTestName() + "_not_hashed_name_bounds",
    {name: 1},
    /*useBounds=*/ true,
    /*splitChunk=*/ false,
);
...
runMoveChunkReplicaRecordIDsTest(
    jsTestName() + "_not_hashed_name_find",
    {name: 1},
    /*useBounds=*/ false,
    /*splitChunk=*/ false,
);
...
runMoveChunkReplicaRecordIDsTest(
    jsTestName() + "_not_hashed_name_split",
    {name: 1},
    /*useBounds=*/ true,
    /*splitChunk=*/ true,
);
...
runMoveChunkReplicaRecordIDsTest(
    jsTestName() + "_not_hashed_name_b_bounds",
    {name: 1, b: 1},
    /*useBounds=*/ true,
    /*splitChunk=*/ false,
);
...
runMoveChunkReplicaRecordIDsTest(
    jsTestName() + "_not_hashed_name_b_find",
    {name: 1, b: 1},
    /*useBounds=*/ false,
    /*splitChunk=*/ false,
);
...
runMoveChunkReplicaRecordIDsTest(
    jsTestName() + "_not_hashed_name_b_split",
    {name: 1, b: 1},
    /*useBounds=*/ true,
    /*splitChunk=*/ true,
);
