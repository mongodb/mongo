...
(function() {
    ...
    assert.writeOK(sourceColl.insert({key: 1}));
    assert.writeOK(sourceColl.insert({key: 2}));
    assert.writeOK(sourceColl.insert({key: 3}));
    assert.writeOK(sourceColl.insert({key: 4}));
    ...
    // shard.
    assert.writeOK(mergeColl.insert({_id: 5, value: 1}));
