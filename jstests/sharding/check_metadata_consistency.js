...
(function testUnsplittableHasInvalidKey() {
    ...
    assert.neq(0, inconsistencies_key2.length);
    assert(inconsistencies_key2.some(object =>
                                         object.type === "TrackedUnshardedCollectionHasInvalidKey"),
           tojson(inconsistencies_key2));
