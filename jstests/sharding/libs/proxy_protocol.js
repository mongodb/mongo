...
export class ProxyProtocolServer {
     ...
     * @param {number} egress_port - Port to forward to (ignored when options.egressUnixSocket is
     *     set).
     * @param {number} version - Proxy protocol version (1 or 2).
     * @param {Object} [options] - Optional configuration.
     * @param {string} [options.egressUnixSocket] - Forward to this Unix domain socket instead of
     *     TCP.
