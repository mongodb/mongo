...
// Test that a deeply nested $lookup from a sharded collection is disallowed.
...
assert.commandFailedWithCode(
    mongosDB.runCommand({aggregate: baseColl.getName(), pipeline: deepLookupPipeline, cursor: {}}),
    28769);
