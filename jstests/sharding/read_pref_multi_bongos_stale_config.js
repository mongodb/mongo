// Tests that a bongos will correctly retry a stale shard version when read preference is used
(function() {
    'use strict';
    ...
    var st = new ShardingTest({
        ...
        bongos: 2,
        other: {bongosOptions: {verbose: 2}}
    });

    var testDB1 = st.s0.getDB('test');
    var testDB2 = st.s1.getDB('test');

    // Trigger a query on bongos 1 so it will have a view of test.user as being unsharded.
    ...
    // The testDB1 bongos does not know the chunk has been moved, and will retry
