...
const recipientUUIDBefore = recipient.getDB(dbName).getCollectionInfos({name: collName})[0]
    .info.uuid;
...
const recipientUUIDAfter = recipient.getDB(dbName).getCollectionInfos({name: collName})[0]
    .info.uuid;
