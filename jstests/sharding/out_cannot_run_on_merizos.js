// Tests that special stages which must run on merizos cannot be run in combination with an $out
// stage.
(function() {
    "use strict";
    ...
    // These should fail because the initial stages require merizos execution and $out requires
    // shard execution.
