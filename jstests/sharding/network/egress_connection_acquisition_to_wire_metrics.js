...
jsTestLog(
    `Initial metric value for mongos totalTimeForEgressConnectionAcquiredToWireMicros: ${tojson(
...
jsTestLog(
    `End metric value for mongos totalTimeForEgressConnectionAcquiredToWireMicros: ${tojson(
...
jsTestLog(
    `Initial metric value for mongod totalTimeForEgressConnectionAcquiredToWireMicros: ${tojson(
        initialConnAcquiredToWireTime,
    )}`,
);
...
jsTestLog(
    `End metric value for mongod totalTimeForEgressConnectionAcquiredToWireMicros: ${tojson(
        afterConnAcquiredToWireTime,
    )}`,
);
