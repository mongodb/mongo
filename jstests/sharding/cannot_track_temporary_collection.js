...
// Ensure the collection didn't get tracked in the global catalog despite the error.
assert(!db.getSiblingDB("config").collections.findOne({_id: coll.getFullName()}));
