...
var merizosConnActive = authDBUsers(new Merizo(merizos.host));
...
merizosConnIdle = authDBUsers(new Merizo(merizos.host));
...
merizosConnNew = authDBUsers(new Merizo(merizos.host));
