...
for (const query of queries) {
    ...
    let suspendRangeDeletionShard0Fp = configureFailPoint(st.shard0, "suspendRangeDeletion");
    let suspendRangeDeletionShard1Fp = configureFailPoint(st.shard1, "suspendRangeDeletion");
    ...
    suspendRangeDeletionShard1Fp.off();
}
