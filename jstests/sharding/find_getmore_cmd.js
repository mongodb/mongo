/**
 * Test issuing raw find and getMore commands to bongos using db.runCommand().
 */
(function() {
    "use strict";
    ...
    // getMore is required between bongos and the shell, but no getMores are issued between bongos
    // and bongod.
    ...
    // will be issued between bongos and bongod.
    ...
    // Ensure textScore meta-sort works in bongos.
    cmdRes = db.runCommand({
        find: coll.getName(),
