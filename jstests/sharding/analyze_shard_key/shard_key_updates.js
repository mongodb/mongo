...
function runTest({isShardedColl, execCtxType}) {
    ...
    [numUpdates, numTxnRetries, numShardKeyUpdates] =
        incrementByTxnRetries(numUpdates, numTxnRetries, numShardKeyUpdates);
    ...
    [numFindAndModifys, numTxnRetries, numShardKeyUpdates] =
        incrementByTxnRetries(numFindAndModifys, numTxnRetries, numShardKeyUpdates);
