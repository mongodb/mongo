...
const verifyMidpointTransactionMetrics =
    function(initialTxnMetrics, expectedParticipants) {
...
const setUpTestCase =
    function(addedParticipantIsExistingParticipantBeforeAgg,
             fooDocsToInsert,
             barDocsToInsert,
             txnNum,
             sessionId) {
...
let shardsToSetHangFp = [st.shard2];
...
// Wait to hit the hang failpoint on shard2, and check that mongos has only contacted the two shards
hangFps[0].wait();
