// Ensures that if the primary config server is blackholed from the point of view of bongos, CRUD
// and read-only config operations continue to work.
(function() {
    'use strict';

    var st = new ShardingTest({shards: 2, bongos: 1, useBridge: true});
    ...
    jsTest.log('Partitioning the config server primary from the bongos');
