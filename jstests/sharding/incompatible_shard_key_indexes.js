...
for (let incompatibleShardKeyIndex of incompatibleShardKeyIndexes) {
    ...
    do {
        ...
        // TODO (SERVER-112358): Enable this test case for multiKey indexes when reshardCollection
        // creates a valid shard key index when a multikey index prefixed by the shard key exists.
        if (incompatibleShardKeyIndex.isMultiKey) {
            break;
        }
