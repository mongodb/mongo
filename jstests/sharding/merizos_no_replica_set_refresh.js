// Tests that merizos and the shard discover changes to the shard's replica set membership.
...
(function() {
    ...
    var st = new ShardingTest({
        name: 'merizos_no_replica_set_refresh',
        shards: 1,
        merizos: 1,
        other: {
            rs0: {
    ...
    printjson(merizos.getCollection("foo.bar").findOne());
