...
removeShard(st, newShard.getURL());

// In 7.3, removing a shard always resets the cluster cardinality parameter to 1, thus allowing
// direct shard operations again.
jsTest.log("Running tests with one shard again.");
directWriteCount = runTests(false /* shouldBlockDirectConnections */, directWriteCount);
