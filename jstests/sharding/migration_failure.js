...
assert.commandWorked(
    st.shard0
        .getDB("admin")
        .runCommand({configureFailPoint: "failMigrationCommit", mode: "alwaysOn"}),
);
...
assert.commandWorked(
    st.shard0
        .getDB("admin")
        .runCommand({configureFailPoint: "migrationCommitNetworkError", mode: "alwaysOn"}),
);
...
assert.commandWorked(
    st.shard0
        .getDB("admin")
        .runCommand({configureFailPoint: "migrationCommitNetworkError", mode: "off"}),
);
