...
(function() {
    ...
    // node reports that it is primary, while in the refactored implementation (2.7.8+) it takes
    // place
    // after the node reports that it is primary via heartbeats, but before ismaster indicates that
    // the
