...
jsTestLog("Refresh after creating sessions");
...
jsTestLog("Session cache stats after creating 10 entries: " + tojson(statsAfterCreatingSessions));
...
jsTestLog("start one more session");
...
jsTestLog("Refresh after enabling failpoint");
...
jsTestLog("Session cache stats after first batch ended: " + tojson(statsAfterFirstBatch));
assert.eq(
...
jsTestLog("End three more sessions");
...
jsTestLog("Attempt to refresh again - failpoint is still active");
...
jsTestLog("Session cache stats after second batch ended: " + tojson(statsAfterSecondBatch));
assert.eq(
...
jsTestLog("End two more sessions after disabling failpoint");
...
jsTestLog("Session cache stats after successful refresh: " + tojson(statsAfter));
