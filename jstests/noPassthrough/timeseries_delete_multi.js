/**
 * # TODO SERVER-73319: Remove this test since the same test will be enabled in the core suite.
 * Tests running the {multi: true} delete command on a time-series collection.
 *
 * @tags: [
