...
assert(
    ftdcData["serverStatus"].hasOwnProperty("featureCompatibilityVersion"),
...
assert.soon(function () {
    ...
    return (
        fcvMetrics["major"] == lastLTSFCVMajorMinor[0] &&
        fcvMetrics["minor"] == lastLTSFCVMajorMinor[1] &&
...
assert.soon(function () {
    ...
    fcvMetrics = ftdcData["serverStatus"]["featureCompatibilityVersion"];
    return (
        fcvMetrics["major"] == fcvMajorMinor[0] &&
        fcvMetrics["minor"] == fcvMajorMinor[1] &&
        fcvMetrics["transitioning"] == 1
    );
});
