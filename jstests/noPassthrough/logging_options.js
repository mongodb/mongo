...
testGetCmdLineOptsMerizod({config: "jstests/libs/config_files/set_verbosity.json"}, expectedResult);
...
testGetCmdLineOptsMerizod({config: "jstests/libs/config_files/set_component_verbosity.json"},
                         expectedResult);

// Log output testing
var baseDir = MerizoRunner.dataPath + baseName;
var logDir = MerizoRunner.dataPath + baseName + "/logs/";
...
testGetCmdLineOptsMerizod({logpath: logDir + "/mylog.log"}, expectedResult);
