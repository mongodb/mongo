 ...
 * results fit into a single batch (and thus don't require a cursor).
...
// Assert that two find queries with identical structures are represented by the same key.
{
    ...
    // timestamps.
    assert.eq(queryStatsEntry.metrics.firstResponseExecMicros,
              queryStatsEntry.metrics.totalExecMicros);
