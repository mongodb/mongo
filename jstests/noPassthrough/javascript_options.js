...
testGetCmdLineOptsBongod({noscripting: ""}, expectedResult);
...
testGetCmdLineOptsBongod({config: "jstests/libs/config_files/disable_noscripting.ini"},
                         expectedResult);
...
testGetCmdLineOptsBongod({config: "jstests/libs/config_files/enable_scripting.json"},
                         expectedResult);
