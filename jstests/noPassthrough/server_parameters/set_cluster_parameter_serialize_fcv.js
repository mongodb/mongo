...
function runShardedTest(fixture) {
    ...
    let hangSetClusterParameterWaiter = fixture.hangTransition(
        {setClusterParameter: {cwspTestNeedsLatestFCV: {intData: 107}}},
