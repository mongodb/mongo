 ...
 * middle of a single document's index keys, with the old primary uncleanly restarted across each
 * failover.
 *
 * @tags: [
 *   requires_otel_build,
...
describe("resumable primary-driven index build spilling mid-document across a unclean restart", function () {
    before(function () {
