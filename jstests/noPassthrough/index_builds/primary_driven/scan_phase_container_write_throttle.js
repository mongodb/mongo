...
// Wait for the scan phase specifically: the progress meter this test reads is only published once
// the build reaches the collection scan, so waiting for the op to merely exist would race with it.
const opId = IndexBuildTest.waitForIndexBuildToScanCollection(db, collName, indexName);
