/**
 * Tests resuming a single primary-driven index build multiple times in a row -- once at the end of
 * each phase (scan, load, drain).
 *
 * @tags: [
 *   requires_otel_build,
...
PrimaryDrivenResumableIndexBuildTest.runMultiPhase(rst, {
    positions: {
        [PdibPhase.SCAN]: PdibPosition.END,
        [PdibPhase.LOAD]: PdibPosition.END,
        [PdibPhase.DRAIN]: PdibPosition.END,
    },
});
