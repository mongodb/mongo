...
expectedResult = {
    "parsed": {"processManagement": {"loadExtensions": [pathToExtensionFoo + "," + pathToExtensionBar]}},
};
// Test passing multiple extensions as array.
testGetCmdLineOptsMongod({loadExtensions: [pathToExtensionFoo, pathToExtensionBar]}, expectedResult);
testGetCmdLineOptsMongos({loadExtensions: [pathToExtensionFoo, pathToExtensionBar]}, expectedResult);
...
testGetCmdLineOptsMongod({config: extensionFooConfig, loadExtensions: pathToExtensionBar}, expectedResult);
testGetCmdLineOptsMongos({config: extensionFooConfig, loadExtensions: pathToExtensionBar}, expectedResult);
