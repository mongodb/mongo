...
const conn = MongoRunner.runMongod({setParameter: "featureFlagBucketUnpackWithSort50=true"});
...
printjson(conn.adminCommand({getParameter: 1, featureFlagBucketUnpackWithSort50: 1}));
