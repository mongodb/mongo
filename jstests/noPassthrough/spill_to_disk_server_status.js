...
load("jstests/libs/analyze_plan.js");     // For getPlanStages, getQueryPlanner, getWinningPlan
...
assert.commandWorked(
    db.adminCommand({setParameter: 1, internalDocumentSourceSetWindowFieldsMaxMemoryBytes: 232}));
...
testSpillingMetrics({
    ...
    expectedSbeSpillingMetrics: {spills: 20, spilledBytes: 853}
});
testSpillingMetrics({
