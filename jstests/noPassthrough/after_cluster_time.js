// This test verifies readConcern:afterClusterTime behavior on a standalone merizod.
...
(function() {
    ...
    assert.commandWorked(
        ...
        "expected majority read without afterClusterTime to succeed on standalone merizod");
    ...
    assert.commandFailedWithCode(
        ...
        "expected non-majority afterClusterTime read to fail on standalone merizod");
    ...
    assert.commandFailedWithCode(
        ...
        ErrorCodes.InvalidOptions,
        "expected afterClusterTime read with null timestamp to fail on standalone merizod");
