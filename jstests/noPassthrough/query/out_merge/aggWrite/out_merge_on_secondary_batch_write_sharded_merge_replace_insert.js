/**
 * Test which verifies that $merge aggregations with whenMatched: "replace", whenNotMatched: "insert"
...
testOutAndMergeOnSecondaryBatchWrite(st.s.getDB("db"), () => st.awaitReplicationOnShards(), "merge_replace_insert");
st.stop();
