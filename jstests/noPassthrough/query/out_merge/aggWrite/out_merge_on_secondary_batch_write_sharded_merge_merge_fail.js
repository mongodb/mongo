/**
 * Test which verifies that $merge aggregations with whenMatched: "merge", whenNotMatched: "fail"
...
testOutAndMergeOnSecondaryBatchWrite(st.s.getDB("db"), () => st.awaitReplicationOnShards(), "merge_merge_fail");
st.stop();
