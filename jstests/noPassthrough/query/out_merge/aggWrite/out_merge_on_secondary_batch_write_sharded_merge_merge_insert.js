/**
 * Test which verifies that $merge aggregations with whenMatched: "merge", whenNotMatched: "insert"
...
testOutAndMergeOnSecondaryBatchWrite(st.s.getDB("db"), () => st.awaitReplicationOnShards(), "merge_merge_insert");
st.stop();
