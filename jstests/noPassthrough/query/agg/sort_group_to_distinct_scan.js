/**
 * Validates that optimizations from $sort+$group to distinct scan and index scan plans are performed when expected and return valid output.
 *
 * @tags: [
 *   requires_fcv_81,
 * ]
...
const distictScanTestCases = [
    ...
    // The change from SERVER-90017, available in v8.1+, treats $bottomN, $topN with N = 1 as $bottom and $top.
    {
        pipeline: [
            {$sort: {season: 1, year: 1}},
