...
function runCommandAndCheckValidatorCount({cmdToRun, cmdName, countDict, error, notFirst}) {
    ...
    assert.eq(
        metricsAfterCommandInvoked.total - metricsBeforeCommandInvoked.total,
        countDict.total,
        metricsAfterCommandInvoked,
    );
    assert.eq(
        metricsAfterCommandInvoked.failed - metricsBeforeCommandInvoked.failed,
        countDict.failed,
        metricsAfterCommandInvoked,
    );
    assert.eq(
        metricsAfterCommandInvoked.jsonSchema - metricsBeforeCommandInvoked.jsonSchema,
