...
const kWildcardCases = [
    {
        ...
        indexOptions: {},
        seedDocs: [
            {_id: 1, nested: {alpha: 100, beta: 101}},
            {_id: 2, nested: {alpha: 200, beta: 201}},
        ],
        ops: [
            {
                type: "wildcardUpdate",
            ...
            {
                type: "wildcardInsert",
                doc: {_id: 3, nested: {alpha: [3000, 3001]}},
                queryHintsForTimestampRetrieval: [{path: "nested.alpha", afterValue: 3000}],
                isFirstMultikey: true,
                description: "wildcard insert _id=3 path=nested.alpha",
            },
        ],
    },
    {
        ...
        indexSpec: {"payload.$**": 1},
        indexOptions: {},
        seedDocs: [{_id: 1, payload: {nested: {alpha: 100}}}],
        ops: [
            {
                type: "wildcardUpdate",
                id: 1,
            ...
            {
                type: "wildcardInsert",
                doc: {_id: 2, payload: {nested: {alpha: [2000, 2001]}}},
                queryHintsForTimestampRetrieval: [{path: "payload.nested.alpha", afterValue: 2000}],
                isFirstMultikey: true,
                description: "wildcard insert _id=2 path=payload.nested.alpha",
            },
        ],
    },
    {
        ...
        seedDocs: [{_id: 1, category: "c1", nested: {alpha: 100}}],
        ops: [
            {
                type: "wildcardUpdate",
                id: 1,
            ...
            {
                type: "wildcardInsert",
                doc: {_id: 2, category: "c2", nested: {alpha: [2000, 2001]}},
                queryHintsForTimestampRetrieval: [{path: "nested.alpha", afterValue: 2000}],
                isFirstMultikey: true,
                description: "wildcard insert _id=2 path=nested.alpha",
            },
        ],
    },
];
