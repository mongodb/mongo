...
import {ConfigExpandRestServer, configExpandSuccess, jsToYaml} from "jstests/noPassthrough/libs/configExpand/lib.js";
...
configExpandSuccess(
    ...
    function (admin) {
        const response = assert.commandWorked(admin.runCommand({getParameter: 1, scramIterationCount: 1}));
