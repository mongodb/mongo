...
import {configExpandSuccess, makeReflectionCmd} from "jstests/noPassthrough/libs/configExpand/lib.js";
...
configExpandSuccess(
    {
        setParameter: {
            ...
            scramSHA256IterationCount: {__exec: makeReflectionCmd("23456\n"), type: "string", trim: "whitespace"},
        },
    },
    function (admin) {
