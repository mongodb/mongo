...

{
    ...
    let ddlOpThread = new Thread(
        (mongosConnString, nss, newShardKey) => {
            let mongos = new Mongo(mongosConnString);
...

{
    ...
    let ddlOpThread = new Thread(
        (mongosConnString, dbName, destShard) => {
            let mongos = new Mongo(mongosConnString);
...

{
    ...
    let ddlOpThread = new Thread(
        (mongosConnString, fromNss, toNss) => {
            let mongos = new Mongo(mongosConnString);
