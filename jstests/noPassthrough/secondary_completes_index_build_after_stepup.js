/**
 * Tests that if secondaries have voted but the primary has not, and if a secondary steps up and
 * sees that commit quorum is satisfied, it proceeds to commit the index build.
 *
 * @tags: [
...
jsTestLog("Waiting for primary to step down");
...
jsTestLog("Waiting for secondary to step up and satisfy commit quorum as new primary");
...
jsTestLog("Waiting for index build to stop");
