 ...
 */
function setupCollectionAndGetExplainTestCases(db, collName, waitTimeMillis) {
    ...
    let failpointBase = {failpointName: "sleepWhilePlanning", failpointOpts: {ms: waitTimeMillis}};
