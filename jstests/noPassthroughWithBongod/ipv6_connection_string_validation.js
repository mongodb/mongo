...
// The outer mode test starts a bongod with --ipv6 and then starts a bongo shell with --ipv6
...
(function() {
    if ("undefined" == typeof inner_mode) {
        ...
        var args = [
            ...
            "jstests/noPassthroughWithBongod/ipv6_connection_string_validation.js"
        ];
