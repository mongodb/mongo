...
// If this fails, most probably some of the configuration settings under bongo::mr::Config have
// changed, such as reduceTriggerRatio or maxInMemSize. If not the case, then something else
// must have changed with when intermediate reduces occur (see bongo::mr::State::checkSize).
//
