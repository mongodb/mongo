...
(function() {
    ...
    BongoRunner.stopBongod(m2);

    var m3 = BongoRunner.runBongod(
    ...
    BongoRunner.stopBongod(m3);

    var m4 = BongoRunner.runBongod({
        setParameter:
