...
//indexOnly should be false but it may be true in some cases due to SERVER-5759.
if (0) { // SERVER-5759
    assert(!plan.indexOnly, "negative.1.6 - indexOnly should be false on a non covered query");
}
