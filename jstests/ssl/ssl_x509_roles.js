...
if (!_isWindows()) {
    ...
    jsTestLog(
        "5. Testing that x.509 role-embedded cert auth fails to mongod through proxy protocol");
    {
    ...
    jsTestLog(
        "6. Testing that x.509 role-embedded cert auth fails to mongos through proxy protocol");
    {
