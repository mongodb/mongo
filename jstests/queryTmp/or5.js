...
// NEW QUERY EXPLAIN
assert.eq(0, t.find( {z:{$near:[50,50]},a:2} ).itcount());
assert.eq(0, t.find( {z:{$near:[50,50]},$or:[{a:2}]} ).itcount());
assert.eq(0, t.find( {$or:[{a:2}],z:{$near:[50,50]}} ).itcount());
assert.eq(0, t.find( {$or:[{a:2},{b:3}],z:{$near:[50,50]}} ).itcount());
