...
// Test no projection
// NEW QUERY EXPLAIN
var e = coll.find({a:10, b:"strvar_10", c:0}).hint({a:1, b:-1, c:1});
/* NEW QUERY EXPLAIN
...
// NEW QUERY EXPLAIN
var e = coll.find({a:10, b:"strvar_10", c:0},{a:1, b:1, c:1}).hint({a:1, b:-1, c:1});
/* NEW QUERY EXPLAIN
...
// NEW QUERY EXPLAIN
var e = coll.find({d:100},{d:1, c:1, _id:0}).hint({d:1});
/* NEW QUERY EXPLAIN
...
// NEW QUERY EXPLAIN
var e = coll.find({e:99},{e:1, _id:0}).hint({e:1});
/* NEW QUERY EXPLAIN
