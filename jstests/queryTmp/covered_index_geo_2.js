...
// NEW QUERY EXPLAIN
var e = coll.find({loc1 : [ 6 , 6 ]}, {loc1:1, type1:1, _id:0}).hint({loc1:"2dsphere", type1:1});
/* NEW QUERY EXPLAIN
...
// NEW QUERY EXPLAIN
var e = coll.find({loc1 : [ 6 , 6 ]}, {type1:1, _id:0}).hint({loc1:"2dsphere", type1:1});
/* NEW QUERY EXPLAIN
...
// NEW QUERY EXPLAIN
var e = coll.find({type2 : {$lt:3}}, {type2:1, loc2:1, _id:0}).hint({type2: 1, loc2:"2dsphere"});
/* NEW QUERY EXPLAIN
...
// NEW QUERY EXPLAIN
var e = coll.find({type2 : {$lt:3}}, {type2:1, _id:0}).hint({type2:1, loc2:"2dsphere"});
/* NEW QUERY EXPLAIN
