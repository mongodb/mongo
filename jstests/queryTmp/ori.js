...
// NEW QUERY EXPLAIN
assert.eq( 2, t.find( {$or:[{a:{$gt:0,$lt:5},b:2},{a:10,c:4}]} ).itcount());
...
*/
assert.eq( 2, t.find( {$or:[{a:{$gt:0,$lt:5}},{a:10,b:1}]} ).itcount() );
...
*/
assert.eq( 2, t.find( {$or:[{a:{$lt:5,$gt:0}},{a:10,b:1}]} ).itcount() );
