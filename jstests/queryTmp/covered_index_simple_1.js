...
// NEW QUERY EXPLAIN
var e = coll.find({foo:1}, {foo:1, _id:0}).hint({foo:1});
/* NEW QUERY EXPLAIN
...
// NEW QUERY EXPLAIN
var e = coll.find({foo:"string"}, {foo:1, _id:0}).hint({foo:1});
/* NEW QUERY EXPLAIN
...
// NEW QUERY EXPLAIN
var e = coll.find({foo:{bar:1}}, {foo:1, _id:0}).hint({foo:1});
/* NEW QUERY EXPLAIN
...
// Test no query
// NEW QUERY EXPLAIN
var e = coll.find({}, {foo:1, _id:0}).hint({foo:1});
/* NEW QUERY EXPLAIN
...
// Test range query
// NEW QUERY EXPLAIN
var e = coll.find({foo:{$gt:2,$lt:6}}, {foo:1, _id:0}).hint({foo:1});
/* NEW QUERY EXPLAIN
...
// Test in query
// NEW QUERY EXPLAIN
var e = coll.find({foo:{$in:[5,8]}}, {foo:1, _id:0}).hint({foo:1});
/* NEW QUERY EXPLAIN
...
// Test no return
// NEW QUERY EXPLAIN
var e = coll.find({foo:"2"}, {foo:1, _id:0}).hint({foo:1});
/* NEW QUERY EXPLAIN
...
// Test not in query
// NEW QUERY EXPLAIN
var e = coll.find({foo:{$nin:[5,8]}}, {foo:1, _id:0}).hint({foo:1});
/* NEW QUERY EXPLAIN
