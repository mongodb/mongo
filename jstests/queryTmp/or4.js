...
// NEW QUERY EXPLAIN
assert.eq(0, t.find( {$or:[{a:1}]} ).sort( {b:1} ).itcount());
assert.eq(0, t.find( {$or:[{}]} ).sort( {b:1} ).itcount());
assert.eq(0, t.find( {$or:[{a:1},{a:3}]} ).itcount());
assert.eq(0, t.find( {$or:[{a:1},{b:3}]} ).sort( {b:1} ).itcount());
assert.eq(0, t.find( {$or:[{b:1}]} ).sort( {b:1} ).itcount());
assert.eq(0, t.find( {$or:[{b:1},{b:2}]} ).sort( {b:1} ).itcount());

// NEW QUERY EXPLAIN
assert.eq(0, t.find( {$or:[{a:1}]} ).hint( {b:1} ).itcount());
assert.eq(0, t.find( {$or:[{}]} ).hint( {b:1} ).itcount());
assert.eq(0, t.find( {$or:[{b:1}]} ).hint( {b:1} ).itcount());
