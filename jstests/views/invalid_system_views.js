...
(function() {
    ...
    assert.writeOK(viewsDB.system.views.insert({_id: "badview", pipeline: "bad"}));
    ...
    // Commands that run on existing regular collections should not be impacted by the presence of
    // invalid views.
