 ...
 * from the Bongo shell authCache when logging out.
 * It is a regression test for SERVER-8798.
 */

var conn = BongoRunner.runBongod({auth: "", remember: true});
...
conn = BongoRunner.runBongod({restart: conn, noCleanData: true});
