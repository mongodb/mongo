...
// The outer mode test starts a merizod with --ipv6 and then starts a merizo shell with --ipv6
...
(function() {
    if ("undefined" == typeof inner_mode) {
        ...
        var args = [
            ...
            "jstests/noPassthroughWithMerizod/ipv6_connection_string_validation.js"
        ];
