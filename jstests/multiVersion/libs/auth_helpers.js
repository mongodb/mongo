...
export var getUserDoc = function(db, username) {
...
// credentials (or not).
export var verifyUserDoc = function(db, username, hasCR, hasSCRAM, hasExternal = false) {
...
export var verifyAuth = function(db, username, password, passCR, passSCRAM) {
