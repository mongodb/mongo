...
testWithProject({
    ...
    medianSpec: {$median: {input: ["$x", "$x1", "$x2", "$x3"], algorithm: "approximate"}},
    expectedResult: 1,
...
testWithProject({
    ...
    medianSpec: {$median: {input: ["$x", "$x1"], algorithm: "approximate"}},
    expectedResult: null,
...
testWithProject({
    doc: {x: 1, x1: "hello"},
    medianSpec: {$median: {input: "$x1", algorithm: "approximate"}},
    expectedResult: null,
