...
(function() {
    ...
    assertErrorCode(
        coll, [{$project: {a: {$round: [NumberLong("9223372036854775806"), -1]}}}], 51062);
    ...
    assertErrorCode(coll, [{$project: {a: {$round: "string"}}}], 51063);
    assertErrorCode(coll, [{$project: {a: {$trunc: "string"}}}], 51063);
    ...
    assertErrorCode(coll, [{$project: {a: {$round: [1, NumberLong("101")]}}}], 51065);
    assertErrorCode(coll, [{$project: {a: {$round: [1, NumberLong("-21")]}}}], 51065);
    assertErrorCode(coll, [{$project: {a: {$round: [1, NumberDecimal("101")]}}}], 51065);
    assertErrorCode(coll, [{$project: {a: {$round: [1, NumberDecimal("-21")]}}}], 51065);
    assertErrorCode(coll, [{$project: {a: {$round: [1, NumberInt("101")]}}}], 51065);
    assertErrorCode(coll, [{$project: {a: {$round: [1, NumberInt("-21")]}}}], 51065);
    assertErrorCode(coll, [{$project: {a: {$round: [1, 101]}}}], 51065);
    assertErrorCode(coll, [{$project: {a: {$round: [1, -21]}}}], 51065);
    assertErrorCode(coll, [{$project: {a: {$trunc: [1, NumberLong("101")]}}}], 51065);
    assertErrorCode(coll, [{$project: {a: {$trunc: [1, NumberLong("-21")]}}}], 51065);
    assertErrorCode(coll, [{$project: {a: {$trunc: [1, NumberDecimal("101")]}}}], 51065);
    assertErrorCode(coll, [{$project: {a: {$trunc: [1, NumberDecimal("-21")]}}}], 51065);
    assertErrorCode(coll, [{$project: {a: {$trunc: [1, NumberInt("101")]}}}], 51065);
    assertErrorCode(coll, [{$project: {a: {$trunc: [1, NumberInt("-21")]}}}], 51065);
    assertErrorCode(coll, [{$project: {a: {$trunc: [1, 101]}}}], 51065);
    assertErrorCode(coll, [{$project: {a: {$trunc: [1, -21]}}}], 51065);

    // Test non-integral precision arguments.
    assertErrorCode(coll, [{$project: {a: {$round: [1, NumberDecimal("1.4")]}}}], 51064);
    assertErrorCode(coll, [{$project: {a: {$trunc: [1, 10.5]}}}], 51064);
}());
