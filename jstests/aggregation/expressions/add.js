...
// values.
let arr = [
    1.4831356930199802e-5, -3.121724665346865, 3041897608700.073, 1001318343149.7166,
    -1714.6229586696593, 1731390114894580.8, 6.256645803154374e-8, -107144114533844.25,
    ...
    -0.0009567520620034965, -1553879364344.9932, -2.1101077525869814e-8, -298421079729.5547,
    0.03182394834273594, 22.201944843278916, -33.35667991109125, 11496013.960449915,
    -40652595.33210472, 3.8496066090328163, 2.5074042398147304e-8, -0.02208724071782122,
    -134211.37290639878, 0.17640433666616578, 4.463787499171126, 9.959669945399718,
    129265976.35224283, 1.5865526187526546e-7, -4746011.710555799, -712048598925.0789,
    582214206210.4034, 0.025236204812875362, 530078170.91147506, -14.865307666195053,
    1.6727994895185032e-5, -113386276.03121366, -6.135827207137054, 10644945799901.145,
    -100848907797.1582, 2.2404406961625282e-8, 1.315662618424494e-9, -0.832190208349044,
...
let result1 = coll
    .aggregate([{$project: {sum: {$add: ["$lhs", "$rhs"]}}}, {$sort: {_id: 1}}])
    .toArray();
