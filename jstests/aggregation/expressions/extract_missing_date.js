...
// Divide
assertErrorCode(coll, {$project: {divide: {$divide: ["$date", 2]}}}, [
    16609,
...
// Multiply
assertErrorCode(coll, {$project: {multiply: {$multiply: ["$date", 2]}}}, [
    16555,
    ErrorCodes.TypeMismatch,
]);

// Subtract
assertErrorCode(coll, {$project: {subtract: {$subtract: [2, "$date"]}}}, [
    16556,
    ErrorCodes.TypeMismatch,
]);
