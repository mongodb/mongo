...
assert.commandWorked(db.createCollection("ts", {timeseries: {timeField: "time", metaField: "tag"}}));
...
const pipeline = [{$project: {"time": 0}}, {$match: {"time": {$lte: new Date("2019-02-13T11:36:03.481Z")}}}];
