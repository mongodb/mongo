...
assertLookupResults({
    ...
    expected: [
        {_id: 0, key: "foo", [fromCollName]: [{_id: "foo", avg: 2.5}]},
        {_id: 1, key: "bar", [fromCollName]: [{_id: "bar", avg: 10}]},
    ],
});
...
assertLookupResults({
    ...
    expected: [
        {_id: 0, key: "foo", [fromCollName]: [{_id: "foo", top: 5}]},
        {_id: 1, key: "bar", [fromCollName]: [{_id: "bar", top: 10}]},
    ],
});
...
assertLookupResults({
    ...
    expected: [
        {_id: 0, key: "foo", [fromCollName]: {_id: "foo", bottom: 0}},
        {_id: 1, key: "bar", [fromCollName]: {_id: "bar", bottom: 10}},
    ],
});
...
assertLookupResults({
    ...
    expected: [
        {_id: 0, key: "foo", [fromCollName]: [{_id: "foo", last: 5}]},
        {_id: 1, key: "bar", [fromCollName]: [{_id: "bar", last: 10}]},
    ],
});
...
assertLookupResults({
    ...
    expected: [
        {_id: 0, key: "foo", [fromCollName]: {_id: "foo", last: 0}},
        {_id: 1, key: "bar", [fromCollName]: {_id: "bar", last: 10}},
    ],
});
