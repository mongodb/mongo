...
function runTests(doCoveredProjection) {
    runTest(doCoveredProjection, {_id: 0, j: 10, b: 11, c: 16, f: 17, g: 14, a: 15, e: 18}, [
        {$project: {a: 0}},
        {$addFields: {b: 11, c: 12}},
        {$project: {d: 0, e: 0}},
        {$addFields: {f: 13, g: 14}},
    ...
    runTest(doCoveredProjection, {_id: 0, j: 10, g: 8, f: 14, c: 16, b: 11, e: 18}, [
        {$addFields: {b: 11, c: 12}},
        {$project: {d: 0, e: 0}},
        {$addFields: {f: 13, g: '$h'}},
        {$addFields: {f: 14}},
    ...
    runTest(doCoveredProjection, {_id: 0, j: 15, g: 7, f: 16, e: 14, d: 4, c: 8, b: 13, i: 12}, [
        {$addFields: {a: '$b', c: 11}},
        {$sort: {a: 1}},
        {$addFields: {f: 12, g: '$g'}},
        {$project: {i: 0}},
    ...
    let subObj1 = {_id: 0, j: 10, i: 9, h: 8, g: 8, f: 13, c: 12, b: 11};

    runTest(doCoveredProjection, {_id: 0, j: 10, g: 8, f: subObj1, c: 16, b: 11, a: 15, e: 18}, [
        {$project: {a: 0}},
        {$addFields: {b: 11, c: 12}},
        {$project: {d: 0, e: 0}},
        {$addFields: {f: 13, g: '$h'}},
    ...
    runTest(doCoveredProjection, {_id: 0, j: 10, i: 9, h: 8, g: 7, f: 6, e: 5, d: 4, c: 3}, [
        {$project: {a: 0}},
        {$addFields: {a: '$c'}},
        {$sort: {a: 1}},
        {$project: {a: 0}},
    ...
    runTest(doCoveredProjection,
            {_id: 0, i: 9, h: 8, g: 7, f: 14, d: 12, c: 11, a: 10, b: 10, j: 15, e: 16},
            [
                {$addFields: {a: '$j', j: 10}},
                {$addFields: {b: '$j', j: 11}},
                {$addFields: {c: '$j', j: 12}},
    ...
    runTest(doCoveredProjection,
            {_id: 0, y: {_id: 0, j: 10, i: 9, h: 8, g: 7, f: 6, e: 5, d: 4, c: 3, a: 1}},
            [{$project: {x: '$$ROOT'}}, {$project: {y: '$x'}}]);

    runTest(doCoveredProjection,
            {_id: 0, x: {_id: 0, j: 10, i: 9, h: 8, g: 7, f: 6, e: 5, d: 4, c: 3, a: 1}, y: 7},
    ...
    let subObj2 = {_id: 0, j: 10, i: 9, h: 8, g: 7, f: 6, e: 5, d: 4, c: 3, a: 1};

    runTest(doCoveredProjection,
            {_id: 0, j: 10, i: 9, h: 8, g: 7, f: 6, e: 5, d: 4, c: 3, a: 1, x: subObj2, y: 7},
            [{$addFields: {x: '$$ROOT'}}, {$addFields: {y: '$x.g'}}]);
}

let indexSpec = {_id: 1, a: 1, b: 1, c: 1, d: 1, e: 1, f: 1, g: 1, h: 1, i: 1, j: 1};
