...
testGetCmdLineOptsBongod({replSet: "mycmdlinename"}, expectedResult);
...
testGetCmdLineOptsBongod({config: "jstests/libs/config_files/set_replsetname.json"},
                         expectedResult);
