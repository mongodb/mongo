...
// as it's expected for config.image_collection to not match.
...
jsTestLog("Secondary: " + initialSyncedNode +
          " Data: " + tojson(initialSyncedNode.getDB(dbName)['collection'].findOne()) + " Image: " +
...
jsTestLog("Secondary: " + initialSyncedNode +
              " Data: " + tojson(initialSyncedNode.getDB(dbName)['collection'].findOne()),
          " Image: " +
              tojson(initialSyncedNode.getDB("config")['image_collection'].findOne(
                  {"_id.id": otherLsid})) +
