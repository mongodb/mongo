...
(function() {
    ...
    assert.writeOK(nodeA.getDB(dbName)[collName].insert({_id: "dummy"}));
    rst.awaitLastOpCommitted();
    stopServerReplication([nodeB, nodeC, nodeD]);
    assert.writeOK(nodeA.getDB(dbName)[collName].insert({_id: "term 1, doc 1"}));
    ...
    assert.writeOK(nodeA.getDB(dbName)[collName].insert({_id: "term 1, doc 2"}));
    ...
    rst.awaitLastOpCommitted([nodeA]);
