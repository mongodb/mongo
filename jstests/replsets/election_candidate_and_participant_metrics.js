...
// Check the log without case sensitivity, since the log message is capitalized in 4.4 and onwards
// but not in 4.2.
assert(checkLog.checkContainsOnce(newPrimary,
                                  /Not becoming primary, we received insufficient votes/i));
