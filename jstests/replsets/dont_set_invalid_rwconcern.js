...
assert.commandWorked(primary.adminCommand({setDefaultRWConcern: 1, defaultWriteConcern: {w: "majority"}}));
...
assert.commandFailedWithCode(coll.insert({a: 1}, {writeConcern: {w: true}}), ErrorCodes.FailedToParse);
assert.commandFailedWithCode(coll.insert({a: 1}, {writeConcern: {w: "1"}}), ErrorCodes.UnknownReplWriteConcern);
assert.commandFailedWithCode(coll.insert({a: 1}, {writeConcern: {w: "bajority"}}), ErrorCodes.UnknownReplWriteConcern);
