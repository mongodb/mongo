// BUG: [SERVER-1768] replica set getlasterror {w: 2} after 2000 inserts hangs while secondary servers log "replSet error RS102 too stale to catch up" every once in a while
