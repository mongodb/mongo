...
assert.commandWorked(restartedSecondary.adminCommand({
...
// cause the startup procedure to request the RSTL in X mode. On a buggy build this races and
...
rst.waitForState(restartedSecondary, ReplSetTest.State.SECONDARY, 600 * 1000);
