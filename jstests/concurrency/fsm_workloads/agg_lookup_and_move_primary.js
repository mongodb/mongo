 ...
 * @tags: [
 *  requires_sharding,
 *  # The test selects shardIds to moveCollections to, which can fail if the topology changes.
        ...
        function movePrimary(db, _) {
            ...
            retryOnRetryableError(
                ...
                [
                    ...
                    7120202,
                    // ConflictingOperationInProgress can occur if another movePrimary is running, 
                    // as can be the case in dedicated config svr transition suites.
