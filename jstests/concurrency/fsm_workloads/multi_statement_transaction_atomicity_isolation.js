...
var $config = (function() {
    ...
    function checkWritesOfCommittedTxns(data, documents) {
        ...
        // that
        // were updated by this thread (this.tid) and exist in the database.
            ...
            update: function update(db, collName) {
                ...
                withTxnAndAutoRetry(this.session, () => {
                    ...
                    for (let [i, docId] of docIds.entries()) {
                        ...
                        const txnDbName = collection.getDB().getName();
                        const txnCollName = collection.getName();
                        const txnNumber = this.session.getTxnNumber_forTesting();
                ...
                this.updatedDocsClientHistory[this.session.getTxnNumber_forTesting()] =
                    committedTxnInfo;
                ++this.iteration;
            },
