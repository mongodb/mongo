/**
 * Tests that the join plans remain stable across releases by comparing the actual plans
 * against the expected ones. See README.plan_stability.join_opt.md for more information.
 *
 * @tags: [
 * incompatible_aubsan,
 * tsan_incompatible,
