...
const profilingToRestore = assert.commandWorked(db.setProfilingLevel(1, {slowms: -1}));
...
try {
    ...
    assert.commandWorked(
        db.setProfilingLevel(profilingToRestore.was, {slowms: profilingToRestore.slowms}),
    );
}
