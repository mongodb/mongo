...
// This golden test requires CBR to be disabled
const prevCostBasedRanker = assert.commandWorked(
    db.adminCommand({getParameter: 1, featureFlagCostBasedRanker: 1}),
).featureFlagCostBasedRanker.value;
...
try {
    ...
    assert.commandWorked(
        db.adminCommand({setParameter: 1, featureFlagCostBasedRanker: prevCostBasedRanker}),
    );
}
