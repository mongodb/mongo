...
assert.eq(
    replDocs.length,
    2,
    "Could not find information about the two replica sets set up by the fixture" + tojsononeline(replDocs),
);
...
OverrideHelpers.prependOverrideInParallelShell("jstests/libs/override_methods/check_parity_replica_set.js");
