/**
 * Loading this file overrides Bongo.prototype.runCommand() with a function that wraps any
...
(function() {
    ...
    var originalRunCommand = Bongo.prototype.runCommand;

    Bongo.prototype.runCommand = function(dbName, cmdObj, options) {
