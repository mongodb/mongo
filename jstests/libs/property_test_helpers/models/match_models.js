...
function makeSimpleConditionArb(leafArb, allowedSimpleComparisons) {
    ...
    const makeSimpleConditionHelper = function (numConditions) {
        return fc.dictionary(fc.constantFrom(...allowedSimpleComparisons), leafArb, {
            minKeys: numConditions,
            maxKeys: numConditions,
        });
    };
    ...
    return oneof(
        {arbitrary: makeSimpleConditionHelper(1 /* numConditions */), weight: 10},
...
export function getMatchPredicateSpec({
    ...
    return fc.letrec((tie) => {
        ...
        return {
            ...
            elemMatch: oneof(
                fc.array(tie("condition"), {minLength: 1, maxLength: 3}),
            ...
            singleCompoundPredicate: singleKeyObjArb(
                fc.constantFrom(...compoundOps),
                fc.array(tie("predicate"), {minLength: 1, maxLength: 3}),
            ),
            // Example: {a: {$eq: 5}}
