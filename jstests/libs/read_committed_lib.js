 ...
 * primary or bongos instance. 'secondary' is the shard/replica set secondary. If 'db' is backed
 * by a bongos instance then the associated cluster should have only a single shard. 'rst' is the
