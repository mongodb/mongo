 ...
 * is running tests.
 *
 * Optional `extraMatch' argument can be used to filter the pipeline.
 */
function getTelemetry(conn, extraMatch) {
    var match = {"key.client.application.name": kShellApplicationName, ...extraMatch};
