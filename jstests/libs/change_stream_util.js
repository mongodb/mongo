...
export function ChangeStreamTest(_db, options) {
    ...
    function updateResumeToken(cursor, changeEvents) {
        // This isn't fool proof since anyone can just run a getMore command on the raw cursor.
    ...
    /**
     * Restarts the change stream and modify 'cursor' by replacing its contents thus updating its
     * cursor ID.
     */
