...
export function testValidServerlessClusterParameterCommands(conn) {
    ...
    runGetClusterParameterReplicaSet(conn, kAllClusterParameterNames, kAllClusterParameterDefaults);
    runGetClusterParameterReplicaSet(conn, "*", kAllClusterParameterDefaults);
    runGetClusterParameterReplicaSet(conn, kAllClusterParameterNames, kAllClusterParameterDefaults, tenantId1);
    ...
    for (let i = 0; i < kAllClusterParameterNames.length; i++) {
        ...
        runGetClusterParameterReplicaSet(
            conn,
            kAllClusterParameterNames[i],
            [kAllClusterParameterDefaults[i]],
            tenantId2,
        );
        runGetClusterParameterReplicaSet(conn, kAllClusterParameterNames[i], [kAllClusterParameterDefaults[i]]);
    ...
    runGetClusterParameterReplicaSet(conn, kAllClusterParameterNames, kAllClusterParameterValues2, tenantId1);
    runGetClusterParameterReplicaSet(conn, "*", kAllClusterParameterValues2, tenantId1);
    runGetClusterParameterReplicaSet(conn, kAllClusterParameterNames, kAllClusterParameterDefaults, tenantId2);
