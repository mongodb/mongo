...
export const _parallelShellRunCommand = function (dbName, cmdObj, expectedCode, checkResultFn, checkResultArgs) {
    ...
    jsTestLog(
        "Finished running command in parallel shell - host: " +
            db.getMongo().host +
            "; db: " +
            dbName +
            "; command: " +
    ...
    jsTestLog(
        "Checking command result in parallel shell - host: " +
            db.getMongo().host +
            "; db: " +
            dbName +
            "; command: " +
            ...
            checkResultFn +
            "; checkResultArgs: " +
            tojson(checkResultArgs),
    );
    checkResultFn(result, checkResultArgs);
    jsTestLog(
        "Successfully verified command result in parallel shell - host: " +
            db.getMongo().host +
            "; db: " +
            dbName +
            "; command: " +
