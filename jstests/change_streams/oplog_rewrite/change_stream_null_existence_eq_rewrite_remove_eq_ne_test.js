/**
 * Tests that change streams correctly handle rewrites of equality and non-equality checks against
 * $$REMOVE, for both existent and non-existent fields and subfields.
 * @tags: [
