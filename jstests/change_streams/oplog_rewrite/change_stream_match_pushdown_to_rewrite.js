...
// each shard.
verifyOnWholeCluster({$match: {to: {db: dbName, coll: "newColl1"}}},
                     {coll1: {rename: ["newColl1"]}},
                     [1, 0] /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({$match: {$expr: {$eq: ["$to", {db: dbName, coll: "newColl1"}]}}},
                     {coll1: {rename: ["newColl1"]}},
                     [1, 0] /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({$match: {to: {db: dbName, coll: "newColl2"}}},
                     {coll2: {rename: ["newColl2"]}},
                     [1, 0] /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({$match: {$expr: {$eq: ["$to", {db: dbName, coll: "newColl2"}]}}},
                     {coll2: {rename: ["newColl2"]}},
                     [1, 0] /* expectedOplogRetDocsForEachShard*/);
...
verifyOnWholeCluster(
    {$match: {$expr: {$eq: ["$to", {db: dbName}]}}}, {}, 0 /* expectedOplogRetDocsForEachShard*/);
...
verifyOnWholeCluster(
    {$match: {to: {db: dbName, coll: "unknown"}}}, {}, 0 /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({$match: {$expr: {$eq: ["$to", {db: dbName, coll: "unknown"}]}}},
                     {},
...
verifyOnWholeCluster(
    {$match: {to: {coll: "newColl1", db: dbName}}}, {}, 0 /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({$match: {$expr: {$eq: ["$to", {coll: "newColl1", db: dbName}]}}},
                     {},
                     0 /* expectedOplogRetDocsForEachShard*/);

// Ensure that the 'to' object and equivalent '$expr' expression with extra fields does not match
// and the oplog cursor returns 0 document.
verifyOnWholeCluster({$match: {to: {db: dbName, coll: "newColl1", extra: "extra"}}},
                     {},
                     0 /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster(
...
// shard.
verifyOnWholeCluster({$match: {"to.db": dbName}},
                     {coll1: {rename: ["newColl1"]}, coll2: {rename: ["newColl2"]}},
                     [2, 0] /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({$match: {$expr: {$eq: ["$to.db", dbName]}}},
                     {coll1: {rename: ["newColl1"]}, coll2: {rename: ["newColl2"]}},
                     [2, 0] /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({$match: {"to.db": /^change_stream_match_pushdown.*$/}},
                     {coll1: {rename: ["newColl1"]}, coll2: {rename: ["newColl2"]}},
                     [2, 0] /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster(
...
verifyOnWholeCluster({
    $match: {$expr: {$regexMatch: {input: "$to.db", regex: "^(change_stream_match_pushdown.*$)"}}}
                     ...
                     {coll1: {rename: ["newColl1"]}, coll2: {rename: ["newColl2"]}},
                     [2, 0] /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({$match: {"to.db": /^(Change_Stream_MATCH_PUSHDOWN.*$)/i}},
                     {coll1: {rename: ["newColl1"]}, coll2: {rename: ["newColl2"]}},
                     [2, 0] /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({
    $match: {
        $expr: {
            $regexMatch:
                {input: "$to.db", regex: "^(Change_Stream_MATCH_PUSHDOWN.*$)", options: "i"}
                     ...
                     {coll1: {rename: ["newColl1"]}, coll2: {rename: ["newColl2"]}},
                     [2, 0] /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({$match: {"to.db": /(^unknown$|^change_stream_match_pushdown.*$)/}},
                     {coll1: {rename: ["newColl1"]}, coll2: {rename: ["newColl2"]}},
                     [2, 0] /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({
    $match: {
...
verifyOnWholeCluster(
    {$match: {$expr: {$eq: ["$to.db", "unknown"]}}}, {}, 0 /* expectedOplogRetDocsForEachShard*/);
...
verifyOnWholeCluster(
    {$match: {$expr: {$eq: ["$to.db", ""]}}}, {}, 0 /* expectedOplogRetDocsForEachShard*/);

// Ensure that the '$match' on sub field of db and equivalent '$expr' expression should not return
// any document and oplog should not return any document for each shard.
verifyOnWholeCluster(
    {$match: {"to.db.extra": dbName}}, {}, 0 /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({$match: {$expr: {$eq: ["$to.db.extra", dbName]}}},
                     {},
                     0 /* expectedOplogRetDocsForEachShard*/);
...
verifyOnWholeCluster({$match: {"to.coll": "newColl1"}},
                     {coll1: {rename: ["newColl1"]}},
                     [1, 0] /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({$match: {$expr: {$eq: ["$to.coll", "newColl1"]}}},
                     {coll1: {rename: ["newColl1"]}},
                     [1, 0] /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({$match: {"to.coll": "newColl2"}},
                     {coll2: {rename: ["newColl2"]}},
                     [1, 0] /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({$match: {$expr: {$eq: ["$to.coll", "newColl2"]}}},
                     {coll2: {rename: ["newColl2"]}},
                     [1, 0] /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({$match: {"to.coll": /^newColl.*1/}},
                     {coll1: {rename: ["newColl1"]}},
                     [1, 0] /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({$match: {$expr: {$regexMatch: {input: "$to.coll", regex: "^newColl.*1"}}}},
                     {coll1: {rename: ["newColl1"]}},
                     [1, 0] /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({$match: {"to.coll": /^newColl.*2/}},
                     {coll2: {rename: ["newColl2"]}},
                     [1, 0] /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({$match: {$expr: {$regexMatch: {input: "$to.coll", regex: "^newColl.*2"}}}},
                     {coll2: {rename: ["newColl2"]}},
                     [1, 0] /* expectedOplogRetDocsForEachShard*/);
...
verifyOnWholeCluster({$match: {"to.coll": /^newColl.*/}},
                     {coll1: {rename: ["newColl1"]}, coll2: {rename: ["newColl2"]}},
                     [2, 0] /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({$match: {$expr: {$regexMatch: {input: "$to.coll", regex: "^newColl.*"}}}},
                     {coll1: {rename: ["newColl1"]}, coll2: {rename: ["newColl2"]}},
                     [2, 0] /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({$match: {"to.coll": /^newColl.*/i}},
                     {coll1: {rename: ["newColl1"]}, coll2: {rename: ["newColl2"]}},
                     [2, 0] /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster(
    ...
    {coll1: {rename: ["newColl1"]}, coll2: {rename: ["newColl2"]}},
    [2, 0] /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({$match: {"to.coll": /^newColl.*1$|^newColl.*2$/}},
                     {coll1: {rename: ["newColl1"]}, coll2: {rename: ["newColl2"]}},
                     [2, 0] /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster(
...
verifyOnWholeCluster(
    {$match: {$expr: {$eq: ["$to.coll", "unknown"]}}}, {}, 0 /* expectedOplogRetDocsForEachShard*/);
...
verifyOnWholeCluster(
    {$match: {$expr: {$eq: ["$to.coll", ""]}}}, {}, 0 /* expectedOplogRetDocsForEachShard*/);

// Ensure that the '$match' on sub field of collection and equivalent '$expr' expression should not
// return any document and oplog should not return any document for each shard.
verifyOnWholeCluster(
    {$match: {"to.coll.extra": "coll1"}}, {}, 0 /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({$match: {$expr: {$eq: ["$to.coll.extra", "coll1"]}}},
                     {},
                     0 /* expectedOplogRetDocsForEachShard*/);
...
verifyOnWholeCluster({$match: {"to.db": {$in: [dbName, "unknown"]}}},
                     {coll1: {rename: ["newColl1"]}, coll2: {rename: ["newColl2"]}},
                     [2, 0] /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({$match: {$expr: {$in: ["$to.db", [dbName, "unknown"]]}}},
                     {coll1: {rename: ["newColl1"]}, coll2: {rename: ["newColl2"]}},
                     [2, 0] /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({$match: {"to.db": {$in: [/^change_stream_match.*$/, /^unknown$/]}}},
                     {coll1: {rename: ["newColl1"]}, coll2: {rename: ["newColl2"]}},
                     [2, 0] /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({
    $match: {
        $expr: {
            $or: [
                ...
                {$regexMatch: {input: "$to.db", regex: "^unknown$"}}
                     ...
                     {coll1: {rename: ["newColl1"]}, coll2: {rename: ["newColl2"]}},
                     [2, 0] /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({$match: {"to.db": {$in: [/^change_stream_MATCH.*$/i, /^unknown$/i]}}},
                     {coll1: {rename: ["newColl1"]}, coll2: {rename: ["newColl2"]}},
                     [2, 0] /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({
    $match: {
...
verifyOnWholeCluster(
    {$match: {$expr: {$in: ["$to.db", []]}}}, {}, 0 /* expectedOplogRetDocsForEachShard*/);

// Ensure that '$in' with invalid db cannot be rewritten and oplog should return all documents for
// each shard.
verifyOnWholeCluster({$match: {"to.db": {$in: [dbName, 1]}}},
                     {coll1: {rename: ["newColl1"]}, coll2: {rename: ["newColl2"]}},
...
verifyOnWholeCluster({$match: {$expr: {$in: ["$to.db", [dbName, 1]]}}},
                     {coll1: {rename: ["newColl1"]}, coll2: {rename: ["newColl2"]}},
                     [2, 0] /* expectedOplogRetDocsForEachShard*/);
...
verifyOnWholeCluster({$match: {"to.db": {$in: ["unknown1", /^unknown2$/]}}},
                     {},
                     0 /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({
    $match: {
...
verifyOnWholeCluster({
    $match:
        {$expr: {$in: ["$to", [{db: dbName, coll: "newColl1"}, {db: dbName, coll: "newColl2"}]]}}
                     ...
                     {coll1: {rename: ["newColl1"]}, coll2: {rename: ["newColl2"]}},
                     [2, 0] /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({$match: {"to.coll": {$in: ["newColl1", "newColl2"]}}},
                     {coll1: {rename: ["newColl1"]}, coll2: {rename: ["newColl2"]}},
                     [2, 0] /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({$match: {$expr: {$in: ["$to.coll", ["newColl1", "newColl2"]]}}},
                     {coll1: {rename: ["newColl1"]}, coll2: {rename: ["newColl2"]}},
                     [2, 0] /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({$match: {"to.coll": {$in: [/^newColl1$/, /^newColl2$/]}}},
                     {coll1: {rename: ["newColl1"]}, coll2: {rename: ["newColl2"]}},
...
// same for each shard.
verifyOnWholeCluster({$match: {"to.coll": {$in: [/^newColl.*$/, /^unknown.*/]}}},
                     {coll1: {rename: ["newColl1"]}, coll2: {rename: ["newColl2"]}},
                     [2, 0] /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({
    $match: {
        $expr: {
            $or: [
                ...
                {$regexMatch: {input: "$to.coll", regex: "^unknown.*"}}
                     ...
                     {coll1: {rename: ["newColl1"]}, coll2: {rename: ["newColl2"]}},
                     [2, 0] /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({$match: {"to.coll": {$in: [/^newcoll.*$/i, /^unknown/i]}}},
                     {coll1: {rename: ["newColl1"]}, coll2: {rename: ["newColl2"]}},
                     [2, 0] /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({
    $match: {
...
verifyOnWholeCluster({$match: {"to.coll": {$in: ["newColl1", 1]}}},
                     {coll1: {rename: ["newColl1"]}},
                     [6, 4] /* expectedOplogRetDocsForEachShard*/);
...
verifyOnWholeCluster({$match: {$expr: {$in: ["$to.coll", ["newColl1", 1]]}}},
                     {coll1: {rename: ["newColl1"]}},
                     [1, 0] /* expectedOplogRetDocsForEachShard*/);
...
verifyOnWholeCluster({$match: {"to.coll": {$in: ["newColl1", /^newColl.*2$/]}}},
                     {coll1: {rename: ["newColl1"]}, coll2: {rename: ["newColl2"]}},
                     [2, 0] /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({
    $match: {
...
verifyOnWholeCluster({$match: {"to.coll": {$in: ["unknown1", /^unknown2$/]}}},
                     {},
                     0 /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({
    $match: {
...
verifyOnWholeCluster({$match: {"to.db": {$nin: []}}},
                     {
                         coll1: {insert: [3, 4, 5, 6], rename: ["newColl1"]},
                         coll2: {insert: [7, 8, 9, 10], rename: ["newColl2"]}
                     },
                     [6, 4] /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({$match: {$expr: {$not: {$in: ["$to.db", []]}}}},
                     {
                         coll1: {insert: [3, 4, 5, 6], rename: ["newColl1"]},
                         coll2: {insert: [7, 8, 9, 10], rename: ["newColl2"]}
                     },
                     [6, 4] /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({$match: {"to.db": {$nin: ["unknown1", "unknown2"]}}},
                     {
                         coll1: {insert: [3, 4, 5, 6], rename: ["newColl1"]},
                         coll2: {insert: [7, 8, 9, 10], rename: ["newColl2"]}
                     },
                     [6, 4] /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({$match: {$expr: {$not: {$in: ['$to.db', ["unknown1", "unknown2"]]}}}},
                     {
                         coll1: {insert: [3, 4, 5, 6], rename: ["newColl1"]},
                         coll2: {insert: [7, 8, 9, 10], rename: ["newColl2"]}
                     },
...
verifyOnWholeCluster({$match: {"to.db": {$nin: [dbName, "unknown"]}}},
                     {coll1: {insert: [3, 4, 5, 6]}, coll2: {insert: [7, 8, 9, 10]}},
                     4 /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({$match: {$expr: {$not: {$in: ["$to.db", [dbName, "unknown"]]}}}},
                     {coll1: {insert: [3, 4, 5, 6]}, coll2: {insert: [7, 8, 9, 10]}},
                     4 /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster(
...
verifyOnWholeCluster({$match: {"to.coll": {$nin: [/^newColl.*$/, /^unknown.*$/]}}},
                     {coll1: {insert: [3, 4, 5, 6]}, coll2: {insert: [7, 8, 9, 10]}},
                     4 /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({
    $match: {
...
// for each shard.
verifyOnWholeCluster({$match: {"to.coll": {$nin: []}}},
                     {
                         coll1: {insert: [3, 4, 5, 6], rename: ["newColl1"]},
                         coll2: {insert: [7, 8, 9, 10], rename: ["newColl2"]}
                     },
                     [6, 4] /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({$match: {$expr: {$not: {$in: ["$to.coll", []]}}}},
                     {
                         coll1: {insert: [3, 4, 5, 6], rename: ["newColl1"]},
                         coll2: {insert: [7, 8, 9, 10], rename: ["newColl2"]}
                     },
...
verifyOnWholeCluster({$match: {"to.coll": {$nin: ["newColl1", /^newColl2$/]}}},
                     {coll1: {insert: [3, 4, 5, 6]}, coll2: {insert: [7, 8, 9, 10]}},
                     4 /* expectedOplogRetDocsForEachShard*/);
verifyOnWholeCluster({
    $match: {
