...
// Create a new change stream cursor filtering out the resume point (SERVER-71565) while projecting
// out the '_id' field.
const csCursor2 = testColl.watch(
    [{$match: {"fullDocument._id": {$gt: 1}}}, {$project: {fullDocument: 1, _id: 0}}], {
