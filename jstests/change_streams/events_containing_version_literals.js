...
setUp();
jsTestLog("tests that updates using $v inside an object literal succeed with upsert when the source documents do not exist");
["test", 1, 2, "1", "2"].forEach((v, i) => {
...
setUp();
jsTestLog("tests that updates using $v inside $set and an object literal succeed with upsert when the source documents do not exist");
...
setUp();
jsTestLog("tests that pipeline updates using $v inside using $replaceWith and an object literal fail");
["test", 1, 2, "1", "2"].forEach((v, i) => {
...
setUp();
jsTestLog("tests that updates using $v inside $replaceWith and $setField and an object literal succeed");
["test", 1, 2, "1", "2"].forEach((v, i) => {
    assert.commandWorked(
