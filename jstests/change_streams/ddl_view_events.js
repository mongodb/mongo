...
function runViewEventAndResumeTest(showSystemEvents) {
    ...
    if (showSystemEvents) {
        ...
        let modifyBucketsEventCopy = Object.assign({}, modifyBucketsEvent);
        modifyBucketsEventCopy = canonicalizeEventForTesting(modifyBucketsEventCopy, expected);
        delete modifyBucketsEventCopy.stateBeforeChange;

        assertChangeStreamEventEq(modifyBucketsEventCopy, expected);
    }
