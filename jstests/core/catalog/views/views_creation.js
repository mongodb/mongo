...
// error code.
assert.commandFailedWithCode(
    viewsDB.runCommand({create: "system.foo", viewOn: "collection"}),
    ErrorCodes.InvalidNamespace,
...
assert(
    arrayEq(res.cursor.firstBatch, expectedListCollectionsOutput),
    tojson({
...
assert.commandFailedWithCode(
    viewsDB.runCommand({create: "collection", viewOn: "collection"}),
    ErrorCodes.NamespaceExists,
);
