...
const collScans = getPlanStages(
    getWinningPlanFromExplain(coll.find(exprQuery).explain()),
    "COLLSCAN",
);
...
ixScans = getPlanStages(
    getWinningPlanFromExplain(coll.find(exprQuery).hint("missing_1_sparse").explain()),
    "IXSCAN",
);
