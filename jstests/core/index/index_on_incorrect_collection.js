 ...
 *   requires_fcv_83,
 *   # Sharded passthroughs that implicitly shard the test collection can race chunk migrations
 *   # with this test's dropIndex/insert sequence.
...
describe("Nonfatal error when attempting to update an improper timeseries-only index on a non-timeseries collection.", function () {
    ...
    it("Prevents updating 2dsphere_bucket indices for top-level measurements", function () {
        ...
        assert.commandFailedWithCode(this.coll.insert(sampleDoc), 12113200);
