...
assert.writeErrorWithCode(
    coll.insert({a: {b: []}, words: "omnibus"}),
    ErrorCodes.CannotBuildIndexKeys,
);
assert.writeErrorWithCode(
    coll.insert({a: {b: [1]}, words: "omnibus"}),
    ErrorCodes.CannotBuildIndexKeys,
);
assert.writeErrorWithCode(
    coll.insert({a: {b: [1, 2]}, words: "omnibus"}),
    ErrorCodes.CannotBuildIndexKeys,
);
...
assert.writeErrorWithCode(
    coll.insert({a: [{b: 1}, {b: 2}], words: "omnibus"}),
    ErrorCodes.CannotBuildIndexKeys,
);
...
assert.writeErrorWithCode(
    coll.insert({words: "macerate", y: {z: []}}),
    ErrorCodes.CannotBuildIndexKeys,
);
assert.writeErrorWithCode(
    coll.insert({words: "macerate", y: {z: [1]}}),
    ErrorCodes.CannotBuildIndexKeys,
);
assert.writeErrorWithCode(
    coll.insert({words: "macerate", y: {z: [1, 2]}}),
    ErrorCodes.CannotBuildIndexKeys,
);
...
assert.writeErrorWithCode(
    coll.insert({words: "macerate", y: [{z: 1}, {z: 2}]}),
    ErrorCodes.CannotBuildIndexKeys,
);
...
assert.writeErrorWithCode(
    coll.insert({a: [[8, 9], 1, 2], words: "dander"}),
    ErrorCodes.CannotBuildIndexKeys,
);
coll.drop();
