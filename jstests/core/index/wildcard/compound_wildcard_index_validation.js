...
assert.commandFailedWithCode(
    coll.createIndex({a: 1, "$**": 1}, {wildcardProjection: {}}),
    ErrorCodes.FailedToParse,
);

// Tests that a wildcardProjection is not allowed for non-wildcard indexes.
assert.commandFailedWithCode(
    coll.createIndex({a: 1, b: 1}, {wildcardProjection: {c: 1}}),
    ErrorCodes.BadValue,
);

// Tests that wildcardProjection cannot include regular index fields.
assert.commandFailedWithCode(
    coll.createIndex({a: 1, "$**": 1}, {wildcardProjection: {a: 1}}),
    7246208,
);
assert.commandFailedWithCode(
    coll.createIndex({a: 1, "$**": 1}, {wildcardProjection: {a: 1, b: 1}}),
    7246208,
);
assert.commandFailedWithCode(
    coll.createIndex({a: 1, "$**": 1, b: 1}, {wildcardProjection: {a: 1, b: 1}}),
    7246208,
);
assert.commandFailedWithCode(
    coll.createIndex({_id: 1, "$**": 1}, {wildcardProjection: {_id: 1}}),
    7246208,
);

// Tests that a wildcardProjection can only mix inclusion/exclusion projections with _id.
assert.commandFailedWithCode(
    coll.createIndex({"$**": 1, c: 1}, {wildcardProjection: {_id: 0, a: 0, b: 1}}),
    7246211,
);
assert.commandFailedWithCode(
    coll.createIndex({"$**": 1, c: 1}, {wildcardProjection: {_id: 1, a: 0, b: 1}}),
    7246211,
);
...
assert.commandFailedWithCode(
    coll.createIndex({"st": 1, "$**": 1}, {wildcardProjection: {"a": "something"}}),
    51271,
);

// Tests that just excluding _id is not valid in the wildcardProjection, unless the regular part is _id.
assert.commandFailedWithCode(
    coll.createIndex({"a": 1, "$**": 1}, {wildcardProjection: {"_id": 0}}),
    7246210,
);
assert.commandFailedWithCode(
    coll.createIndex({"$**": 1, "a": 1}, {wildcardProjection: {"_id": 0}}),
    7246210,
);
assert.commandFailedWithCode(
    coll.createIndex({"b": 1, "$**": 1, "a": 1}, {wildcardProjection: {"_id": 0}}),
    7246210,
);
...
assert.commandFailedWithCode(
    coll.createIndex({"_id": 1, "$**": 1, "a": 1}, {wildcardProjection: {"_id": 0}}),
    7246210,
);
...
assert.commandFailedWithCode(
    coll.createIndex({"a": 1, "_id": 1, "$**": 1}, {wildcardProjection: {"a": 0}}),
    7246209,
);
assert.commandFailedWithCode(
    coll.createIndex({"a": 1, "b": 1, "$**": 1}, {wildcardProjection: {"b": 0}}),
    7246209,
);
assert.commandWorked(
...
assert.commandFailedWithCode(
    coll.createIndex({"b": 1, "$**": 1}, {wildcardProjection: {"_id": 0, "a": 0}}),
    7246210,
);
assert.commandFailedWithCode(
    coll.createIndex({"a": 1, "$**": 1}, {wildcardProjection: {"_id": 0, "a": 1}}),
    7246208,
);
assert.commandFailedWithCode(
    coll.createIndex({"a": 1, "$**": 1}, {wildcardProjection: {"_id": 1, "a": 1}}),
    7246208,
);
assert.commandFailedWithCode(
    coll.createIndex({"_id": 1, "$**": 1}, {wildcardProjection: {"_id": 1, "a": 1}}),
    7246208,
);
assert.commandFailedWithCode(
    coll.createIndex({"$**": 1, "d": 1}, {wildcardProjection: {"_id": 1, e: 0}}),
    7246209,
);
...
assert.commandFailedWithCode(
    coll.createIndex({"a": 1, "$**": 1}, {wildcardProjection: {"_id": 0, "a.b": 0}}),
    7246209,
);
assert.commandWorked(
...
assert.commandFailedWithCode(
    coll.createIndex({"$**": 1, "e": 1}, {wildcardProjection: {"_id": 1, "e.b": 0}}),
    7246209,
);
assert.commandFailedWithCode(
