...
assertKeysExamined(
    19,
    {age: {$gte: 25, $lte: 30}, rating: {$in: [0, 9]}},
    {age: 1, rating: 1},
    "C1",
);
assertKeysExamined(
    24,
    {age: {$gte: 25, $lte: 30}, rating: {$in: [0, 8]}},
    {age: 1, rating: 1},
    "C2",
);
assertKeysExamined(
    29,
    {age: {$gte: 25, $lte: 30}, rating: {$in: [1, 8]}},
    {age: 1, rating: 1},
    "C3",
);
...
assert.eq(
    2,
    t.find({age: 30, rating: {$gte: 4, $lte: 5}}).explain("executionStats").executionStats
        .totalKeysExamined,
);
