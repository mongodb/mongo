...
// Check bucket collection. We are using all unique metadata values so each measurement should be
// in its own bucket.
...
assert.commandWorked(
    coll.createIndex(indexKey,
                     {name: 'index_string', collation: {locale: 'en_US', numericOrdering: false}}),
    'failed to create index: ' + tojson(indexKey));
