...
(function() {
    ...
    function executeQueryTestCase(testCase) {
        ...
        assert.writeOK(coll.insert(testCase.inputDocuments));
    ...
    const testCases = [
        ...
        },
        {
          ...
          // on the suffix of the index key returns correct results when the index is a compound
          // index
          // with a non-simple collation and the query has a collation specified matching collation
          // of
          // the index.
          indexes: [{a: 1, b: 1}],
        ...
        {
          // Verifies that a collatable $or query on the prefixes of the keys of 3 indexes, and a
          // sort
          // on a suffix of the keys of indexes returns correct results when the indexes are
          // compound
          ...
          // 'e'/'g' that are not covered by the indexes therefore triggers addition of a FETCH
          // stage
        ...
        {
          // Verifies that an $or query on the prefixes of index keys, and a sort on the suffix of
          // the
        ...
        },
        {
          ...
          // collatable sort on the suffix of the index key returns correct results when the index
          // is
        ...
        {
          // Verifies that a non-collatable $or query on the prefixes of the index keys, and a sort
          // on
        ...
        },
        {
          ...
          // index key, and a sort on a suffix of an index key returns correct results when the
          // index
          // is a compound index.
          indexes: [{a: 1, c: 1}],
          filter: {a: {$in: [1, 2]}},
