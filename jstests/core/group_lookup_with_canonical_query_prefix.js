...
try {
    originalParamValue = db.adminCommand({getParameter: 1, internalQueryForceClassicEngine: 1});
    ...
    assert.commandWorked(db.adminCommand({
        setParameter: 1,
        internalQueryForceClassicEngine: originalParamValue.internalQueryForceClassicEngine
    }));
}
