...
assert.eq(0, coll.find({a: {$mod: [10, 1]}}).explain("executionStats").executionStats.totalKeysExamined, "A3");
...
assert.eq(4, coll.find({a: {$mod: [10, 1]}}).explain("executionStats").executionStats.totalKeysExamined, "B5");
