...
runWithAndWithoutIndex({a: 1}, () => {
    assert(
        arrayEq(t.find({a: "foo"}, {_id: 0}).toArray(), [
            {a: [123, "foo"]},
            {a: ["foo", 123]},
            {a: ["bar", "foo"]},
            {a: ["bar", "baz", "foo"]},
...
runWithAndWithoutIndex({"a.b": 1}, () => {
    assert(
        arrayEq(t.find({"a.b": "foo"}, {_id: 0}).toArray(), [
            {a: [{}, {b: "foo"}]},
            {a: [{b: "foo"}, {}]},
            {a: [{b: 123}, {b: "foo"}]},
            {a: [{b: "foo"}, {b: 123}]},
...
runWithAndWithoutIndex({"a.b": 1}, () => {
    assert(
        arrayEq(t.find({"a.b.c": 5}, {_id: 0}).toArray(), [
            {"a": [{"b": [{"c": [5, 7]}]}]},
            {"a": [{"b": []}, {"b": [{"c": [5, 7]}]}]},
        ]),
    );
    assert(
        arrayEq(t.find({"a.b.c": {$eq: 5}}, {_id: 0}).toArray(), [
            {"a": [{"b": [{"c": [5, 7]}]}]},
            {"a": [{"b": []}, {"b": [{"c": [5, 7]}]}]},
        ]),
    );
    ...
    assert(
        arrayEq(t.find({"a.b.c": {$in: [5]}}, {_id: 0}).toArray(), [
            {"a": [{"b": [{"c": [5, 7]}]}]},
            {"a": [{"b": []}, {"b": [{"c": [5, 7]}]}]},
        ]),
    );
    ...
    assert(
        arrayEq(t.find({"a.b.c": {$size: 2}}, {_id: 0}).toArray(), [
            {"a": [{"b": [{"c": [5, 7]}]}]},
            {"a": [{"b": []}, {"b": [{"c": [5, 7]}]}]},
        ]),
    );
    ...
    assert(
        arrayEq(t.find({"a.b.c": {$elemMatch: {$eq: 5}}}, {_id: 0}).toArray(), [
            {"a": [{"b": [{"c": [5, 7]}]}]},
            {"a": [{"b": []}, {"b": [{"c": [5, 7]}]}]},
        ]),
    );
...
runWithAndWithoutIndex({a: 1}, () => {
    ...
    assert(
        arrayEq(t.find({a: {$gt: [2]}}, {_id: 0}).toArray(), [
            {a: [3]},
            {a: [3, 1]},
            {a: [3, 2]},
            {a: [3, 2, 1]},
    ...
    assert(
        arrayEq(t.find({a: {$lt: [1, 2]}}, {_id: 0}).toArray(), [
            {a: [1]},
            {a: [[1]]},
            {a: [3, [1]]},
            {a: [[1], 2]},
    ...
    assert(
        arrayEq(t.find({a: {$gt: [1, 2]}}, {_id: 0}).toArray(), [
            {a: [2]},
            {a: [3]},
            {a: [3, 1]},
            {a: [3, 2]},
