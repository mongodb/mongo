...
(function () {
    ...
    assert.commandWorked(source.mapReduce(map, reduce, {out: {merge: outName}, query: {_id: {$gt: 3}}}));
    ...
    assert.commandWorked(source.mapReduce(map, reduce, {out: {merge: outName}, query: {_id: {$gt: 4}}}));
...
(function () {
    ...
    assert.commandWorked(source.mapReduce(map, reduce, {out: {merge: outName}, query: {_id: {$gt: 0}}}));
