...
runTest(
    {query: {a: 1}, sort: {_id: -1}, projection: {c: 0}},
    [{_id: 0, a: 1}],
...
runTest(
    {query: {$and: [{a: 3}, {a: 6}]}, projection: {_id: 1}},
    [{_id: 5}],
...
runTest(
    {query: {$or: [{a: 3}, {a: 6}]}, projection: {_id: 1}},
    [{_id: 2}, {_id: 5}, {_id: 6}],
...
runTest(
    {query: {$nor: [{a: 3}, {a: 6}], a: {$type: "number"}}, projection: {_id: 1}},
...
runTest(
    {query: {$and: [{a: {$ne: 4}}, {a: {$type: "number"}}]}, projection: {_id: 1}},
...
runTest(
    {query: {$and: [{a: {$not: {$lt: 4}}}, {a: {$type: "number"}}]}, projection: {_id: 1}},
    [{_id: 3}, {_id: 4}],
...
runTest(
    {query: {a: {$exists: true}}, projection: {_id: 1}},
    [
        {_id: 0},
        {_id: 1},
        {_id: 2},
...
runTest(
    {query: {$expr: {$eq: ["$a", 3]}}, projection: {_id: 1}},
    [{_id: 2}],
...
runTest(
    {query: {$expr: {$lt: ["$a", 3]}, a: {$type: "number"}}, projection: {_id: 1}},
    [{_id: 0}, {_id: 1}],
...
runTest(
    {query: {$expr: {$lte: ["$a", 3]}, a: {$type: "number"}}, projection: {_id: 1}},
    [{_id: 0}, {_id: 1}, {_id: 2}],
...
runTest(
    {query: {$expr: {$gt: ["$a", 2]}, a: {$type: "number"}}, projection: {_id: 1}},
    [{_id: 2}, {_id: 3}, {_id: 4}, {_id: 5}, {_id: 6}],
...
runTest(
    {query: {$expr: {$gte: ["$a", 2]}, a: {$type: "number"}}, projection: {_id: 1}},
...
// there is a sort.
runTest(
    {query: {a: {$in: [1, 2]}}, projection: {_id: 1}, sort: {a: 1}},
    [{_id: 0}, {_id: 1}],
    {query: {a: {$in: [1, 2, 3, 4]}}, projection: {_id: 1}},
    [{_id: 0}, {_id: 1}, {_id: 2}, {_id: 3}, {_id: 4}, {_id: 5}, {_id: 6}],
    false,
...
runTest(
    {query: {a: {$mod: [2, 0]}}, projection: {_id: 1}},
...
runTest(
    {query: {a: {$size: 4}}, projection: {_id: 1}},
    [{_id: 5}],
...
runTest(
    {query: {$where: "this.a == 1;"}, projection: {_id: 1}},
    [{_id: 0}],
...
runTest(
    {query: {a: {$type: "double"}}, projection: {_id: 1}},
    [{_id: 0}, {_id: 1}, {_id: 2}, {_id: 3}, {_id: 4}, {_id: 5}, {_id: 6}],
