...
assert(
    arrayEq(
        coll
            .find({a: {$elemMatch: {b: {$elemMatch: {}}, c: {$elemMatch: {}}}}}, {_id: 0})
            .toArray(),
        [
            {
                a: [
...
assert(
    arrayEq(
        coll
            .find({a: {$elemMatch: {b: {$elemMatch: {w: 1, x: 2}}, c: {$elemMatch: {}}}}}, {_id: 0})
            .toArray(),
        [
            {
                a: [
...
assert(
    arrayEq(
        coll
            .find(
                {a: {$elemMatch: {b: {$elemMatch: {w: 1, x: 2}}, c: {$elemMatch: {y: 3, z: 4}}}}},
                {_id: 0},
            )
            .toArray(),
        [
