...
testSingleDocument(
    {_id: 0, x: {$elemMatch: {a: 1}}, y: {$elemMatch: {c: 3}}},
    {
        x: [
            {a: 1, b: 2},
            {a: 3, b: 4},
...
testSingleDocument(
    {x: {$elemMatch: {$ref: "otherCollection2"}}},
    {
        x: [
            new DBRef("otherCollection", "id0", db.getName()),
            new DBRef("otherCollection", "id1", db.getName()),
