...
describe("upgrade to constraint preconditions", function () {
    ...
    it("fails to set prepareConstraintValidationLevel on a collection already at constraint", function () {
        create({validator, validationLevel: "strict"});
        ...
        assert.commandFailed(collMod({prepareConstraintValidationLevel: true}));
    });
