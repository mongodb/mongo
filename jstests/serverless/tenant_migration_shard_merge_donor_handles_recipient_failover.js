/**
 * Tests that donor is able to implicitly abort the migration upon recipient failover.
 *
 * @tags: [
...
jsTestLog("Stepdown recipient primary");
recipientRst.freeze(recipientPrimary);

// Unblock merge recipient.
...
jsTestLog("Stepup recipient primary");
recipientRst.unfreeze(recipientPrimary);
recipientRst.stepUp(recipientPrimary);
