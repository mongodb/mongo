...
files.forEach(
	...
	if (/[\/\\](dbadmin|error1|fsync|fsync2|geo.*|indexh|remove5|update4|loglong|bnotablescan|compact.*|check_shard_index|bench_test.*|mr_replaceIntoDB|mr_auth)\.js$/.test(x.name)) {
