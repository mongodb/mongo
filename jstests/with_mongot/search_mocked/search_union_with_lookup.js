...
import {getMongotStagesAndValidateExplainExecutionStats} from "jstests/with_mongot/mongotmock/lib/utils.js";
...
function searchWithLookup({localField, times}) {
    const lookupSearchQuery = setupSearchQuery(
        "cakes",
        times,
        [
...
const lookupWithMatch = setupSearchQuery(
    "cakes",
    1,
    [
        {_id: 1, $searchScore: 0.99},
        {_id: 2, $searchScore: 0.2},
...
const unionSearchQuery = setupSearchQuery(
    "cakes",
    1,
    [
        {_id: 1, $searchScore: 0.9},
...
const multiUnionSearch = setupSearchQuery(
    "cakes",
    2,
    [
        {_id: 1, $searchScore: 0.9},
...
const multiLookupSearch = setupSearchQuery(
    "cakes",
    2,
    [
        {_id: 1, $searchScore: 0.9},
...
const unionSubSearch = setupSearchQuery(
    "cakes",
    1,
    [
        {_id: 1, $searchScore: 0.9},
...
const lookupSubSearchMeta = setupSearchQuery(
    "cakes",
    1,
    [
        {_id: 1, $searchScore: 0.9},
...
const lookupSubSearchMeta2 = [{_id: 1, title: "cakes", arr: [{value: "metaVal"}]}];

assert.sameMembers(result.cursor.firstBatch, lookupSubSearchMeta2);

// Reset the history for the next test.
let cookiesQuery = setupSearchQuery("cookies", 1, [{_id: 2, $searchScore: 0.6}], 2);
...
const unionSubSearchMeta = setupSearchQuery(
    "cakes",
    1,
    [
        {_id: 1, $searchScore: 0.9},
...
const unionSubSearchMetaResults = [{_id: 1, title: "cakes"}, {value: "metaVal"}];
...
const searchMetaTestGenericQuery = setupSearchQuery(
    "cakes",
    2,
    [
        {_id: 1, $searchScore: 0.9},
...
const searchMetaTestExpected2 = [{value: "outer"}, {value: "inner"}];
...
const viewSearchQuery = setupSearchQuery(
    "cakes",
    1,
    [
        {_id: 1, $searchScore: 0.9},
...
assert.commandWorked(
    db.createView(view1.getName(), collBase.getName(), [
        {$project: {"localField": 1, "_id": 0}},
...
const viewSearchQuery2 = setupSearchQuery(
    "cakes",
    1,
    [
        {_id: 1, $searchScore: 0.9},
...
const nestedLookupQuery = setupSearchQuery(
    "cakes",
    1,
    [
        {_id: 1, $searchScore: 0.9},
...
const unionSearchViewQuery = setupSearchQuery(
    "cakes",
    1,
    [
        {_id: 1, $searchScore: 0.9},
...
const successfulSearchThenMetaLookup = setupSearchQuery(
    "cakes",
    1,
    [
        {_id: 1, $searchScore: 0.9},
...
for (const currentVerbosity of ["executionStats", "allPlansExecution"]) {
    ...
    {
        const unionSearchQueryExplain = setupSearchQuery(
            "cakes",
            1,
            [
                {_id: 1, $searchScore: 0.9},
    ...
    {
        const unionSubSearchMetaExplain = setupSearchQuery(
            "cakes",
            1,
            [
                {_id: 1, $searchScore: 0.9},
    ...
    {
        const lookupSearchQueryExplain = setupSearchQuery(
            "cakes",
            1,
            [
                {_id: 1, $searchScore: 0.9},
    ...
    {
        const lookupSearchMetaExplain = setupSearchQuery(
            "cakes",
            1,
            [
                {_id: 1, $searchScore: 0.9},
