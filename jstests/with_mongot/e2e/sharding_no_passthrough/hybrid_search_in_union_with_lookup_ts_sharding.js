...
function shardCollection({collName, key, split, moveChunk, timeseries}) {
    let fullName = testDb[collName].getFullName();
    if (timeseries) {
        fullName = getTimeseriesCollForDDLOps(db, testDb[collName]).getFullName();
    }
