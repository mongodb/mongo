...
assert.commandWorked(
    reviewColl.insertMany([
        ...
        },
        {
            _id: 6,
            productId: 3,
            review: "Don't know what ppl are saying - perfectly fine battery. Maybe your battery was out of juice from the start. Try buying new batteries",
        },
    ]),
);
    ...
    let lookupPipeline = [
        {
            $lookup: {
                ...
                pipeline: [{$search: searchQuery}, {$project: {_id: 0}}],
                as: "batteryReviews",
            },
        },
        {
