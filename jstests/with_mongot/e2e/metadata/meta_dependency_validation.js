 ...
 * relevant metadata fields, then a stage that tries to reference a metadata field. We verify based
 * on a set of rules if the reference to the metadata value should pass validation or fail.
 *
