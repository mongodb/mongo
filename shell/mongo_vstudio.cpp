...
"__quiet = false;\n"
 ...
 "var extraGlobals = \"Infinity NaN undefined null decodeURI decodeURIComponent encodeURI encodeURIComponent escape eval isFinite isNaN parseFloat parseInt unescape Array Boolean Date Math Number RegExp String\".split(' ');\n"
 "var isPrivate = function(name){\n"
 "if (shellAutocomplete.showPrivate) return false;\n"
 "if (name == '_id') return false;\n"
 "if (name[0] == '_') return true;\n"
 "if (name[name.length-1] == '_') return true;\n"
 "return false;}\n"
 ...
 "print(\"\\nautocomleters must return real Arrays\");\n"
 "return [];}\n"
 "return ret;\n"
 "} else {\n"
 "return [];}\n"
 ...
 "builtinMethods[curObj] || [],\n"
 "builtinMethods[curObj.constructor] || [],\n"
 ...
 "if (curObj[p] === undefined && curObj != global) continue;\n"
