...
def get_toolchain_ver(env, tool):
    ...
    # command gets executed (gcc vs /opt/bongodbtoolchain/bin/gcc).
...
# printed by the --version command-line option to bongod.
...
def default_buildinfo_environment_data():
    return (
        ('distmod', '$BONGO_DISTMOD', True, True,),
        ('distarch', '$BONGO_DISTARCH', True, True,),
...
# env['BONGO_BUILDINFO_ENVIRONMENT_DATA'] = empty_buildinfo_environment_data()
