...
namespace mongo {
    ...
    void V8Scope::localConnect( const char * dbName ) {
        {
            ...
            _global->Set( v8::String::New( "Mongo" ) , getMongoFunctionTemplate( this, true )->GetFunction() );
            execCoreFiles();
    ...
    void V8Scope::externalSetup() {
        ...
        _global->Set( v8::String::New( "Mongo" ) , getMongoFunctionTemplate( this, false )->GetFunction() );
        execCoreFiles();
    ...
    BSONObj V8Scope::v8ToMongo( v8::Handle<v8::Object> o , int depth ) {
        ...
        if ( depth == 0 ) {
            v8::Handle<v8::String> idName = V8STR_ID;
