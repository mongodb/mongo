...
btree_stats = {
    ...
    'FILE_HUFFMAN_VALUE' : Stat('file: huffman value compression in bytes'),
    'FILE_ITEMS_INSERTED' : Stat('file: key/value pairs inserted'),
    'FILE_OVERFLOW_DATA' : Stat('file: overflow values inserted'),
