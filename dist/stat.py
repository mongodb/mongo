...
for line in open('../inc_posix/stat.h', 'r'):
	...
	if line.count('Statistics section: END'):
		...
		print_def('DB/IDB handle', 'DB', stat_class.idb_dstats)
		print_def('DB/IDB database', 'DATABASE', stat_class.idb_stats)
...
print_func('DB', stat_class.idb_dstats)
print_func('DATABASE', stat_class.idb_stats)
