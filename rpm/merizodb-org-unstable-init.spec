...
%package server
Summary: MerizoDB database server
Group: Applications/Databases
...
%package merizos
Summary: MerizoDB sharded cluster query router
Group: Applications/Databases
