...
cd $TOP/src/server
g++ -O -Igen-cpp -I$THRIFT_HOME/include/thrift -Iinclude -I../../include -o WiredTiger_server WiredTiger_server.cpp gen-cpp/wiredtiger_*.cpp ../api/api.c $THRIFT_HOME/lib/libthrift.a
