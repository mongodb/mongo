...
def get_visibility(
    ...
    default_vis = file_level_visibility.get(normpath, default_vis)
...
class Decl:
    ...
    visibility: str
    alt: str
    vis_from: dict[str, str] | None
    vis_from_non_ns: dict[str, str] | None
    sem_par: str
    lex_par: str
